...
| **[tools.ozone.moderation.emitEvent](https://pub.dev/documentation/bluesky/latest/ozone/ModerationService/emitEvent.html)** | [Reference](lexicons/tools/ozone/moderation/emitEvent.md) | ✅ | ❌ |
...
| **[tools.ozone.moderation.getEvent](https://pub.dev/documentation/bluesky/latest/ozone/ModerationService/getEvent.html)** | [Reference](lexicons/tools/ozone/moderation/getEvent.md) | ✅ | ❌ |

### tools.ozone.server

| Method | Docs | Auth Required | Paging (cursor) |
| --- | --- | :---: | :---: |
| **[tools.ozone.server.getConfig](https://pub.dev/documentation/bluesky/latest/ozone/ServerService/getConfig.html)** | [Reference](lexicons/tools/ozone/server/getConfig.md) | ❌ | ❌ |

### tools.ozone.communication

| Method | Docs | Auth Required | Paging (cursor) |
| --- | --- | :---: | :---: |
| **[tools.ozone.communication.listTemplates](https://pub.dev/documentation/bluesky/latest/ozone/CommunicationService/listTemplates.html)** | [Reference](lexicons/tools/ozone/communication/listTemplates.md) | ✅ | ❌ |
| **[tools.ozone.communication.createTemplate](https://pub.dev/documentation/bluesky/latest/ozone/CommunicationService/createTemplate.html)** | [Reference](lexicons/tools/ozone/communication/createTemplate.md) | ✅ | ❌ |
| **[tools.ozone.communication.deleteTemplate](https://pub.dev/documentation/bluesky/latest/ozone/CommunicationService/deleteTemplate.html)** | [Reference](lexicons/tools/ozone/communication/deleteTemplate.md) | ✅ | ❌ |
| **[tools.ozone.communication.updateTemplate](https://pub.dev/documentation/bluesky/latest/ozone/CommunicationService/updateTemplate.html)** | [Reference](lexicons/tools/ozone/communication/updateTemplate.md) | ✅ | ❌ |

### tools.ozone.team

| Method | Docs | Auth Required | Paging (cursor) |
| --- | --- | :---: | :---: |
| **[tools.ozone.team.deleteMember](https://pub.dev/documentation/bluesky/latest/ozone/TeamService/deleteMember.html)** | [Reference](lexicons/tools/ozone/team/deleteMember.md) | ❌ | ❌ |
| **[tools.ozone.team.listMembers](https://pub.dev/documentation/bluesky/latest/ozone/TeamService/listMembers.html)** | [Reference](lexicons/tools/ozone/team/listMembers.md) | ❌ | ✅ |
| **[tools.ozone.team.addMember](https://pub.dev/documentation/bluesky/latest/ozone/TeamService/addMember.html)** | [Reference](lexicons/tools/ozone/team/addMember.md) | ❌ | ❌ |
| **[tools.ozone.team.updateMember](https://pub.dev/documentation/bluesky/latest/ozone/TeamService/updateMember.html)** | [Reference](lexicons/tools/ozone/team/updateMember.md) | ❌ | ❌ |
