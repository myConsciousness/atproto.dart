...
final class QueryRulesCommand extends ProcedureCommand {
  QueryRulesCommand() {
    argParser
      ...
      ..addMultiOption(
        "urls",
        help: r"Filter by specific URLs or domains",
      )
      ..addOption(
        "patternType",
        help: r"Filter by pattern type",
      )
      ..addMultiOption(
        "actions",
        help: r"Filter by action types",
      )
      ..addOption(
        "reason",
        help: r"Filter by reason type",
      )
      ..addOption(
        "createdBy",
        help: r"Filter by rule creator",
      )
      ..addOption(
        "sortDirection",
        help: r"Sort direction",
        defaultsTo: "desc",
      );
  }
