...
final class ChatBskyNotificationCommand extends Command<void> {
  ...
  @override
  String get name => "chat-bsky-notification";

  @override
  String get description => "Provides commands for chat.bsky.notification.*";
}
