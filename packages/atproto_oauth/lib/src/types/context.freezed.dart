...
extension OAuthContextPatterns on OAuthContext {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_OAuthContext value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String codeVerifier, String state, String dpopNonce)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _OAuthContext() when $default != null:
        return $default(_that.codeVerifier, _that.state, _that.dpopNonce);
      case _:
        return orElse();
    }
  }
