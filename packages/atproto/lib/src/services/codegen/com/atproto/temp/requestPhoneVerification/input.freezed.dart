...
mixin _$TempRequestPhoneVerificationInput {
  ...
  $TempRequestPhoneVerificationInputCopyWith<TempRequestPhoneVerificationInput>
      get copyWith => _$TempRequestPhoneVerificationInputCopyWithImpl<
              TempRequestPhoneVerificationInput>(
          this as TempRequestPhoneVerificationInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TempRequestPhoneVerificationInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, phoneNumber, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $TempRequestPhoneVerificationInputCopyWith<$Res> {
  factory $TempRequestPhoneVerificationInputCopyWith(
          ...
          $Res Function(TempRequestPhoneVerificationInput) _then) =
      _$TempRequestPhoneVerificationInputCopyWithImpl;
  @useResult
...
extension TempRequestPhoneVerificationInputPatterns
    on TempRequestPhoneVerificationInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TempRequestPhoneVerificationInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String phoneNumber, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TempRequestPhoneVerificationInput() when $default != null:
        return $default(_that.phoneNumber, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _TempRequestPhoneVerificationInput
    implements TempRequestPhoneVerificationInput {
  const _TempRequestPhoneVerificationInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TempRequestPhoneVerificationInputCopyWith<
          _TempRequestPhoneVerificationInput>
      get copyWith => __$TempRequestPhoneVerificationInputCopyWithImpl<
          _TempRequestPhoneVerificationInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TempRequestPhoneVerificationInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TempRequestPhoneVerificationInput &&
            (identical(other.phoneNumber, phoneNumber) ||
                other.phoneNumber == phoneNumber) &&
...
/// @nodoc
abstract mixin class _$TempRequestPhoneVerificationInputCopyWith<$Res>
    implements $TempRequestPhoneVerificationInputCopyWith<$Res> {
  factory _$TempRequestPhoneVerificationInputCopyWith(
          _TempRequestPhoneVerificationInput value,
          $Res Function(_TempRequestPhoneVerificationInput) _then) =
      __$TempRequestPhoneVerificationInputCopyWithImpl;
  @override
  @useResult
  $Res call({String phoneNumber, Map<String, dynamic>? $unknown});
}
