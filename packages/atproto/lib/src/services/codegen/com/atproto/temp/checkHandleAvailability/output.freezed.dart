...
@pragma('vm:prefer-inline') @override $Res call({Object? handle = null,Object? result = null,Object? $unknown = freezed,}) {
  return _then(TempCheckHandleAvailabilityOutput(
...
class _TempCheckHandleAvailabilityOutput implements TempCheckHandleAvailabilityOutput {
  const _TempCheckHandleAvailabilityOutput({required this.handle, @UTempCheckHandleAvailabilityResultConverter() required this.result,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
