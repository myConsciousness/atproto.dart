...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? accounts = null,Object? $unknown = freezed,}) {
  return _then(AdminSearchAccountsOutput(
...
class _AdminSearchAccountsOutput implements AdminSearchAccountsOutput {
  const _AdminSearchAccountsOutput({this.cursor, @AccountViewConverter() required  List<AccountView> accounts,  Map<String, dynamic>? $unknown}): _accounts = accounts,_$unknown = $unknown;
