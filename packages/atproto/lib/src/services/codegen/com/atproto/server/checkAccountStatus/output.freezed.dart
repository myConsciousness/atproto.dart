...
mixin _$ServerCheckAccountStatusOutput {
  ...
  $ServerCheckAccountStatusOutputCopyWith<ServerCheckAccountStatusOutput>
      get copyWith => _$ServerCheckAccountStatusOutputCopyWithImpl<
              ServerCheckAccountStatusOutput>(
          this as ServerCheckAccountStatusOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCheckAccountStatusOutput &&
...
abstract mixin class $ServerCheckAccountStatusOutputCopyWith<$Res> {
  factory $ServerCheckAccountStatusOutputCopyWith(
          ...
          $Res Function(ServerCheckAccountStatusOutput) _then) =
      _$ServerCheckAccountStatusOutputCopyWithImpl;
  @useResult
  $Res call(
      {bool activated,
      bool validDid,
...
extension ServerCheckAccountStatusOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCheckAccountStatusOutput value)? $default, {
    ...
    switch (_that) {
      case _ServerCheckAccountStatusOutput() when $default != null:
        return $default(
            ...
            _that.repoRev,
            _that.repoBlocks,
            _that.indexedRecords,
            _that.privateStateValues,
            _that.expectedBlobs,
            _that.importedBlobs,
            _that.$unknown);
      case _:
...
/// @nodoc
@JsonSerializable()
class _ServerCheckAccountStatusOutput
    implements ServerCheckAccountStatusOutput {
  const _ServerCheckAccountStatusOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCheckAccountStatusOutputCopyWith<_ServerCheckAccountStatusOutput>
      get copyWith => __$ServerCheckAccountStatusOutputCopyWithImpl<
          _ServerCheckAccountStatusOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCheckAccountStatusOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCheckAccountStatusOutput &&
            (identical(other.activated, activated) ||
                other.activated == activated) &&
            (identical(other.validDid, validDid) ||
                other.validDid == validDid) &&
...
/// @nodoc
abstract mixin class _$ServerCheckAccountStatusOutputCopyWith<$Res>
    implements $ServerCheckAccountStatusOutputCopyWith<$Res> {
  factory _$ServerCheckAccountStatusOutputCopyWith(
          _ServerCheckAccountStatusOutput value,
          $Res Function(_ServerCheckAccountStatusOutput) _then) =
      __$ServerCheckAccountStatusOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool activated,
