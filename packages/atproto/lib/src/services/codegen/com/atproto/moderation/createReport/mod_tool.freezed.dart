...
class _ModTool implements ModTool {
  const _ModTool({this.$type = 'com.atproto.moderation.createReport#modTool', required this.name,  Map<String, dynamic>? meta,  Map<String, dynamic>? $unknown}): _meta = meta,_$unknown = $unknown;
