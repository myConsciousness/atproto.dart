...
class _StatusAttr implements StatusAttr {
  const _StatusAttr({this.$type = 'com.atproto.admin.defs#statusAttr', required this.applied, this.ref,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
