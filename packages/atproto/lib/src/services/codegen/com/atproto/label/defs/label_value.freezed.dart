...
extension LabelValuePatterns on LabelValue {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case LabelValueUnknown() when unknown != null:
...
class LabelValueKnownValue extends LabelValue {
  ...
  $LabelValueKnownValueCopyWith<LabelValueKnownValue> get copyWith =>
      _$LabelValueKnownValueCopyWithImpl<LabelValueKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $LabelValueKnownValueCopyWith<$Res>
    implements $LabelValueCopyWith<$Res> {
  factory $LabelValueKnownValueCopyWith(LabelValueKnownValue value,
          $Res Function(LabelValueKnownValue) _then) =
      _$LabelValueKnownValueCopyWithImpl;
  @useResult
...
class LabelValueUnknown extends LabelValue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $LabelValueUnknownCopyWith<LabelValueUnknown> get copyWith =>
      _$LabelValueUnknownCopyWithImpl<LabelValueUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LabelValueUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $LabelValueUnknownCopyWith<$Res>
    implements $LabelValueCopyWith<$Res> {
  factory $LabelValueUnknownCopyWith(
          LabelValueUnknown value, $Res Function(LabelValueUnknown) _then) =
      _$LabelValueUnknownCopyWithImpl;
  @useResult
