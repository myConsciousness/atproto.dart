...
class _AppPassword implements AppPassword {
  const _AppPassword({this.$type = 'com.atproto.server.createAppPassword#appPassword', required this.name, required this.password, @JsonKey(toJson: iso8601) required this.createdAt, this.privileged,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
