...
mixin _$AdminGetSubjectStatusOutput {
  ...
  $AdminGetSubjectStatusOutputCopyWith<AdminGetSubjectStatusOutput>
      get copyWith => _$AdminGetSubjectStatusOutputCopyWithImpl<
              AdminGetSubjectStatusOutput>(
          this as AdminGetSubjectStatusOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminGetSubjectStatusOutput &&
...
abstract mixin class $AdminGetSubjectStatusOutputCopyWith<$Res> {
  factory $AdminGetSubjectStatusOutputCopyWith(
          ...
          $Res Function(AdminGetSubjectStatusOutput) _then) =
      _$AdminGetSubjectStatusOutputCopyWithImpl;
  @useResult
  $Res call(
      {@UAdminGetSubjectStatusSubjectConverter()
...
extension AdminGetSubjectStatusOutputPatterns on AdminGetSubjectStatusOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminGetSubjectStatusOutput value)? $default, {
...
class _AdminGetSubjectStatusOutput implements AdminGetSubjectStatusOutput {
  const _AdminGetSubjectStatusOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminGetSubjectStatusOutputCopyWith<_AdminGetSubjectStatusOutput>
      get copyWith => __$AdminGetSubjectStatusOutputCopyWithImpl<
          _AdminGetSubjectStatusOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminGetSubjectStatusOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminGetSubjectStatusOutput &&
            (identical(other.subject, subject) || other.subject == subject) &&
            (identical(other.takedown, takedown) ||
                other.takedown == takedown) &&
            (identical(other.deactivated, deactivated) ||
...
/// @nodoc
abstract mixin class _$AdminGetSubjectStatusOutputCopyWith<$Res>
    implements $AdminGetSubjectStatusOutputCopyWith<$Res> {
  factory _$AdminGetSubjectStatusOutputCopyWith(
          _AdminGetSubjectStatusOutput value,
          $Res Function(_AdminGetSubjectStatusOutput) _then) =
      __$AdminGetSubjectStatusOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@UAdminGetSubjectStatusSubjectConverter()
