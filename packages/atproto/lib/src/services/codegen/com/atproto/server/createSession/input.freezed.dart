...
mixin _$ServerCreateSessionInput {
  ...
  $ServerCreateSessionInputCopyWith<ServerCreateSessionInput> get copyWith =>
      _$ServerCreateSessionInputCopyWithImpl<ServerCreateSessionInput>(
          this as ServerCreateSessionInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateSessionInput &&
...
abstract mixin class $ServerCreateSessionInputCopyWith<$Res> {
  factory $ServerCreateSessionInputCopyWith(ServerCreateSessionInput value,
          $Res Function(ServerCreateSessionInput) _then) =
      _$ServerCreateSessionInputCopyWithImpl;
  @useResult
  $Res call(
      {String identifier,
      String password,
...
extension ServerCreateSessionInputPatterns on ServerCreateSessionInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCreateSessionInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerCreateSessionInput() when $default != null:
        return $default(_that.identifier, _that.password, _that.authFactorToken,
            _that.allowTakendown, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerCreateSessionInput implements ServerCreateSessionInput {
  const _ServerCreateSessionInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCreateSessionInputCopyWith<_ServerCreateSessionInput> get copyWith =>
      __$ServerCreateSessionInputCopyWithImpl<_ServerCreateSessionInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCreateSessionInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCreateSessionInput &&
            (identical(other.identifier, identifier) ||
                other.identifier == identifier) &&
            (identical(other.password, password) ||
                other.password == password) &&
...
/// @nodoc
abstract mixin class _$ServerCreateSessionInputCopyWith<$Res>
    implements $ServerCreateSessionInputCopyWith<$Res> {
  factory _$ServerCreateSessionInputCopyWith(_ServerCreateSessionInput value,
          $Res Function(_ServerCreateSessionInput) _then) =
      __$ServerCreateSessionInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String identifier,
