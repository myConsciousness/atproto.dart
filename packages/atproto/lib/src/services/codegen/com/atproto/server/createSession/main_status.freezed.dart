  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateSessionStatus &&
...
class $ServerCreateSessionStatusCopyWith<$Res> {
  $ServerCreateSessionStatusCopyWith(
      ServerCreateSessionStatus _, $Res Function(ServerCreateSessionStatus) __);
}
...
extension ServerCreateSessionStatusPatterns on ServerCreateSessionStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ServerCreateSessionStatusUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ServerCreateSessionStatusKnownValue():
        return knownValue(_that);
      case ServerCreateSessionStatusUnknown():
        return unknown(_that);
      case _:
...
class ServerCreateSessionStatusKnownValue extends ServerCreateSessionStatus {
  ...
  $ServerCreateSessionStatusKnownValueCopyWith<
          ServerCreateSessionStatusKnownValue>
      get copyWith => _$ServerCreateSessionStatusKnownValueCopyWithImpl<
          ServerCreateSessionStatusKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateSessionStatusKnownValue &&
...
/// @nodoc
abstract mixin class $ServerCreateSessionStatusKnownValueCopyWith<$Res>
    implements $ServerCreateSessionStatusCopyWith<$Res> {
  factory $ServerCreateSessionStatusKnownValueCopyWith(
          ServerCreateSessionStatusKnownValue value,
          $Res Function(ServerCreateSessionStatusKnownValue) _then) =
      _$ServerCreateSessionStatusKnownValueCopyWithImpl;
  @useResult
...
class ServerCreateSessionStatusUnknown extends ServerCreateSessionStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ServerCreateSessionStatusUnknownCopyWith<ServerCreateSessionStatusUnknown>
      get copyWith => _$ServerCreateSessionStatusUnknownCopyWithImpl<
          ServerCreateSessionStatusUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateSessionStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ServerCreateSessionStatusUnknownCopyWith<$Res>
    implements $ServerCreateSessionStatusCopyWith<$Res> {
  factory $ServerCreateSessionStatusUnknownCopyWith(
          ServerCreateSessionStatusUnknown value,
          $Res Function(ServerCreateSessionStatusUnknown) _then) =
      _$ServerCreateSessionStatusUnknownCopyWithImpl;
  @useResult
