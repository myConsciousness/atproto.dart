...
mixin _$AdminUpdateAccountPasswordInput {
  ...
  $AdminUpdateAccountPasswordInputCopyWith<AdminUpdateAccountPasswordInput>
      get copyWith => _$AdminUpdateAccountPasswordInputCopyWithImpl<
              AdminUpdateAccountPasswordInput>(
          this as AdminUpdateAccountPasswordInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateAccountPasswordInput &&
...
abstract mixin class $AdminUpdateAccountPasswordInputCopyWith<$Res> {
  factory $AdminUpdateAccountPasswordInputCopyWith(
          ...
          $Res Function(AdminUpdateAccountPasswordInput) _then) =
      _$AdminUpdateAccountPasswordInputCopyWithImpl;
  @useResult
...
extension AdminUpdateAccountPasswordInputPatterns
    on AdminUpdateAccountPasswordInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminUpdateAccountPasswordInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AdminUpdateAccountPasswordInput() when $default != null:
        return $default(_that.did, _that.password, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _AdminUpdateAccountPasswordInput
    implements AdminUpdateAccountPasswordInput {
  const _AdminUpdateAccountPasswordInput(
      {required this.did,
      required this.password,
      final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _AdminUpdateAccountPasswordInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateAccountPasswordInputCopyWith<_AdminUpdateAccountPasswordInput>
      get copyWith => __$AdminUpdateAccountPasswordInputCopyWithImpl<
          _AdminUpdateAccountPasswordInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateAccountPasswordInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateAccountPasswordInput &&
            (identical(other.did, did) || other.did == did) &&
            (identical(other.password, password) ||
                other.password == password) &&
...
/// @nodoc
abstract mixin class _$AdminUpdateAccountPasswordInputCopyWith<$Res>
    implements $AdminUpdateAccountPasswordInputCopyWith<$Res> {
  factory _$AdminUpdateAccountPasswordInputCopyWith(
          _AdminUpdateAccountPasswordInput value,
          $Res Function(_AdminUpdateAccountPasswordInput) _then) =
      __$AdminUpdateAccountPasswordInputCopyWithImpl;
  @override
  @useResult
  $Res call({String did, String password, Map<String, dynamic>? $unknown});
}
