...
mixin _$AdminSearchAccountsInput {
  ...
  $AdminSearchAccountsInputCopyWith<AdminSearchAccountsInput> get copyWith =>
      _$AdminSearchAccountsInputCopyWithImpl<AdminSearchAccountsInput>(
          this as AdminSearchAccountsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminSearchAccountsInput &&
...
abstract mixin class $AdminSearchAccountsInputCopyWith<$Res> {
  factory $AdminSearchAccountsInputCopyWith(AdminSearchAccountsInput value,
          $Res Function(AdminSearchAccountsInput) _then) =
      _$AdminSearchAccountsInputCopyWithImpl;
  @useResult
  $Res call(
      {String? email,
      String? cursor,
...
extension AdminSearchAccountsInputPatterns on AdminSearchAccountsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminSearchAccountsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? email, String? cursor, int limit,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AdminSearchAccountsInput() when $default != null:
        return $default(_that.email, _that.cursor, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminSearchAccountsInput implements AdminSearchAccountsInput {
  const _AdminSearchAccountsInput(
      {this.email,
      this.cursor,
      this.limit = 50,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminSearchAccountsInputCopyWith<_AdminSearchAccountsInput> get copyWith =>
      __$AdminSearchAccountsInputCopyWithImpl<_AdminSearchAccountsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminSearchAccountsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminSearchAccountsInput &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$AdminSearchAccountsInputCopyWith<$Res>
    implements $AdminSearchAccountsInputCopyWith<$Res> {
  factory _$AdminSearchAccountsInputCopyWith(_AdminSearchAccountsInput value,
          $Res Function(_AdminSearchAccountsInput) _then) =
      __$AdminSearchAccountsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? email,
