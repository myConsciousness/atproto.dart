...
extension HostStatusPatterns on HostStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case HostStatusUnknown() when unknown != null:
...
class HostStatusKnownValue extends HostStatus {
  ...
  $HostStatusKnownValueCopyWith<HostStatusKnownValue> get copyWith =>
      _$HostStatusKnownValueCopyWithImpl<HostStatusKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $HostStatusKnownValueCopyWith<$Res>
    implements $HostStatusCopyWith<$Res> {
  factory $HostStatusKnownValueCopyWith(HostStatusKnownValue value,
          $Res Function(HostStatusKnownValue) _then) =
      _$HostStatusKnownValueCopyWithImpl;
  @useResult
...
class HostStatusUnknown extends HostStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $HostStatusUnknownCopyWith<HostStatusUnknown> get copyWith =>
      _$HostStatusUnknownCopyWithImpl<HostStatusUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is HostStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $HostStatusUnknownCopyWith<$Res>
    implements $HostStatusCopyWith<$Res> {
  factory $HostStatusUnknownCopyWith(
          HostStatusUnknown value, $Res Function(HostStatusUnknown) _then) =
      _$HostStatusUnknownCopyWithImpl;
  @useResult
