...
class _ThreatSignature implements ThreatSignature {
  const _ThreatSignature({this.$type = 'com.atproto.admin.defs#threatSignature', required this.property, required this.value,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
