...
extension RepoOpActionPatterns on RepoOpAction {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case RepoOpActionUnknown() when unknown != null:
...
class RepoOpActionKnownValue extends RepoOpAction {
  ...
  $RepoOpActionKnownValueCopyWith<RepoOpActionKnownValue> get copyWith =>
      _$RepoOpActionKnownValueCopyWithImpl<RepoOpActionKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoOpActionKnownValue &&
...
/// @nodoc
abstract mixin class $RepoOpActionKnownValueCopyWith<$Res>
    implements $RepoOpActionCopyWith<$Res> {
  factory $RepoOpActionKnownValueCopyWith(RepoOpActionKnownValue value,
          $Res Function(RepoOpActionKnownValue) _then) =
      _$RepoOpActionKnownValueCopyWithImpl;
  @useResult
...
class RepoOpActionUnknown extends RepoOpAction {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RepoOpActionUnknownCopyWith<RepoOpActionUnknown> get copyWith =>
      _$RepoOpActionUnknownCopyWithImpl<RepoOpActionUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoOpActionUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $RepoOpActionUnknownCopyWith<$Res>
    implements $RepoOpActionCopyWith<$Res> {
  factory $RepoOpActionUnknownCopyWith(
          RepoOpActionUnknown value, $Res Function(RepoOpActionUnknown) _then) =
      _$RepoOpActionUnknownCopyWithImpl;
  @useResult
