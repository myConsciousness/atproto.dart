...
class _RepoBlobRef implements RepoBlobRef {
  const _RepoBlobRef({this.$type = 'com.atproto.admin.defs#repoBlobRef', required this.did, required this.cid, @AtUriConverter() this.recordUri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
