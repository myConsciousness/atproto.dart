  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetSessionStatus &&
...
class $ServerGetSessionStatusCopyWith<$Res> {
  $ServerGetSessionStatusCopyWith(
      ServerGetSessionStatus _, $Res Function(ServerGetSessionStatus) __);
}
...
extension ServerGetSessionStatusPatterns on ServerGetSessionStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ServerGetSessionStatusUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ServerGetSessionStatusKnownValue():
        return knownValue(_that);
      case ServerGetSessionStatusUnknown():
        return unknown(_that);
      case _:
...
class ServerGetSessionStatusKnownValue extends ServerGetSessionStatus {
  ...
  $ServerGetSessionStatusKnownValueCopyWith<ServerGetSessionStatusKnownValue>
      get copyWith => _$ServerGetSessionStatusKnownValueCopyWithImpl<
          ServerGetSessionStatusKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetSessionStatusKnownValue &&
...
/// @nodoc
abstract mixin class $ServerGetSessionStatusKnownValueCopyWith<$Res>
    implements $ServerGetSessionStatusCopyWith<$Res> {
  factory $ServerGetSessionStatusKnownValueCopyWith(
          ServerGetSessionStatusKnownValue value,
          $Res Function(ServerGetSessionStatusKnownValue) _then) =
      _$ServerGetSessionStatusKnownValueCopyWithImpl;
  @useResult
...
class ServerGetSessionStatusUnknown extends ServerGetSessionStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ServerGetSessionStatusUnknownCopyWith<ServerGetSessionStatusUnknown>
      get copyWith => _$ServerGetSessionStatusUnknownCopyWithImpl<
          ServerGetSessionStatusUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetSessionStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ServerGetSessionStatusUnknownCopyWith<$Res>
    implements $ServerGetSessionStatusCopyWith<$Res> {
  factory $ServerGetSessionStatusUnknownCopyWith(
          ServerGetSessionStatusUnknown value,
          $Res Function(ServerGetSessionStatusUnknown) _then) =
      _$ServerGetSessionStatusUnknownCopyWithImpl;
  @useResult
