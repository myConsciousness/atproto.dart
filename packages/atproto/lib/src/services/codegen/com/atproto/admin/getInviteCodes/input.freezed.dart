...
mixin _$AdminGetInviteCodesInput {
  ...
  $AdminGetInviteCodesInputCopyWith<AdminGetInviteCodesInput> get copyWith =>
      _$AdminGetInviteCodesInputCopyWithImpl<AdminGetInviteCodesInput>(
          this as AdminGetInviteCodesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminGetInviteCodesInput &&
...
abstract mixin class $AdminGetInviteCodesInputCopyWith<$Res> {
  factory $AdminGetInviteCodesInputCopyWith(AdminGetInviteCodesInput value,
          $Res Function(AdminGetInviteCodesInput) _then) =
      _$AdminGetInviteCodesInputCopyWithImpl;
  @useResult
  $Res call(
...
extension AdminGetInviteCodesInputPatterns on AdminGetInviteCodesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminGetInviteCodesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AdminGetInviteCodesInput() when $default != null:
        return $default(_that.sort, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminGetInviteCodesInput implements AdminGetInviteCodesInput {
  const _AdminGetInviteCodesInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminGetInviteCodesInputCopyWith<_AdminGetInviteCodesInput> get copyWith =>
      __$AdminGetInviteCodesInputCopyWithImpl<_AdminGetInviteCodesInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminGetInviteCodesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminGetInviteCodesInput &&
            (identical(other.sort, sort) || other.sort == sort) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$AdminGetInviteCodesInputCopyWith<$Res>
    implements $AdminGetInviteCodesInputCopyWith<$Res> {
  factory _$AdminGetInviteCodesInputCopyWith(_AdminGetInviteCodesInput value,
          $Res Function(_AdminGetInviteCodesInput) _then) =
      __$AdminGetInviteCodesInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@AdminGetInviteCodesSortConverter() AdminGetInviteCodesSort? sort,
