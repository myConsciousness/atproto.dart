...
mixin _$Suggestion {
 ...
 String get $type; String get handle;/// Method used to build this suggestion. Should be considered opaque to clients. Can be used for metrics.
 String get method; Map<String, dynamic>? get $unknown;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Suggestion&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.handle, handle) || other.handle == handle)&&(identical(other.method, method) || other.method == method)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,handle,method,const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type, String handle, String method, Map<String, dynamic>? $unknown
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String handle,  String method,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Suggestion() when $default != null:
return $default(_that.$type,_that.handle,_that.method,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String handle,  String method,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _Suggestion():
return $default(_that.$type,_that.handle,_that.method,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String handle,  String method,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _Suggestion() when $default != null:
return $default(_that.$type,_that.handle,_that.method,_that.$unknown);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Suggestion&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.handle, handle) || other.handle == handle)&&(identical(other.method, method) || other.method == method)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,handle,method,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of Suggestion
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? handle = null,Object? method = null,Object? $unknown = freezed,}) {
