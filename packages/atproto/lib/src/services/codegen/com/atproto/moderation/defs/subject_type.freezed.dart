...
extension SubjectTypePatterns on SubjectType {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SubjectTypeUnknown() when unknown != null:
...
class SubjectTypeKnownValue extends SubjectType {
  ...
  $SubjectTypeKnownValueCopyWith<SubjectTypeKnownValue> get copyWith =>
      _$SubjectTypeKnownValueCopyWithImpl<SubjectTypeKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SubjectTypeKnownValue &&
...
/// @nodoc
abstract mixin class $SubjectTypeKnownValueCopyWith<$Res>
    implements $SubjectTypeCopyWith<$Res> {
  factory $SubjectTypeKnownValueCopyWith(SubjectTypeKnownValue value,
          $Res Function(SubjectTypeKnownValue) _then) =
      _$SubjectTypeKnownValueCopyWithImpl;
  @useResult
...
class SubjectTypeUnknown extends SubjectType {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SubjectTypeUnknownCopyWith<SubjectTypeUnknown> get copyWith =>
      _$SubjectTypeUnknownCopyWithImpl<SubjectTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SubjectTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $SubjectTypeUnknownCopyWith<$Res>
    implements $SubjectTypeCopyWith<$Res> {
  factory $SubjectTypeUnknownCopyWith(
          SubjectTypeUnknown value, $Res Function(SubjectTypeUnknown) _then) =
      _$SubjectTypeUnknownCopyWithImpl;
  @useResult
