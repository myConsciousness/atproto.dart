...
mixin _$AdminGetAccountInfosOutput {
  ...
  $AdminGetAccountInfosOutputCopyWith<AdminGetAccountInfosOutput>
      get copyWith =>
          _$AdminGetAccountInfosOutputCopyWithImpl<AdminGetAccountInfosOutput>(
              this as AdminGetAccountInfosOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminGetAccountInfosOutput &&
...
abstract mixin class $AdminGetAccountInfosOutputCopyWith<$Res> {
  factory $AdminGetAccountInfosOutputCopyWith(AdminGetAccountInfosOutput value,
          $Res Function(AdminGetAccountInfosOutput) _then) =
      _$AdminGetAccountInfosOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension AdminGetAccountInfosOutputPatterns on AdminGetAccountInfosOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminGetAccountInfosOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@AccountViewConverter() List<AccountView> infos,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AdminGetAccountInfosOutput() when $default != null:
        return $default(_that.infos, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminGetAccountInfosOutput implements AdminGetAccountInfosOutput {
  const _AdminGetAccountInfosOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminGetAccountInfosOutputCopyWith<_AdminGetAccountInfosOutput>
      get copyWith => __$AdminGetAccountInfosOutputCopyWithImpl<
          _AdminGetAccountInfosOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminGetAccountInfosOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminGetAccountInfosOutput &&
...
/// @nodoc
abstract mixin class _$AdminGetAccountInfosOutputCopyWith<$Res>
    implements $AdminGetAccountInfosOutputCopyWith<$Res> {
  factory _$AdminGetAccountInfosOutputCopyWith(
          _AdminGetAccountInfosOutput value,
          $Res Function(_AdminGetAccountInfosOutput) _then) =
      __$AdminGetAccountInfosOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@AccountViewConverter() List<AccountView> infos,
