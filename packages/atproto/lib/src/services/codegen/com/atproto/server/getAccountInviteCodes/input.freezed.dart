...
mixin _$ServerGetAccountInviteCodesInput {
  ...
  $ServerGetAccountInviteCodesInputCopyWith<ServerGetAccountInviteCodesInput>
      get copyWith => _$ServerGetAccountInviteCodesInputCopyWithImpl<
              ServerGetAccountInviteCodesInput>(
          this as ServerGetAccountInviteCodesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetAccountInviteCodesInput &&
...
abstract mixin class $ServerGetAccountInviteCodesInputCopyWith<$Res> {
  factory $ServerGetAccountInviteCodesInputCopyWith(
          ...
          $Res Function(ServerGetAccountInviteCodesInput) _then) =
      _$ServerGetAccountInviteCodesInputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerGetAccountInviteCodesInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerGetAccountInviteCodesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool includeUsed, bool createAvailable,
    ...
    switch (_that) {
      case _ServerGetAccountInviteCodesInput() when $default != null:
        return $default(
            _that.includeUsed, _that.createAvailable, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ServerGetAccountInviteCodesInput
    implements ServerGetAccountInviteCodesInput {
  const _ServerGetAccountInviteCodesInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerGetAccountInviteCodesInputCopyWith<_ServerGetAccountInviteCodesInput>
      get copyWith => __$ServerGetAccountInviteCodesInputCopyWithImpl<
          _ServerGetAccountInviteCodesInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerGetAccountInviteCodesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerGetAccountInviteCodesInput &&
            (identical(other.includeUsed, includeUsed) ||
                other.includeUsed == includeUsed) &&
            (identical(other.createAvailable, createAvailable) ||
                other.createAvailable == createAvailable) &&
...
/// @nodoc
abstract mixin class _$ServerGetAccountInviteCodesInputCopyWith<$Res>
    implements $ServerGetAccountInviteCodesInputCopyWith<$Res> {
  factory _$ServerGetAccountInviteCodesInputCopyWith(
          _ServerGetAccountInviteCodesInput value,
          $Res Function(_ServerGetAccountInviteCodesInput) _then) =
      __$ServerGetAccountInviteCodesInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool includeUsed, bool createAvailable, Map<String, dynamic>? $unknown});
