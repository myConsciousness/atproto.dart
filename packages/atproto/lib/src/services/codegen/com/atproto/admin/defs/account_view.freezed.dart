...
mixin _$AccountView {
  ...
  $AccountViewCopyWith<AccountView> get copyWith =>
      _$AccountViewCopyWithImpl<AccountView>(this as AccountView, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.threatSignatures, threatSignatures) &&
  ...
  int get hashCode => Object.hash(
      ...
      handle,
      email,
      const DeepCollectionEquality().hash(relatedRecords),
      indexedAt,
      invitedBy,
      ...
      inviteNote,
      deactivatedAt,
      const DeepCollectionEquality().hash(threatSignatures),
...
abstract mixin class $AccountViewCopyWith<$Res> {
  factory $AccountViewCopyWith(
          AccountView value, $Res Function(AccountView) _then) =
      _$AccountViewCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String did,
...
/// @nodoc
class _$AccountViewCopyWithImpl<$Res> implements $AccountViewCopyWith<$Res> {
...
extension AccountViewPatterns on AccountView {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AccountView value)? $default, {
    ...
    switch (_that) {
      case _AccountView() when $default != null:
        return $default(
            ...
            _that.handle,
            _that.email,
            _that.relatedRecords,
            _that.indexedAt,
            _that.invitedBy,
            _that.invites,
            _that.invitesDisabled,
            _that.emailConfirmedAt,
            _that.inviteNote,
            _that.deactivatedAt,
            _that.threatSignatures,
            _that.$unknown);
      case _:
        return orElse();
    }
...
class _AccountView implements AccountView {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AccountViewCopyWith<_AccountView> get copyWith =>
      __$AccountViewCopyWithImpl<_AccountView>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AccountViewToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AccountViewCopyWith<$Res>
    implements $AccountViewCopyWith<$Res> {
  factory _$AccountViewCopyWith(
          _AccountView value, $Res Function(_AccountView) _then) =
      __$AccountViewCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
...
/// @nodoc
class __$AccountViewCopyWithImpl<$Res> implements _$AccountViewCopyWith<$Res> {
