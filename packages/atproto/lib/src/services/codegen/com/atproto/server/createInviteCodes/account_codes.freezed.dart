...
extension AccountCodesPatterns on AccountCodes {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AccountCodes value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String account, List<String> codes,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AccountCodes() when $default != null:
        return $default(
            _that.$type, _that.account, _that.codes, _that.$unknown);
      case _:
        return orElse();
    }
  }
