...
mixin _$ServerDeleteAccountInput {
  ...
  $ServerDeleteAccountInputCopyWith<ServerDeleteAccountInput> get copyWith =>
      _$ServerDeleteAccountInputCopyWithImpl<ServerDeleteAccountInput>(
          this as ServerDeleteAccountInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerDeleteAccountInput &&
...
abstract mixin class $ServerDeleteAccountInputCopyWith<$Res> {
  factory $ServerDeleteAccountInputCopyWith(ServerDeleteAccountInput value,
          $Res Function(ServerDeleteAccountInput) _then) =
      _$ServerDeleteAccountInputCopyWithImpl;
  @useResult
  $Res call(
      {String did,
      String password,
...
extension ServerDeleteAccountInputPatterns on ServerDeleteAccountInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerDeleteAccountInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String did, String password, String token,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServerDeleteAccountInput() when $default != null:
        return $default(_that.did, _that.password, _that.token, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerDeleteAccountInput implements ServerDeleteAccountInput {
  const _ServerDeleteAccountInput(
      {required this.did,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerDeleteAccountInputCopyWith<_ServerDeleteAccountInput> get copyWith =>
      __$ServerDeleteAccountInputCopyWithImpl<_ServerDeleteAccountInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerDeleteAccountInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerDeleteAccountInput &&
            (identical(other.did, did) || other.did == did) &&
            (identical(other.password, password) ||
                other.password == password) &&
            (identical(other.token, token) || other.token == token) &&
...
/// @nodoc
abstract mixin class _$ServerDeleteAccountInputCopyWith<$Res>
    implements $ServerDeleteAccountInputCopyWith<$Res> {
  factory _$ServerDeleteAccountInputCopyWith(_ServerDeleteAccountInput value,
          $Res Function(_ServerDeleteAccountInput) _then) =
      __$ServerDeleteAccountInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String did,
