...
mixin _$AdminUpdateAccountEmailInput {
  ...
  $AdminUpdateAccountEmailInputCopyWith<AdminUpdateAccountEmailInput>
      get copyWith => _$AdminUpdateAccountEmailInputCopyWithImpl<
              AdminUpdateAccountEmailInput>(
          this as AdminUpdateAccountEmailInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateAccountEmailInput &&
...
abstract mixin class $AdminUpdateAccountEmailInputCopyWith<$Res> {
  factory $AdminUpdateAccountEmailInputCopyWith(
          ...
          $Res Function(AdminUpdateAccountEmailInput) _then) =
      _$AdminUpdateAccountEmailInputCopyWithImpl;
  @useResult
...
extension AdminUpdateAccountEmailInputPatterns on AdminUpdateAccountEmailInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminUpdateAccountEmailInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AdminUpdateAccountEmailInput() when $default != null:
        return $default(_that.account, _that.email, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminUpdateAccountEmailInput implements AdminUpdateAccountEmailInput {
  const _AdminUpdateAccountEmailInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateAccountEmailInputCopyWith<_AdminUpdateAccountEmailInput>
      get copyWith => __$AdminUpdateAccountEmailInputCopyWithImpl<
          _AdminUpdateAccountEmailInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateAccountEmailInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateAccountEmailInput &&
            (identical(other.account, account) || other.account == account) &&
            (identical(other.email, email) || other.email == email) &&
...
/// @nodoc
abstract mixin class _$AdminUpdateAccountEmailInputCopyWith<$Res>
    implements $AdminUpdateAccountEmailInputCopyWith<$Res> {
  factory _$AdminUpdateAccountEmailInputCopyWith(
          _AdminUpdateAccountEmailInput value,
          $Res Function(_AdminUpdateAccountEmailInput) _then) =
      __$AdminUpdateAccountEmailInputCopyWithImpl;
  @override
  @useResult
  $Res call({String account, String email, Map<String, dynamic>? $unknown});
}
