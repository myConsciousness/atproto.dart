...
mixin _$AdminUpdateAccountHandleInput {
  ...
  $AdminUpdateAccountHandleInputCopyWith<AdminUpdateAccountHandleInput>
      get copyWith => _$AdminUpdateAccountHandleInputCopyWithImpl<
              AdminUpdateAccountHandleInput>(
          this as AdminUpdateAccountHandleInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateAccountHandleInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, did, handle, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $AdminUpdateAccountHandleInputCopyWith<$Res> {
  factory $AdminUpdateAccountHandleInputCopyWith(
          ...
          $Res Function(AdminUpdateAccountHandleInput) _then) =
      _$AdminUpdateAccountHandleInputCopyWithImpl;
  @useResult
...
extension AdminUpdateAccountHandleInputPatterns
    on AdminUpdateAccountHandleInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminUpdateAccountHandleInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String did, String handle, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AdminUpdateAccountHandleInput() when $default != null:
        return $default(_that.did, _that.handle, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminUpdateAccountHandleInput implements AdminUpdateAccountHandleInput {
  const _AdminUpdateAccountHandleInput(
      {required this.did,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateAccountHandleInputCopyWith<_AdminUpdateAccountHandleInput>
      get copyWith => __$AdminUpdateAccountHandleInputCopyWithImpl<
          _AdminUpdateAccountHandleInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateAccountHandleInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateAccountHandleInput &&
            (identical(other.did, did) || other.did == did) &&
            (identical(other.handle, handle) || other.handle == handle) &&
...
/// @nodoc
abstract mixin class _$AdminUpdateAccountHandleInputCopyWith<$Res>
    implements $AdminUpdateAccountHandleInputCopyWith<$Res> {
  factory _$AdminUpdateAccountHandleInputCopyWith(
          _AdminUpdateAccountHandleInput value,
          $Res Function(_AdminUpdateAccountHandleInput) _then) =
      __$AdminUpdateAccountHandleInputCopyWithImpl;
  @override
  @useResult
  $Res call({String did, String handle, Map<String, dynamic>? $unknown});
}
