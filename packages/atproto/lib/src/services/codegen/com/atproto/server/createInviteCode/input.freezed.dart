...
mixin _$ServerCreateInviteCodeInput {
  ...
  $ServerCreateInviteCodeInputCopyWith<ServerCreateInviteCodeInput>
      get copyWith => _$ServerCreateInviteCodeInputCopyWithImpl<
              ServerCreateInviteCodeInput>(
          this as ServerCreateInviteCodeInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateInviteCodeInput &&
...
abstract mixin class $ServerCreateInviteCodeInputCopyWith<$Res> {
  factory $ServerCreateInviteCodeInputCopyWith(
          ...
          $Res Function(ServerCreateInviteCodeInput) _then) =
      _$ServerCreateInviteCodeInputCopyWithImpl;
  @useResult
...
extension ServerCreateInviteCodeInputPatterns on ServerCreateInviteCodeInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCreateInviteCodeInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerCreateInviteCodeInput() when $default != null:
        return $default(_that.useCount, _that.forAccount, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerCreateInviteCodeInput implements ServerCreateInviteCodeInput {
  const _ServerCreateInviteCodeInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCreateInviteCodeInputCopyWith<_ServerCreateInviteCodeInput>
      get copyWith => __$ServerCreateInviteCodeInputCopyWithImpl<
          _ServerCreateInviteCodeInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCreateInviteCodeInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCreateInviteCodeInput &&
            (identical(other.useCount, useCount) ||
                other.useCount == useCount) &&
            (identical(other.forAccount, forAccount) ||
                other.forAccount == forAccount) &&
...
/// @nodoc
abstract mixin class _$ServerCreateInviteCodeInputCopyWith<$Res>
    implements $ServerCreateInviteCodeInputCopyWith<$Res> {
  factory _$ServerCreateInviteCodeInputCopyWith(
          _ServerCreateInviteCodeInput value,
          $Res Function(_ServerCreateInviteCodeInput) _then) =
      __$ServerCreateInviteCodeInputCopyWithImpl;
  @override
  @useResult
  $Res call({int useCount, String? forAccount, Map<String, dynamic>? $unknown});
}
