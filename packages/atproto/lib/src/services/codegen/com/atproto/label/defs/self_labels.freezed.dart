...
extension SelfLabelsPatterns on SelfLabels {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SelfLabels value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, @SelfLabelConverter() List<SelfLabel> values,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SelfLabels() when $default != null:
        return $default(_that.$type, _that.values, _that.$unknown);
      case _:
        return orElse();
    }
  }
