...
mixin _$RepoListRecordsRecord {
  ...
  $RepoListRecordsRecordCopyWith<RepoListRecordsRecord> get copyWith =>
      _$RepoListRecordsRecordCopyWithImpl<RepoListRecordsRecord>(
          this as RepoListRecordsRecord, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoListRecordsRecord &&
...
abstract mixin class $RepoListRecordsRecordCopyWith<$Res> {
  factory $RepoListRecordsRecordCopyWith(RepoListRecordsRecord value,
          $Res Function(RepoListRecordsRecord) _then) =
      _$RepoListRecordsRecordCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String uri,
...
extension RepoListRecordsRecordPatterns on RepoListRecordsRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoListRecordsRecord value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String uri, String cid,
            Map<String, dynamic> value, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RepoListRecordsRecord() when $default != null:
        return $default(
            _that.$type, _that.uri, _that.cid, _that.value, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoListRecordsRecord implements RepoListRecordsRecord {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoListRecordsRecordCopyWith<_RepoListRecordsRecord> get copyWith =>
      __$RepoListRecordsRecordCopyWithImpl<_RepoListRecordsRecord>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoListRecordsRecordToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoListRecordsRecord &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.cid, cid) || other.cid == cid) &&
...
/// @nodoc
abstract mixin class _$RepoListRecordsRecordCopyWith<$Res>
    implements $RepoListRecordsRecordCopyWith<$Res> {
  factory _$RepoListRecordsRecordCopyWith(_RepoListRecordsRecord value,
          $Res Function(_RepoListRecordsRecord) _then) =
      __$RepoListRecordsRecordCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
