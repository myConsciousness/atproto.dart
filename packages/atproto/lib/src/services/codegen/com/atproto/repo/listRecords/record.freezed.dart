...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? cid = null,Object? value = null,Object? $unknown = freezed,}) {
  return _then(RepoListRecordsRecord(
...
class _RepoListRecordsRecord implements RepoListRecordsRecord {
  const _RepoListRecordsRecord({this.$type = 'com.atproto.repo.listRecords#record', @AtUriConverter() required this.uri, required this.cid, required  Map<String, dynamic> value,  Map<String, dynamic>? $unknown}): _value = value,_$unknown = $unknown;
