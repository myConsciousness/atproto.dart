...
mixin _$SyncListReposByCollectionOutput {
  ...
  $SyncListReposByCollectionOutputCopyWith<SyncListReposByCollectionOutput>
      get copyWith => _$SyncListReposByCollectionOutputCopyWithImpl<
              SyncListReposByCollectionOutput>(
          this as SyncListReposByCollectionOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncListReposByCollectionOutput &&
...
abstract mixin class $SyncListReposByCollectionOutputCopyWith<$Res> {
  factory $SyncListReposByCollectionOutputCopyWith(
          ...
          $Res Function(SyncListReposByCollectionOutput) _then) =
      _$SyncListReposByCollectionOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension SyncListReposByCollectionOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncListReposByCollectionOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? cursor, @RepoConverter() List<Repo> repos,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SyncListReposByCollectionOutput() when $default != null:
        return $default(_that.cursor, _that.repos, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _SyncListReposByCollectionOutput
    implements SyncListReposByCollectionOutput {
  const _SyncListReposByCollectionOutput(
      {this.cursor,
      @RepoConverter() required final List<Repo> repos,
      final Map<String, dynamic>? $unknown})
      : _repos = repos,
        _$unknown = $unknown;
  factory _SyncListReposByCollectionOutput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncListReposByCollectionOutputCopyWith<_SyncListReposByCollectionOutput>
      get copyWith => __$SyncListReposByCollectionOutputCopyWithImpl<
          _SyncListReposByCollectionOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncListReposByCollectionOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncListReposByCollectionOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SyncListReposByCollectionOutputCopyWith<$Res>
    implements $SyncListReposByCollectionOutputCopyWith<$Res> {
  factory _$SyncListReposByCollectionOutputCopyWith(
          _SyncListReposByCollectionOutput value,
          $Res Function(_SyncListReposByCollectionOutput) _then) =
      __$SyncListReposByCollectionOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
