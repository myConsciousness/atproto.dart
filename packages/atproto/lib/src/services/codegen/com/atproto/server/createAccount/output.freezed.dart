...
@pragma('vm:prefer-inline') @override $Res call({Object? accessJwt = null,Object? refreshJwt = null,Object? handle = null,Object? did = null,Object? didDoc = freezed,Object? $unknown = freezed,}) {
  return _then(ServerCreateAccountOutput(
...
class _ServerCreateAccountOutput implements ServerCreateAccountOutput {
  const _ServerCreateAccountOutput({required this.accessJwt, required this.refreshJwt, required this.handle, required this.did,  Map<String, dynamic>? didDoc,  Map<String, dynamic>? $unknown}): _didDoc = didDoc,_$unknown = $unknown;
