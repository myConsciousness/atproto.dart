...
mixin _$SyncGetLatestCommitOutput {
  ...
  $SyncGetLatestCommitOutputCopyWith<SyncGetLatestCommitOutput> get copyWith =>
      _$SyncGetLatestCommitOutputCopyWithImpl<SyncGetLatestCommitOutput>(
          this as SyncGetLatestCommitOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncGetLatestCommitOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, cid, rev, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $SyncGetLatestCommitOutputCopyWith<$Res> {
  factory $SyncGetLatestCommitOutputCopyWith(SyncGetLatestCommitOutput value,
          $Res Function(SyncGetLatestCommitOutput) _then) =
      _$SyncGetLatestCommitOutputCopyWithImpl;
  @useResult
...
extension SyncGetLatestCommitOutputPatterns on SyncGetLatestCommitOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncGetLatestCommitOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String cid, String rev, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SyncGetLatestCommitOutput() when $default != null:
        return $default(_that.cid, _that.rev, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SyncGetLatestCommitOutput implements SyncGetLatestCommitOutput {
  const _SyncGetLatestCommitOutput(
      {required this.cid,
      required this.rev,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncGetLatestCommitOutputCopyWith<_SyncGetLatestCommitOutput>
      get copyWith =>
          __$SyncGetLatestCommitOutputCopyWithImpl<_SyncGetLatestCommitOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncGetLatestCommitOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncGetLatestCommitOutput &&
            (identical(other.cid, cid) || other.cid == cid) &&
            (identical(other.rev, rev) || other.rev == rev) &&
...
/// @nodoc
abstract mixin class _$SyncGetLatestCommitOutputCopyWith<$Res>
    implements $SyncGetLatestCommitOutputCopyWith<$Res> {
  factory _$SyncGetLatestCommitOutputCopyWith(_SyncGetLatestCommitOutput value,
          $Res Function(_SyncGetLatestCommitOutput) _then) =
      __$SyncGetLatestCommitOutputCopyWithImpl;
  @override
  @useResult
  $Res call({String cid, String rev, Map<String, dynamic>? $unknown});
}
