...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? repos = null,Object? $unknown = freezed,}) {
  return _then(SyncListReposOutput(
...
class _SyncListReposOutput implements SyncListReposOutput {
  const _SyncListReposOutput({this.cursor, @RepoConverter() required  List<Repo> repos,  Map<String, dynamic>? $unknown}): _repos = repos,_$unknown = $unknown;
