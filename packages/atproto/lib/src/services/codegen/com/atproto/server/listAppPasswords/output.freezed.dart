...
@pragma('vm:prefer-inline') @override $Res call({Object? passwords = null,Object? $unknown = freezed,}) {
  return _then(ServerListAppPasswordsOutput(
...
class _ServerListAppPasswordsOutput implements ServerListAppPasswordsOutput {
  const _ServerListAppPasswordsOutput({@AppPasswordConverter() required  List<AppPassword> passwords,  Map<String, dynamic>? $unknown}): _passwords = passwords,_$unknown = $unknown;
