...
mixin _$ServerListAppPasswordsOutput {
  ...
  $ServerListAppPasswordsOutputCopyWith<ServerListAppPasswordsOutput>
      get copyWith => _$ServerListAppPasswordsOutputCopyWithImpl<
              ServerListAppPasswordsOutput>(
          this as ServerListAppPasswordsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerListAppPasswordsOutput &&
...
abstract mixin class $ServerListAppPasswordsOutputCopyWith<$Res> {
  factory $ServerListAppPasswordsOutputCopyWith(
          ...
          $Res Function(ServerListAppPasswordsOutput) _then) =
      _$ServerListAppPasswordsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerListAppPasswordsOutputPatterns on ServerListAppPasswordsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerListAppPasswordsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@AppPasswordConverter() List<AppPassword> passwords,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServerListAppPasswordsOutput() when $default != null:
        return $default(_that.passwords, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerListAppPasswordsOutput implements ServerListAppPasswordsOutput {
  const _ServerListAppPasswordsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerListAppPasswordsOutputCopyWith<_ServerListAppPasswordsOutput>
      get copyWith => __$ServerListAppPasswordsOutputCopyWithImpl<
          _ServerListAppPasswordsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerListAppPasswordsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerListAppPasswordsOutput &&
...
/// @nodoc
abstract mixin class _$ServerListAppPasswordsOutputCopyWith<$Res>
    implements $ServerListAppPasswordsOutputCopyWith<$Res> {
  factory _$ServerListAppPasswordsOutputCopyWith(
          _ServerListAppPasswordsOutput value,
          $Res Function(_ServerListAppPasswordsOutput) _then) =
      __$ServerListAppPasswordsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@AppPasswordConverter() List<AppPassword> passwords,
