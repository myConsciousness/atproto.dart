...
mixin _$AdminUpdateSubjectStatusOutput {
  ...
  $AdminUpdateSubjectStatusOutputCopyWith<AdminUpdateSubjectStatusOutput>
      get copyWith => _$AdminUpdateSubjectStatusOutputCopyWithImpl<
              AdminUpdateSubjectStatusOutput>(
          this as AdminUpdateSubjectStatusOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminUpdateSubjectStatusOutput &&
...
abstract mixin class $AdminUpdateSubjectStatusOutputCopyWith<$Res> {
  factory $AdminUpdateSubjectStatusOutputCopyWith(
          ...
          $Res Function(AdminUpdateSubjectStatusOutput) _then) =
      _$AdminUpdateSubjectStatusOutputCopyWithImpl;
  @useResult
  $Res call(
      {@UAdminUpdateSubjectStatusSubjectConverter()
...
class _$AdminUpdateSubjectStatusOutputCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $UAdminUpdateSubjectStatusSubjectCopyWith<$Res> get subject {
    return $UAdminUpdateSubjectStatusSubjectCopyWith<$Res>(_self.subject,
        (value) {
...
extension AdminUpdateSubjectStatusOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminUpdateSubjectStatusOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AdminUpdateSubjectStatusOutput() when $default != null:
        return $default(_that.subject, _that.takedown, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _AdminUpdateSubjectStatusOutput
    implements AdminUpdateSubjectStatusOutput {
  const _AdminUpdateSubjectStatusOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminUpdateSubjectStatusOutputCopyWith<_AdminUpdateSubjectStatusOutput>
      get copyWith => __$AdminUpdateSubjectStatusOutputCopyWithImpl<
          _AdminUpdateSubjectStatusOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminUpdateSubjectStatusOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminUpdateSubjectStatusOutput &&
            (identical(other.subject, subject) || other.subject == subject) &&
            (identical(other.takedown, takedown) ||
                other.takedown == takedown) &&
...
/// @nodoc
abstract mixin class _$AdminUpdateSubjectStatusOutputCopyWith<$Res>
    implements $AdminUpdateSubjectStatusOutputCopyWith<$Res> {
  factory _$AdminUpdateSubjectStatusOutputCopyWith(
          _AdminUpdateSubjectStatusOutput value,
          $Res Function(_AdminUpdateSubjectStatusOutput) _then) =
      __$AdminUpdateSubjectStatusOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@UAdminUpdateSubjectStatusSubjectConverter()
