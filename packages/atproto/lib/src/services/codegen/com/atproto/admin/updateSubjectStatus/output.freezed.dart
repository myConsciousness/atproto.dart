...
@pragma('vm:prefer-inline') @override $Res call({Object? subject = null,Object? takedown = freezed,Object? $unknown = freezed,}) {
  return _then(AdminUpdateSubjectStatusOutput(
...
class _AdminUpdateSubjectStatusOutput implements AdminUpdateSubjectStatusOutput {
  const _AdminUpdateSubjectStatusOutput({@UAdminUpdateSubjectStatusSubjectConverter() required this.subject, @StatusAttrConverter() this.takedown,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
