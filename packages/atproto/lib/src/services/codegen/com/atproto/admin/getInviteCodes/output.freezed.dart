...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? codes = null,Object? $unknown = freezed,}) {
  return _then(AdminGetInviteCodesOutput(
...
class _AdminGetInviteCodesOutput implements AdminGetInviteCodesOutput {
  const _AdminGetInviteCodesOutput({this.cursor, @InviteCodeConverter() required  List<InviteCode> codes,  Map<String, dynamic>? $unknown}): _codes = codes,_$unknown = $unknown;
