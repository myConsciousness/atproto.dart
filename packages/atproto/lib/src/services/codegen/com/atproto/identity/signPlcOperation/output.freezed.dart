...
mixin _$IdentitySignPlcOperationOutput {
  ...
  $IdentitySignPlcOperationOutputCopyWith<IdentitySignPlcOperationOutput>
      get copyWith => _$IdentitySignPlcOperationOutputCopyWithImpl<
              IdentitySignPlcOperationOutput>(
          this as IdentitySignPlcOperationOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IdentitySignPlcOperationOutput &&
...
abstract mixin class $IdentitySignPlcOperationOutputCopyWith<$Res> {
  factory $IdentitySignPlcOperationOutputCopyWith(
          ...
          $Res Function(IdentitySignPlcOperationOutput) _then) =
      _$IdentitySignPlcOperationOutputCopyWithImpl;
  @useResult
...
extension IdentitySignPlcOperationOutputPatterns
    on IdentitySignPlcOperationOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IdentitySignPlcOperationOutput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _IdentitySignPlcOperationOutput
    implements IdentitySignPlcOperationOutput {
  const _IdentitySignPlcOperationOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IdentitySignPlcOperationOutputCopyWith<_IdentitySignPlcOperationOutput>
      get copyWith => __$IdentitySignPlcOperationOutputCopyWithImpl<
          _IdentitySignPlcOperationOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IdentitySignPlcOperationOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IdentitySignPlcOperationOutput &&
...
/// @nodoc
abstract mixin class _$IdentitySignPlcOperationOutputCopyWith<$Res>
    implements $IdentitySignPlcOperationOutputCopyWith<$Res> {
  factory _$IdentitySignPlcOperationOutputCopyWith(
          _IdentitySignPlcOperationOutput value,
          $Res Function(_IdentitySignPlcOperationOutput) _then) =
      __$IdentitySignPlcOperationOutputCopyWithImpl;
  @override
  @useResult
  $Res call({Map<String, dynamic> operation, Map<String, dynamic>? $unknown});
}
