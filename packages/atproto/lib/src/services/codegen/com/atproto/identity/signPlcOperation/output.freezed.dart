...
@pragma('vm:prefer-inline') @override $Res call({Object? operation = null,Object? $unknown = freezed,}) {
  return _then(IdentitySignPlcOperationOutput(
...
class _IdentitySignPlcOperationOutput implements IdentitySignPlcOperationOutput {
  const _IdentitySignPlcOperationOutput({required  Map<String, dynamic> operation,  Map<String, dynamic>? $unknown}): _operation = operation,_$unknown = $unknown;
