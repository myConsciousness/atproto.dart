...
class _Account implements Account {
  const _Account({this.$type = 'com.atproto.sync.subscribeRepos#account', required this.seq, required this.did, @JsonKey(toJson: iso8601) required this.time, required this.active, @AccountStatusConverter() this.status,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
