...
mixin _$ModerationCreateReportInput {
  ...
  $ModerationCreateReportInputCopyWith<ModerationCreateReportInput>
      get copyWith => _$ModerationCreateReportInputCopyWithImpl<
              ModerationCreateReportInput>(
          this as ModerationCreateReportInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationCreateReportInput &&
  ...
  int get hashCode => Object.hash(runtimeType, reasonType, reason, subject,
      modTool, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ModerationCreateReportInputCopyWith<$Res> {
  factory $ModerationCreateReportInputCopyWith(
          ...
          $Res Function(ModerationCreateReportInput) _then) =
      _$ModerationCreateReportInputCopyWithImpl;
  @useResult
  $Res call(
...
extension ModerationCreateReportInputPatterns on ModerationCreateReportInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationCreateReportInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ModerationCreateReportInput() when $default != null:
        return $default(_that.reasonType, _that.reason, _that.subject,
            _that.modTool, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModerationCreateReportInput implements ModerationCreateReportInput {
  const _ModerationCreateReportInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationCreateReportInputCopyWith<_ModerationCreateReportInput>
      get copyWith => __$ModerationCreateReportInputCopyWithImpl<
          _ModerationCreateReportInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationCreateReportInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationCreateReportInput &&
            (identical(other.reasonType, reasonType) ||
                other.reasonType == reasonType) &&
            (identical(other.reason, reason) || other.reason == reason) &&
            (identical(other.subject, subject) || other.subject == subject) &&
...
/// @nodoc
abstract mixin class _$ModerationCreateReportInputCopyWith<$Res>
    implements $ModerationCreateReportInputCopyWith<$Res> {
  factory _$ModerationCreateReportInputCopyWith(
          _ModerationCreateReportInput value,
          $Res Function(_ModerationCreateReportInput) _then) =
      __$ModerationCreateReportInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ReasonTypeConverter() ReasonType reasonType,
