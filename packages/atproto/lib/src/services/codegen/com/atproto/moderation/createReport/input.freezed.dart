...
@pragma('vm:prefer-inline') @override $Res call({Object? reasonType = null,Object? reason = freezed,Object? subject = null,Object? modTool = freezed,Object? $unknown = freezed,}) {
  return _then(ModerationCreateReportInput(
...
class _ModerationCreateReportInput implements ModerationCreateReportInput {
  const _ModerationCreateReportInput({@ReasonTypeConverter() required this.reasonType, this.reason, @UModerationCreateReportSubjectConverter() required this.subject, @ModToolConverter() this.modTool,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
