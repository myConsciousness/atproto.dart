...
@pragma('vm:prefer-inline') @override $Res call({Object? dids = null,Object? $unknown = freezed,}) {
  return _then(AdminGetAccountInfosInput(
...
class _AdminGetAccountInfosInput implements AdminGetAccountInfosInput {
  const _AdminGetAccountInfosInput({required  List<String> dids,  Map<String, dynamic>? $unknown}): _dids = dids,_$unknown = $unknown;
