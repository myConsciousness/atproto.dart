  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCreateReportSubject &&
...
class $UModerationCreateReportSubjectCopyWith<$Res> {
  $UModerationCreateReportSubjectCopyWith(UModerationCreateReportSubject _,
      $Res Function(UModerationCreateReportSubject) __);
}

/// Adds pattern-matching-related methods to [UModerationCreateReportSubject].
extension UModerationCreateReportSubjectPatterns
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UModerationCreateReportSubjectRepoStrongRef()
          when repoStrongRef != null:
        return repoStrongRef(_that);
      case UModerationCreateReportSubjectUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UModerationCreateReportSubjectRepoStrongRef():
        return repoStrongRef(_that);
      case UModerationCreateReportSubjectUnknown():
        return unknown(_that);
      case _:
...
class UModerationCreateReportSubjectRepoRef
  ...
  $UModerationCreateReportSubjectRepoRefCopyWith<
          UModerationCreateReportSubjectRepoRef>
      get copyWith => _$UModerationCreateReportSubjectRepoRefCopyWithImpl<
          UModerationCreateReportSubjectRepoRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCreateReportSubjectRepoRef &&
...
/// @nodoc
abstract mixin class $UModerationCreateReportSubjectRepoRefCopyWith<$Res>
    implements $UModerationCreateReportSubjectCopyWith<$Res> {
  factory $UModerationCreateReportSubjectRepoRefCopyWith(
          UModerationCreateReportSubjectRepoRef value,
          $Res Function(UModerationCreateReportSubjectRepoRef) _then) =
      _$UModerationCreateReportSubjectRepoRefCopyWithImpl;
  @useResult
...
class UModerationCreateReportSubjectRepoStrongRef
    extends UModerationCreateReportSubject {
  const UModerationCreateReportSubjectRepoStrongRef({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationCreateReportSubjectRepoStrongRefCopyWith<
          UModerationCreateReportSubjectRepoStrongRef>
      get copyWith => _$UModerationCreateReportSubjectRepoStrongRefCopyWithImpl<
          UModerationCreateReportSubjectRepoStrongRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCreateReportSubjectRepoStrongRef &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModerationCreateReportSubjectRepoStrongRefCopyWith<$Res>
    implements $UModerationCreateReportSubjectCopyWith<$Res> {
  factory $UModerationCreateReportSubjectRepoStrongRefCopyWith(
          UModerationCreateReportSubjectRepoStrongRef value,
          $Res Function(UModerationCreateReportSubjectRepoStrongRef) _then) =
      _$UModerationCreateReportSubjectRepoStrongRefCopyWithImpl;
  @useResult
...
class UModerationCreateReportSubjectUnknown
    extends UModerationCreateReportSubject {
  const UModerationCreateReportSubjectUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationCreateReportSubjectUnknownCopyWith<
          UModerationCreateReportSubjectUnknown>
      get copyWith => _$UModerationCreateReportSubjectUnknownCopyWithImpl<
          UModerationCreateReportSubjectUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCreateReportSubjectUnknown &&
...
/// @nodoc
abstract mixin class $UModerationCreateReportSubjectUnknownCopyWith<$Res>
    implements $UModerationCreateReportSubjectCopyWith<$Res> {
  factory $UModerationCreateReportSubjectUnknownCopyWith(
          UModerationCreateReportSubjectUnknown value,
          $Res Function(UModerationCreateReportSubjectUnknown) _then) =
      _$UModerationCreateReportSubjectUnknownCopyWithImpl;
  @useResult
