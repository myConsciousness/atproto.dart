...
mixin _$SyncListReposByCollectionInput {
  ...
  $SyncListReposByCollectionInputCopyWith<SyncListReposByCollectionInput>
      get copyWith => _$SyncListReposByCollectionInputCopyWithImpl<
              SyncListReposByCollectionInput>(
          this as SyncListReposByCollectionInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncListReposByCollectionInput &&
...
abstract mixin class $SyncListReposByCollectionInputCopyWith<$Res> {
  factory $SyncListReposByCollectionInputCopyWith(
          ...
          $Res Function(SyncListReposByCollectionInput) _then) =
      _$SyncListReposByCollectionInputCopyWithImpl;
  @useResult
  $Res call(
      {String collection,
      int limit,
...
extension SyncListReposByCollectionInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncListReposByCollectionInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String collection, int limit, String? cursor,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SyncListReposByCollectionInput() when $default != null:
        return $default(
            _that.collection, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _SyncListReposByCollectionInput
    implements SyncListReposByCollectionInput {
  const _SyncListReposByCollectionInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncListReposByCollectionInputCopyWith<_SyncListReposByCollectionInput>
      get copyWith => __$SyncListReposByCollectionInputCopyWithImpl<
          _SyncListReposByCollectionInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncListReposByCollectionInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncListReposByCollectionInput &&
            (identical(other.collection, collection) ||
                other.collection == collection) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SyncListReposByCollectionInputCopyWith<$Res>
    implements $SyncListReposByCollectionInputCopyWith<$Res> {
  factory _$SyncListReposByCollectionInputCopyWith(
          _SyncListReposByCollectionInput value,
          $Res Function(_SyncListReposByCollectionInput) _then) =
      __$SyncListReposByCollectionInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String collection,
