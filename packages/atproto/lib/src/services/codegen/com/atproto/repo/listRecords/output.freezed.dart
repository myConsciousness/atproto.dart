...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? records = null,Object? $unknown = freezed,}) {
  return _then(RepoListRecordsOutput(
...
class _RepoListRecordsOutput implements RepoListRecordsOutput {
  const _RepoListRecordsOutput({this.cursor, @RepoListRecordsRecordConverter() required  List<RepoListRecordsRecord> records,  Map<String, dynamic>? $unknown}): _records = records,_$unknown = $unknown;
