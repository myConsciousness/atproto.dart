...
@pragma('vm:prefer-inline') @override $Res call({Object? codes = null,Object? $unknown = freezed,}) {
  return _then(ServerCreateInviteCodesOutput(
...
class _ServerCreateInviteCodesOutput implements ServerCreateInviteCodesOutput {
  const _ServerCreateInviteCodesOutput({@AccountCodesConverter() required  List<AccountCodes> codes,  Map<String, dynamic>? $unknown}): _codes = codes,_$unknown = $unknown;
