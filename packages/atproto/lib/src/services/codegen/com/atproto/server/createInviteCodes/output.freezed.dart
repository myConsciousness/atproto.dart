...
mixin _$ServerCreateInviteCodesOutput {
  ...
  $ServerCreateInviteCodesOutputCopyWith<ServerCreateInviteCodesOutput>
      get copyWith => _$ServerCreateInviteCodesOutputCopyWithImpl<
              ServerCreateInviteCodesOutput>(
          this as ServerCreateInviteCodesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateInviteCodesOutput &&
...
abstract mixin class $ServerCreateInviteCodesOutputCopyWith<$Res> {
  factory $ServerCreateInviteCodesOutputCopyWith(
          ...
          $Res Function(ServerCreateInviteCodesOutput) _then) =
      _$ServerCreateInviteCodesOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerCreateInviteCodesOutputPatterns
    on ServerCreateInviteCodesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCreateInviteCodesOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@AccountCodesConverter() List<AccountCodes> codes,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
...
class _ServerCreateInviteCodesOutput implements ServerCreateInviteCodesOutput {
  const _ServerCreateInviteCodesOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCreateInviteCodesOutputCopyWith<_ServerCreateInviteCodesOutput>
      get copyWith => __$ServerCreateInviteCodesOutputCopyWithImpl<
          _ServerCreateInviteCodesOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCreateInviteCodesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCreateInviteCodesOutput &&
...
/// @nodoc
abstract mixin class _$ServerCreateInviteCodesOutputCopyWith<$Res>
    implements $ServerCreateInviteCodesOutputCopyWith<$Res> {
  factory _$ServerCreateInviteCodesOutputCopyWith(
          _ServerCreateInviteCodesOutput value,
          $Res Function(_ServerCreateInviteCodesOutput) _then) =
      __$ServerCreateInviteCodesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@AccountCodesConverter() List<AccountCodes> codes,
