...
mixin _$ServerGetAccountInviteCodesOutput {
  ...
  $ServerGetAccountInviteCodesOutputCopyWith<ServerGetAccountInviteCodesOutput>
      get copyWith => _$ServerGetAccountInviteCodesOutputCopyWithImpl<
              ServerGetAccountInviteCodesOutput>(
          this as ServerGetAccountInviteCodesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetAccountInviteCodesOutput &&
...
abstract mixin class $ServerGetAccountInviteCodesOutputCopyWith<$Res> {
  factory $ServerGetAccountInviteCodesOutputCopyWith(
          ...
          $Res Function(ServerGetAccountInviteCodesOutput) _then) =
      _$ServerGetAccountInviteCodesOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerGetAccountInviteCodesOutputPatterns
    on ServerGetAccountInviteCodesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerGetAccountInviteCodesOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@InviteCodeConverter() List<InviteCode> codes,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServerGetAccountInviteCodesOutput() when $default != null:
        return $default(_that.codes, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ServerGetAccountInviteCodesOutput
    implements ServerGetAccountInviteCodesOutput {
  const _ServerGetAccountInviteCodesOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerGetAccountInviteCodesOutputCopyWith<
          _ServerGetAccountInviteCodesOutput>
      get copyWith => __$ServerGetAccountInviteCodesOutputCopyWithImpl<
          _ServerGetAccountInviteCodesOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerGetAccountInviteCodesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerGetAccountInviteCodesOutput &&
...
/// @nodoc
abstract mixin class _$ServerGetAccountInviteCodesOutputCopyWith<$Res>
    implements $ServerGetAccountInviteCodesOutputCopyWith<$Res> {
  factory _$ServerGetAccountInviteCodesOutputCopyWith(
          _ServerGetAccountInviteCodesOutput value,
          $Res Function(_ServerGetAccountInviteCodesOutput) _then) =
      __$ServerGetAccountInviteCodesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@InviteCodeConverter() List<InviteCode> codes,
