...
@pragma('vm:prefer-inline') @override $Res call({Object? codes = null,Object? $unknown = freezed,}) {
  return _then(ServerGetAccountInviteCodesOutput(
...
class _ServerGetAccountInviteCodesOutput implements ServerGetAccountInviteCodesOutput {
  const _ServerGetAccountInviteCodesOutput({@InviteCodeConverter() required  List<InviteCode> codes,  Map<String, dynamic>? $unknown}): _codes = codes,_$unknown = $unknown;
