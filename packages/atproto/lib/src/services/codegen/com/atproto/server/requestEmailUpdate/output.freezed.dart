...
mixin _$ServerRequestEmailUpdateOutput {
  ...
  $ServerRequestEmailUpdateOutputCopyWith<ServerRequestEmailUpdateOutput>
      get copyWith => _$ServerRequestEmailUpdateOutputCopyWithImpl<
              ServerRequestEmailUpdateOutput>(
          this as ServerRequestEmailUpdateOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerRequestEmailUpdateOutput &&
...
abstract mixin class $ServerRequestEmailUpdateOutputCopyWith<$Res> {
  factory $ServerRequestEmailUpdateOutputCopyWith(
          ...
          $Res Function(ServerRequestEmailUpdateOutput) _then) =
      _$ServerRequestEmailUpdateOutputCopyWithImpl;
  @useResult
...
extension ServerRequestEmailUpdateOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerRequestEmailUpdateOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool tokenRequired, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ServerRequestEmailUpdateOutput() when $default != null:
        return $default(_that.tokenRequired, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ServerRequestEmailUpdateOutput
    implements ServerRequestEmailUpdateOutput {
  const _ServerRequestEmailUpdateOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerRequestEmailUpdateOutputCopyWith<_ServerRequestEmailUpdateOutput>
      get copyWith => __$ServerRequestEmailUpdateOutputCopyWithImpl<
          _ServerRequestEmailUpdateOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerRequestEmailUpdateOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerRequestEmailUpdateOutput &&
            (identical(other.tokenRequired, tokenRequired) ||
                other.tokenRequired == tokenRequired) &&
...
/// @nodoc
abstract mixin class _$ServerRequestEmailUpdateOutputCopyWith<$Res>
    implements $ServerRequestEmailUpdateOutputCopyWith<$Res> {
  factory _$ServerRequestEmailUpdateOutputCopyWith(
          _ServerRequestEmailUpdateOutput value,
          $Res Function(_ServerRequestEmailUpdateOutput) _then) =
      __$ServerRequestEmailUpdateOutputCopyWithImpl;
  @override
  @useResult
  $Res call({bool tokenRequired, Map<String, dynamic>? $unknown});
}
