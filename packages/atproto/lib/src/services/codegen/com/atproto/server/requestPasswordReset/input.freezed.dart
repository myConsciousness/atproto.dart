...
mixin _$ServerRequestPasswordResetInput {
  ...
  $ServerRequestPasswordResetInputCopyWith<ServerRequestPasswordResetInput>
      get copyWith => _$ServerRequestPasswordResetInputCopyWithImpl<
              ServerRequestPasswordResetInput>(
          this as ServerRequestPasswordResetInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerRequestPasswordResetInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, email, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerRequestPasswordResetInputCopyWith<$Res> {
  factory $ServerRequestPasswordResetInputCopyWith(
          ...
          $Res Function(ServerRequestPasswordResetInput) _then) =
      _$ServerRequestPasswordResetInputCopyWithImpl;
  @useResult
...
extension ServerRequestPasswordResetInputPatterns
    on ServerRequestPasswordResetInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerRequestPasswordResetInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ServerRequestPasswordResetInput() when $default != null:
        return $default(_that.email, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ServerRequestPasswordResetInput
    implements ServerRequestPasswordResetInput {
  const _ServerRequestPasswordResetInput(
      {required this.email, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _ServerRequestPasswordResetInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerRequestPasswordResetInputCopyWith<_ServerRequestPasswordResetInput>
      get copyWith => __$ServerRequestPasswordResetInputCopyWithImpl<
          _ServerRequestPasswordResetInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerRequestPasswordResetInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerRequestPasswordResetInput &&
            (identical(other.email, email) || other.email == email) &&
...
/// @nodoc
abstract mixin class _$ServerRequestPasswordResetInputCopyWith<$Res>
    implements $ServerRequestPasswordResetInputCopyWith<$Res> {
  factory _$ServerRequestPasswordResetInputCopyWith(
          _ServerRequestPasswordResetInput value,
          $Res Function(_ServerRequestPasswordResetInput) _then) =
      __$ServerRequestPasswordResetInputCopyWithImpl;
  @override
  @useResult
  $Res call({String email, Map<String, dynamic>? $unknown});
}
