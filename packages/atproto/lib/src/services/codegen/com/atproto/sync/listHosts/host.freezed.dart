...
mixin _$Host {
  ...
  int get hashCode => Object.hash(runtimeType, $type, hostname, seq,
      accountCount, status, const DeepCollectionEquality().hash($unknown));
...
extension HostPatterns on Host {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Host() when $default != null:
        return $default(_that.$type, _that.hostname, _that.seq,
            _that.accountCount, _that.status, _that.$unknown);
      case _:
        return orElse();
    }
  }
