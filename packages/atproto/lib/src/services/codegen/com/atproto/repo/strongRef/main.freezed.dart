...
class _RepoStrongRef implements RepoStrongRef {
  const _RepoStrongRef({this.$type = 'com.atproto.repo.strongRef', @AtUriConverter() required this.uri, required this.cid,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
