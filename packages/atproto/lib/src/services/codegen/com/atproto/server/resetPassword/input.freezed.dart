...
mixin _$ServerResetPasswordInput {
  ...
  $ServerResetPasswordInputCopyWith<ServerResetPasswordInput> get copyWith =>
      _$ServerResetPasswordInputCopyWithImpl<ServerResetPasswordInput>(
          this as ServerResetPasswordInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerResetPasswordInput &&
...
abstract mixin class $ServerResetPasswordInputCopyWith<$Res> {
  factory $ServerResetPasswordInputCopyWith(ServerResetPasswordInput value,
          $Res Function(ServerResetPasswordInput) _then) =
      _$ServerResetPasswordInputCopyWithImpl;
  @useResult
...
extension ServerResetPasswordInputPatterns on ServerResetPasswordInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerResetPasswordInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerResetPasswordInput() when $default != null:
        return $default(_that.token, _that.password, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerResetPasswordInput implements ServerResetPasswordInput {
  const _ServerResetPasswordInput(
      {required this.token,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerResetPasswordInputCopyWith<_ServerResetPasswordInput> get copyWith =>
      __$ServerResetPasswordInputCopyWithImpl<_ServerResetPasswordInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerResetPasswordInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerResetPasswordInput &&
            (identical(other.token, token) || other.token == token) &&
            (identical(other.password, password) ||
                other.password == password) &&
...
/// @nodoc
abstract mixin class _$ServerResetPasswordInputCopyWith<$Res>
    implements $ServerResetPasswordInputCopyWith<$Res> {
  factory _$ServerResetPasswordInputCopyWith(_ServerResetPasswordInput value,
          $Res Function(_ServerResetPasswordInput) _then) =
      __$ServerResetPasswordInputCopyWithImpl;
  @override
  @useResult
  $Res call({String token, String password, Map<String, dynamic>? $unknown});
}
