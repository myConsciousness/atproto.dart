...
mixin _$LabelQueryLabelsInput {
  ...
  $LabelQueryLabelsInputCopyWith<LabelQueryLabelsInput> get copyWith =>
      _$LabelQueryLabelsInputCopyWithImpl<LabelQueryLabelsInput>(
          this as LabelQueryLabelsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LabelQueryLabelsInput &&
            const DeepCollectionEquality()
                .equals(other.uriPatterns, uriPatterns) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(uriPatterns),
...
abstract mixin class $LabelQueryLabelsInputCopyWith<$Res> {
  factory $LabelQueryLabelsInputCopyWith(LabelQueryLabelsInput value,
          $Res Function(LabelQueryLabelsInput) _then) =
      _$LabelQueryLabelsInputCopyWithImpl;
  @useResult
  $Res call(
...
extension LabelQueryLabelsInputPatterns on LabelQueryLabelsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LabelQueryLabelsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> uriPatterns, List<String>? sources, int limit,
    ...
    switch (_that) {
      case _LabelQueryLabelsInput() when $default != null:
        return $default(_that.uriPatterns, _that.sources, _that.limit,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    TResult? Function(List<String> uriPatterns, List<String>? sources,
...
class _LabelQueryLabelsInput implements LabelQueryLabelsInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LabelQueryLabelsInputCopyWith<_LabelQueryLabelsInput> get copyWith =>
      __$LabelQueryLabelsInputCopyWithImpl<_LabelQueryLabelsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LabelQueryLabelsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LabelQueryLabelsInput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$LabelQueryLabelsInputCopyWith<$Res>
    implements $LabelQueryLabelsInputCopyWith<$Res> {
  factory _$LabelQueryLabelsInputCopyWith(_LabelQueryLabelsInput value,
          $Res Function(_LabelQueryLabelsInput) _then) =
      __$LabelQueryLabelsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String> uriPatterns,
