...
class _Labels implements Labels {
  const _Labels({this.$type = 'com.atproto.label.subscribeLabels#labels', required this.seq, @LabelConverter() required  List<Label> labels,  Map<String, dynamic>? $unknown}): _labels = labels,_$unknown = $unknown;
