...
mixin _$AdminDisableAccountInvitesInput {
  ...
  $AdminDisableAccountInvitesInputCopyWith<AdminDisableAccountInvitesInput>
      get copyWith => _$AdminDisableAccountInvitesInputCopyWithImpl<
              AdminDisableAccountInvitesInput>(
          this as AdminDisableAccountInvitesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminDisableAccountInvitesInput &&
...
abstract mixin class $AdminDisableAccountInvitesInputCopyWith<$Res> {
  factory $AdminDisableAccountInvitesInputCopyWith(
          ...
          $Res Function(AdminDisableAccountInvitesInput) _then) =
      _$AdminDisableAccountInvitesInputCopyWithImpl;
  @useResult
...
extension AdminDisableAccountInvitesInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminDisableAccountInvitesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _AdminDisableAccountInvitesInput() when $default != null:
        return $default(_that.account, _that.note, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _AdminDisableAccountInvitesInput
    implements AdminDisableAccountInvitesInput {
  const _AdminDisableAccountInvitesInput(
      {required this.account, this.note, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _AdminDisableAccountInvitesInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminDisableAccountInvitesInputCopyWith<_AdminDisableAccountInvitesInput>
      get copyWith => __$AdminDisableAccountInvitesInputCopyWithImpl<
          _AdminDisableAccountInvitesInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminDisableAccountInvitesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminDisableAccountInvitesInput &&
            (identical(other.account, account) || other.account == account) &&
            (identical(other.note, note) || other.note == note) &&
...
/// @nodoc
abstract mixin class _$AdminDisableAccountInvitesInputCopyWith<$Res>
    implements $AdminDisableAccountInvitesInputCopyWith<$Res> {
  factory _$AdminDisableAccountInvitesInputCopyWith(
          _AdminDisableAccountInvitesInput value,
          $Res Function(_AdminDisableAccountInvitesInput) _then) =
      __$AdminDisableAccountInvitesInputCopyWithImpl;
  @override
  @useResult
  $Res call({String account, String? note, Map<String, dynamic>? $unknown});
}
