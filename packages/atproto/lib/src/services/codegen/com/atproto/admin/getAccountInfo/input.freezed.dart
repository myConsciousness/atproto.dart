...
mixin _$AdminGetAccountInfoInput {
  ...
  $AdminGetAccountInfoInputCopyWith<AdminGetAccountInfoInput> get copyWith =>
      _$AdminGetAccountInfoInputCopyWithImpl<AdminGetAccountInfoInput>(
          this as AdminGetAccountInfoInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminGetAccountInfoInput &&
...
abstract mixin class $AdminGetAccountInfoInputCopyWith<$Res> {
  factory $AdminGetAccountInfoInputCopyWith(AdminGetAccountInfoInput value,
          $Res Function(AdminGetAccountInfoInput) _then) =
      _$AdminGetAccountInfoInputCopyWithImpl;
  @useResult
...
extension AdminGetAccountInfoInputPatterns on AdminGetAccountInfoInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminGetAccountInfoInput value)? $default, {
...
class _AdminGetAccountInfoInput implements AdminGetAccountInfoInput {
  const _AdminGetAccountInfoInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminGetAccountInfoInputCopyWith<_AdminGetAccountInfoInput> get copyWith =>
      __$AdminGetAccountInfoInputCopyWithImpl<_AdminGetAccountInfoInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminGetAccountInfoInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminGetAccountInfoInput &&
            (identical(other.did, did) || other.did == did) &&
...
/// @nodoc
abstract mixin class _$AdminGetAccountInfoInputCopyWith<$Res>
    implements $AdminGetAccountInfoInputCopyWith<$Res> {
  factory _$AdminGetAccountInfoInputCopyWith(_AdminGetAccountInfoInput value,
          $Res Function(_AdminGetAccountInfoInput) _then) =
      __$AdminGetAccountInfoInputCopyWithImpl;
  @override
  @useResult
  $Res call({String did, Map<String, dynamic>? $unknown});
}
