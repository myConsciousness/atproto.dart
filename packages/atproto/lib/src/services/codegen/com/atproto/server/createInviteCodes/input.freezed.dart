...
mixin _$ServerCreateInviteCodesInput {
  ...
  $ServerCreateInviteCodesInputCopyWith<ServerCreateInviteCodesInput>
      get copyWith => _$ServerCreateInviteCodesInputCopyWithImpl<
              ServerCreateInviteCodesInput>(
          this as ServerCreateInviteCodesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateInviteCodesInput &&
            ...
            const DeepCollectionEquality()
                .equals(other.forAccounts, forAccounts) &&
  ...
  int get hashCode => Object.hash(
      ...
      codeCount,
      useCount,
      const DeepCollectionEquality().hash(forAccounts),
...
abstract mixin class $ServerCreateInviteCodesInputCopyWith<$Res> {
  factory $ServerCreateInviteCodesInputCopyWith(
          ...
          $Res Function(ServerCreateInviteCodesInput) _then) =
      _$ServerCreateInviteCodesInputCopyWithImpl;
  @useResult
  $Res call(
      {int codeCount,
      int useCount,
...
extension ServerCreateInviteCodesInputPatterns on ServerCreateInviteCodesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCreateInviteCodesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int codeCount, int useCount, List<String>? forAccounts,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServerCreateInviteCodesInput() when $default != null:
        return $default(
            _that.codeCount, _that.useCount, _that.forAccounts, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerCreateInviteCodesInput implements ServerCreateInviteCodesInput {
  const _ServerCreateInviteCodesInput(
      {this.codeCount = 1,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCreateInviteCodesInputCopyWith<_ServerCreateInviteCodesInput>
      get copyWith => __$ServerCreateInviteCodesInputCopyWithImpl<
          _ServerCreateInviteCodesInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCreateInviteCodesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCreateInviteCodesInput &&
            (identical(other.codeCount, codeCount) ||
                other.codeCount == codeCount) &&
            (identical(other.useCount, useCount) ||
                other.useCount == useCount) &&
...
/// @nodoc
abstract mixin class _$ServerCreateInviteCodesInputCopyWith<$Res>
    implements $ServerCreateInviteCodesInputCopyWith<$Res> {
  factory _$ServerCreateInviteCodesInputCopyWith(
          _ServerCreateInviteCodesInput value,
          $Res Function(_ServerCreateInviteCodesInput) _then) =
      __$ServerCreateInviteCodesInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int codeCount,
