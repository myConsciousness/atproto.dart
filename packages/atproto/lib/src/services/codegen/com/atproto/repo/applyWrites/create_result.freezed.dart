...
class _CreateResult implements CreateResult {
  const _CreateResult({this.$type = 'com.atproto.repo.applyWrites#createResult', @AtUriConverter() required this.uri, required this.cid, @CreateResultValidationStatusConverter() this.validationStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
