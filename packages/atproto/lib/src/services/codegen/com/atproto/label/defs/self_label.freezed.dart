...
mixin _$SelfLabel {
  ...
  int get hashCode => Object.hash(
      runtimeType, $type, val, const DeepCollectionEquality().hash($unknown));
...
extension SelfLabelPatterns on SelfLabel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SelfLabel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String val, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SelfLabel() when $default != null:
        return $default(_that.$type, _that.val, _that.$unknown);
      case _:
        return orElse();
    }
  }
