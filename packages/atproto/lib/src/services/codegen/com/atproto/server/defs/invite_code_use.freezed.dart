...
extension InviteCodeUsePatterns on InviteCodeUse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_InviteCodeUse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String usedBy, DateTime usedAt,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _InviteCodeUse() when $default != null:
        return $default(
            _that.$type, _that.usedBy, _that.usedAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
