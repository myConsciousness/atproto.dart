...
class _InviteCodeUse implements InviteCodeUse {
  const _InviteCodeUse({this.$type = 'com.atproto.server.defs#inviteCodeUse', required this.usedBy, @JsonKey(toJson: iso8601) required this.usedAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
