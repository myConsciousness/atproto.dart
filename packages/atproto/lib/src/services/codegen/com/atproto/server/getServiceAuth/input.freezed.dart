...
mixin _$ServerGetServiceAuthInput {
  ...
  $ServerGetServiceAuthInputCopyWith<ServerGetServiceAuthInput> get copyWith =>
      _$ServerGetServiceAuthInputCopyWithImpl<ServerGetServiceAuthInput>(
          this as ServerGetServiceAuthInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetServiceAuthInput &&
...
abstract mixin class $ServerGetServiceAuthInputCopyWith<$Res> {
  factory $ServerGetServiceAuthInputCopyWith(ServerGetServiceAuthInput value,
          $Res Function(ServerGetServiceAuthInput) _then) =
      _$ServerGetServiceAuthInputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerGetServiceAuthInputPatterns on ServerGetServiceAuthInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerGetServiceAuthInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerGetServiceAuthInput() when $default != null:
        return $default(_that.aud, _that.exp, _that.lxm, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerGetServiceAuthInput implements ServerGetServiceAuthInput {
  const _ServerGetServiceAuthInput(
      {required this.aud,
      this.exp,
      this.lxm,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerGetServiceAuthInputCopyWith<_ServerGetServiceAuthInput>
      get copyWith =>
          __$ServerGetServiceAuthInputCopyWithImpl<_ServerGetServiceAuthInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerGetServiceAuthInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerGetServiceAuthInput &&
            (identical(other.aud, aud) || other.aud == aud) &&
            (identical(other.exp, exp) || other.exp == exp) &&
            (identical(other.lxm, lxm) || other.lxm == lxm) &&
...
/// @nodoc
abstract mixin class _$ServerGetServiceAuthInputCopyWith<$Res>
    implements $ServerGetServiceAuthInputCopyWith<$Res> {
  factory _$ServerGetServiceAuthInputCopyWith(_ServerGetServiceAuthInput value,
          $Res Function(_ServerGetServiceAuthInput) _then) =
      __$ServerGetServiceAuthInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String aud, int? exp, String? lxm, Map<String, dynamic>? $unknown});
