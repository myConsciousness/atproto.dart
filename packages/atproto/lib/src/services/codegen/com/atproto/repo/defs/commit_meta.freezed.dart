...
class _CommitMeta implements CommitMeta {
  const _CommitMeta({this.$type = 'com.atproto.repo.defs#commitMeta', required this.cid, required this.rev,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
