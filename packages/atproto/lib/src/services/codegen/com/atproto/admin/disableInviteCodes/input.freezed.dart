...
mixin _$AdminDisableInviteCodesInput {
  ...
  $AdminDisableInviteCodesInputCopyWith<AdminDisableInviteCodesInput>
      get copyWith => _$AdminDisableInviteCodesInputCopyWithImpl<
              AdminDisableInviteCodesInput>(
          this as AdminDisableInviteCodesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AdminDisableInviteCodesInput &&
...
abstract mixin class $AdminDisableInviteCodesInputCopyWith<$Res> {
  factory $AdminDisableInviteCodesInputCopyWith(
          ...
          $Res Function(AdminDisableInviteCodesInput) _then) =
      _$AdminDisableInviteCodesInputCopyWithImpl;
  @useResult
  $Res call(
      {List<String>? codes,
...
extension AdminDisableInviteCodesInputPatterns on AdminDisableInviteCodesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminDisableInviteCodesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String>? codes, List<String>? accounts,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AdminDisableInviteCodesInput() when $default != null:
        return $default(_that.codes, _that.accounts, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminDisableInviteCodesInput implements AdminDisableInviteCodesInput {
  const _AdminDisableInviteCodesInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminDisableInviteCodesInputCopyWith<_AdminDisableInviteCodesInput>
      get copyWith => __$AdminDisableInviteCodesInputCopyWithImpl<
          _AdminDisableInviteCodesInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminDisableInviteCodesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminDisableInviteCodesInput &&
...
/// @nodoc
abstract mixin class _$AdminDisableInviteCodesInputCopyWith<$Res>
    implements $AdminDisableInviteCodesInputCopyWith<$Res> {
  factory _$AdminDisableInviteCodesInputCopyWith(
          _AdminDisableInviteCodesInput value,
          $Res Function(_AdminDisableInviteCodesInput) _then) =
      __$AdminDisableInviteCodesInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String>? codes,
