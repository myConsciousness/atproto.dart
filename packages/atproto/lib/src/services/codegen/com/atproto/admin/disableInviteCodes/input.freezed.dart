...
@pragma('vm:prefer-inline') @override $Res call({Object? codes = freezed,Object? accounts = freezed,Object? $unknown = freezed,}) {
  return _then(AdminDisableInviteCodesInput(
...
class _AdminDisableInviteCodesInput implements AdminDisableInviteCodesInput {
  const _AdminDisableInviteCodesInput({ List<String>? codes,  List<String>? accounts,  Map<String, dynamic>? $unknown}): _codes = codes,_accounts = accounts,_$unknown = $unknown;
