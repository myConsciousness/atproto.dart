...
mixin _$TempAddReservedHandleInput {
  ...
  $TempAddReservedHandleInputCopyWith<TempAddReservedHandleInput>
      get copyWith =>
          _$TempAddReservedHandleInputCopyWithImpl<TempAddReservedHandleInput>(
              this as TempAddReservedHandleInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TempAddReservedHandleInput &&
...
abstract mixin class $TempAddReservedHandleInputCopyWith<$Res> {
  factory $TempAddReservedHandleInputCopyWith(TempAddReservedHandleInput value,
          $Res Function(TempAddReservedHandleInput) _then) =
      _$TempAddReservedHandleInputCopyWithImpl;
  @useResult
...
extension TempAddReservedHandleInputPatterns on TempAddReservedHandleInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TempAddReservedHandleInput value)? $default, {
...
class _TempAddReservedHandleInput implements TempAddReservedHandleInput {
  const _TempAddReservedHandleInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TempAddReservedHandleInputCopyWith<_TempAddReservedHandleInput>
      get copyWith => __$TempAddReservedHandleInputCopyWithImpl<
          _TempAddReservedHandleInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TempAddReservedHandleInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TempAddReservedHandleInput &&
            (identical(other.handle, handle) || other.handle == handle) &&
...
/// @nodoc
abstract mixin class _$TempAddReservedHandleInputCopyWith<$Res>
    implements $TempAddReservedHandleInputCopyWith<$Res> {
  factory _$TempAddReservedHandleInputCopyWith(
          _TempAddReservedHandleInput value,
          $Res Function(_TempAddReservedHandleInput) _then) =
      __$TempAddReservedHandleInputCopyWithImpl;
  @override
  @useResult
  $Res call({String handle, Map<String, dynamic>? $unknown});
}
