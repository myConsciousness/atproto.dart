...
mixin _$AppPassword {
 ...
 String get $type; String get name;@JsonKey(toJson: iso8601) DateTime get createdAt; bool? get privileged; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type, String name,@JsonKey(toJson: iso8601) DateTime createdAt, bool? privileged, Map<String, dynamic>? $unknown
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String name, @JsonKey(toJson: iso8601)  DateTime createdAt,  bool? privileged,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppPassword() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String name, @JsonKey(toJson: iso8601)  DateTime createdAt,  bool? privileged,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _AppPassword():
return $default(_that.$type,_that.name,_that.createdAt,_that.privileged,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String name, @JsonKey(toJson: iso8601)  DateTime createdAt,  bool? privileged,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _AppPassword() when $default != null:
return $default(_that.$type,_that.name,_that.createdAt,_that.privileged,_that.$unknown);case _:
  return null;
...
class _AppPassword implements AppPassword {
  const _AppPassword({this.$type = 'com.atproto.server.listAppPasswords#appPassword', required this.name, @JsonKey(toJson: iso8601) required this.createdAt, this.privileged,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
