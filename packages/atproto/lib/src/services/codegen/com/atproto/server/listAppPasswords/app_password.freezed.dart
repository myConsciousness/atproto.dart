...
mixin _$AppPassword {
  ...
  int get hashCode => Object.hash(runtimeType, $type, name, createdAt,
      privileged, const DeepCollectionEquality().hash($unknown));
...
extension AppPasswordPatterns on AppPassword {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AppPassword value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String name, DateTime createdAt,
            bool? privileged, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AppPassword() when $default != null:
        return $default(_that.$type, _that.name, _that.createdAt,
            _that.privileged, _that.$unknown);
      case _:
        return orElse();
    }
  }
