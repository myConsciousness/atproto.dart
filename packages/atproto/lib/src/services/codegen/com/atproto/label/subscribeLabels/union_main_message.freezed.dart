  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelSubscribeLabelsMessage &&
...
class $ULabelSubscribeLabelsMessageCopyWith<$Res> {
  $ULabelSubscribeLabelsMessageCopyWith(ULabelSubscribeLabelsMessage _,
      $Res Function(ULabelSubscribeLabelsMessage) __);
}
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case ULabelSubscribeLabelsMessageLabels() when labels != null:
        return labels(_that);
      case ULabelSubscribeLabelsMessageInfo() when info != null:
        return info(_that);
      case ULabelSubscribeLabelsMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ULabelSubscribeLabelsMessageLabels():
        return labels(_that);
      case ULabelSubscribeLabelsMessageInfo():
        return info(_that);
      case ULabelSubscribeLabelsMessageUnknown():
        return unknown(_that);
      case _:
...
class ULabelSubscribeLabelsMessageLabels extends ULabelSubscribeLabelsMessage {
  ...
  $ULabelSubscribeLabelsMessageLabelsCopyWith<
          ULabelSubscribeLabelsMessageLabels>
      get copyWith => _$ULabelSubscribeLabelsMessageLabelsCopyWithImpl<
          ULabelSubscribeLabelsMessageLabels>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelSubscribeLabelsMessageLabels &&
...
/// @nodoc
abstract mixin class $ULabelSubscribeLabelsMessageLabelsCopyWith<$Res>
    implements $ULabelSubscribeLabelsMessageCopyWith<$Res> {
  factory $ULabelSubscribeLabelsMessageLabelsCopyWith(
          ULabelSubscribeLabelsMessageLabels value,
          $Res Function(ULabelSubscribeLabelsMessageLabels) _then) =
      _$ULabelSubscribeLabelsMessageLabelsCopyWithImpl;
  @useResult
...
class ULabelSubscribeLabelsMessageInfo extends ULabelSubscribeLabelsMessage {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULabelSubscribeLabelsMessageInfoCopyWith<ULabelSubscribeLabelsMessageInfo>
      get copyWith => _$ULabelSubscribeLabelsMessageInfoCopyWithImpl<
          ULabelSubscribeLabelsMessageInfo>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelSubscribeLabelsMessageInfo &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ULabelSubscribeLabelsMessageInfoCopyWith<$Res>
    implements $ULabelSubscribeLabelsMessageCopyWith<$Res> {
  factory $ULabelSubscribeLabelsMessageInfoCopyWith(
          ULabelSubscribeLabelsMessageInfo value,
          $Res Function(ULabelSubscribeLabelsMessageInfo) _then) =
      _$ULabelSubscribeLabelsMessageInfoCopyWithImpl;
  @useResult
  $Res call({Info data});
...
class ULabelSubscribeLabelsMessageUnknown extends ULabelSubscribeLabelsMessage {
  const ULabelSubscribeLabelsMessageUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULabelSubscribeLabelsMessageUnknownCopyWith<
          ULabelSubscribeLabelsMessageUnknown>
      get copyWith => _$ULabelSubscribeLabelsMessageUnknownCopyWithImpl<
          ULabelSubscribeLabelsMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelSubscribeLabelsMessageUnknown &&
...
/// @nodoc
abstract mixin class $ULabelSubscribeLabelsMessageUnknownCopyWith<$Res>
    implements $ULabelSubscribeLabelsMessageCopyWith<$Res> {
  factory $ULabelSubscribeLabelsMessageUnknownCopyWith(
          ULabelSubscribeLabelsMessageUnknown value,
          $Res Function(ULabelSubscribeLabelsMessageUnknown) _then) =
      _$ULabelSubscribeLabelsMessageUnknownCopyWithImpl;
  @useResult
