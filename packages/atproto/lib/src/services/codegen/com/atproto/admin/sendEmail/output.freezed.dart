...
mixin _$AdminSendEmailOutput {
  ...
  $AdminSendEmailOutputCopyWith<AdminSendEmailOutput> get copyWith =>
      _$AdminSendEmailOutputCopyWithImpl<AdminSendEmailOutput>(
          this as AdminSendEmailOutput, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, sent, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $AdminSendEmailOutputCopyWith<$Res> {
  factory $AdminSendEmailOutputCopyWith(AdminSendEmailOutput value,
          $Res Function(AdminSendEmailOutput) _then) =
      _$AdminSendEmailOutputCopyWithImpl;
  @useResult
...
extension AdminSendEmailOutputPatterns on AdminSendEmailOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdminSendEmailOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool sent, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AdminSendEmailOutput() when $default != null:
        return $default(_that.sent, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _AdminSendEmailOutput implements AdminSendEmailOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdminSendEmailOutputCopyWith<_AdminSendEmailOutput> get copyWith =>
      __$AdminSendEmailOutputCopyWithImpl<_AdminSendEmailOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdminSendEmailOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AdminSendEmailOutput &&
            (identical(other.sent, sent) || other.sent == sent) &&
...
/// @nodoc
abstract mixin class _$AdminSendEmailOutputCopyWith<$Res>
    implements $AdminSendEmailOutputCopyWith<$Res> {
  factory _$AdminSendEmailOutputCopyWith(_AdminSendEmailOutput value,
          $Res Function(_AdminSendEmailOutput) _then) =
      __$AdminSendEmailOutputCopyWithImpl;
  @override
  @useResult
  $Res call({bool sent, Map<String, dynamic>? $unknown});
}
