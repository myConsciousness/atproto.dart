...
mixin _$ServerUpdateEmailInput {
  ...
  $ServerUpdateEmailInputCopyWith<ServerUpdateEmailInput> get copyWith =>
      _$ServerUpdateEmailInputCopyWithImpl<ServerUpdateEmailInput>(
          this as ServerUpdateEmailInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerUpdateEmailInput &&
...
abstract mixin class $ServerUpdateEmailInputCopyWith<$Res> {
  factory $ServerUpdateEmailInputCopyWith(ServerUpdateEmailInput value,
          $Res Function(ServerUpdateEmailInput) _then) =
      _$ServerUpdateEmailInputCopyWithImpl;
  @useResult
  $Res call(
      {String email,
...
extension ServerUpdateEmailInputPatterns on ServerUpdateEmailInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerUpdateEmailInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, bool? emailAuthFactor, String? token,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServerUpdateEmailInput() when $default != null:
        return $default(
            _that.email, _that.emailAuthFactor, _that.token, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerUpdateEmailInput implements ServerUpdateEmailInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerUpdateEmailInputCopyWith<_ServerUpdateEmailInput> get copyWith =>
      __$ServerUpdateEmailInputCopyWithImpl<_ServerUpdateEmailInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerUpdateEmailInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerUpdateEmailInput &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.emailAuthFactor, emailAuthFactor) ||
                other.emailAuthFactor == emailAuthFactor) &&
            (identical(other.token, token) || other.token == token) &&
...
/// @nodoc
abstract mixin class _$ServerUpdateEmailInputCopyWith<$Res>
    implements $ServerUpdateEmailInputCopyWith<$Res> {
  factory _$ServerUpdateEmailInputCopyWith(_ServerUpdateEmailInput value,
          $Res Function(_ServerUpdateEmailInput) _then) =
      __$ServerUpdateEmailInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String email,
