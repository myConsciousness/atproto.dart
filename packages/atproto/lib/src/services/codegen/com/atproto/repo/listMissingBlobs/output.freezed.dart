...
mixin _$RepoListMissingBlobsOutput {
  ...
  $RepoListMissingBlobsOutputCopyWith<RepoListMissingBlobsOutput>
      get copyWith =>
          _$RepoListMissingBlobsOutputCopyWithImpl<RepoListMissingBlobsOutput>(
              this as RepoListMissingBlobsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoListMissingBlobsOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      cursor,
      const DeepCollectionEquality().hash(blobs),
...
abstract mixin class $RepoListMissingBlobsOutputCopyWith<$Res> {
  factory $RepoListMissingBlobsOutputCopyWith(RepoListMissingBlobsOutput value,
          $Res Function(RepoListMissingBlobsOutput) _then) =
      _$RepoListMissingBlobsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension RepoListMissingBlobsOutputPatterns on RepoListMissingBlobsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoListMissingBlobsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _RepoListMissingBlobsOutput() when $default != null:
        return $default(_that.cursor, _that.blobs, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoListMissingBlobsOutput implements RepoListMissingBlobsOutput {
  const _RepoListMissingBlobsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoListMissingBlobsOutputCopyWith<_RepoListMissingBlobsOutput>
      get copyWith => __$RepoListMissingBlobsOutputCopyWithImpl<
          _RepoListMissingBlobsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoListMissingBlobsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoListMissingBlobsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$RepoListMissingBlobsOutputCopyWith<$Res>
    implements $RepoListMissingBlobsOutputCopyWith<$Res> {
  factory _$RepoListMissingBlobsOutputCopyWith(
          _RepoListMissingBlobsOutput value,
          $Res Function(_RepoListMissingBlobsOutput) _then) =
      __$RepoListMissingBlobsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
