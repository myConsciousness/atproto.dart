...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? blobs = null,Object? $unknown = freezed,}) {
  return _then(RepoListMissingBlobsOutput(
...
class _RepoListMissingBlobsOutput implements RepoListMissingBlobsOutput {
  const _RepoListMissingBlobsOutput({this.cursor, @RecordBlobConverter() required  List<RecordBlob> blobs,  Map<String, dynamic>? $unknown}): _blobs = blobs,_$unknown = $unknown;
