...
mixin _$SyncGetLatestCommitInput {
  ...
  $SyncGetLatestCommitInputCopyWith<SyncGetLatestCommitInput> get copyWith =>
      _$SyncGetLatestCommitInputCopyWithImpl<SyncGetLatestCommitInput>(
          this as SyncGetLatestCommitInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncGetLatestCommitInput &&
...
abstract mixin class $SyncGetLatestCommitInputCopyWith<$Res> {
  factory $SyncGetLatestCommitInputCopyWith(SyncGetLatestCommitInput value,
          $Res Function(SyncGetLatestCommitInput) _then) =
      _$SyncGetLatestCommitInputCopyWithImpl;
  @useResult
...
extension SyncGetLatestCommitInputPatterns on SyncGetLatestCommitInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncGetLatestCommitInput value)? $default, {
...
class _SyncGetLatestCommitInput implements SyncGetLatestCommitInput {
  const _SyncGetLatestCommitInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncGetLatestCommitInputCopyWith<_SyncGetLatestCommitInput> get copyWith =>
      __$SyncGetLatestCommitInputCopyWithImpl<_SyncGetLatestCommitInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncGetLatestCommitInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncGetLatestCommitInput &&
            (identical(other.did, did) || other.did == did) &&
...
/// @nodoc
abstract mixin class _$SyncGetLatestCommitInputCopyWith<$Res>
    implements $SyncGetLatestCommitInputCopyWith<$Res> {
  factory _$SyncGetLatestCommitInputCopyWith(_SyncGetLatestCommitInput value,
          $Res Function(_SyncGetLatestCommitInput) _then) =
      __$SyncGetLatestCommitInputCopyWithImpl;
  @override
  @useResult
  $Res call({String did, Map<String, dynamic>? $unknown});
}
