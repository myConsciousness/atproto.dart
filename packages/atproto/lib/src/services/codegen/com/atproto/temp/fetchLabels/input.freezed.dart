...
mixin _$TempFetchLabelsInput {
  ...
  $TempFetchLabelsInputCopyWith<TempFetchLabelsInput> get copyWith =>
      _$TempFetchLabelsInputCopyWithImpl<TempFetchLabelsInput>(
          this as TempFetchLabelsInput, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, since, limit, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $TempFetchLabelsInputCopyWith<$Res> {
  factory $TempFetchLabelsInputCopyWith(TempFetchLabelsInput value,
          $Res Function(TempFetchLabelsInput) _then) =
      _$TempFetchLabelsInputCopyWithImpl;
  @useResult
...
extension TempFetchLabelsInputPatterns on TempFetchLabelsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TempFetchLabelsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int? since, int limit, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TempFetchLabelsInput() when $default != null:
        return $default(_that.since, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _TempFetchLabelsInput implements TempFetchLabelsInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TempFetchLabelsInputCopyWith<_TempFetchLabelsInput> get copyWith =>
      __$TempFetchLabelsInputCopyWithImpl<_TempFetchLabelsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TempFetchLabelsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TempFetchLabelsInput &&
            (identical(other.since, since) || other.since == since) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$TempFetchLabelsInputCopyWith<$Res>
    implements $TempFetchLabelsInputCopyWith<$Res> {
  factory _$TempFetchLabelsInputCopyWith(_TempFetchLabelsInput value,
          $Res Function(_TempFetchLabelsInput) _then) =
      __$TempFetchLabelsInputCopyWithImpl;
  @override
  @useResult
  $Res call({int? since, int limit, Map<String, dynamic>? $unknown});
}
