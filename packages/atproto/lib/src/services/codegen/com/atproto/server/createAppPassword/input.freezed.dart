...
mixin _$ServerCreateAppPasswordInput {
  ...
  $ServerCreateAppPasswordInputCopyWith<ServerCreateAppPasswordInput>
      get copyWith => _$ServerCreateAppPasswordInputCopyWithImpl<
              ServerCreateAppPasswordInput>(
          this as ServerCreateAppPasswordInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerCreateAppPasswordInput &&
...
abstract mixin class $ServerCreateAppPasswordInputCopyWith<$Res> {
  factory $ServerCreateAppPasswordInputCopyWith(
          ...
          $Res Function(ServerCreateAppPasswordInput) _then) =
      _$ServerCreateAppPasswordInputCopyWithImpl;
  @useResult
...
extension ServerCreateAppPasswordInputPatterns on ServerCreateAppPasswordInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerCreateAppPasswordInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerCreateAppPasswordInput() when $default != null:
        return $default(_that.name, _that.privileged, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerCreateAppPasswordInput implements ServerCreateAppPasswordInput {
  const _ServerCreateAppPasswordInput(
      {required this.name,
      this.privileged,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerCreateAppPasswordInputCopyWith<_ServerCreateAppPasswordInput>
      get copyWith => __$ServerCreateAppPasswordInputCopyWithImpl<
          _ServerCreateAppPasswordInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerCreateAppPasswordInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerCreateAppPasswordInput &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.privileged, privileged) ||
                other.privileged == privileged) &&
...
/// @nodoc
abstract mixin class _$ServerCreateAppPasswordInputCopyWith<$Res>
    implements $ServerCreateAppPasswordInputCopyWith<$Res> {
  factory _$ServerCreateAppPasswordInputCopyWith(
          _ServerCreateAppPasswordInput value,
          $Res Function(_ServerCreateAppPasswordInput) _then) =
      __$ServerCreateAppPasswordInputCopyWithImpl;
  @override
  @useResult
  $Res call({String name, bool? privileged, Map<String, dynamic>? $unknown});
}
