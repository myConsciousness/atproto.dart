...
mixin _$ServerDeactivateAccountInput {
  ...
  $ServerDeactivateAccountInputCopyWith<ServerDeactivateAccountInput>
      get copyWith => _$ServerDeactivateAccountInputCopyWithImpl<
              ServerDeactivateAccountInput>(
          this as ServerDeactivateAccountInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerDeactivateAccountInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, deleteAfter, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerDeactivateAccountInputCopyWith<$Res> {
  factory $ServerDeactivateAccountInputCopyWith(
          ...
          $Res Function(ServerDeactivateAccountInput) _then) =
      _$ServerDeactivateAccountInputCopyWithImpl;
  @useResult
...
extension ServerDeactivateAccountInputPatterns on ServerDeactivateAccountInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerDeactivateAccountInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime? deleteAfter, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ServerDeactivateAccountInput() when $default != null:
        return $default(_that.deleteAfter, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerDeactivateAccountInput implements ServerDeactivateAccountInput {
  const _ServerDeactivateAccountInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerDeactivateAccountInputCopyWith<_ServerDeactivateAccountInput>
      get copyWith => __$ServerDeactivateAccountInputCopyWithImpl<
          _ServerDeactivateAccountInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerDeactivateAccountInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerDeactivateAccountInput &&
            (identical(other.deleteAfter, deleteAfter) ||
                other.deleteAfter == deleteAfter) &&
...
/// @nodoc
abstract mixin class _$ServerDeactivateAccountInputCopyWith<$Res>
    implements $ServerDeactivateAccountInputCopyWith<$Res> {
  factory _$ServerDeactivateAccountInputCopyWith(
          _ServerDeactivateAccountInput value,
          $Res Function(_ServerDeactivateAccountInput) _then) =
      __$ServerDeactivateAccountInputCopyWithImpl;
  @override
  @useResult
  $Res call({DateTime? deleteAfter, Map<String, dynamic>? $unknown});
}
