...
mixin _$ServerConfirmEmailInput {
  ...
  $ServerConfirmEmailInputCopyWith<ServerConfirmEmailInput> get copyWith =>
      _$ServerConfirmEmailInputCopyWithImpl<ServerConfirmEmailInput>(
          this as ServerConfirmEmailInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerConfirmEmailInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, email, token, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerConfirmEmailInputCopyWith<$Res> {
  factory $ServerConfirmEmailInputCopyWith(ServerConfirmEmailInput value,
          $Res Function(ServerConfirmEmailInput) _then) =
      _$ServerConfirmEmailInputCopyWithImpl;
  @useResult
...
extension ServerConfirmEmailInputPatterns on ServerConfirmEmailInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerConfirmEmailInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerConfirmEmailInput() when $default != null:
        return $default(_that.email, _that.token, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String email, String token, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _ServerConfirmEmailInput implements ServerConfirmEmailInput {
  const _ServerConfirmEmailInput(
      {required this.email,
      required this.token,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerConfirmEmailInputCopyWith<_ServerConfirmEmailInput> get copyWith =>
      __$ServerConfirmEmailInputCopyWithImpl<_ServerConfirmEmailInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerConfirmEmailInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerConfirmEmailInput &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.token, token) || other.token == token) &&
...
/// @nodoc
abstract mixin class _$ServerConfirmEmailInputCopyWith<$Res>
    implements $ServerConfirmEmailInputCopyWith<$Res> {
  factory _$ServerConfirmEmailInputCopyWith(_ServerConfirmEmailInput value,
          $Res Function(_ServerConfirmEmailInput) _then) =
      __$ServerConfirmEmailInputCopyWithImpl;
  @override
  @useResult
  $Res call({String email, String token, Map<String, dynamic>? $unknown});
}
