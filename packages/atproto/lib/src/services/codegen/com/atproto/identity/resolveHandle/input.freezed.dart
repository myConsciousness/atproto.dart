...
mixin _$IdentityResolveHandleInput {
  ...
  $IdentityResolveHandleInputCopyWith<IdentityResolveHandleInput>
      get copyWith =>
          _$IdentityResolveHandleInputCopyWithImpl<IdentityResolveHandleInput>(
              this as IdentityResolveHandleInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IdentityResolveHandleInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, handle, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $IdentityResolveHandleInputCopyWith<$Res> {
  factory $IdentityResolveHandleInputCopyWith(IdentityResolveHandleInput value,
          $Res Function(IdentityResolveHandleInput) _then) =
      _$IdentityResolveHandleInputCopyWithImpl;
  @useResult
...
extension IdentityResolveHandleInputPatterns on IdentityResolveHandleInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IdentityResolveHandleInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String handle, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _IdentityResolveHandleInput() when $default != null:
        return $default(_that.handle, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _IdentityResolveHandleInput implements IdentityResolveHandleInput {
  const _IdentityResolveHandleInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IdentityResolveHandleInputCopyWith<_IdentityResolveHandleInput>
      get copyWith => __$IdentityResolveHandleInputCopyWithImpl<
          _IdentityResolveHandleInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IdentityResolveHandleInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IdentityResolveHandleInput &&
            (identical(other.handle, handle) || other.handle == handle) &&
...
/// @nodoc
abstract mixin class _$IdentityResolveHandleInputCopyWith<$Res>
    implements $IdentityResolveHandleInputCopyWith<$Res> {
  factory _$IdentityResolveHandleInputCopyWith(
          _IdentityResolveHandleInput value,
          $Res Function(_IdentityResolveHandleInput) _then) =
      __$IdentityResolveHandleInputCopyWithImpl;
  @override
  @useResult
  $Res call({String handle, Map<String, dynamic>? $unknown});
}
