...
class _InviteCode implements InviteCode {
  const _InviteCode({this.$type = 'com.atproto.server.defs#inviteCode', required this.code, required this.available, required this.disabled, required this.forAccount, required this.createdBy, @JsonKey(toJson: iso8601) required this.createdAt, @InviteCodeUseConverter() required  List<InviteCodeUse> uses,  Map<String, dynamic>? $unknown}): _uses = uses,_$unknown = $unknown;
