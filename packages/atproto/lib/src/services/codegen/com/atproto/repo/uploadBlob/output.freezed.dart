...
mixin _$RepoUploadBlobOutput {
  ...
  $RepoUploadBlobOutputCopyWith<RepoUploadBlobOutput> get copyWith =>
      _$RepoUploadBlobOutputCopyWithImpl<RepoUploadBlobOutput>(
          this as RepoUploadBlobOutput, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, blob, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $RepoUploadBlobOutputCopyWith<$Res> {
  factory $RepoUploadBlobOutputCopyWith(RepoUploadBlobOutput value,
          $Res Function(RepoUploadBlobOutput) _then) =
      _$RepoUploadBlobOutputCopyWithImpl;
  @useResult
...
extension RepoUploadBlobOutputPatterns on RepoUploadBlobOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoUploadBlobOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _RepoUploadBlobOutput() when $default != null:
        return $default(_that.blob, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(@BlobConverter() Blob blob, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _RepoUploadBlobOutput implements RepoUploadBlobOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoUploadBlobOutputCopyWith<_RepoUploadBlobOutput> get copyWith =>
      __$RepoUploadBlobOutputCopyWithImpl<_RepoUploadBlobOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoUploadBlobOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoUploadBlobOutput &&
            (identical(other.blob, blob) || other.blob == blob) &&
...
/// @nodoc
abstract mixin class _$RepoUploadBlobOutputCopyWith<$Res>
    implements $RepoUploadBlobOutputCopyWith<$Res> {
  factory _$RepoUploadBlobOutputCopyWith(_RepoUploadBlobOutput value,
          $Res Function(_RepoUploadBlobOutput) _then) =
      __$RepoUploadBlobOutputCopyWithImpl;
  @override
  @useResult
  $Res call({@BlobConverter() Blob blob, Map<String, dynamic>? $unknown});
