...
mixin _$RepoDescribeRepoInput {
  ...
  $RepoDescribeRepoInputCopyWith<RepoDescribeRepoInput> get copyWith =>
      _$RepoDescribeRepoInputCopyWithImpl<RepoDescribeRepoInput>(
          this as RepoDescribeRepoInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoDescribeRepoInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, repo, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $RepoDescribeRepoInputCopyWith<$Res> {
  factory $RepoDescribeRepoInputCopyWith(RepoDescribeRepoInput value,
          $Res Function(RepoDescribeRepoInput) _then) =
      _$RepoDescribeRepoInputCopyWithImpl;
  @useResult
...
extension RepoDescribeRepoInputPatterns on RepoDescribeRepoInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoDescribeRepoInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String repo, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RepoDescribeRepoInput() when $default != null:
        return $default(_that.repo, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoDescribeRepoInput implements RepoDescribeRepoInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoDescribeRepoInputCopyWith<_RepoDescribeRepoInput> get copyWith =>
      __$RepoDescribeRepoInputCopyWithImpl<_RepoDescribeRepoInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoDescribeRepoInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoDescribeRepoInput &&
            (identical(other.repo, repo) || other.repo == repo) &&
...
/// @nodoc
abstract mixin class _$RepoDescribeRepoInputCopyWith<$Res>
    implements $RepoDescribeRepoInputCopyWith<$Res> {
  factory _$RepoDescribeRepoInputCopyWith(_RepoDescribeRepoInput value,
          $Res Function(_RepoDescribeRepoInput) _then) =
      __$RepoDescribeRepoInputCopyWithImpl;
  @override
  @useResult
  $Res call({String repo, Map<String, dynamic>? $unknown});
}
