...
mixin _$IdentitySubmitPlcOperationInput {
  ...
  $IdentitySubmitPlcOperationInputCopyWith<IdentitySubmitPlcOperationInput>
      get copyWith => _$IdentitySubmitPlcOperationInputCopyWithImpl<
              IdentitySubmitPlcOperationInput>(
          this as IdentitySubmitPlcOperationInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IdentitySubmitPlcOperationInput &&
...
abstract mixin class $IdentitySubmitPlcOperationInputCopyWith<$Res> {
  factory $IdentitySubmitPlcOperationInputCopyWith(
          ...
          $Res Function(IdentitySubmitPlcOperationInput) _then) =
      _$IdentitySubmitPlcOperationInputCopyWithImpl;
  @useResult
...
extension IdentitySubmitPlcOperationInputPatterns
    on IdentitySubmitPlcOperationInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IdentitySubmitPlcOperationInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _IdentitySubmitPlcOperationInput() when $default != null:
        return $default(_that.operation, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _IdentitySubmitPlcOperationInput
    implements IdentitySubmitPlcOperationInput {
  const _IdentitySubmitPlcOperationInput(
      {required final Map<String, dynamic> operation,
      final Map<String, dynamic>? $unknown})
      : _operation = operation,
        _$unknown = $unknown;
  factory _IdentitySubmitPlcOperationInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IdentitySubmitPlcOperationInputCopyWith<_IdentitySubmitPlcOperationInput>
      get copyWith => __$IdentitySubmitPlcOperationInputCopyWithImpl<
          _IdentitySubmitPlcOperationInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$IdentitySubmitPlcOperationInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IdentitySubmitPlcOperationInput &&
...
/// @nodoc
abstract mixin class _$IdentitySubmitPlcOperationInputCopyWith<$Res>
    implements $IdentitySubmitPlcOperationInputCopyWith<$Res> {
  factory _$IdentitySubmitPlcOperationInputCopyWith(
          _IdentitySubmitPlcOperationInput value,
          $Res Function(_IdentitySubmitPlcOperationInput) _then) =
      __$IdentitySubmitPlcOperationInputCopyWithImpl;
  @override
  @useResult
  $Res call({Map<String, dynamic> operation, Map<String, dynamic>? $unknown});
}
