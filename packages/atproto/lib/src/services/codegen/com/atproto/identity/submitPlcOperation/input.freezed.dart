...
@pragma('vm:prefer-inline') @override $Res call({Object? operation = null,Object? $unknown = freezed,}) {
  return _then(IdentitySubmitPlcOperationInput(
...
class _IdentitySubmitPlcOperationInput implements IdentitySubmitPlcOperationInput {
  const _IdentitySubmitPlcOperationInput({required  Map<String, dynamic> operation,  Map<String, dynamic>? $unknown}): _operation = operation,_$unknown = $unknown;
