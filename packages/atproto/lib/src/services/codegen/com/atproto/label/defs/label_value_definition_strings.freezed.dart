...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? lang = null,Object? name = null,Object? description = null,Object? $unknown = freezed,}) {
  return _then(LabelValueDefinitionStrings(
...
class _LabelValueDefinitionStrings implements LabelValueDefinitionStrings {
  const _LabelValueDefinitionStrings({this.$type = 'com.atproto.label.defs#labelValueDefinitionStrings', required this.lang, required this.name, required this.description,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
