...
@pragma('vm:prefer-inline') @override $Res call({Object? didDoc = null,Object? $unknown = freezed,}) {
  return _then(IdentityResolveDidOutput(
...
class _IdentityResolveDidOutput implements IdentityResolveDidOutput {
  const _IdentityResolveDidOutput({required  Map<String, dynamic> didDoc,  Map<String, dynamic>? $unknown}): _didDoc = didDoc,_$unknown = $unknown;
