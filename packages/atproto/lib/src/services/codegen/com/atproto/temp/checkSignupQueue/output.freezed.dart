...
mixin _$TempCheckSignupQueueOutput {
  ...
  $TempCheckSignupQueueOutputCopyWith<TempCheckSignupQueueOutput>
      get copyWith =>
          _$TempCheckSignupQueueOutputCopyWithImpl<TempCheckSignupQueueOutput>(
              this as TempCheckSignupQueueOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TempCheckSignupQueueOutput &&
  ...
  int get hashCode => Object.hash(runtimeType, activated, placeInQueue,
      estimatedTimeMs, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $TempCheckSignupQueueOutputCopyWith<$Res> {
  factory $TempCheckSignupQueueOutputCopyWith(TempCheckSignupQueueOutput value,
          $Res Function(TempCheckSignupQueueOutput) _then) =
      _$TempCheckSignupQueueOutputCopyWithImpl;
  @useResult
  $Res call(
      {bool activated,
      int? placeInQueue,
...
extension TempCheckSignupQueueOutputPatterns on TempCheckSignupQueueOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TempCheckSignupQueueOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool activated, int? placeInQueue, int? estimatedTimeMs,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _TempCheckSignupQueueOutput() when $default != null:
        return $default(_that.activated, _that.placeInQueue,
            _that.estimatedTimeMs, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _TempCheckSignupQueueOutput implements TempCheckSignupQueueOutput {
  const _TempCheckSignupQueueOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TempCheckSignupQueueOutputCopyWith<_TempCheckSignupQueueOutput>
      get copyWith => __$TempCheckSignupQueueOutputCopyWithImpl<
          _TempCheckSignupQueueOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TempCheckSignupQueueOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TempCheckSignupQueueOutput &&
            (identical(other.activated, activated) ||
                other.activated == activated) &&
            (identical(other.placeInQueue, placeInQueue) ||
                other.placeInQueue == placeInQueue) &&
...
/// @nodoc
abstract mixin class _$TempCheckSignupQueueOutputCopyWith<$Res>
    implements $TempCheckSignupQueueOutputCopyWith<$Res> {
  factory _$TempCheckSignupQueueOutputCopyWith(
          _TempCheckSignupQueueOutput value,
          $Res Function(_TempCheckSignupQueueOutput) _then) =
      __$TempCheckSignupQueueOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool activated,
