...
mixin _$SyncSubscribeReposInput {
  ...
  $SyncSubscribeReposInputCopyWith<SyncSubscribeReposInput> get copyWith =>
      _$SyncSubscribeReposInputCopyWithImpl<SyncSubscribeReposInput>(
          this as SyncSubscribeReposInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncSubscribeReposInput &&
...
abstract mixin class $SyncSubscribeReposInputCopyWith<$Res> {
  factory $SyncSubscribeReposInputCopyWith(SyncSubscribeReposInput value,
          $Res Function(SyncSubscribeReposInput) _then) =
      _$SyncSubscribeReposInputCopyWithImpl;
  @useResult
...
extension SyncSubscribeReposInputPatterns on SyncSubscribeReposInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncSubscribeReposInput value)? $default, {
...
class _SyncSubscribeReposInput implements SyncSubscribeReposInput {
  const _SyncSubscribeReposInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncSubscribeReposInputCopyWith<_SyncSubscribeReposInput> get copyWith =>
      __$SyncSubscribeReposInputCopyWithImpl<_SyncSubscribeReposInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncSubscribeReposInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncSubscribeReposInput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SyncSubscribeReposInputCopyWith<$Res>
    implements $SyncSubscribeReposInputCopyWith<$Res> {
  factory _$SyncSubscribeReposInputCopyWith(_SyncSubscribeReposInput value,
          $Res Function(_SyncSubscribeReposInput) _then) =
      __$SyncSubscribeReposInputCopyWithImpl;
  @override
  @useResult
  $Res call({int? cursor, Map<String, dynamic>? $unknown});
}
