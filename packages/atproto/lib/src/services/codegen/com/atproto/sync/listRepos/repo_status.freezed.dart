...
extension RepoStatusPatterns on RepoStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case RepoStatusUnknown() when unknown != null:
...
class RepoStatusKnownValue extends RepoStatus {
  ...
  $RepoStatusKnownValueCopyWith<RepoStatusKnownValue> get copyWith =>
      _$RepoStatusKnownValueCopyWithImpl<RepoStatusKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $RepoStatusKnownValueCopyWith<$Res>
    implements $RepoStatusCopyWith<$Res> {
  factory $RepoStatusKnownValueCopyWith(RepoStatusKnownValue value,
          $Res Function(RepoStatusKnownValue) _then) =
      _$RepoStatusKnownValueCopyWithImpl;
  @useResult
...
class RepoStatusUnknown extends RepoStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RepoStatusUnknownCopyWith<RepoStatusUnknown> get copyWith =>
      _$RepoStatusUnknownCopyWithImpl<RepoStatusUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $RepoStatusUnknownCopyWith<$Res>
    implements $RepoStatusCopyWith<$Res> {
  factory $RepoStatusUnknownCopyWith(
          RepoStatusUnknown value, $Res Function(RepoStatusUnknown) _then) =
      _$RepoStatusUnknownCopyWithImpl;
  @useResult
