...
mixin _$RepoListMissingBlobsInput {
  ...
  $RepoListMissingBlobsInputCopyWith<RepoListMissingBlobsInput> get copyWith =>
      _$RepoListMissingBlobsInputCopyWithImpl<RepoListMissingBlobsInput>(
          this as RepoListMissingBlobsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoListMissingBlobsInput &&
...
abstract mixin class $RepoListMissingBlobsInputCopyWith<$Res> {
  factory $RepoListMissingBlobsInputCopyWith(RepoListMissingBlobsInput value,
          $Res Function(RepoListMissingBlobsInput) _then) =
      _$RepoListMissingBlobsInputCopyWithImpl;
  @useResult
...
extension RepoListMissingBlobsInputPatterns on RepoListMissingBlobsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoListMissingBlobsInput value)? $default, {
...
class _RepoListMissingBlobsInput implements RepoListMissingBlobsInput {
  const _RepoListMissingBlobsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoListMissingBlobsInputCopyWith<_RepoListMissingBlobsInput>
      get copyWith =>
          __$RepoListMissingBlobsInputCopyWithImpl<_RepoListMissingBlobsInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoListMissingBlobsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoListMissingBlobsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$RepoListMissingBlobsInputCopyWith<$Res>
    implements $RepoListMissingBlobsInputCopyWith<$Res> {
  factory _$RepoListMissingBlobsInputCopyWith(_RepoListMissingBlobsInput value,
          $Res Function(_RepoListMissingBlobsInput) _then) =
      __$RepoListMissingBlobsInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
