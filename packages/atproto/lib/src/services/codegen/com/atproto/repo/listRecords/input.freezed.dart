...
mixin _$RepoListRecordsInput {
  ...
  $RepoListRecordsInputCopyWith<RepoListRecordsInput> get copyWith =>
      _$RepoListRecordsInputCopyWithImpl<RepoListRecordsInput>(
          this as RepoListRecordsInput, _$identity);
  ...
  int get hashCode => Object.hash(runtimeType, repo, collection, limit, cursor,
      reverse, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $RepoListRecordsInputCopyWith<$Res> {
  factory $RepoListRecordsInputCopyWith(RepoListRecordsInput value,
          $Res Function(RepoListRecordsInput) _then) =
      _$RepoListRecordsInputCopyWithImpl;
  @useResult
  $Res call(
      {String repo,
      String collection,
...
extension RepoListRecordsInputPatterns on RepoListRecordsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoListRecordsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String repo, String collection, int limit, String? cursor,
            bool? reverse, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _RepoListRecordsInput() when $default != null:
        return $default(_that.repo, _that.collection, _that.limit, _that.cursor,
            _that.reverse, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoListRecordsInput implements RepoListRecordsInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoListRecordsInputCopyWith<_RepoListRecordsInput> get copyWith =>
      __$RepoListRecordsInputCopyWithImpl<_RepoListRecordsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoListRecordsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoListRecordsInput &&
            (identical(other.repo, repo) || other.repo == repo) &&
            (identical(other.collection, collection) ||
                other.collection == collection) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$RepoListRecordsInputCopyWith<$Res>
    implements $RepoListRecordsInputCopyWith<$Res> {
  factory _$RepoListRecordsInputCopyWith(_RepoListRecordsInput value,
          $Res Function(_RepoListRecordsInput) _then) =
      __$RepoListRecordsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String repo,
