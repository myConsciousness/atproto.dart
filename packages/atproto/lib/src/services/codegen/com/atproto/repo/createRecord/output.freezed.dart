...
mixin _$RepoCreateRecordOutput {
  ...
  $RepoCreateRecordOutputCopyWith<RepoCreateRecordOutput> get copyWith =>
      _$RepoCreateRecordOutputCopyWithImpl<RepoCreateRecordOutput>(
          this as RepoCreateRecordOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoCreateRecordOutput &&
...
abstract mixin class $RepoCreateRecordOutputCopyWith<$Res> {
  factory $RepoCreateRecordOutputCopyWith(RepoCreateRecordOutput value,
          $Res Function(RepoCreateRecordOutput) _then) =
      _$RepoCreateRecordOutputCopyWithImpl;
  @useResult
  $Res call(
      {String uri,
      String cid,
...
extension RepoCreateRecordOutputPatterns on RepoCreateRecordOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoCreateRecordOutput value)? $default, {
...
class _RepoCreateRecordOutput implements RepoCreateRecordOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoCreateRecordOutputCopyWith<_RepoCreateRecordOutput> get copyWith =>
      __$RepoCreateRecordOutputCopyWithImpl<_RepoCreateRecordOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoCreateRecordOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoCreateRecordOutput &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.cid, cid) || other.cid == cid) &&
            (identical(other.commit, commit) || other.commit == commit) &&
            (identical(other.validationStatus, validationStatus) ||
...
/// @nodoc
abstract mixin class _$RepoCreateRecordOutputCopyWith<$Res>
    implements $RepoCreateRecordOutputCopyWith<$Res> {
  factory _$RepoCreateRecordOutputCopyWith(_RepoCreateRecordOutput value,
          $Res Function(_RepoCreateRecordOutput) _then) =
      __$RepoCreateRecordOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String uri,
