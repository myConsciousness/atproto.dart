...
@pragma('vm:prefer-inline') @override $Res call({Object? uri = null,Object? cid = null,Object? commit = freezed,Object? validationStatus = freezed,Object? $unknown = freezed,}) {
  return _then(RepoCreateRecordOutput(
...
class _RepoCreateRecordOutput implements RepoCreateRecordOutput {
  const _RepoCreateRecordOutput({@AtUriConverter() required this.uri, required this.cid, @CommitMetaConverter() this.commit, @RepoCreateRecordValidationStatusConverter() this.validationStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
