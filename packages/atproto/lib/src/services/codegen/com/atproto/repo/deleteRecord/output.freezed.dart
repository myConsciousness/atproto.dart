...
mixin _$RepoDeleteRecordOutput {
  ...
  $RepoDeleteRecordOutputCopyWith<RepoDeleteRecordOutput> get copyWith =>
      _$RepoDeleteRecordOutputCopyWithImpl<RepoDeleteRecordOutput>(
          this as RepoDeleteRecordOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoDeleteRecordOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, commit, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $RepoDeleteRecordOutputCopyWith<$Res> {
  factory $RepoDeleteRecordOutputCopyWith(RepoDeleteRecordOutput value,
          $Res Function(RepoDeleteRecordOutput) _then) =
      _$RepoDeleteRecordOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension RepoDeleteRecordOutputPatterns on RepoDeleteRecordOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoDeleteRecordOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@CommitMetaConverter() CommitMeta? commit,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _RepoDeleteRecordOutput() when $default != null:
        return $default(_that.commit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoDeleteRecordOutput implements RepoDeleteRecordOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoDeleteRecordOutputCopyWith<_RepoDeleteRecordOutput> get copyWith =>
      __$RepoDeleteRecordOutputCopyWithImpl<_RepoDeleteRecordOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoDeleteRecordOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoDeleteRecordOutput &&
            (identical(other.commit, commit) || other.commit == commit) &&
...
/// @nodoc
abstract mixin class _$RepoDeleteRecordOutputCopyWith<$Res>
    implements $RepoDeleteRecordOutputCopyWith<$Res> {
  factory _$RepoDeleteRecordOutputCopyWith(_RepoDeleteRecordOutput value,
          $Res Function(_RepoDeleteRecordOutput) _then) =
      __$RepoDeleteRecordOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@CommitMetaConverter() CommitMeta? commit,
