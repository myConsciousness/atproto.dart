...
mixin _$ServerGetServiceAuthOutput {
  ...
  $ServerGetServiceAuthOutputCopyWith<ServerGetServiceAuthOutput>
      get copyWith =>
          _$ServerGetServiceAuthOutputCopyWithImpl<ServerGetServiceAuthOutput>(
              this as ServerGetServiceAuthOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetServiceAuthOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, token, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerGetServiceAuthOutputCopyWith<$Res> {
  factory $ServerGetServiceAuthOutputCopyWith(ServerGetServiceAuthOutput value,
          $Res Function(ServerGetServiceAuthOutput) _then) =
      _$ServerGetServiceAuthOutputCopyWithImpl;
  @useResult
...
extension ServerGetServiceAuthOutputPatterns on ServerGetServiceAuthOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerGetServiceAuthOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String token, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ServerGetServiceAuthOutput() when $default != null:
        return $default(_that.token, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerGetServiceAuthOutput implements ServerGetServiceAuthOutput {
  const _ServerGetServiceAuthOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerGetServiceAuthOutputCopyWith<_ServerGetServiceAuthOutput>
      get copyWith => __$ServerGetServiceAuthOutputCopyWithImpl<
          _ServerGetServiceAuthOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerGetServiceAuthOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerGetServiceAuthOutput &&
            (identical(other.token, token) || other.token == token) &&
...
/// @nodoc
abstract mixin class _$ServerGetServiceAuthOutputCopyWith<$Res>
    implements $ServerGetServiceAuthOutputCopyWith<$Res> {
  factory _$ServerGetServiceAuthOutputCopyWith(
          _ServerGetServiceAuthOutput value,
          $Res Function(_ServerGetServiceAuthOutput) _then) =
      __$ServerGetServiceAuthOutputCopyWithImpl;
  @override
  @useResult
  $Res call({String token, Map<String, dynamic>? $unknown});
}
