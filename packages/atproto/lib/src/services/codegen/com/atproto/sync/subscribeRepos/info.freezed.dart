...
class _Info implements Info {
  const _Info({this.$type = 'com.atproto.sync.subscribeRepos#info', @InfoNameConverter() required this.name, this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
