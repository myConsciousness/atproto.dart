...
extension InfoPatterns on Info {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, @InfoNameConverter() InfoName name,
            String? message, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Info() when $default != null:
        return $default(_that.$type, _that.name, _that.message, _that.$unknown);
      case _:
        return orElse();
    }
  }
