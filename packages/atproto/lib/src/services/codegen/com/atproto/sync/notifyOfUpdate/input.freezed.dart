...
mixin _$SyncNotifyOfUpdateInput {
  ...
  $SyncNotifyOfUpdateInputCopyWith<SyncNotifyOfUpdateInput> get copyWith =>
      _$SyncNotifyOfUpdateInputCopyWithImpl<SyncNotifyOfUpdateInput>(
          this as SyncNotifyOfUpdateInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SyncNotifyOfUpdateInput &&
...
abstract mixin class $SyncNotifyOfUpdateInputCopyWith<$Res> {
  factory $SyncNotifyOfUpdateInputCopyWith(SyncNotifyOfUpdateInput value,
          $Res Function(SyncNotifyOfUpdateInput) _then) =
      _$SyncNotifyOfUpdateInputCopyWithImpl;
  @useResult
...
extension SyncNotifyOfUpdateInputPatterns on SyncNotifyOfUpdateInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SyncNotifyOfUpdateInput value)? $default, {
...
class _SyncNotifyOfUpdateInput implements SyncNotifyOfUpdateInput {
  const _SyncNotifyOfUpdateInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SyncNotifyOfUpdateInputCopyWith<_SyncNotifyOfUpdateInput> get copyWith =>
      __$SyncNotifyOfUpdateInputCopyWithImpl<_SyncNotifyOfUpdateInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SyncNotifyOfUpdateInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SyncNotifyOfUpdateInput &&
            (identical(other.hostname, hostname) ||
                other.hostname == hostname) &&
...
/// @nodoc
abstract mixin class _$SyncNotifyOfUpdateInputCopyWith<$Res>
    implements $SyncNotifyOfUpdateInputCopyWith<$Res> {
  factory _$SyncNotifyOfUpdateInputCopyWith(_SyncNotifyOfUpdateInput value,
          $Res Function(_SyncNotifyOfUpdateInput) _then) =
      __$SyncNotifyOfUpdateInputCopyWithImpl;
  @override
  @useResult
  $Res call({String hostname, Map<String, dynamic>? $unknown});
}
