...
mixin _$ServerReserveSigningKeyOutput {
  ...
  $ServerReserveSigningKeyOutputCopyWith<ServerReserveSigningKeyOutput>
      get copyWith => _$ServerReserveSigningKeyOutputCopyWithImpl<
              ServerReserveSigningKeyOutput>(
          this as ServerReserveSigningKeyOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerReserveSigningKeyOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, signingKey, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerReserveSigningKeyOutputCopyWith<$Res> {
  factory $ServerReserveSigningKeyOutputCopyWith(
          ...
          $Res Function(ServerReserveSigningKeyOutput) _then) =
      _$ServerReserveSigningKeyOutputCopyWithImpl;
  @useResult
...
extension ServerReserveSigningKeyOutputPatterns
    on ServerReserveSigningKeyOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerReserveSigningKeyOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String signingKey, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ServerReserveSigningKeyOutput() when $default != null:
        return $default(_that.signingKey, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerReserveSigningKeyOutput implements ServerReserveSigningKeyOutput {
  const _ServerReserveSigningKeyOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerReserveSigningKeyOutputCopyWith<_ServerReserveSigningKeyOutput>
      get copyWith => __$ServerReserveSigningKeyOutputCopyWithImpl<
          _ServerReserveSigningKeyOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerReserveSigningKeyOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerReserveSigningKeyOutput &&
            (identical(other.signingKey, signingKey) ||
                other.signingKey == signingKey) &&
...
/// @nodoc
abstract mixin class _$ServerReserveSigningKeyOutputCopyWith<$Res>
    implements $ServerReserveSigningKeyOutputCopyWith<$Res> {
  factory _$ServerReserveSigningKeyOutputCopyWith(
          _ServerReserveSigningKeyOutput value,
          $Res Function(_ServerReserveSigningKeyOutput) _then) =
      __$ServerReserveSigningKeyOutputCopyWithImpl;
  @override
  @useResult
  $Res call({String signingKey, Map<String, dynamic>? $unknown});
}
