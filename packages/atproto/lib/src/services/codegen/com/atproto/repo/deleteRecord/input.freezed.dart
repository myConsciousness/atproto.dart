...
mixin _$RepoDeleteRecordInput {
  ...
  $RepoDeleteRecordInputCopyWith<RepoDeleteRecordInput> get copyWith =>
      _$RepoDeleteRecordInputCopyWithImpl<RepoDeleteRecordInput>(
          this as RepoDeleteRecordInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RepoDeleteRecordInput &&
  ...
  int get hashCode => Object.hash(runtimeType, repo, collection, rkey,
      swapRecord, swapCommit, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $RepoDeleteRecordInputCopyWith<$Res> {
  factory $RepoDeleteRecordInputCopyWith(RepoDeleteRecordInput value,
          $Res Function(RepoDeleteRecordInput) _then) =
      _$RepoDeleteRecordInputCopyWithImpl;
  @useResult
  $Res call(
      {String repo,
      String collection,
...
extension RepoDeleteRecordInputPatterns on RepoDeleteRecordInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RepoDeleteRecordInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _RepoDeleteRecordInput() when $default != null:
        return $default(_that.repo, _that.collection, _that.rkey,
            _that.swapRecord, _that.swapCommit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RepoDeleteRecordInput implements RepoDeleteRecordInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RepoDeleteRecordInputCopyWith<_RepoDeleteRecordInput> get copyWith =>
      __$RepoDeleteRecordInputCopyWithImpl<_RepoDeleteRecordInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RepoDeleteRecordInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RepoDeleteRecordInput &&
            (identical(other.repo, repo) || other.repo == repo) &&
            (identical(other.collection, collection) ||
                other.collection == collection) &&
            (identical(other.rkey, rkey) || other.rkey == rkey) &&
...
/// @nodoc
abstract mixin class _$RepoDeleteRecordInputCopyWith<$Res>
    implements $RepoDeleteRecordInputCopyWith<$Res> {
  factory _$RepoDeleteRecordInputCopyWith(_RepoDeleteRecordInput value,
          $Res Function(_RepoDeleteRecordInput) _then) =
      __$RepoDeleteRecordInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String repo,
