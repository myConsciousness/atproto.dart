...
class _MessageMe implements MessageMe {
  const _MessageMe({this.$type = 'com.germnetwork.declaration#messageMe', required this.messageMeUrl, @MessageMeShowButtonToConverter() required this.showButtonTo,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
