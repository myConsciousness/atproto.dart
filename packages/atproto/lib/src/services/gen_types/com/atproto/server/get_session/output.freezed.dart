...
mixin _$GetSessionOutput {
  ...
  @UGetSessionStatusConverter()
  UGetSessionStatus? get status => throw _privateConstructorUsedError;
...
abstract class $GetSessionOutputCopyWith<$Res> {
  ...
  $UGetSessionStatusCopyWith<$Res>? get status;
}
...
class _$GetSessionOutputCopyWithImpl<$Res, $Val extends GetSessionOutput>
  ...
  $UGetSessionStatusCopyWith<$Res>? get status {
    ...
    return $UGetSessionStatusCopyWith<$Res>(_value.status!, (value) {
...
class _$GetSessionOutputImpl implements _GetSessionOutput {
  const _$GetSessionOutputImpl(
      ...
      this.active = false,
      @UGetSessionStatusConverter() this.status,
  ...
  @override
  @UGetSessionStatusConverter()
  final UGetSessionStatus? status;
...
abstract class _GetSessionOutput implements GetSessionOutput {
  const factory _GetSessionOutput(
          ...
          final Map<String, dynamic>? didDoc,
          final bool active,
          @UGetSessionStatusConverter() final UGetSessionStatus? status,
          @JsonKey(name: r'$unknown') final Map<String, dynamic>? $unknown}) =
