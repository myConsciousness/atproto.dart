...
/// Create a copy of SyncListReposByCollectionInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? collection = null,Object? limit = freezed,Object? cursor = freezed,Object? $unknown = freezed,}) {
...
class _SyncListReposByCollectionInput implements SyncListReposByCollectionInput {
  const _SyncListReposByCollectionInput({required this.collection, this.limit, this.cursor, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
/// Create a copy of SyncListReposByCollectionInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? collection = null,Object? limit = freezed,Object? cursor = freezed,Object? $unknown = freezed,}) {
