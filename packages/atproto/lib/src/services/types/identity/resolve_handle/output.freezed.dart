...
class _$IdentityResolveHandleOutputImpl
  ...
  const _$IdentityResolveHandleOutputImpl({required this.did});
  ...
  @override
  String toString() {
    return 'IdentityResolveHandleOutput(did: $did)';
  }
...
abstract class _IdentityResolveHandleOutput
  ...
  const factory _IdentityResolveHandleOutput({required final String did}) =
      _$IdentityResolveHandleOutputImpl;
