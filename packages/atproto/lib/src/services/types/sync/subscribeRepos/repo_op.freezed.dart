...
abstract class $RepoOpCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@RepoOpActionConverter() RepoOpAction action, String path, String cid});
...
class _$RepoOpImpl implements _RepoOp {
  ...
  @override
  String toString() {
    return 'RepoOp(action: $action, path: $path, cid: $cid)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, action, path, cid);
