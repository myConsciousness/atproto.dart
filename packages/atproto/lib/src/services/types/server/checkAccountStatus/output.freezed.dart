...
CheckAccountStatusOutput _$CheckAccountStatusOutputFromJson(
    Map<String, dynamic> json) {
  return _CheckAccountStatusOutput.fromJson(json);
}

/// @nodoc
mixin _$CheckAccountStatusOutput {
  ...
  @JsonKey(ignore: true)
  $CheckAccountStatusOutputCopyWith<CheckAccountStatusOutput> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CheckAccountStatusOutputCopyWith<$Res> {
  factory $CheckAccountStatusOutputCopyWith(CheckAccountStatusOutput value,
          $Res Function(CheckAccountStatusOutput) then) =
      _$CheckAccountStatusOutputCopyWithImpl<$Res, CheckAccountStatusOutput>;
  @useResult
  $Res call(
      {bool activated,
      bool validDid,
...
/// @nodoc
class _$CheckAccountStatusOutputCopyWithImpl<$Res,
        $Val extends CheckAccountStatusOutput>
    implements $CheckAccountStatusOutputCopyWith<$Res> {
  _$CheckAccountStatusOutputCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CheckAccountStatusOutputImplCopyWith<$Res>
    implements $CheckAccountStatusOutputCopyWith<$Res> {
  factory _$$CheckAccountStatusOutputImplCopyWith(
          _$CheckAccountStatusOutputImpl value,
          $Res Function(_$CheckAccountStatusOutputImpl) then) =
      __$$CheckAccountStatusOutputImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool activated,
...
/// @nodoc
class __$$CheckAccountStatusOutputImplCopyWithImpl<$Res>
    extends _$CheckAccountStatusOutputCopyWithImpl<$Res,
        _$CheckAccountStatusOutputImpl>
    implements _$$CheckAccountStatusOutputImplCopyWith<$Res> {
  __$$CheckAccountStatusOutputImplCopyWithImpl(
      _$CheckAccountStatusOutputImpl _value,
      $Res Function(_$CheckAccountStatusOutputImpl) _then)
      : super(_value, _then);
...
class _$CheckAccountStatusOutputImpl implements _CheckAccountStatusOutput {
  ...
  factory _$CheckAccountStatusOutputImpl.fromJson(Map<String, dynamic> json) =>
      _$$CheckAccountStatusOutputImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CheckAccountStatusOutput(activated: $activated, validDid: $validDid, repoCommit: $repoCommit, repoRev: $repoRev, repoBlocks: $repoBlocks, indexedRecords: $indexedRecords, privateStateValues: $privateStateValues, expectedBlobs: $expectedBlobs, importedBlobs: $importedBlobs)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CheckAccountStatusOutputImpl &&
  ...
  _$$CheckAccountStatusOutputImplCopyWith<_$CheckAccountStatusOutputImpl>
      get copyWith => __$$CheckAccountStatusOutputImplCopyWithImpl<
          _$CheckAccountStatusOutputImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CheckAccountStatusOutputImplToJson(
      this,
    );
  }
}

abstract class _CheckAccountStatusOutput implements CheckAccountStatusOutput {
  const factory _CheckAccountStatusOutput(
      ...
      required final int importedBlobs}) = _$CheckAccountStatusOutputImpl;

  factory _CheckAccountStatusOutput.fromJson(Map<String, dynamic> json) =
      _$CheckAccountStatusOutputImpl.fromJson;
