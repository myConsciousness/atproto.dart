...
class _$ServerCreateAccountOutputImpl implements _ServerCreateAccountOutput {
  ...
  @override
  String toString() {
    return 'ServerCreateAccountOutput(accessJwt: $accessJwt, refreshJwt: $refreshJwt, handle: $handle, did: $did, didDoc: $didDoc)';
  }
...
abstract class _ServerCreateAccountOutput implements ServerCreateAccountOutput {
  const factory _ServerCreateAccountOutput(
      ...
      final Map<String, dynamic>? didDoc}) = _$ServerCreateAccountOutputImpl;
