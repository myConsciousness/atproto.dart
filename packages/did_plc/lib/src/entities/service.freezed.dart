...
extension ServicePatterns on Service {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String type, String serviceEndpoint)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Service() when $default != null:
        return $default(_that.id, _that.type, _that.serviceEndpoint);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, String type, String serviceEndpoint) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _Service():
