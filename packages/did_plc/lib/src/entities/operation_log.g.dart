...
_$OperationLogImpl _$$OperationLogImplFromJson(Map json) =>
    $checkedCreate(r'_$OperationLogImpl', json, ($checkedConvert) {
      final val = _$OperationLogImpl(
        log: $checkedConvert(
          'log',
          (v) => (v as List<dynamic>)
              .map(
                (e) => compatibleOpOrTombstoneConverter.fromJson(
