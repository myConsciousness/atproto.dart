...
extension CompatibleOpOrTombstonePatterns on CompatibleOpOrTombstone {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UCompatibleOpOrTombstoneOp() when op != null:
        return op(_that);
      case UCompatibleOpOrTombstoneTombstone() when tombstone != null:
        return tombstone(_that);
      case UCompatibleOpOrTombstoneCreateOperationV1() when createOpV1 != null:
        return createOpV1(_that);
      case UCompatibleOpOrTombstoneUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UCompatibleOpOrTombstoneOp():
        return op(_that);
      case UCompatibleOpOrTombstoneTombstone():
        return tombstone(_that);
      case UCompatibleOpOrTombstoneCreateOperationV1():
        return createOpV1(_that);
      case UCompatibleOpOrTombstoneUnknown():
        return unknown(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UCompatibleOpOrTombstoneOp() when op != null:
        return op(_that.data);
      case UCompatibleOpOrTombstoneTombstone() when tombstone != null:
        return tombstone(_that.data);
      case UCompatibleOpOrTombstoneCreateOperationV1() when createOpV1 != null:
        return createOpV1(_that.data);
      case UCompatibleOpOrTombstoneUnknown() when unknown != null:
