...
void main() {
  group('ThreadgateRecord', () {
    test('fromJson', () {
      final json = {
        'threadgate': {
          'uri': 'at://did:plc:irshngrijywpgtvdsdkfmb34/app.bsky.feed.threadgate/3lijbupcbhs2c',
          ...
          'record': {
            ...
            'allow': [
              ...
              {'\$type': 'app.bsky.feed.threadgate#followerRule'},
              {
                ...
                'list': 'at://did:plc:irshngrijywpgtvdsdkfmb34/app.bsky.graph.list/3lhybxukqos2n'
              },
              {
                '\$type': 'app.bsky.feed.threadgate#listRule',
                'list': 'at://did:plc:irshngrijywpgtvdsdkfmb34/app.bsky.graph.list/3lgae7jyaf62n'
              }
            ],
            'createdAt': '2025-02-19T07:46:42.122Z',
            'hiddenReplies': [],
            'post': 'at://did:plc:irshngrijywpgtvdsdkfmb34/app.bsky.feed.post/3lijbupcbhs2c'
          },
          'lists': []
        }
      };
      ...
      final record = ThreadgateRecord.fromJson(json['threadgate']!['record'] as Map<String, Object?>);

      expect(record.type, equals('app.bsky.feed.threadgate'));
      expect(
        record.postUri.toString(),
        equals('at://did:plc:irshngrijywpgtvdsdkfmb34/app.bsky.feed.post/3lijbupcbhs2c'),
      );
