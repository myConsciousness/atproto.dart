...
extension ModerationTestSuiteConfigurationPatterns
    on ModerationTestSuiteConfiguration {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationTestSuiteConfiguration value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool authed, bool adultContentEnabled,
            Map<String, LabelPreference> settings)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ModerationTestSuiteConfiguration() when $default != null:
        return $default(
            _that.authed, _that.adultContentEnabled, _that.settings);
      case _:
        return orElse();
    }
  }
