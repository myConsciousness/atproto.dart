...
extension ModerationTestSuiteScenarioPatterns on ModerationTestSuiteScenario {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationTestSuiteScenario value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ModerationTestSuiteScenario() when $default != null:
        return $default(_that.cfg, _that.subject, _that.author,
            _that.quoteAuthor, _that.labels, _that.behaviors);
      case _:
        return orElse();
    }
  }
