...
extension ModerationTestSuiteUserPatterns on ModerationTestSuiteUser {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationTestSuiteUser value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool blocking, bool blockingByList, bool blockedBy,
            bool muted, bool mutedByList)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ModerationTestSuiteUser() when $default != null:
        return $default(_that.blocking, _that.blockingByList, _that.blockedBy,
            _that.muted, _that.mutedByList);
      case _:
        return orElse();
    }
  }
