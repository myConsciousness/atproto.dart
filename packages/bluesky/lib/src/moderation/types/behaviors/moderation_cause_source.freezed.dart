  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationCauseSource &&
...
class $ModerationCauseSourceCopyWith<$Res> {
  $ModerationCauseSourceCopyWith(
      ModerationCauseSource _, $Res Function(ModerationCauseSource) __);
}
...
extension ModerationCauseSourcePatterns on ModerationCauseSource {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseSourceUser() when user != null:
        return user(_that);
      case UModerationCauseSourceList() when list != null:
        return list(_that);
      case UModerationCauseSourceLabeler() when labeler != null:
        return labeler(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseSourceUser():
        return user(_that);
      case UModerationCauseSourceList():
        return list(_that);
      case UModerationCauseSourceLabeler():
        return labeler(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseSourceUser() when user != null:
        return user(_that.data);
      case UModerationCauseSourceList() when list != null:
        return list(_that.data);
      case UModerationCauseSourceLabeler() when labeler != null:
        return labeler(_that.data);
      case _:
        return orElse();
    }
  }
...
class UModerationCauseSourceUser implements ModerationCauseSource {
  ...
  $UModerationCauseSourceUserCopyWith<UModerationCauseSourceUser>
      get copyWith =>
          _$UModerationCauseSourceUserCopyWithImpl<UModerationCauseSourceUser>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCauseSourceUser &&
...
/// @nodoc
abstract mixin class $UModerationCauseSourceUserCopyWith<$Res>
    implements $ModerationCauseSourceCopyWith<$Res> {
  factory $UModerationCauseSourceUserCopyWith(UModerationCauseSourceUser value,
          $Res Function(UModerationCauseSourceUser) _then) =
      _$UModerationCauseSourceUserCopyWithImpl;
  @useResult
...
class UModerationCauseSourceList implements ModerationCauseSource {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationCauseSourceListCopyWith<UModerationCauseSourceList>
      get copyWith =>
          _$UModerationCauseSourceListCopyWithImpl<UModerationCauseSourceList>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCauseSourceList &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModerationCauseSourceListCopyWith<$Res>
    implements $ModerationCauseSourceCopyWith<$Res> {
  factory $UModerationCauseSourceListCopyWith(UModerationCauseSourceList value,
          $Res Function(UModerationCauseSourceList) _then) =
      _$UModerationCauseSourceListCopyWithImpl;
  @useResult
...
class UModerationCauseSourceLabeler implements ModerationCauseSource {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationCauseSourceLabelerCopyWith<UModerationCauseSourceLabeler>
      get copyWith => _$UModerationCauseSourceLabelerCopyWithImpl<
          UModerationCauseSourceLabeler>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationCauseSourceLabeler &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModerationCauseSourceLabelerCopyWith<$Res>
    implements $ModerationCauseSourceCopyWith<$Res> {
  factory $UModerationCauseSourceLabelerCopyWith(
          UModerationCauseSourceLabeler value,
          $Res Function(UModerationCauseSourceLabeler) _then) =
      _$UModerationCauseSourceLabelerCopyWithImpl;
  @useResult
