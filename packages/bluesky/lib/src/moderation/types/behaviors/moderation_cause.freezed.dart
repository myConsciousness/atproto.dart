...
extension ModerationCausePatterns on ModerationCause {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseBlocking() when blocking != null:
        return blocking(_that);
      case UModerationCauseBlockedBy() when blockedBy != null:
        return blockedBy(_that);
      case UModerationCauseBlockOther() when blockOther != null:
        return blockOther(_that);
      case UModerationCauseLabel() when label != null:
        return label(_that);
      case UModerationCauseMuted() when muted != null:
        return muted(_that);
      case UModerationCauseMuteWord() when muteWord != null:
        return muteWord(_that);
      case UModerationCauseHidden() when hidden != null:
        return hidden(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseBlocking():
        return blocking(_that);
      case UModerationCauseBlockedBy():
        return blockedBy(_that);
      case UModerationCauseBlockOther():
        return blockOther(_that);
      case UModerationCauseLabel():
        return label(_that);
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationCauseBlocking() when blocking != null:
        return blocking(_that.data);
      case UModerationCauseBlockedBy() when blockedBy != null:
        return blockedBy(_that.data);
      case UModerationCauseBlockOther() when blockOther != null:
        return blockOther(_that.data);
      case UModerationCauseLabel() when label != null:
        return label(_that.data);
      case UModerationCauseMuted() when muted != null:
        return muted(_that.data);
      case UModerationCauseMuteWord() when muteWord != null:
        return muteWord(_that.data);
      case UModerationCauseHidden() when hidden != null:
