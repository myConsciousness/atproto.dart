...
$ModerationPrefsCopyWith<ModerationPrefs> get copyWith => _$ModerationPrefsCopyWithImpl<ModerationPrefs>(this as ModerationPrefs, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModerationPrefs&&(identical(other.adultContentEnabled, adultContentEnabled) || other.adultContentEnabled == adultContentEnabled)&&const DeepCollectionEquality().equals(other.labels, labels)&&const DeepCollectionEquality().equals(other.labelers, labelers)&&const DeepCollectionEquality().equals(other.mutedWords, mutedWords)&&const DeepCollectionEquality().equals(other.hiddenPosts, hiddenPosts));
}


@override
int get hashCode => Object.hash(runtimeType,adultContentEnabled,const DeepCollectionEquality().hash(labels),const DeepCollectionEquality().hash(labelers),const DeepCollectionEquality().hash(mutedWords),const DeepCollectionEquality().hash(hiddenPosts));
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ModerationPrefs value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ModerationPrefs value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ModerationPrefs value)?  $default,){
final _that = this;
switch (_that) {
case _ModerationPrefs() when $default != null:
return $default(_that);case _:
...
@override List<ModerationPrefsLabeler> get labelers {
...
@override List<MutedWord> get mutedWords {
...
@pragma('vm:prefer-inline')
_$ModerationPrefsCopyWith<_ModerationPrefs> get copyWith => __$ModerationPrefsCopyWithImpl<_ModerationPrefs>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ModerationPrefs&&(identical(other.adultContentEnabled, adultContentEnabled) || other.adultContentEnabled == adultContentEnabled)&&const DeepCollectionEquality().equals(other._labels, _labels)&&const DeepCollectionEquality().equals(other._labelers, _labelers)&&const DeepCollectionEquality().equals(other._mutedWords, _mutedWords)&&const DeepCollectionEquality().equals(other._hiddenPosts, _hiddenPosts));
}


@override
int get hashCode => Object.hash(runtimeType,adultContentEnabled,const DeepCollectionEquality().hash(_labels),const DeepCollectionEquality().hash(_labelers),const DeepCollectionEquality().hash(_mutedWords),const DeepCollectionEquality().hash(_hiddenPosts));
...
/// @nodoc
abstract mixin class _$ModerationPrefsCopyWith<$Res> implements $ModerationPrefsCopyWith<$Res> {
...
/// Create a copy of ModerationPrefs
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? adultContentEnabled = null,Object? labels = null,Object? labelers = null,Object? mutedWords = null,Object? hiddenPosts = null,}) {
