...
$ModerationOptsCopyWith<ModerationOpts> get copyWith => _$ModerationOptsCopyWithImpl<ModerationOpts>(this as ModerationOpts, _$identity);
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ModerationOpts value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ModerationOpts value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ModerationOpts value)?  $default,){
final _that = this;
switch (_that) {
case _ModerationOpts() when $default != null:
return $default(_that);case _:
...
class _ModerationOpts implements ModerationOpts {
  const _ModerationOpts({this.userDid, required this.prefs,  Map<String, List<InterpretedLabelValueDefinition>> labelDefs = const {}, this.behaviors = const ModerationBehaviors()}): _labelDefs = labelDefs;
  

@override final  String? userDid;
@override final  ModerationPrefs prefs;
 final  Map<String, List<InterpretedLabelValueDefinition>> _labelDefs;
@override@JsonKey() Map<String, List<InterpretedLabelValueDefinition>> get labelDefs {
...
@pragma('vm:prefer-inline')
_$ModerationOptsCopyWith<_ModerationOpts> get copyWith => __$ModerationOptsCopyWithImpl<_ModerationOpts>(this, _$identity);
...
/// @nodoc
abstract mixin class _$ModerationOptsCopyWith<$Res> implements $ModerationOptsCopyWith<$Res> {
...
@override $ModerationPrefsCopyWith<$Res> get prefs;
