...
extension ModerationPrefsLabelerPatterns on ModerationPrefsLabeler {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationPrefsLabeler value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String did, Map<String, LabelPreference> labels)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ModerationPrefsLabeler() when $default != null:
        return $default(_that.did, _that.labels);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String did, Map<String, LabelPreference> labels) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _ModerationPrefsLabeler():
