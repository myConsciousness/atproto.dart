...
extension ModerationSubjectProfilePatterns on ModerationSubjectProfile {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationSubjectProfileProfileViewBasic()
          when profileViewBasic != null:
        return profileViewBasic(_that);
      case UModerationSubjectProfileProfileView() when profileView != null:
        return profileView(_that);
      case UModerationSubjectProfileProfileViewDetailed()
          when profileViewDetailed != null:
        return profileViewDetailed(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationSubjectProfileProfileViewBasic():
        return profileViewBasic(_that);
      case UModerationSubjectProfileProfileView():
        return profileView(_that);
      case UModerationSubjectProfileProfileViewDetailed():
        return profileViewDetailed(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UModerationSubjectProfileProfileViewBasic()
          when profileViewBasic != null:
        return profileViewBasic(_that.data);
      case UModerationSubjectProfileProfileView() when profileView != null:
        return profileView(_that.data);
      case UModerationSubjectProfileProfileViewDetailed()
          when profileViewDetailed != null:
        return profileViewDetailed(_that.data);
      case _:
        return orElse();
    }
  }
