...
_GroupedNotification _$GroupedNotificationFromJson(
  Map json,
) => $checkedCreate('_GroupedNotification', json, ($checkedConvert) {
  final val = _GroupedNotification(
    ...
    authors: $checkedConvert(
      'authors',
      (v) => (v as List<dynamic>)
          .map((e) => ProfileView.fromJson(Map<String, Object?>.from(e as Map)))
          .toList(),
    ),
    ...
    labels: $checkedConvert(
      'labels',
      (v) => (v as List<dynamic>)
          .map((e) => Label.fromJson(Map<String, Object?>.from(e as Map)))
          .toList(),
    ),
