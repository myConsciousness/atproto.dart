...
/// Create a copy of ActorSearchActorsTypeaheadInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? q = freezed,Object? limit = freezed,Object? $unknown = freezed,}) {
...
class _ActorSearchActorsTypeaheadInput implements ActorSearchActorsTypeaheadInput {
  const _ActorSearchActorsTypeaheadInput({this.q, this.limit, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
/// Create a copy of ActorSearchActorsTypeaheadInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? q = freezed,Object? limit = freezed,Object? $unknown = freezed,}) {
