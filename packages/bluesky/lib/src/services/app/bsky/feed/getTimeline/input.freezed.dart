...
$FeedGetTimelineInputCopyWith<FeedGetTimelineInput> get copyWith => _$FeedGetTimelineInputCopyWithImpl<FeedGetTimelineInput>(this as FeedGetTimelineInput, _$identity);
...
/// Create a copy of FeedGetTimelineInput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? algorithm = freezed,Object? limit = freezed,Object? cursor = freezed,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FeedGetTimelineInput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FeedGetTimelineInput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FeedGetTimelineInput value)?  $default,){
final _that = this;
switch (_that) {
case _FeedGetTimelineInput() when $default != null:
return $default(_that);case _:
...
class _FeedGetTimelineInput implements FeedGetTimelineInput {
  const _FeedGetTimelineInput({this.algorithm, this.limit, this.cursor, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$FeedGetTimelineInputCopyWith<_FeedGetTimelineInput> get copyWith => __$FeedGetTimelineInputCopyWithImpl<_FeedGetTimelineInput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FeedGetTimelineInputToJson(this, );
}
...
/// @nodoc
abstract mixin class _$FeedGetTimelineInputCopyWith<$Res> implements $FeedGetTimelineInputCopyWith<$Res> {
...
/// Create a copy of FeedGetTimelineInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? algorithm = freezed,Object? limit = freezed,Object? cursor = freezed,Object? $unknown = freezed,}) {
