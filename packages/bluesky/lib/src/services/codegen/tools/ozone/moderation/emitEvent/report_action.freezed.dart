...
class _ReportAction implements ReportAction {
  const _ReportAction({this.$type = 'tools.ozone.moderation.emitEvent#reportAction',  List<int>? ids,  List<String>? types, this.all, this.note,  Map<String, dynamic>? $unknown}): _ids = ids,_types = types,_$unknown = $unknown;
