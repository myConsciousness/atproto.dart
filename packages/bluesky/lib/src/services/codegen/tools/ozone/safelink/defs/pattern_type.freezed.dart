...
extension PatternTypePatterns on PatternType {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case PatternTypeUnknown() when unknown != null:
...
class PatternTypeKnownValue extends PatternType {
  ...
  $PatternTypeKnownValueCopyWith<PatternTypeKnownValue> get copyWith =>
      _$PatternTypeKnownValueCopyWithImpl<PatternTypeKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PatternTypeKnownValue &&
...
/// @nodoc
abstract mixin class $PatternTypeKnownValueCopyWith<$Res>
    implements $PatternTypeCopyWith<$Res> {
  factory $PatternTypeKnownValueCopyWith(PatternTypeKnownValue value,
          $Res Function(PatternTypeKnownValue) _then) =
      _$PatternTypeKnownValueCopyWithImpl;
  @useResult
...
class PatternTypeUnknown extends PatternType {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PatternTypeUnknownCopyWith<PatternTypeUnknown> get copyWith =>
      _$PatternTypeUnknownCopyWithImpl<PatternTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PatternTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $PatternTypeUnknownCopyWith<$Res>
    implements $PatternTypeCopyWith<$Res> {
  factory $PatternTypeUnknownCopyWith(
          PatternTypeUnknown value, $Res Function(PatternTypeUnknown) _then) =
      _$PatternTypeUnknownCopyWithImpl;
  @useResult
