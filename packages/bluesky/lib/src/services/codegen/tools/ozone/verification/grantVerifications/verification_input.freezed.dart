...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? subject = null,Object? handle = null,Object? displayName = null,Object? createdAt = freezed,Object? $unknown = freezed,}) {
  return _then(VerificationInput(
...
class _VerificationInput implements VerificationInput {
  const _VerificationInput({this.$type = 'tools.ozone.verification.grantVerifications#verificationInput', required this.subject, required this.handle, required this.displayName, @JsonKey(toJson: iso8601) this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
