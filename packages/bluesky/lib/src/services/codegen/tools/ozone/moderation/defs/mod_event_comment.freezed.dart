...
class _ModEventComment implements ModEventComment {
  const _ModEventComment({this.$type = 'tools.ozone.moderation.defs#modEventComment', this.comment, this.sticky,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
