...
extension MemberRolePatterns on MemberRole {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case MemberRoleUnknown() when unknown != null:
...
class MemberRoleKnownValue extends MemberRole {
  ...
  $MemberRoleKnownValueCopyWith<MemberRoleKnownValue> get copyWith =>
      _$MemberRoleKnownValueCopyWithImpl<MemberRoleKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $MemberRoleKnownValueCopyWith<$Res>
    implements $MemberRoleCopyWith<$Res> {
  factory $MemberRoleKnownValueCopyWith(MemberRoleKnownValue value,
          $Res Function(MemberRoleKnownValue) _then) =
      _$MemberRoleKnownValueCopyWithImpl;
  @useResult
...
class MemberRoleUnknown extends MemberRole {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MemberRoleUnknownCopyWith<MemberRoleUnknown> get copyWith =>
      _$MemberRoleUnknownCopyWithImpl<MemberRoleUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MemberRoleUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $MemberRoleUnknownCopyWith<$Res>
    implements $MemberRoleCopyWith<$Res> {
  factory $MemberRoleUnknownCopyWith(
          MemberRoleUnknown value, $Res Function(MemberRoleUnknown) _then) =
      _$MemberRoleUnknownCopyWithImpl;
  @useResult
