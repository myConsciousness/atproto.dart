  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationGetReposRepos &&
...
class $UModerationGetReposReposCopyWith<$Res> {
  $UModerationGetReposReposCopyWith(
      UModerationGetReposRepos _, $Res Function(UModerationGetReposRepos) __);
}
...
extension UModerationGetReposReposPatterns on UModerationGetReposRepos {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UModerationGetReposReposRepoViewNotFound()
          when repoViewNotFound != null:
        return repoViewNotFound(_that);
      case UModerationGetReposReposUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UModerationGetReposReposRepoViewNotFound():
        return repoViewNotFound(_that);
      case UModerationGetReposReposUnknown():
        return unknown(_that);
      case _:
...
class UModerationGetReposReposRepoViewDetail extends UModerationGetReposRepos {
  const UModerationGetReposReposRepoViewDetail({required this.data})
      : super._();
  ...
  $UModerationGetReposReposRepoViewDetailCopyWith<
          UModerationGetReposReposRepoViewDetail>
      get copyWith => _$UModerationGetReposReposRepoViewDetailCopyWithImpl<
          UModerationGetReposReposRepoViewDetail>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationGetReposReposRepoViewDetail &&
...
/// @nodoc
abstract mixin class $UModerationGetReposReposRepoViewDetailCopyWith<$Res>
    implements $UModerationGetReposReposCopyWith<$Res> {
  factory $UModerationGetReposReposRepoViewDetailCopyWith(
          UModerationGetReposReposRepoViewDetail value,
          $Res Function(UModerationGetReposReposRepoViewDetail) _then) =
      _$UModerationGetReposReposRepoViewDetailCopyWithImpl;
  @useResult
...
class UModerationGetReposReposRepoViewNotFound
    extends UModerationGetReposRepos {
  const UModerationGetReposReposRepoViewNotFound({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationGetReposReposRepoViewNotFoundCopyWith<
          UModerationGetReposReposRepoViewNotFound>
      get copyWith => _$UModerationGetReposReposRepoViewNotFoundCopyWithImpl<
          UModerationGetReposReposRepoViewNotFound>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationGetReposReposRepoViewNotFound &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModerationGetReposReposRepoViewNotFoundCopyWith<$Res>
    implements $UModerationGetReposReposCopyWith<$Res> {
  factory $UModerationGetReposReposRepoViewNotFoundCopyWith(
          UModerationGetReposReposRepoViewNotFound value,
          $Res Function(UModerationGetReposReposRepoViewNotFound) _then) =
      _$UModerationGetReposReposRepoViewNotFoundCopyWithImpl;
  @useResult
...
class UModerationGetReposReposUnknown extends UModerationGetReposRepos {
  const UModerationGetReposReposUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModerationGetReposReposUnknownCopyWith<UModerationGetReposReposUnknown>
      get copyWith => _$UModerationGetReposReposUnknownCopyWithImpl<
          UModerationGetReposReposUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModerationGetReposReposUnknown &&
...
/// @nodoc
abstract mixin class $UModerationGetReposReposUnknownCopyWith<$Res>
    implements $UModerationGetReposReposCopyWith<$Res> {
  factory $UModerationGetReposReposUnknownCopyWith(
          UModerationGetReposReposUnknown value,
          $Res Function(UModerationGetReposReposUnknown) _then) =
      _$UModerationGetReposReposUnknownCopyWithImpl;
  @useResult
