...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? members = null,Object? $unknown = freezed,}) {
  return _then(TeamListMembersOutput(
...
class _TeamListMembersOutput implements TeamListMembersOutput {
  const _TeamListMembersOutput({this.cursor, @MemberConverter() required  List<Member> members,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
