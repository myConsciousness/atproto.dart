...
class $TeamUpdateMemberRoleCopyWith<$Res> {
  $TeamUpdateMemberRoleCopyWith(
      TeamUpdateMemberRole _, $Res Function(TeamUpdateMemberRole) __);
}
...
extension TeamUpdateMemberRolePatterns on TeamUpdateMemberRole {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case TeamUpdateMemberRoleUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case TeamUpdateMemberRoleKnownValue():
        return knownValue(_that);
      case TeamUpdateMemberRoleUnknown():
        return unknown(_that);
      case _:
...
class TeamUpdateMemberRoleKnownValue extends TeamUpdateMemberRole {
  ...
  $TeamUpdateMemberRoleKnownValueCopyWith<TeamUpdateMemberRoleKnownValue>
      get copyWith => _$TeamUpdateMemberRoleKnownValueCopyWithImpl<
          TeamUpdateMemberRoleKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TeamUpdateMemberRoleKnownValue &&
...
/// @nodoc
abstract mixin class $TeamUpdateMemberRoleKnownValueCopyWith<$Res>
    implements $TeamUpdateMemberRoleCopyWith<$Res> {
  factory $TeamUpdateMemberRoleKnownValueCopyWith(
          TeamUpdateMemberRoleKnownValue value,
          $Res Function(TeamUpdateMemberRoleKnownValue) _then) =
      _$TeamUpdateMemberRoleKnownValueCopyWithImpl;
  @useResult
...
class TeamUpdateMemberRoleUnknown extends TeamUpdateMemberRole {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TeamUpdateMemberRoleUnknownCopyWith<TeamUpdateMemberRoleUnknown>
      get copyWith => _$TeamUpdateMemberRoleUnknownCopyWithImpl<
          TeamUpdateMemberRoleUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TeamUpdateMemberRoleUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $TeamUpdateMemberRoleUnknownCopyWith<$Res>
    implements $TeamUpdateMemberRoleCopyWith<$Res> {
  factory $TeamUpdateMemberRoleUnknownCopyWith(
          TeamUpdateMemberRoleUnknown value,
          $Res Function(TeamUpdateMemberRoleUnknown) _then) =
      _$TeamUpdateMemberRoleUnknownCopyWithImpl;
  @useResult
