...
class _ReporterStats implements ReporterStats {
  const _ReporterStats({this.$type = 'tools.ozone.moderation.defs#reporterStats', required this.did, required this.accountReportCount, required this.recordReportCount, required this.reportedAccountCount, required this.reportedRecordCount, required this.takendownAccountCount, required this.takendownRecordCount, required this.labeledAccountCount, required this.labeledRecordCount,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
