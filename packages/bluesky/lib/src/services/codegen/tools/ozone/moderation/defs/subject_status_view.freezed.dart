...
@JsonKey(toJson: iso8601) DateTime get createdAt;@SubjectReviewStateConverter() SubjectReviewState get reviewState;/// Sticky comment on the subject.
 ...
 int? get priorityScore;@JsonKey(toJson: iso8601) DateTime? get muteUntil;@JsonKey(toJson: iso8601) DateTime? get muteReportingUntil; String? get lastReviewedBy;@JsonKey(toJson: iso8601) DateTime? get lastReviewedAt;@JsonKey(toJson: iso8601) DateTime? get lastReportedAt;/// Timestamp referencing when the author of the subject appealed a moderation action
@JsonKey(toJson: iso8601) DateTime? get lastAppealedAt; bool? get takendown;/// True indicates that the a previously taken moderator action was appealed against, by the author of the content. False indicates last appeal was resolved by moderators.
...
@override@JsonKey(toJson: iso8601) final  DateTime? muteUntil;
@override@JsonKey(toJson: iso8601) final  DateTime? muteReportingUntil;
@override final  String? lastReviewedBy;
@override@JsonKey(toJson: iso8601) final  DateTime? lastReviewedAt;
@override@JsonKey(toJson: iso8601) final  DateTime? lastReportedAt;
/// Timestamp referencing when the author of the subject appealed a moderation action
@override@JsonKey(toJson: iso8601) final  DateTime? lastAppealedAt;
@override final  bool? takendown;
/// True indicates that the a previously taken moderator action was appealed against, by the author of the content. False indicates last appeal was resolved by moderators.
@override final  bool? appealed;
@override@JsonKey(toJson: iso8601) final  DateTime? suspendUntil;
