...
class $TeamAddMemberRoleCopyWith<$Res> {
  $TeamAddMemberRoleCopyWith(
      TeamAddMemberRole _, $Res Function(TeamAddMemberRole) __);
}
...
extension TeamAddMemberRolePatterns on TeamAddMemberRole {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case TeamAddMemberRoleUnknown() when unknown != null:
...
class TeamAddMemberRoleKnownValue extends TeamAddMemberRole {
  ...
  $TeamAddMemberRoleKnownValueCopyWith<TeamAddMemberRoleKnownValue>
      get copyWith => _$TeamAddMemberRoleKnownValueCopyWithImpl<
          TeamAddMemberRoleKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TeamAddMemberRoleKnownValue &&
...
/// @nodoc
abstract mixin class $TeamAddMemberRoleKnownValueCopyWith<$Res>
    implements $TeamAddMemberRoleCopyWith<$Res> {
  factory $TeamAddMemberRoleKnownValueCopyWith(
          TeamAddMemberRoleKnownValue value,
          $Res Function(TeamAddMemberRoleKnownValue) _then) =
      _$TeamAddMemberRoleKnownValueCopyWithImpl;
  @useResult
...
class TeamAddMemberRoleUnknown extends TeamAddMemberRole {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TeamAddMemberRoleUnknownCopyWith<TeamAddMemberRoleUnknown> get copyWith =>
      _$TeamAddMemberRoleUnknownCopyWithImpl<TeamAddMemberRoleUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TeamAddMemberRoleUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $TeamAddMemberRoleUnknownCopyWith<$Res>
    implements $TeamAddMemberRoleCopyWith<$Res> {
  factory $TeamAddMemberRoleUnknownCopyWith(TeamAddMemberRoleUnknown value,
          $Res Function(TeamAddMemberRoleUnknown) _then) =
      _$TeamAddMemberRoleUnknownCopyWithImpl;
  @useResult
