...
extension OptionScopePatterns on OptionScope {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case OptionScopeUnknown() when unknown != null:
...
class OptionScopeKnownValue extends OptionScope {
  ...
  $OptionScopeKnownValueCopyWith<OptionScopeKnownValue> get copyWith =>
      _$OptionScopeKnownValueCopyWithImpl<OptionScopeKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is OptionScopeKnownValue &&
...
/// @nodoc
abstract mixin class $OptionScopeKnownValueCopyWith<$Res>
    implements $OptionScopeCopyWith<$Res> {
  factory $OptionScopeKnownValueCopyWith(OptionScopeKnownValue value,
          $Res Function(OptionScopeKnownValue) _then) =
      _$OptionScopeKnownValueCopyWithImpl;
  @useResult
...
class OptionScopeUnknown extends OptionScope {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $OptionScopeUnknownCopyWith<OptionScopeUnknown> get copyWith =>
      _$OptionScopeUnknownCopyWithImpl<OptionScopeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is OptionScopeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $OptionScopeUnknownCopyWith<$Res>
    implements $OptionScopeCopyWith<$Res> {
  factory $OptionScopeUnknownCopyWith(
          OptionScopeUnknown value, $Res Function(OptionScopeUnknown) _then) =
      _$OptionScopeUnknownCopyWithImpl;
  @useResult
