...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? events = null,Object? $unknown = freezed,}) {
  return _then(HostingGetAccountHistoryOutput(
...
class _HostingGetAccountHistoryOutput implements HostingGetAccountHistoryOutput {
  const _HostingGetAccountHistoryOutput({this.cursor, @EventConverter() required  List<Event> events,  Map<String, dynamic>? $unknown}): _events = events,_$unknown = $unknown;
