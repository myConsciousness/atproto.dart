...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? events = null,Object? $unknown = freezed,}) {
  return _then(SafelinkQueryEventsOutput(
...
class _SafelinkQueryEventsOutput implements SafelinkQueryEventsOutput {
  const _SafelinkQueryEventsOutput({this.cursor, @EventConverter() required  List<Event> events,  Map<String, dynamic>? $unknown}): _events = events,_$unknown = $unknown;
