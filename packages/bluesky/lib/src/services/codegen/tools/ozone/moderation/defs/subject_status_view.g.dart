...
_SubjectStatusView _$SubjectStatusViewFromJson(Map json) => $checkedCreate(
      '_SubjectStatusView',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$SubjectStatusViewToJson(_SubjectStatusView instance) =>
    <String, dynamic>{
      r'$type': instance.$type,
      'id': instance.id,
      'subject':
          const USubjectStatusViewSubjectConverter().toJson(instance.subject),
      'hosting': _$JsonConverterToJson<Map<String, dynamic>,
              USubjectStatusViewHosting>(
          instance.hosting, const USubjectStatusViewHostingConverter().toJson),
