  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingListOptionsScope &&
...
class $SettingListOptionsScopeCopyWith<$Res> {
  $SettingListOptionsScopeCopyWith(
      SettingListOptionsScope _, $Res Function(SettingListOptionsScope) __);
}
...
extension SettingListOptionsScopePatterns on SettingListOptionsScope {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SettingListOptionsScopeUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case SettingListOptionsScopeKnownValue():
        return knownValue(_that);
      case SettingListOptionsScopeUnknown():
        return unknown(_that);
      case _:
...
class SettingListOptionsScopeKnownValue extends SettingListOptionsScope {
  ...
  $SettingListOptionsScopeKnownValueCopyWith<SettingListOptionsScopeKnownValue>
      get copyWith => _$SettingListOptionsScopeKnownValueCopyWithImpl<
          SettingListOptionsScopeKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingListOptionsScopeKnownValue &&
...
/// @nodoc
abstract mixin class $SettingListOptionsScopeKnownValueCopyWith<$Res>
    implements $SettingListOptionsScopeCopyWith<$Res> {
  factory $SettingListOptionsScopeKnownValueCopyWith(
          SettingListOptionsScopeKnownValue value,
          $Res Function(SettingListOptionsScopeKnownValue) _then) =
      _$SettingListOptionsScopeKnownValueCopyWithImpl;
  @useResult
...
class SettingListOptionsScopeUnknown extends SettingListOptionsScope {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SettingListOptionsScopeUnknownCopyWith<SettingListOptionsScopeUnknown>
      get copyWith => _$SettingListOptionsScopeUnknownCopyWithImpl<
          SettingListOptionsScopeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingListOptionsScopeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $SettingListOptionsScopeUnknownCopyWith<$Res>
    implements $SettingListOptionsScopeCopyWith<$Res> {
  factory $SettingListOptionsScopeUnknownCopyWith(
          SettingListOptionsScopeUnknown value,
          $Res Function(SettingListOptionsScopeUnknown) _then) =
      _$SettingListOptionsScopeUnknownCopyWithImpl;
  @useResult
