...
class _AccountStrike implements AccountStrike {
  const _AccountStrike({this.$type = 'tools.ozone.moderation.defs#accountStrike', this.activeStrikeCount, this.totalStrikeCount, @JsonKey(toJson: iso8601) this.firstStrikeAt, @JsonKey(toJson: iso8601) this.lastStrikeAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
