  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationQueryStatusesSubjectType &&
...
class $ModerationQueryStatusesSubjectTypeCopyWith<$Res> {
  $ModerationQueryStatusesSubjectTypeCopyWith(
      ModerationQueryStatusesSubjectType _,
      $Res Function(ModerationQueryStatusesSubjectType) __);
}

/// Adds pattern-matching-related methods to [ModerationQueryStatusesSubjectType].
extension ModerationQueryStatusesSubjectTypePatterns
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ModerationQueryStatusesSubjectTypeUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ModerationQueryStatusesSubjectTypeKnownValue():
        return knownValue(_that);
      case ModerationQueryStatusesSubjectTypeUnknown():
        return unknown(_that);
      case _:
...
class ModerationQueryStatusesSubjectTypeKnownValue
    extends ModerationQueryStatusesSubjectType {
  const ModerationQueryStatusesSubjectTypeKnownValue({required this.data})
      : super._();
  ...
  $ModerationQueryStatusesSubjectTypeKnownValueCopyWith<
          ModerationQueryStatusesSubjectTypeKnownValue>
      get copyWith =>
          _$ModerationQueryStatusesSubjectTypeKnownValueCopyWithImpl<
              ModerationQueryStatusesSubjectTypeKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationQueryStatusesSubjectTypeKnownValue &&
...
/// @nodoc
abstract mixin class $ModerationQueryStatusesSubjectTypeKnownValueCopyWith<$Res>
    implements $ModerationQueryStatusesSubjectTypeCopyWith<$Res> {
  factory $ModerationQueryStatusesSubjectTypeKnownValueCopyWith(
          ModerationQueryStatusesSubjectTypeKnownValue value,
          $Res Function(ModerationQueryStatusesSubjectTypeKnownValue) _then) =
      _$ModerationQueryStatusesSubjectTypeKnownValueCopyWithImpl;
  @useResult
...
class ModerationQueryStatusesSubjectTypeUnknown
    extends ModerationQueryStatusesSubjectType {
  const ModerationQueryStatusesSubjectTypeUnknown({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ModerationQueryStatusesSubjectTypeUnknownCopyWith<
          ModerationQueryStatusesSubjectTypeUnknown>
      get copyWith => _$ModerationQueryStatusesSubjectTypeUnknownCopyWithImpl<
          ModerationQueryStatusesSubjectTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationQueryStatusesSubjectTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ModerationQueryStatusesSubjectTypeUnknownCopyWith<$Res>
    implements $ModerationQueryStatusesSubjectTypeCopyWith<$Res> {
  factory $ModerationQueryStatusesSubjectTypeUnknownCopyWith(
          ModerationQueryStatusesSubjectTypeUnknown value,
          $Res Function(ModerationQueryStatusesSubjectTypeUnknown) _then) =
      _$ModerationQueryStatusesSubjectTypeUnknownCopyWithImpl;
  @useResult
