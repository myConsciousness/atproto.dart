...
class _ModEventDivert implements ModEventDivert {
  const _ModEventDivert({this.$type = 'tools.ozone.moderation.defs#modEventDivert', this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
