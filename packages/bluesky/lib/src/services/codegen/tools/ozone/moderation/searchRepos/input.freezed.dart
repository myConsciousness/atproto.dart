...
mixin _$ModerationSearchReposInput {
  ...
  $ModerationSearchReposInputCopyWith<ModerationSearchReposInput>
      get copyWith =>
          _$ModerationSearchReposInputCopyWithImpl<ModerationSearchReposInput>(
              this as ModerationSearchReposInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationSearchReposInput &&
...
abstract mixin class $ModerationSearchReposInputCopyWith<$Res> {
  factory $ModerationSearchReposInputCopyWith(ModerationSearchReposInput value,
          $Res Function(ModerationSearchReposInput) _then) =
      _$ModerationSearchReposInputCopyWithImpl;
  @useResult
  $Res call(
...
extension ModerationSearchReposInputPatterns on ModerationSearchReposInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationSearchReposInput value)? $default, {
...
class _ModerationSearchReposInput implements ModerationSearchReposInput {
  const _ModerationSearchReposInput(
      {this.q,
      this.limit = 50,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationSearchReposInputCopyWith<_ModerationSearchReposInput>
      get copyWith => __$ModerationSearchReposInputCopyWithImpl<
          _ModerationSearchReposInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationSearchReposInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationSearchReposInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$ModerationSearchReposInputCopyWith<$Res>
    implements $ModerationSearchReposInputCopyWith<$Res> {
  factory _$ModerationSearchReposInputCopyWith(
          _ModerationSearchReposInput value,
          $Res Function(_ModerationSearchReposInput) _then) =
      __$ModerationSearchReposInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? q, int limit, String? cursor, Map<String, dynamic>? $unknown});
