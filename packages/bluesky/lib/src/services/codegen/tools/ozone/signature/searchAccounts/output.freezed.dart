...
mixin _$SignatureSearchAccountsOutput {
  ...
  $SignatureSearchAccountsOutputCopyWith<SignatureSearchAccountsOutput>
      get copyWith => _$SignatureSearchAccountsOutputCopyWithImpl<
              SignatureSearchAccountsOutput>(
          this as SignatureSearchAccountsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignatureSearchAccountsOutput &&
...
abstract mixin class $SignatureSearchAccountsOutputCopyWith<$Res> {
  factory $SignatureSearchAccountsOutputCopyWith(
          ...
          $Res Function(SignatureSearchAccountsOutput) _then) =
      _$SignatureSearchAccountsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension SignatureSearchAccountsOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignatureSearchAccountsOutput value)? $default, {
...
class _SignatureSearchAccountsOutput implements SignatureSearchAccountsOutput {
  const _SignatureSearchAccountsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SignatureSearchAccountsOutputCopyWith<_SignatureSearchAccountsOutput>
      get copyWith => __$SignatureSearchAccountsOutputCopyWithImpl<
          _SignatureSearchAccountsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SignatureSearchAccountsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SignatureSearchAccountsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SignatureSearchAccountsOutputCopyWith<$Res>
    implements $SignatureSearchAccountsOutputCopyWith<$Res> {
  factory _$SignatureSearchAccountsOutputCopyWith(
          _SignatureSearchAccountsOutput value,
          $Res Function(_SignatureSearchAccountsOutput) _then) =
      __$SignatureSearchAccountsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
