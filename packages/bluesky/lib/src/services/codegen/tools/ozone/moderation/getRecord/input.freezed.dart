...
mixin _$ModerationGetRecordInput {
  ...
  $ModerationGetRecordInputCopyWith<ModerationGetRecordInput> get copyWith =>
      _$ModerationGetRecordInputCopyWithImpl<ModerationGetRecordInput>(
          this as ModerationGetRecordInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetRecordInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, uri, cid, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ModerationGetRecordInputCopyWith<$Res> {
  factory $ModerationGetRecordInputCopyWith(ModerationGetRecordInput value,
          $Res Function(ModerationGetRecordInput) _then) =
      _$ModerationGetRecordInputCopyWithImpl;
  @useResult
...
extension ModerationGetRecordInputPatterns on ModerationGetRecordInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetRecordInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String uri, String? cid, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ModerationGetRecordInput() when $default != null:
        return $default(_that.uri, _that.cid, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModerationGetRecordInput implements ModerationGetRecordInput {
  const _ModerationGetRecordInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetRecordInputCopyWith<_ModerationGetRecordInput> get copyWith =>
      __$ModerationGetRecordInputCopyWithImpl<_ModerationGetRecordInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetRecordInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetRecordInput &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.cid, cid) || other.cid == cid) &&
...
/// @nodoc
abstract mixin class _$ModerationGetRecordInputCopyWith<$Res>
    implements $ModerationGetRecordInputCopyWith<$Res> {
  factory _$ModerationGetRecordInputCopyWith(_ModerationGetRecordInput value,
          $Res Function(_ModerationGetRecordInput) _then) =
      __$ModerationGetRecordInputCopyWithImpl;
  @override
  @useResult
  $Res call({String uri, String? cid, Map<String, dynamic>? $unknown});
}
