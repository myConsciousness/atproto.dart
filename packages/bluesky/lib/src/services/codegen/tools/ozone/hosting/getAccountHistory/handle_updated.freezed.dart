...
class _HandleUpdated implements HandleUpdated {
  const _HandleUpdated({this.$type = 'tools.ozone.hosting.getAccountHistory#handleUpdated', required this.handle,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
