...
@pragma('vm:prefer-inline') @override $Res call({Object? stats = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetReporterStatsOutput(
...
class _ModerationGetReporterStatsOutput implements ModerationGetReporterStatsOutput {
  const _ModerationGetReporterStatsOutput({@ReporterStatsConverter() required  List<ReporterStats> stats,  Map<String, dynamic>? $unknown}): _stats = stats,_$unknown = $unknown;
