...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? previousStatus = freezed,Object? $unknown = freezed,}) {
  return _then(EscalationActivity(
...
class _EscalationActivity implements EscalationActivity {
  const _EscalationActivity({this.$type = 'tools.ozone.report.defs#escalationActivity', @EscalationActivityPreviousStatusConverter() this.previousStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
