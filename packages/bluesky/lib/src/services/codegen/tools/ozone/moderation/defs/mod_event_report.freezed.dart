...
class _ModEventReport implements ModEventReport {
  const _ModEventReport({this.$type = 'tools.ozone.moderation.defs#modEventReport', this.comment, this.isReporterMuted, @ReasonTypeConverter() required this.reportType,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
