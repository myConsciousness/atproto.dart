...
mixin _$TeamUpdateMemberInput {
  ...
  $TeamUpdateMemberInputCopyWith<TeamUpdateMemberInput> get copyWith =>
      _$TeamUpdateMemberInputCopyWithImpl<TeamUpdateMemberInput>(
          this as TeamUpdateMemberInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TeamUpdateMemberInput &&
...
abstract mixin class $TeamUpdateMemberInputCopyWith<$Res> {
  factory $TeamUpdateMemberInputCopyWith(TeamUpdateMemberInput value,
          $Res Function(TeamUpdateMemberInput) _then) =
      _$TeamUpdateMemberInputCopyWithImpl;
  @useResult
  $Res call(
      {String did,
      bool? disabled,
...
extension TeamUpdateMemberInputPatterns on TeamUpdateMemberInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TeamUpdateMemberInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _TeamUpdateMemberInput() when $default != null:
        return $default(_that.did, _that.disabled, _that.role, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _TeamUpdateMemberInput implements TeamUpdateMemberInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TeamUpdateMemberInputCopyWith<_TeamUpdateMemberInput> get copyWith =>
      __$TeamUpdateMemberInputCopyWithImpl<_TeamUpdateMemberInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TeamUpdateMemberInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TeamUpdateMemberInput &&
            (identical(other.did, did) || other.did == did) &&
            (identical(other.disabled, disabled) ||
                other.disabled == disabled) &&
            (identical(other.role, role) || other.role == role) &&
...
/// @nodoc
abstract mixin class _$TeamUpdateMemberInputCopyWith<$Res>
    implements $TeamUpdateMemberInputCopyWith<$Res> {
  factory _$TeamUpdateMemberInputCopyWith(_TeamUpdateMemberInput value,
          $Res Function(_TeamUpdateMemberInput) _then) =
      __$TeamUpdateMemberInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String did,
