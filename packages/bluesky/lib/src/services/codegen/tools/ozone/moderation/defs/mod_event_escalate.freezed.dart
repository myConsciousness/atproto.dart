...
class _ModEventEscalate implements ModEventEscalate {
  const _ModEventEscalate({this.$type = 'tools.ozone.moderation.defs#modEventEscalate', this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
