...
_$VerificationGrantVerificationsOutputFromJson(
  Map json,
) => $checkedCreate('_VerificationGrantVerificationsOutput', json, (
  $checkedConvert,
) {
  final val = _VerificationGrantVerificationsOutput(
    ...
    failedVerifications: $checkedConvert(
      ...
      (v) => (v as List<dynamic>)
          .map(
            (e) =>
                const GrantErrorConverter().fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    ),
