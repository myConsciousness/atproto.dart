...
class _SetView implements SetView {
  const _SetView({this.$type = 'tools.ozone.set.defs#setView', required this.name, this.description, required this.setSize, @JsonKey(toJson: iso8601) required this.createdAt, @JsonKey(toJson: iso8601) required this.updatedAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
