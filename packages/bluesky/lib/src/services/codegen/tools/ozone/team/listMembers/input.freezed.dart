...
mixin _$TeamListMembersInput {
  ...
  $TeamListMembersInputCopyWith<TeamListMembersInput> get copyWith =>
      _$TeamListMembersInputCopyWithImpl<TeamListMembersInput>(
          this as TeamListMembersInput, _$identity);
...
abstract mixin class $TeamListMembersInputCopyWith<$Res> {
  factory $TeamListMembersInputCopyWith(TeamListMembersInput value,
          $Res Function(TeamListMembersInput) _then) =
      _$TeamListMembersInputCopyWithImpl;
  @useResult
  $Res call(
      {String? q,
      bool? disabled,
...
extension TeamListMembersInputPatterns on TeamListMembersInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TeamListMembersInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? q, bool? disabled, List<String>? roles, int limit,
    ...
    switch (_that) {
      case _TeamListMembersInput() when $default != null:
        return $default(_that.q, _that.disabled, _that.roles, _that.limit,
...
class _TeamListMembersInput implements TeamListMembersInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TeamListMembersInputCopyWith<_TeamListMembersInput> get copyWith =>
      __$TeamListMembersInputCopyWithImpl<_TeamListMembersInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TeamListMembersInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TeamListMembersInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.disabled, disabled) ||
                other.disabled == disabled) &&
...
/// @nodoc
abstract mixin class _$TeamListMembersInputCopyWith<$Res>
    implements $TeamListMembersInputCopyWith<$Res> {
  factory _$TeamListMembersInputCopyWith(_TeamListMembersInput value,
          $Res Function(_TeamListMembersInput) _then) =
      __$TeamListMembersInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? q,
