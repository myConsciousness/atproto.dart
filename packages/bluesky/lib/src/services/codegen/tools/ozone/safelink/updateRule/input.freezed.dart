...
@pragma('vm:prefer-inline') @override $Res call({Object? url = null,Object? pattern = null,Object? action = null,Object? reason = null,Object? comment = freezed,Object? createdBy = freezed,Object? $unknown = freezed,}) {
  return _then(SafelinkUpdateRuleInput(
...
class _SafelinkUpdateRuleInput implements SafelinkUpdateRuleInput {
  const _SafelinkUpdateRuleInput({required this.url, @PatternTypeConverter() required this.pattern, @ActionTypeConverter() required this.action, @ReasonTypeConverter() required this.reason, this.comment, this.createdBy,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
