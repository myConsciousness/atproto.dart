...
class _VideoDetails implements VideoDetails {
  const _VideoDetails({this.$type = 'tools.ozone.moderation.defs#videoDetails', required this.width, required this.height, required this.length,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
