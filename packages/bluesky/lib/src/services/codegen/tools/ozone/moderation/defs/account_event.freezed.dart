...
class _AccountEvent implements AccountEvent {
  const _AccountEvent({this.$type = 'tools.ozone.moderation.defs#accountEvent', this.comment, required this.active, @AccountEventStatusConverter() this.status, @JsonKey(toJson: iso8601) required this.timestamp,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
