...
class _ViewerConfig implements ViewerConfig {
  const _ViewerConfig({this.$type = 'tools.ozone.server.getConfig#viewerConfig', @ViewerConfigRoleConverter() this.role,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
