...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? comment = null,Object? $unknown = freezed,}) {
  return _then(RevokeAccountCredentialsEvent(
...
class _RevokeAccountCredentialsEvent implements RevokeAccountCredentialsEvent {
  const _RevokeAccountCredentialsEvent({this.$type = 'tools.ozone.moderation.defs#revokeAccountCredentialsEvent', required this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
