...
mixin _$SettingUpsertOptionOutput {
  ...
  $SettingUpsertOptionOutputCopyWith<SettingUpsertOptionOutput> get copyWith =>
      _$SettingUpsertOptionOutputCopyWithImpl<SettingUpsertOptionOutput>(
          this as SettingUpsertOptionOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingUpsertOptionOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, option, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $SettingUpsertOptionOutputCopyWith<$Res> {
  factory $SettingUpsertOptionOutputCopyWith(SettingUpsertOptionOutput value,
          $Res Function(SettingUpsertOptionOutput) _then) =
      _$SettingUpsertOptionOutputCopyWithImpl;
  @useResult
...
extension SettingUpsertOptionOutputPatterns on SettingUpsertOptionOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SettingUpsertOptionOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SettingUpsertOptionOutput() when $default != null:
        return $default(_that.option, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SettingUpsertOptionOutput implements SettingUpsertOptionOutput {
  const _SettingUpsertOptionOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SettingUpsertOptionOutputCopyWith<_SettingUpsertOptionOutput>
      get copyWith =>
          __$SettingUpsertOptionOutputCopyWithImpl<_SettingUpsertOptionOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SettingUpsertOptionOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SettingUpsertOptionOutput &&
            (identical(other.option, option) || other.option == option) &&
...
/// @nodoc
abstract mixin class _$SettingUpsertOptionOutputCopyWith<$Res>
    implements $SettingUpsertOptionOutputCopyWith<$Res> {
  factory _$SettingUpsertOptionOutputCopyWith(_SettingUpsertOptionOutput value,
          $Res Function(_SettingUpsertOptionOutput) _then) =
      __$SettingUpsertOptionOutputCopyWithImpl;
  @override
  @useResult
  $Res call({@OptionConverter() Option option, Map<String, dynamic>? $unknown});
