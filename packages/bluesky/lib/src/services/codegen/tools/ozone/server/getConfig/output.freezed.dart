...
mixin _$ServerGetConfigOutput {
  ...
  $ServerGetConfigOutputCopyWith<ServerGetConfigOutput> get copyWith =>
      _$ServerGetConfigOutputCopyWithImpl<ServerGetConfigOutput>(
          this as ServerGetConfigOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ServerGetConfigOutput &&
  ...
  int get hashCode => Object.hash(runtimeType, appview, pds, blobDivert, chat,
      viewer, verifierDid, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ServerGetConfigOutputCopyWith<$Res> {
  factory $ServerGetConfigOutputCopyWith(ServerGetConfigOutput value,
          $Res Function(ServerGetConfigOutput) _then) =
      _$ServerGetConfigOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ServerGetConfigOutputPatterns on ServerGetConfigOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServerGetConfigOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ServerGetConfigOutput() when $default != null:
        return $default(_that.appview, _that.pds, _that.blobDivert, _that.chat,
            _that.viewer, _that.verifierDid, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ServerGetConfigOutput implements ServerGetConfigOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ServerGetConfigOutputCopyWith<_ServerGetConfigOutput> get copyWith =>
      __$ServerGetConfigOutputCopyWithImpl<_ServerGetConfigOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ServerGetConfigOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ServerGetConfigOutput &&
            (identical(other.appview, appview) || other.appview == appview) &&
            (identical(other.pds, pds) || other.pds == pds) &&
            (identical(other.blobDivert, blobDivert) ||
                other.blobDivert == blobDivert) &&
...
/// @nodoc
abstract mixin class _$ServerGetConfigOutputCopyWith<$Res>
    implements $ServerGetConfigOutputCopyWith<$Res> {
  factory _$ServerGetConfigOutputCopyWith(_ServerGetConfigOutput value,
          $Res Function(_ServerGetConfigOutput) _then) =
      __$ServerGetConfigOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ServiceConfigConverter() ServiceConfig? appview,
