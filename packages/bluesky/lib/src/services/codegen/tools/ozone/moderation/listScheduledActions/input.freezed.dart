...
@pragma('vm:prefer-inline') @override $Res call({Object? startsAfter = freezed,Object? endsBefore = freezed,Object? subjects = freezed,Object? statuses = null,Object? limit = null,Object? cursor = freezed,Object? $unknown = freezed,}) {
  return _then(ModerationListScheduledActionsInput(
...
class _ModerationListScheduledActionsInput implements ModerationListScheduledActionsInput {
  const _ModerationListScheduledActionsInput({@JsonKey(toJson: iso8601) this.startsAfter, @JsonKey(toJson: iso8601) this.endsBefore,  List<String>? subjects, @ModerationListScheduledActionsStatusesConverter() required  List<ModerationListScheduledActionsStatuses> statuses, this.limit = 50, this.cursor,  Map<String, dynamic>? $unknown}): _subjects = subjects,_statuses = statuses,_$unknown = $unknown;
