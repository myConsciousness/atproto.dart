...
class $UBlobViewDetailsCopyWith<$Res> {
  $UBlobViewDetailsCopyWith(
      UBlobViewDetails _, $Res Function(UBlobViewDetails) __);
}
...
extension UBlobViewDetailsPatterns on UBlobViewDetails {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UBlobViewDetailsImageDetails() when imageDetails != null:
        return imageDetails(_that);
      case UBlobViewDetailsVideoDetails() when videoDetails != null:
        return videoDetails(_that);
      case UBlobViewDetailsUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UBlobViewDetailsImageDetails():
        return imageDetails(_that);
      case UBlobViewDetailsVideoDetails():
        return videoDetails(_that);
      case UBlobViewDetailsUnknown():
        return unknown(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UBlobViewDetailsImageDetails() when imageDetails != null:
        return imageDetails(_that.data);
      case UBlobViewDetailsVideoDetails() when videoDetails != null:
        return videoDetails(_that.data);
      case UBlobViewDetailsUnknown() when unknown != null:
...
class UBlobViewDetailsImageDetails extends UBlobViewDetails {
  ...
  $UBlobViewDetailsImageDetailsCopyWith<UBlobViewDetailsImageDetails>
      get copyWith => _$UBlobViewDetailsImageDetailsCopyWithImpl<
          UBlobViewDetailsImageDetails>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UBlobViewDetailsImageDetails &&
...
/// @nodoc
abstract mixin class $UBlobViewDetailsImageDetailsCopyWith<$Res>
    implements $UBlobViewDetailsCopyWith<$Res> {
  factory $UBlobViewDetailsImageDetailsCopyWith(
          UBlobViewDetailsImageDetails value,
          $Res Function(UBlobViewDetailsImageDetails) _then) =
      _$UBlobViewDetailsImageDetailsCopyWithImpl;
  @useResult
...
class UBlobViewDetailsVideoDetails extends UBlobViewDetails {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UBlobViewDetailsVideoDetailsCopyWith<UBlobViewDetailsVideoDetails>
      get copyWith => _$UBlobViewDetailsVideoDetailsCopyWithImpl<
          UBlobViewDetailsVideoDetails>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UBlobViewDetailsVideoDetails &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UBlobViewDetailsVideoDetailsCopyWith<$Res>
    implements $UBlobViewDetailsCopyWith<$Res> {
  factory $UBlobViewDetailsVideoDetailsCopyWith(
          UBlobViewDetailsVideoDetails value,
          $Res Function(UBlobViewDetailsVideoDetails) _then) =
      _$UBlobViewDetailsVideoDetailsCopyWithImpl;
  @useResult
...
class UBlobViewDetailsUnknown extends UBlobViewDetails {
  const UBlobViewDetailsUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UBlobViewDetailsUnknownCopyWith<UBlobViewDetailsUnknown> get copyWith =>
      _$UBlobViewDetailsUnknownCopyWithImpl<UBlobViewDetailsUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UBlobViewDetailsUnknown &&
...
/// @nodoc
abstract mixin class $UBlobViewDetailsUnknownCopyWith<$Res>
    implements $UBlobViewDetailsCopyWith<$Res> {
  factory $UBlobViewDetailsUnknownCopyWith(UBlobViewDetailsUnknown value,
          $Res Function(UBlobViewDetailsUnknown) _then) =
      _$UBlobViewDetailsUnknownCopyWithImpl;
  @useResult
