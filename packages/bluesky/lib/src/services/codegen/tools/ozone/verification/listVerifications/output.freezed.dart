...
mixin _$VerificationListVerificationsOutput {
  ...
  $VerificationListVerificationsOutputCopyWith<
      ...
      get copyWith => _$VerificationListVerificationsOutputCopyWithImpl<
              VerificationListVerificationsOutput>(
          this as VerificationListVerificationsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationListVerificationsOutput &&
...
abstract mixin class $VerificationListVerificationsOutputCopyWith<$Res> {
  factory $VerificationListVerificationsOutputCopyWith(
          ...
          $Res Function(VerificationListVerificationsOutput) _then) =
      _$VerificationListVerificationsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension VerificationListVerificationsOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationListVerificationsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VerificationListVerificationsOutput() when $default != null:
        return $default(_that.cursor, _that.verifications, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _VerificationListVerificationsOutput
    implements VerificationListVerificationsOutput {
  const _VerificationListVerificationsOutput(
      {this.cursor,
      @VerificationViewConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationListVerificationsOutputCopyWith<
          _VerificationListVerificationsOutput>
      get copyWith => __$VerificationListVerificationsOutputCopyWithImpl<
          _VerificationListVerificationsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationListVerificationsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationListVerificationsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$VerificationListVerificationsOutputCopyWith<$Res>
    implements $VerificationListVerificationsOutputCopyWith<$Res> {
  factory _$VerificationListVerificationsOutputCopyWith(
          _VerificationListVerificationsOutput value,
          $Res Function(_VerificationListVerificationsOutput) _then) =
      __$VerificationListVerificationsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
