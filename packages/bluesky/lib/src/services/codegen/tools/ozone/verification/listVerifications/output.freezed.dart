...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? verifications = null,Object? $unknown = freezed,}) {
  return _then(VerificationListVerificationsOutput(
...
class _VerificationListVerificationsOutput implements VerificationListVerificationsOutput {
  const _VerificationListVerificationsOutput({this.cursor, @VerificationViewConverter() required  List<VerificationView> verifications,  Map<String, dynamic>? $unknown}): _verifications = verifications,_$unknown = $unknown;
