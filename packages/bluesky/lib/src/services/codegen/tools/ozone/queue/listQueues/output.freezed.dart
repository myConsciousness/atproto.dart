...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? queues = null,Object? $unknown = freezed,}) {
  return _then(QueueListQueuesOutput(
...
class _QueueListQueuesOutput implements QueueListQueuesOutput {
  const _QueueListQueuesOutput({this.cursor, @QueueViewConverter() required  List<QueueView> queues,  Map<String, dynamic>? $unknown}): _queues = queues,_$unknown = $unknown;
