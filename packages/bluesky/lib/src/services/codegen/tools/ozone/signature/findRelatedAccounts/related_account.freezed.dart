...
class _RelatedAccount implements RelatedAccount {
  const _RelatedAccount({this.$type = 'tools.ozone.signature.findRelatedAccounts#relatedAccount', @AccountViewConverter() required this.account, @SigDetailConverter()  List<SigDetail>? similarities,  Map<String, dynamic>? $unknown}): _similarities = similarities,_$unknown = $unknown;
