...
class _Moderation implements Moderation {
  const _Moderation({this.$type = 'tools.ozone.moderation.defs#moderation', @SubjectStatusViewConverter() this.subjectStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
