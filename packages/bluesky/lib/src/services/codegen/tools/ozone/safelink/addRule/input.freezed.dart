...
mixin _$SafelinkAddRuleInput {
  ...
  $SafelinkAddRuleInputCopyWith<SafelinkAddRuleInput> get copyWith =>
      _$SafelinkAddRuleInputCopyWithImpl<SafelinkAddRuleInput>(
          this as SafelinkAddRuleInput, _$identity);
...
abstract mixin class $SafelinkAddRuleInputCopyWith<$Res> {
  factory $SafelinkAddRuleInputCopyWith(SafelinkAddRuleInput value,
          $Res Function(SafelinkAddRuleInput) _then) =
      _$SafelinkAddRuleInputCopyWithImpl;
  @useResult
  $Res call(
      {String url,
...
extension SafelinkAddRuleInputPatterns on SafelinkAddRuleInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SafelinkAddRuleInput value)? $default, {
...
class _SafelinkAddRuleInput implements SafelinkAddRuleInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SafelinkAddRuleInputCopyWith<_SafelinkAddRuleInput> get copyWith =>
      __$SafelinkAddRuleInputCopyWithImpl<_SafelinkAddRuleInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SafelinkAddRuleInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SafelinkAddRuleInput &&
            (identical(other.url, url) || other.url == url) &&
            (identical(other.pattern, pattern) || other.pattern == pattern) &&
            (identical(other.action, action) || other.action == action) &&
            (identical(other.reason, reason) || other.reason == reason) &&
...
/// @nodoc
abstract mixin class _$SafelinkAddRuleInputCopyWith<$Res>
    implements $SafelinkAddRuleInputCopyWith<$Res> {
  factory _$SafelinkAddRuleInputCopyWith(_SafelinkAddRuleInput value,
          $Res Function(_SafelinkAddRuleInput) _then) =
      __$SafelinkAddRuleInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String url,
