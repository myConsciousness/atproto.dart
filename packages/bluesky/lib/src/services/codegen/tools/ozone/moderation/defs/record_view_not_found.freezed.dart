...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? $unknown = freezed,}) {
  return _then(RecordViewNotFound(
...
class _RecordViewNotFound implements RecordViewNotFound {
  const _RecordViewNotFound({this.$type = 'tools.ozone.moderation.defs#recordViewNotFound', @AtUriConverter() required this.uri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
