...
class _Event implements Event {
  const _Event({this.$type = 'tools.ozone.hosting.getAccountHistory#event', @UEventDetailsConverter() required this.details, required this.createdBy, @JsonKey(toJson: iso8601) required this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
