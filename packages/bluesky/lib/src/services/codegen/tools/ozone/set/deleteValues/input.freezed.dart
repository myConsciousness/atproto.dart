...
mixin _$SetDeleteValuesInput {
  ...
  $SetDeleteValuesInputCopyWith<SetDeleteValuesInput> get copyWith =>
      _$SetDeleteValuesInputCopyWithImpl<SetDeleteValuesInput>(
          this as SetDeleteValuesInput, _$identity);
...
abstract mixin class $SetDeleteValuesInputCopyWith<$Res> {
  factory $SetDeleteValuesInputCopyWith(SetDeleteValuesInput value,
          $Res Function(SetDeleteValuesInput) _then) =
      _$SetDeleteValuesInputCopyWithImpl;
  @useResult
...
extension SetDeleteValuesInputPatterns on SetDeleteValuesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SetDeleteValuesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SetDeleteValuesInput() when $default != null:
        return $default(_that.name, _that.values, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SetDeleteValuesInput implements SetDeleteValuesInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SetDeleteValuesInputCopyWith<_SetDeleteValuesInput> get copyWith =>
      __$SetDeleteValuesInputCopyWithImpl<_SetDeleteValuesInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SetDeleteValuesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SetDeleteValuesInput &&
            (identical(other.name, name) || other.name == name) &&
...
/// @nodoc
abstract mixin class _$SetDeleteValuesInputCopyWith<$Res>
    implements $SetDeleteValuesInputCopyWith<$Res> {
  factory _$SetDeleteValuesInputCopyWith(_SetDeleteValuesInput value,
          $Res Function(_SetDeleteValuesInput) _then) =
      __$SetDeleteValuesInputCopyWithImpl;
  @override
  @useResult
  $Res call({String name, List<String> values, Map<String, dynamic>? $unknown});
}
