...
mixin _$SafelinkQueryRulesOutput {
  ...
  $SafelinkQueryRulesOutputCopyWith<SafelinkQueryRulesOutput> get copyWith =>
      _$SafelinkQueryRulesOutputCopyWithImpl<SafelinkQueryRulesOutput>(
          this as SafelinkQueryRulesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SafelinkQueryRulesOutput &&
...
abstract mixin class $SafelinkQueryRulesOutputCopyWith<$Res> {
  factory $SafelinkQueryRulesOutputCopyWith(SafelinkQueryRulesOutput value,
          $Res Function(SafelinkQueryRulesOutput) _then) =
      _$SafelinkQueryRulesOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension SafelinkQueryRulesOutputPatterns on SafelinkQueryRulesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SafelinkQueryRulesOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? cursor, @UrlRuleConverter() List<UrlRule> rules,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SafelinkQueryRulesOutput() when $default != null:
        return $default(_that.cursor, _that.rules, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SafelinkQueryRulesOutput implements SafelinkQueryRulesOutput {
  const _SafelinkQueryRulesOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SafelinkQueryRulesOutputCopyWith<_SafelinkQueryRulesOutput> get copyWith =>
      __$SafelinkQueryRulesOutputCopyWithImpl<_SafelinkQueryRulesOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SafelinkQueryRulesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SafelinkQueryRulesOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SafelinkQueryRulesOutputCopyWith<$Res>
    implements $SafelinkQueryRulesOutputCopyWith<$Res> {
  factory _$SafelinkQueryRulesOutputCopyWith(_SafelinkQueryRulesOutput value,
          $Res Function(_SafelinkQueryRulesOutput) _then) =
      __$SafelinkQueryRulesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
