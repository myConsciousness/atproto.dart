...
mixin _$SignatureFindCorrelationInput {
  ...
  $SignatureFindCorrelationInputCopyWith<SignatureFindCorrelationInput>
      get copyWith => _$SignatureFindCorrelationInputCopyWithImpl<
              SignatureFindCorrelationInput>(
          this as SignatureFindCorrelationInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignatureFindCorrelationInput &&
...
abstract mixin class $SignatureFindCorrelationInputCopyWith<$Res> {
  factory $SignatureFindCorrelationInputCopyWith(
          ...
          $Res Function(SignatureFindCorrelationInput) _then) =
      _$SignatureFindCorrelationInputCopyWithImpl;
  @useResult
...
extension SignatureFindCorrelationInputPatterns
    on SignatureFindCorrelationInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignatureFindCorrelationInput value)? $default, {
...
class _SignatureFindCorrelationInput implements SignatureFindCorrelationInput {
  const _SignatureFindCorrelationInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SignatureFindCorrelationInputCopyWith<_SignatureFindCorrelationInput>
      get copyWith => __$SignatureFindCorrelationInputCopyWithImpl<
          _SignatureFindCorrelationInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SignatureFindCorrelationInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SignatureFindCorrelationInput &&
...
/// @nodoc
abstract mixin class _$SignatureFindCorrelationInputCopyWith<$Res>
    implements $SignatureFindCorrelationInputCopyWith<$Res> {
  factory _$SignatureFindCorrelationInputCopyWith(
          _SignatureFindCorrelationInput value,
          $Res Function(_SignatureFindCorrelationInput) _then) =
      __$SignatureFindCorrelationInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> dids, Map<String, dynamic>? $unknown});
}
