...
@pragma('vm:prefer-inline') @override $Res call({Object? dids = null,Object? $unknown = freezed,}) {
  return _then(SignatureFindCorrelationInput(
...
class _SignatureFindCorrelationInput implements SignatureFindCorrelationInput {
  const _SignatureFindCorrelationInput({required  List<String> dids,  Map<String, dynamic>? $unknown}): _dids = dids,_$unknown = $unknown;
