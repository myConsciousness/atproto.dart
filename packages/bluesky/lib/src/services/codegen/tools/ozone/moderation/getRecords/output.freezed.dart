...
@pragma('vm:prefer-inline') @override $Res call({Object? records = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetRecordsOutput(
...
class _ModerationGetRecordsOutput implements ModerationGetRecordsOutput {
  const _ModerationGetRecordsOutput({@UModerationGetRecordsRecordsConverter() required  List<UModerationGetRecordsRecords> records,  Map<String, dynamic>? $unknown}): _records = records,_$unknown = $unknown;
