...
class _RevokeError implements RevokeError {
  const _RevokeError({this.$type = 'tools.ozone.verification.revokeVerifications#revokeError', @AtUriConverter() required this.uri, required this.error,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
