...
@pragma('vm:prefer-inline') @override $Res call({Object? uris = null,Object? revokeReason = freezed,Object? $unknown = freezed,}) {
  return _then(VerificationRevokeVerificationsInput(
...
class _VerificationRevokeVerificationsInput implements VerificationRevokeVerificationsInput {
  const _VerificationRevokeVerificationsInput({@AtUriConverter() required  List<AtUri> uris, this.revokeReason,  Map<String, dynamic>? $unknown}): _uris = uris,_$unknown = $unknown;
