...
mixin _$VerificationRevokeVerificationsInput {
  ...
  $VerificationRevokeVerificationsInputCopyWith<
      ...
      get copyWith => _$VerificationRevokeVerificationsInputCopyWithImpl<
              VerificationRevokeVerificationsInput>(
          this as VerificationRevokeVerificationsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationRevokeVerificationsInput &&
...
abstract mixin class $VerificationRevokeVerificationsInputCopyWith<$Res> {
  factory $VerificationRevokeVerificationsInputCopyWith(
          ...
          $Res Function(VerificationRevokeVerificationsInput) _then) =
      _$VerificationRevokeVerificationsInputCopyWithImpl;
  @useResult
  $Res call(
      {List<String> uris,
      String? revokeReason,
...
extension VerificationRevokeVerificationsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationRevokeVerificationsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> uris, String? revokeReason,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _VerificationRevokeVerificationsInput() when $default != null:
        return $default(_that.uris, _that.revokeReason, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _VerificationRevokeVerificationsInput
    implements VerificationRevokeVerificationsInput {
  const _VerificationRevokeVerificationsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationRevokeVerificationsInputCopyWith<
          _VerificationRevokeVerificationsInput>
      get copyWith => __$VerificationRevokeVerificationsInputCopyWithImpl<
          _VerificationRevokeVerificationsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationRevokeVerificationsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationRevokeVerificationsInput &&
...
/// @nodoc
abstract mixin class _$VerificationRevokeVerificationsInputCopyWith<$Res>
    implements $VerificationRevokeVerificationsInputCopyWith<$Res> {
  factory _$VerificationRevokeVerificationsInputCopyWith(
          _VerificationRevokeVerificationsInput value,
          $Res Function(_VerificationRevokeVerificationsInput) _then) =
      __$VerificationRevokeVerificationsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String> uris,
