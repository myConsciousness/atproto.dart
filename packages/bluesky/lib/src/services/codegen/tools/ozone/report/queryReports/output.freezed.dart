...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? reports = null,Object? $unknown = freezed,}) {
  return _then(ReportQueryReportsOutput(
...
class _ReportQueryReportsOutput implements ReportQueryReportsOutput {
  const _ReportQueryReportsOutput({this.cursor, @ReportViewConverter() required  List<ReportView> reports,  Map<String, dynamic>? $unknown}): _reports = reports,_$unknown = $unknown;
