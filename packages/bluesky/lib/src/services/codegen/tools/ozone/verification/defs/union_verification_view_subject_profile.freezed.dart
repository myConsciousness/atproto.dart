...
mixin _$UVerificationViewSubjectProfile {
  ...
  $UVerificationViewSubjectProfileCopyWith<UVerificationViewSubjectProfile>
      get copyWith => _$UVerificationViewSubjectProfileCopyWithImpl<
              UVerificationViewSubjectProfile>(
          this as UVerificationViewSubjectProfile, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewSubjectProfile &&
...
abstract mixin class $UVerificationViewSubjectProfileCopyWith<$Res> {
  factory $UVerificationViewSubjectProfileCopyWith(
          UVerificationViewSubjectProfile value,
          $Res Function(UVerificationViewSubjectProfile) _then) =
      _$UVerificationViewSubjectProfileCopyWithImpl;
  @useResult
...
extension UVerificationViewSubjectProfilePatterns
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(UVerificationViewSubjectProfileUnknown value)? unknown,
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(UVerificationViewSubjectProfileUnknown value)
        unknown,
  }) {
    final _that = this;
    switch (_that) {
...
class UVerificationViewSubjectProfileUnknown
    extends UVerificationViewSubjectProfile {
  const UVerificationViewSubjectProfileUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UVerificationViewSubjectProfileUnknownCopyWith<
          UVerificationViewSubjectProfileUnknown>
      get copyWith => _$UVerificationViewSubjectProfileUnknownCopyWithImpl<
          UVerificationViewSubjectProfileUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewSubjectProfileUnknown &&
...
/// @nodoc
abstract mixin class $UVerificationViewSubjectProfileUnknownCopyWith<$Res>
    implements $UVerificationViewSubjectProfileCopyWith<$Res> {
  factory $UVerificationViewSubjectProfileUnknownCopyWith(
          UVerificationViewSubjectProfileUnknown value,
          $Res Function(UVerificationViewSubjectProfileUnknown) _then) =
      _$UVerificationViewSubjectProfileUnknownCopyWithImpl;
  @override
  @useResult
  $Res call({Map<String, dynamic> data});
}
