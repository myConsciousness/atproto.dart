...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? events = null,Object? $unknown = freezed,}) {
  return _then(ModerationQueryEventsOutput(
...
class _ModerationQueryEventsOutput implements ModerationQueryEventsOutput {
  const _ModerationQueryEventsOutput({this.cursor, @ModEventViewConverter() required  List<ModEventView> events,  Map<String, dynamic>? $unknown}): _events = events,_$unknown = $unknown;
