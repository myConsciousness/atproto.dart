...
@pragma('vm:prefer-inline') @override $Res call({Object? activities = null,Object? cursor = freezed,Object? $unknown = freezed,}) {
  return _then(ReportQueryActivitiesOutput(
...
class _ReportQueryActivitiesOutput implements ReportQueryActivitiesOutput {
  const _ReportQueryActivitiesOutput({@ReportActivityViewConverter() required  List<ReportActivityView> activities, this.cursor,  Map<String, dynamic>? $unknown}): _activities = activities,_$unknown = $unknown;
