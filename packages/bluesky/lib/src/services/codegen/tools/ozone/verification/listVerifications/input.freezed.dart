...
mixin _$VerificationListVerificationsInput {
  ...
  $VerificationListVerificationsInputCopyWith<
      ...
      get copyWith => _$VerificationListVerificationsInputCopyWithImpl<
              VerificationListVerificationsInput>(
          this as VerificationListVerificationsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationListVerificationsInput &&
            ...
            const DeepCollectionEquality().equals(other.issuers, issuers) &&
  ...
  int get hashCode => Object.hash(
      ...
      createdAfter,
      createdBefore,
      const DeepCollectionEquality().hash(issuers),
...
abstract mixin class $VerificationListVerificationsInputCopyWith<$Res> {
  factory $VerificationListVerificationsInputCopyWith(
          ...
          $Res Function(VerificationListVerificationsInput) _then) =
      _$VerificationListVerificationsInputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
      int limit,
...
extension VerificationListVerificationsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationListVerificationsInput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _VerificationListVerificationsInput
    implements VerificationListVerificationsInput {
  const _VerificationListVerificationsInput(
      {this.cursor,
      this.limit = 50,
      this.createdAfter,
      this.createdBefore,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationListVerificationsInputCopyWith<
          _VerificationListVerificationsInput>
      get copyWith => __$VerificationListVerificationsInputCopyWithImpl<
          _VerificationListVerificationsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationListVerificationsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationListVerificationsInput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.createdAfter, createdAfter) ||
                other.createdAfter == createdAfter) &&
...
/// @nodoc
abstract mixin class _$VerificationListVerificationsInputCopyWith<$Res>
    implements $VerificationListVerificationsInputCopyWith<$Res> {
  factory _$VerificationListVerificationsInputCopyWith(
          _VerificationListVerificationsInput value,
          $Res Function(_VerificationListVerificationsInput) _then) =
      __$VerificationListVerificationsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
