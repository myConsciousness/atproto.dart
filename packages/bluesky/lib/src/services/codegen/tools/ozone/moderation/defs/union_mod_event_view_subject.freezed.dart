...
class $UModEventViewSubjectCopyWith<$Res> {
  $UModEventViewSubjectCopyWith(
      UModEventViewSubject _, $Res Function(UModEventViewSubject) __);
}
...
extension UModEventViewSubjectPatterns on UModEventViewSubject {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UModEventViewSubjectRepoStrongRef() when repoStrongRef != null:
        return repoStrongRef(_that);
      case UModEventViewSubjectMessageRef() when messageRef != null:
        return messageRef(_that);
      case UModEventViewSubjectUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UModEventViewSubjectRepoRef():
        return repoRef(_that);
      case UModEventViewSubjectRepoStrongRef():
        return repoStrongRef(_that);
      case UModEventViewSubjectMessageRef():
        return messageRef(_that);
      case UModEventViewSubjectUnknown():
        return unknown(_that);
      case _:
...
class UModEventViewSubjectRepoRef extends UModEventViewSubject {
  ...
  $UModEventViewSubjectRepoRefCopyWith<UModEventViewSubjectRepoRef>
      get copyWith => _$UModEventViewSubjectRepoRefCopyWithImpl<
          UModEventViewSubjectRepoRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModEventViewSubjectRepoRef &&
...
/// @nodoc
abstract mixin class $UModEventViewSubjectRepoRefCopyWith<$Res>
    implements $UModEventViewSubjectCopyWith<$Res> {
  factory $UModEventViewSubjectRepoRefCopyWith(
          UModEventViewSubjectRepoRef value,
          $Res Function(UModEventViewSubjectRepoRef) _then) =
      _$UModEventViewSubjectRepoRefCopyWithImpl;
  @useResult
...
class UModEventViewSubjectRepoStrongRef extends UModEventViewSubject {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModEventViewSubjectRepoStrongRefCopyWith<UModEventViewSubjectRepoStrongRef>
      get copyWith => _$UModEventViewSubjectRepoStrongRefCopyWithImpl<
          UModEventViewSubjectRepoStrongRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModEventViewSubjectRepoStrongRef &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModEventViewSubjectRepoStrongRefCopyWith<$Res>
    implements $UModEventViewSubjectCopyWith<$Res> {
  factory $UModEventViewSubjectRepoStrongRefCopyWith(
          UModEventViewSubjectRepoStrongRef value,
          $Res Function(UModEventViewSubjectRepoStrongRef) _then) =
      _$UModEventViewSubjectRepoStrongRefCopyWithImpl;
  @useResult
...
class UModEventViewSubjectMessageRef extends UModEventViewSubject {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModEventViewSubjectMessageRefCopyWith<UModEventViewSubjectMessageRef>
      get copyWith => _$UModEventViewSubjectMessageRefCopyWithImpl<
          UModEventViewSubjectMessageRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModEventViewSubjectMessageRef &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UModEventViewSubjectMessageRefCopyWith<$Res>
    implements $UModEventViewSubjectCopyWith<$Res> {
  factory $UModEventViewSubjectMessageRefCopyWith(
          UModEventViewSubjectMessageRef value,
          $Res Function(UModEventViewSubjectMessageRef) _then) =
      _$UModEventViewSubjectMessageRefCopyWithImpl;
  @useResult
...
class UModEventViewSubjectUnknown extends UModEventViewSubject {
  const UModEventViewSubjectUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UModEventViewSubjectUnknownCopyWith<UModEventViewSubjectUnknown>
      get copyWith => _$UModEventViewSubjectUnknownCopyWithImpl<
          UModEventViewSubjectUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UModEventViewSubjectUnknown &&
...
/// @nodoc
abstract mixin class $UModEventViewSubjectUnknownCopyWith<$Res>
    implements $UModEventViewSubjectCopyWith<$Res> {
  factory $UModEventViewSubjectUnknownCopyWith(
          UModEventViewSubjectUnknown value,
          $Res Function(UModEventViewSubjectUnknown) _then) =
      _$UModEventViewSubjectUnknownCopyWithImpl;
  @useResult
