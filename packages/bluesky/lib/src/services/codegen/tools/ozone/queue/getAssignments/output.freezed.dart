...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? assignments = null,Object? $unknown = freezed,}) {
  return _then(QueueGetAssignmentsOutput(
...
class _QueueGetAssignmentsOutput implements QueueGetAssignmentsOutput {
  const _QueueGetAssignmentsOutput({this.cursor, @AssignmentViewConverter() required  List<AssignmentView> assignments,  Map<String, dynamic>? $unknown}): _assignments = assignments,_$unknown = $unknown;
