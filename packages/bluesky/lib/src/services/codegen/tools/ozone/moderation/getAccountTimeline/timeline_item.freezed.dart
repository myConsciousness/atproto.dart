...
class _TimelineItem implements TimelineItem {
  const _TimelineItem({this.$type = 'tools.ozone.moderation.getAccountTimeline#timelineItem', required this.day, @TimelineItemSummaryConverter() required  List<TimelineItemSummary> summary,  Map<String, dynamic>? $unknown}): _summary = summary,_$unknown = $unknown;
