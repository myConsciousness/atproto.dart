...
class _FailedScheduling implements FailedScheduling {
  const _FailedScheduling({this.$type = 'tools.ozone.moderation.scheduleAction#failedScheduling', required this.subject, required this.error, this.errorCode,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
