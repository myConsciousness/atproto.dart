...
mixin _$SettingListOptionsInput {
  ...
  $SettingListOptionsInputCopyWith<SettingListOptionsInput> get copyWith =>
      _$SettingListOptionsInputCopyWithImpl<SettingListOptionsInput>(
          this as SettingListOptionsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingListOptionsInput &&
...
abstract mixin class $SettingListOptionsInputCopyWith<$Res> {
  factory $SettingListOptionsInputCopyWith(SettingListOptionsInput value,
          $Res Function(SettingListOptionsInput) _then) =
      _$SettingListOptionsInputCopyWithImpl;
  @useResult
  $Res call(
      {int limit,
      String? cursor,
...
extension SettingListOptionsInputPatterns on SettingListOptionsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SettingListOptionsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SettingListOptionsInput() when $default != null:
        return $default(_that.limit, _that.cursor, _that.scope, _that.prefix,
            _that.keys, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SettingListOptionsInput implements SettingListOptionsInput {
  const _SettingListOptionsInput(
      {this.limit = 50,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SettingListOptionsInputCopyWith<_SettingListOptionsInput> get copyWith =>
      __$SettingListOptionsInputCopyWithImpl<_SettingListOptionsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SettingListOptionsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SettingListOptionsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.scope, scope) || other.scope == scope) &&
            (identical(other.prefix, prefix) || other.prefix == prefix) &&
...
/// @nodoc
abstract mixin class _$SettingListOptionsInputCopyWith<$Res>
    implements $SettingListOptionsInputCopyWith<$Res> {
  factory _$SettingListOptionsInputCopyWith(_SettingListOptionsInput value,
          $Res Function(_SettingListOptionsInput) _then) =
      __$SettingListOptionsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int limit,
