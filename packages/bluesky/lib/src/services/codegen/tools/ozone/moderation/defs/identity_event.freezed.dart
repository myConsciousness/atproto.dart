...
class _IdentityEvent implements IdentityEvent {
  const _IdentityEvent({this.$type = 'tools.ozone.moderation.defs#identityEvent', this.comment, this.handle, this.pdsHost, this.tombstone, @JsonKey(toJson: iso8601) required this.timestamp,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
