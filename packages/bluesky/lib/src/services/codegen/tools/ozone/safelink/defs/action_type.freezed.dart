...
extension ActionTypePatterns on ActionType {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ActionTypeUnknown() when unknown != null:
...
class ActionTypeKnownValue extends ActionType {
  ...
  $ActionTypeKnownValueCopyWith<ActionTypeKnownValue> get copyWith =>
      _$ActionTypeKnownValueCopyWithImpl<ActionTypeKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $ActionTypeKnownValueCopyWith<$Res>
    implements $ActionTypeCopyWith<$Res> {
  factory $ActionTypeKnownValueCopyWith(ActionTypeKnownValue value,
          $Res Function(ActionTypeKnownValue) _then) =
      _$ActionTypeKnownValueCopyWithImpl;
  @useResult
...
class ActionTypeUnknown extends ActionType {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ActionTypeUnknownCopyWith<ActionTypeUnknown> get copyWith =>
      _$ActionTypeUnknownCopyWithImpl<ActionTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActionTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ActionTypeUnknownCopyWith<$Res>
    implements $ActionTypeCopyWith<$Res> {
  factory $ActionTypeUnknownCopyWith(
          ActionTypeUnknown value, $Res Function(ActionTypeUnknown) _then) =
      _$ActionTypeUnknownCopyWithImpl;
  @useResult
