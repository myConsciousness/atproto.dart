...
class _QueueActivity implements QueueActivity {
  const _QueueActivity({this.$type = 'tools.ozone.report.defs#queueActivity', @QueueActivityPreviousStatusConverter() this.previousStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
