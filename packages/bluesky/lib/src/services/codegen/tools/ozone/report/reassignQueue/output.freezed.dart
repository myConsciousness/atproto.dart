...
@pragma('vm:prefer-inline') @override $Res call({Object? report = null,Object? $unknown = freezed,}) {
  return _then(ReportReassignQueueOutput(
...
class _ReportReassignQueueOutput implements ReportReassignQueueOutput {
  const _ReportReassignQueueOutput({@ReportViewConverter() required this.report,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
