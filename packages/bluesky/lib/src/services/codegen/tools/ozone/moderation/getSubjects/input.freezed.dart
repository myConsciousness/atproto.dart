...
@pragma('vm:prefer-inline') @override $Res call({Object? subjects = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetSubjectsInput(
...
class _ModerationGetSubjectsInput implements ModerationGetSubjectsInput {
  const _ModerationGetSubjectsInput({required  List<String> subjects,  Map<String, dynamic>? $unknown}): _subjects = subjects,_$unknown = $unknown;
