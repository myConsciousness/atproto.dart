...
mixin _$ModerationGetSubjectsInput {
  ...
  $ModerationGetSubjectsInputCopyWith<ModerationGetSubjectsInput>
      get copyWith =>
          _$ModerationGetSubjectsInputCopyWithImpl<ModerationGetSubjectsInput>(
              this as ModerationGetSubjectsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetSubjectsInput &&
...
abstract mixin class $ModerationGetSubjectsInputCopyWith<$Res> {
  factory $ModerationGetSubjectsInputCopyWith(ModerationGetSubjectsInput value,
          $Res Function(ModerationGetSubjectsInput) _then) =
      _$ModerationGetSubjectsInputCopyWithImpl;
  @useResult
...
extension ModerationGetSubjectsInputPatterns on ModerationGetSubjectsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetSubjectsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> subjects, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _ModerationGetSubjectsInput implements ModerationGetSubjectsInput {
  const _ModerationGetSubjectsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetSubjectsInputCopyWith<_ModerationGetSubjectsInput>
      get copyWith => __$ModerationGetSubjectsInputCopyWithImpl<
          _ModerationGetSubjectsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetSubjectsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetSubjectsInput &&
...
/// @nodoc
abstract mixin class _$ModerationGetSubjectsInputCopyWith<$Res>
    implements $ModerationGetSubjectsInputCopyWith<$Res> {
  factory _$ModerationGetSubjectsInputCopyWith(
          _ModerationGetSubjectsInput value,
          $Res Function(_ModerationGetSubjectsInput) _then) =
      __$ModerationGetSubjectsInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> subjects, Map<String, dynamic>? $unknown});
}
