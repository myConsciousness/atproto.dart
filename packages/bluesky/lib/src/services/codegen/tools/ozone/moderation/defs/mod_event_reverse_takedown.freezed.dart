...
mixin _$ModEventReverseTakedown {
  ...
  $ModEventReverseTakedownCopyWith<ModEventReverseTakedown> get copyWith =>
      _$ModEventReverseTakedownCopyWithImpl<ModEventReverseTakedown>(
          this as ModEventReverseTakedown, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModEventReverseTakedown &&
...
abstract mixin class $ModEventReverseTakedownCopyWith<$Res> {
  factory $ModEventReverseTakedownCopyWith(ModEventReverseTakedown value,
          $Res Function(ModEventReverseTakedown) _then) =
      _$ModEventReverseTakedownCopyWithImpl;
  @useResult
...
extension ModEventReverseTakedownPatterns on ModEventReverseTakedown {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventReverseTakedown value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ModEventReverseTakedown() when $default != null:
        return $default(_that.$type, _that.comment, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModEventReverseTakedown implements ModEventReverseTakedown {
  const _ModEventReverseTakedown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventReverseTakedownCopyWith<_ModEventReverseTakedown> get copyWith =>
      __$ModEventReverseTakedownCopyWithImpl<_ModEventReverseTakedown>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventReverseTakedownToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModEventReverseTakedown &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
...
/// @nodoc
abstract mixin class _$ModEventReverseTakedownCopyWith<$Res>
    implements $ModEventReverseTakedownCopyWith<$Res> {
  factory _$ModEventReverseTakedownCopyWith(_ModEventReverseTakedown value,
          $Res Function(_ModEventReverseTakedown) _then) =
      __$ModEventReverseTakedownCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String? comment, Map<String, dynamic>? $unknown});
}
