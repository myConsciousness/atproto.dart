...
class _CloseActivity implements CloseActivity {
  const _CloseActivity({this.$type = 'tools.ozone.report.defs#closeActivity', @CloseActivityPreviousStatusConverter() this.previousStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
