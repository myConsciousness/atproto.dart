...
class $AccountEventStatusCopyWith<$Res> {
  $AccountEventStatusCopyWith(
      AccountEventStatus _, $Res Function(AccountEventStatus) __);
}
...
extension AccountEventStatusPatterns on AccountEventStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case AccountEventStatusUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case AccountEventStatusKnownValue():
        return knownValue(_that);
      case AccountEventStatusUnknown():
        return unknown(_that);
      case _:
...
class AccountEventStatusKnownValue extends AccountEventStatus {
  ...
  $AccountEventStatusKnownValueCopyWith<AccountEventStatusKnownValue>
      get copyWith => _$AccountEventStatusKnownValueCopyWithImpl<
          AccountEventStatusKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AccountEventStatusKnownValue &&
...
/// @nodoc
abstract mixin class $AccountEventStatusKnownValueCopyWith<$Res>
    implements $AccountEventStatusCopyWith<$Res> {
  factory $AccountEventStatusKnownValueCopyWith(
          AccountEventStatusKnownValue value,
          $Res Function(AccountEventStatusKnownValue) _then) =
      _$AccountEventStatusKnownValueCopyWithImpl;
  @useResult
...
class AccountEventStatusUnknown extends AccountEventStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AccountEventStatusUnknownCopyWith<AccountEventStatusUnknown> get copyWith =>
      _$AccountEventStatusUnknownCopyWithImpl<AccountEventStatusUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AccountEventStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $AccountEventStatusUnknownCopyWith<$Res>
    implements $AccountEventStatusCopyWith<$Res> {
  factory $AccountEventStatusUnknownCopyWith(AccountEventStatusUnknown value,
          $Res Function(AccountEventStatusUnknown) _then) =
      _$AccountEventStatusUnknownCopyWithImpl;
  @useResult
