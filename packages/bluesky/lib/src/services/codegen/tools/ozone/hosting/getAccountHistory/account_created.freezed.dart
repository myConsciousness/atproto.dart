...
class _AccountCreated implements AccountCreated {
  const _AccountCreated({this.$type = 'tools.ozone.hosting.getAccountHistory#accountCreated', this.email, this.handle,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
