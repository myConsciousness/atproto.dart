...
class _ImageDetails implements ImageDetails {
  const _ImageDetails({this.$type = 'tools.ozone.moderation.defs#imageDetails', required this.width, required this.height,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
