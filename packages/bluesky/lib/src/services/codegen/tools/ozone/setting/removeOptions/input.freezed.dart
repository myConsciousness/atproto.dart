...
@pragma('vm:prefer-inline') @override $Res call({Object? keys = null,Object? scope = null,Object? $unknown = freezed,}) {
  return _then(SettingRemoveOptionsInput(
...
class _SettingRemoveOptionsInput implements SettingRemoveOptionsInput {
  const _SettingRemoveOptionsInput({required  List<String> keys, @SettingRemoveOptionsScopeConverter() required this.scope,  Map<String, dynamic>? $unknown}): _keys = keys,_$unknown = $unknown;
