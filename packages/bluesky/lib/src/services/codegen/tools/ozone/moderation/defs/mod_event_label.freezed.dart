...
mixin _$ModEventLabel {
  ...
  $ModEventLabelCopyWith<ModEventLabel> get copyWith =>
      _$ModEventLabelCopyWithImpl<ModEventLabel>(
          this as ModEventLabel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModEventLabel &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
            const DeepCollectionEquality()
                .equals(other.createLabelVals, createLabelVals) &&
            const DeepCollectionEquality()
                .equals(other.negateLabelVals, negateLabelVals) &&
  ...
  int get hashCode => Object.hash(
      ...
      $type,
      comment,
      const DeepCollectionEquality().hash(createLabelVals),
      const DeepCollectionEquality().hash(negateLabelVals),
      durationInHours,
...
abstract mixin class $ModEventLabelCopyWith<$Res> {
  factory $ModEventLabelCopyWith(
          ModEventLabel value, $Res Function(ModEventLabel) _then) =
      _$ModEventLabelCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String? comment,
...
extension ModEventLabelPatterns on ModEventLabel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventLabel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ModEventLabel() when $default != null:
        return $default(_that.$type, _that.comment, _that.createLabelVals,
            _that.negateLabelVals, _that.durationInHours, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModEventLabel implements ModEventLabel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventLabelCopyWith<_ModEventLabel> get copyWith =>
      __$ModEventLabelCopyWithImpl<_ModEventLabel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventLabelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ModEventLabelCopyWith<$Res>
    implements $ModEventLabelCopyWith<$Res> {
  factory _$ModEventLabelCopyWith(
          _ModEventLabel value, $Res Function(_ModEventLabel) _then) =
      __$ModEventLabelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
    ...
    return _then(_ModEventLabel(
      ...
      comment: freezed == comment
          ...
          : comment // ignore: cast_nullable_to_non_nullable
              as String?,
      createLabelVals: null == createLabelVals
          ? _self._createLabelVals
          : createLabelVals // ignore: cast_nullable_to_non_nullable
              as List<String>,
      negateLabelVals: null == negateLabelVals
          ? _self._negateLabelVals
          : negateLabelVals // ignore: cast_nullable_to_non_nullable
              as List<String>,
      durationInHours: freezed == durationInHours
          ? _self.durationInHours
