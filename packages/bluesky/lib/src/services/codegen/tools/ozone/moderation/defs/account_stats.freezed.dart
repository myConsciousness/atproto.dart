...
class _AccountStats implements AccountStats {
  const _AccountStats({this.$type = 'tools.ozone.moderation.defs#accountStats', this.reportCount, this.appealCount, this.suspendCount, this.escalateCount, this.takedownCount,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
