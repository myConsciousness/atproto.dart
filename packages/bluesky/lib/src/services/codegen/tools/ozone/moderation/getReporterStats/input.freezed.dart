...
@pragma('vm:prefer-inline') @override $Res call({Object? dids = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetReporterStatsInput(
...
class _ModerationGetReporterStatsInput implements ModerationGetReporterStatsInput {
  const _ModerationGetReporterStatsInput({required  List<String> dids,  Map<String, dynamic>? $unknown}): _dids = dids,_$unknown = $unknown;
