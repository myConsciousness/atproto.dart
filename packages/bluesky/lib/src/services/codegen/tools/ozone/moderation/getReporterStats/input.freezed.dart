...
mixin _$ModerationGetReporterStatsInput {
  ...
  $ModerationGetReporterStatsInputCopyWith<ModerationGetReporterStatsInput>
      get copyWith => _$ModerationGetReporterStatsInputCopyWithImpl<
              ModerationGetReporterStatsInput>(
          this as ModerationGetReporterStatsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetReporterStatsInput &&
...
abstract mixin class $ModerationGetReporterStatsInputCopyWith<$Res> {
  factory $ModerationGetReporterStatsInputCopyWith(
          ...
          $Res Function(ModerationGetReporterStatsInput) _then) =
      _$ModerationGetReporterStatsInputCopyWithImpl;
  @useResult
...
extension ModerationGetReporterStatsInputPatterns
    on ModerationGetReporterStatsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetReporterStatsInput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _ModerationGetReporterStatsInput
    implements ModerationGetReporterStatsInput {
  const _ModerationGetReporterStatsInput(
      {required final List<String> dids, final Map<String, dynamic>? $unknown})
      : _dids = dids,
        _$unknown = $unknown;
  factory _ModerationGetReporterStatsInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetReporterStatsInputCopyWith<_ModerationGetReporterStatsInput>
      get copyWith => __$ModerationGetReporterStatsInputCopyWithImpl<
          _ModerationGetReporterStatsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetReporterStatsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetReporterStatsInput &&
...
/// @nodoc
abstract mixin class _$ModerationGetReporterStatsInputCopyWith<$Res>
    implements $ModerationGetReporterStatsInputCopyWith<$Res> {
  factory _$ModerationGetReporterStatsInputCopyWith(
          _ModerationGetReporterStatsInput value,
          $Res Function(_ModerationGetReporterStatsInput) _then) =
      __$ModerationGetReporterStatsInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> dids, Map<String, dynamic>? $unknown});
}
