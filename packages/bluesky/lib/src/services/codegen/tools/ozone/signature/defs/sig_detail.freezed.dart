...
class _SigDetail implements SigDetail {
  const _SigDetail({this.$type = 'tools.ozone.signature.defs#sigDetail', required this.property, required this.value,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
