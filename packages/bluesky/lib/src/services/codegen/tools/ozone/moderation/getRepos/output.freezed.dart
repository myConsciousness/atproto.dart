...
@pragma('vm:prefer-inline') @override $Res call({Object? repos = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetReposOutput(
...
class _ModerationGetReposOutput implements ModerationGetReposOutput {
  const _ModerationGetReposOutput({@UModerationGetReposReposConverter() required  List<UModerationGetReposRepos> repos,  Map<String, dynamic>? $unknown}): _repos = repos,_$unknown = $unknown;
