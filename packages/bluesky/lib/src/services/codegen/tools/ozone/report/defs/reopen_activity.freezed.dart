...
class _ReopenActivity implements ReopenActivity {
  const _ReopenActivity({this.$type = 'tools.ozone.report.defs#reopenActivity', @ReopenActivityPreviousStatusConverter() this.previousStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
