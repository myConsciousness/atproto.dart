...
mixin _$CommunicationCreateTemplateInput {
  ...
  $CommunicationCreateTemplateInputCopyWith<CommunicationCreateTemplateInput>
      get copyWith => _$CommunicationCreateTemplateInputCopyWithImpl<
              CommunicationCreateTemplateInput>(
          this as CommunicationCreateTemplateInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CommunicationCreateTemplateInput &&
  ...
  int get hashCode => Object.hash(runtimeType, name, contentMarkdown, subject,
      lang, createdBy, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $CommunicationCreateTemplateInputCopyWith<$Res> {
  factory $CommunicationCreateTemplateInputCopyWith(
          ...
          $Res Function(CommunicationCreateTemplateInput) _then) =
      _$CommunicationCreateTemplateInputCopyWithImpl;
  @useResult
  $Res call(
      {String name,
...
extension CommunicationCreateTemplateInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CommunicationCreateTemplateInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String contentMarkdown, String subject,
            String? lang, String? createdBy, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CommunicationCreateTemplateInput() when $default != null:
        return $default(_that.name, _that.contentMarkdown, _that.subject,
            _that.lang, _that.createdBy, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _CommunicationCreateTemplateInput
    implements CommunicationCreateTemplateInput {
  const _CommunicationCreateTemplateInput(
      {required this.name,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CommunicationCreateTemplateInputCopyWith<_CommunicationCreateTemplateInput>
      get copyWith => __$CommunicationCreateTemplateInputCopyWithImpl<
          _CommunicationCreateTemplateInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CommunicationCreateTemplateInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CommunicationCreateTemplateInput &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.contentMarkdown, contentMarkdown) ||
                other.contentMarkdown == contentMarkdown) &&
            (identical(other.subject, subject) || other.subject == subject) &&
...
/// @nodoc
abstract mixin class _$CommunicationCreateTemplateInputCopyWith<$Res>
    implements $CommunicationCreateTemplateInputCopyWith<$Res> {
  factory _$CommunicationCreateTemplateInputCopyWith(
          _CommunicationCreateTemplateInput value,
          $Res Function(_CommunicationCreateTemplateInput) _then) =
      __$CommunicationCreateTemplateInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
