...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? accounts = null,Object? $unknown = freezed,}) {
  return _then(SignatureFindRelatedAccountsOutput(
...
class _SignatureFindRelatedAccountsOutput implements SignatureFindRelatedAccountsOutput {
  const _SignatureFindRelatedAccountsOutput({this.cursor, @RelatedAccountConverter() required  List<RelatedAccount> accounts,  Map<String, dynamic>? $unknown}): _accounts = accounts,_$unknown = $unknown;
