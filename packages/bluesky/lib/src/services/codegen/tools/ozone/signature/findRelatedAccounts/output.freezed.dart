...
mixin _$SignatureFindRelatedAccountsOutput {
  ...
  $SignatureFindRelatedAccountsOutputCopyWith<
      ...
      get copyWith => _$SignatureFindRelatedAccountsOutputCopyWithImpl<
              SignatureFindRelatedAccountsOutput>(
          this as SignatureFindRelatedAccountsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignatureFindRelatedAccountsOutput &&
...
abstract mixin class $SignatureFindRelatedAccountsOutputCopyWith<$Res> {
  factory $SignatureFindRelatedAccountsOutputCopyWith(
          ...
          $Res Function(SignatureFindRelatedAccountsOutput) _then) =
      _$SignatureFindRelatedAccountsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension SignatureFindRelatedAccountsOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignatureFindRelatedAccountsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SignatureFindRelatedAccountsOutput() when $default != null:
        return $default(_that.cursor, _that.accounts, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _SignatureFindRelatedAccountsOutput
    implements SignatureFindRelatedAccountsOutput {
  const _SignatureFindRelatedAccountsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SignatureFindRelatedAccountsOutputCopyWith<
          _SignatureFindRelatedAccountsOutput>
      get copyWith => __$SignatureFindRelatedAccountsOutputCopyWithImpl<
          _SignatureFindRelatedAccountsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SignatureFindRelatedAccountsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SignatureFindRelatedAccountsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SignatureFindRelatedAccountsOutputCopyWith<$Res>
    implements $SignatureFindRelatedAccountsOutputCopyWith<$Res> {
  factory _$SignatureFindRelatedAccountsOutputCopyWith(
          _SignatureFindRelatedAccountsOutput value,
          $Res Function(_SignatureFindRelatedAccountsOutput) _then) =
      __$SignatureFindRelatedAccountsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
