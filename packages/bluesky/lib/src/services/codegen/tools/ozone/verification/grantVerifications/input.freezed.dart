...
@pragma('vm:prefer-inline') @override $Res call({Object? verifications = null,Object? $unknown = freezed,}) {
  return _then(VerificationGrantVerificationsInput(
...
class _VerificationGrantVerificationsInput implements VerificationGrantVerificationsInput {
  const _VerificationGrantVerificationsInput({@VerificationInputConverter() required  List<VerificationInput> verifications,  Map<String, dynamic>? $unknown}): _verifications = verifications,_$unknown = $unknown;
