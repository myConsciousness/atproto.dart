...
mixin _$VerificationGrantVerificationsInput {
  ...
  $VerificationGrantVerificationsInputCopyWith<
      ...
      get copyWith => _$VerificationGrantVerificationsInputCopyWithImpl<
              VerificationGrantVerificationsInput>(
          this as VerificationGrantVerificationsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationGrantVerificationsInput &&
...
abstract mixin class $VerificationGrantVerificationsInputCopyWith<$Res> {
  factory $VerificationGrantVerificationsInputCopyWith(
          ...
          $Res Function(VerificationGrantVerificationsInput) _then) =
      _$VerificationGrantVerificationsInputCopyWithImpl;
  @useResult
  $Res call(
...
extension VerificationGrantVerificationsInputPatterns
    on VerificationGrantVerificationsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationGrantVerificationsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VerificationGrantVerificationsInput() when $default != null:
        return $default(_that.verifications, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _VerificationGrantVerificationsInput
    implements VerificationGrantVerificationsInput {
  const _VerificationGrantVerificationsInput(
      {@VerificationInputConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationGrantVerificationsInputCopyWith<
          _VerificationGrantVerificationsInput>
      get copyWith => __$VerificationGrantVerificationsInputCopyWithImpl<
          _VerificationGrantVerificationsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationGrantVerificationsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationGrantVerificationsInput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$VerificationGrantVerificationsInputCopyWith<$Res>
    implements $VerificationGrantVerificationsInputCopyWith<$Res> {
  factory _$VerificationGrantVerificationsInputCopyWith(
          _VerificationGrantVerificationsInput value,
          $Res Function(_VerificationGrantVerificationsInput) _then) =
      __$VerificationGrantVerificationsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@VerificationInputConverter() List<VerificationInput> verifications,
