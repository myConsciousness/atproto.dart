...
class $SubjectReviewStateCopyWith<$Res> {
  $SubjectReviewStateCopyWith(
      SubjectReviewState _, $Res Function(SubjectReviewState) __);
}
...
extension SubjectReviewStatePatterns on SubjectReviewState {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(SubjectReviewStateKnownValue value)? knownValue,
    TResult Function(SubjectReviewStateUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case SubjectReviewStateUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(SubjectReviewStateKnownValue value) knownValue,
    required TResult Function(SubjectReviewStateUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case SubjectReviewStateKnownValue():
        return knownValue(_that);
      case SubjectReviewStateUnknown():
        return unknown(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(KnownSubjectReviewState data)? knownValue,
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(KnownSubjectReviewState data) knownValue,
...
class SubjectReviewStateKnownValue extends SubjectReviewState {
  ...
  @override
  final KnownSubjectReviewState data;

  /// Create a copy of SubjectReviewState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SubjectReviewStateKnownValueCopyWith<SubjectReviewStateKnownValue>
      get copyWith => _$SubjectReviewStateKnownValueCopyWithImpl<
          SubjectReviewStateKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SubjectReviewStateKnownValue &&
...
/// @nodoc
abstract mixin class $SubjectReviewStateKnownValueCopyWith<$Res>
    implements $SubjectReviewStateCopyWith<$Res> {
  factory $SubjectReviewStateKnownValueCopyWith(
          SubjectReviewStateKnownValue value,
          $Res Function(SubjectReviewStateKnownValue) _then) =
      _$SubjectReviewStateKnownValueCopyWithImpl;
  @useResult
  $Res call({KnownSubjectReviewState data});
}
...
class SubjectReviewStateUnknown extends SubjectReviewState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SubjectReviewStateUnknownCopyWith<SubjectReviewStateUnknown> get copyWith =>
      _$SubjectReviewStateUnknownCopyWithImpl<SubjectReviewStateUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SubjectReviewStateUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $SubjectReviewStateUnknownCopyWith<$Res>
    implements $SubjectReviewStateCopyWith<$Res> {
  factory $SubjectReviewStateUnknownCopyWith(SubjectReviewStateUnknown value,
          $Res Function(SubjectReviewStateUnknown) _then) =
      _$SubjectReviewStateUnknownCopyWithImpl;
  @useResult
