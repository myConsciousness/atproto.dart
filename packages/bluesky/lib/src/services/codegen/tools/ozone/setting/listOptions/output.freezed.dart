...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? options = null,Object? $unknown = freezed,}) {
  return _then(SettingListOptionsOutput(
...
class _SettingListOptionsOutput implements SettingListOptionsOutput {
  const _SettingListOptionsOutput({this.cursor, @OptionConverter() required  List<Option> options,  Map<String, dynamic>? $unknown}): _options = options,_$unknown = $unknown;
