...
mixin _$SettingListOptionsOutput {
  ...
  $SettingListOptionsOutputCopyWith<SettingListOptionsOutput> get copyWith =>
      _$SettingListOptionsOutputCopyWithImpl<SettingListOptionsOutput>(
          this as SettingListOptionsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettingListOptionsOutput &&
...
abstract mixin class $SettingListOptionsOutputCopyWith<$Res> {
  factory $SettingListOptionsOutputCopyWith(SettingListOptionsOutput value,
          $Res Function(SettingListOptionsOutput) _then) =
      _$SettingListOptionsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension SettingListOptionsOutputPatterns on SettingListOptionsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SettingListOptionsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? cursor, @OptionConverter() List<Option> options,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SettingListOptionsOutput() when $default != null:
        return $default(_that.cursor, _that.options, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SettingListOptionsOutput implements SettingListOptionsOutput {
  const _SettingListOptionsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SettingListOptionsOutputCopyWith<_SettingListOptionsOutput> get copyWith =>
      __$SettingListOptionsOutputCopyWithImpl<_SettingListOptionsOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SettingListOptionsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SettingListOptionsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$SettingListOptionsOutputCopyWith<$Res>
    implements $SettingListOptionsOutputCopyWith<$Res> {
  factory _$SettingListOptionsOutputCopyWith(_SettingListOptionsOutput value,
          $Res Function(_SettingListOptionsOutput) _then) =
      __$SettingListOptionsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
