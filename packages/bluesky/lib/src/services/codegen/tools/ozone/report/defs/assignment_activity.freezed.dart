...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? previousStatus = freezed,Object? $unknown = freezed,}) {
  return _then(AssignmentActivity(
...
class _AssignmentActivity implements AssignmentActivity {
  const _AssignmentActivity({this.$type = 'tools.ozone.report.defs#assignmentActivity', @AssignmentActivityPreviousStatusConverter() this.previousStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
