...
mixin _$ModerationGetReposInput {
  ...
  $ModerationGetReposInputCopyWith<ModerationGetReposInput> get copyWith =>
      _$ModerationGetReposInputCopyWithImpl<ModerationGetReposInput>(
          this as ModerationGetReposInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetReposInput &&
...
abstract mixin class $ModerationGetReposInputCopyWith<$Res> {
  factory $ModerationGetReposInputCopyWith(ModerationGetReposInput value,
          $Res Function(ModerationGetReposInput) _then) =
      _$ModerationGetReposInputCopyWithImpl;
  @useResult
...
extension ModerationGetReposInputPatterns on ModerationGetReposInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetReposInput value)? $default, {
...
class _ModerationGetReposInput implements ModerationGetReposInput {
  const _ModerationGetReposInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetReposInputCopyWith<_ModerationGetReposInput> get copyWith =>
      __$ModerationGetReposInputCopyWithImpl<_ModerationGetReposInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetReposInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetReposInput &&
...
/// @nodoc
abstract mixin class _$ModerationGetReposInputCopyWith<$Res>
    implements $ModerationGetReposInputCopyWith<$Res> {
  factory _$ModerationGetReposInputCopyWith(_ModerationGetReposInput value,
          $Res Function(_ModerationGetReposInput) _then) =
      __$ModerationGetReposInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> dids, Map<String, dynamic>? $unknown});
}
