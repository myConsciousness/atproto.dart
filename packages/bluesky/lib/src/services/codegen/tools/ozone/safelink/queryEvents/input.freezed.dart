...
mixin _$SafelinkQueryEventsInput {
  ...
  $SafelinkQueryEventsInputCopyWith<SafelinkQueryEventsInput> get copyWith =>
      _$SafelinkQueryEventsInputCopyWithImpl<SafelinkQueryEventsInput>(
          this as SafelinkQueryEventsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SafelinkQueryEventsInput &&
...
abstract mixin class $SafelinkQueryEventsInputCopyWith<$Res> {
  factory $SafelinkQueryEventsInputCopyWith(SafelinkQueryEventsInput value,
          $Res Function(SafelinkQueryEventsInput) _then) =
      _$SafelinkQueryEventsInputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
      int limit,
...
class _$SafelinkQueryEventsInputCopyWithImpl<$Res>
  ...
  $SafelinkQueryEventsSortDirectionCopyWith<$Res>? get sortDirection {
    ...
    return $SafelinkQueryEventsSortDirectionCopyWith<$Res>(_self.sortDirection!,
        (value) {
...
extension SafelinkQueryEventsInputPatterns on SafelinkQueryEventsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SafelinkQueryEventsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SafelinkQueryEventsInput() when $default != null:
        return $default(_that.cursor, _that.limit, _that.urls,
            _that.patternType, _that.sortDirection, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SafelinkQueryEventsInput implements SafelinkQueryEventsInput {
  const _SafelinkQueryEventsInput(
      {this.cursor,
      this.limit = 50,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SafelinkQueryEventsInputCopyWith<_SafelinkQueryEventsInput> get copyWith =>
      __$SafelinkQueryEventsInputCopyWithImpl<_SafelinkQueryEventsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SafelinkQueryEventsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SafelinkQueryEventsInput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$SafelinkQueryEventsInputCopyWith<$Res>
    implements $SafelinkQueryEventsInputCopyWith<$Res> {
  factory _$SafelinkQueryEventsInputCopyWith(_SafelinkQueryEventsInput value,
          $Res Function(_SafelinkQueryEventsInput) _then) =
      __$SafelinkQueryEventsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
