...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? limit = null,Object? urls = freezed,Object? patternType = freezed,Object? sortDirection = null,Object? $unknown = freezed,}) {
  return _then(SafelinkQueryEventsInput(
...
class _SafelinkQueryEventsInput implements SafelinkQueryEventsInput {
  const _SafelinkQueryEventsInput({this.cursor, this.limit = 50,  List<String>? urls, this.patternType, @SafelinkQueryEventsSortDirectionConverter() this.sortDirection = const SafelinkQueryEventsSortDirection.knownValue(data: KnownSafelinkQueryEventsSortDirection.desc),  Map<String, dynamic>? $unknown}): _urls = urls,_$unknown = $unknown;
