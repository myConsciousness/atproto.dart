...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? repos = null,Object? $unknown = freezed,}) {
  return _then(ModerationSearchReposOutput(
...
class _ModerationSearchReposOutput implements ModerationSearchReposOutput {
  const _ModerationSearchReposOutput({this.cursor, @RepoViewConverter() required  List<RepoView> repos,  Map<String, dynamic>? $unknown}): _repos = repos,_$unknown = $unknown;
