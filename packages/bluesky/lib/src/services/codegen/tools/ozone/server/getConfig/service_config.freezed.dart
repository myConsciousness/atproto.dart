...
class _ServiceConfig implements ServiceConfig {
  const _ServiceConfig({this.$type = 'tools.ozone.server.getConfig#serviceConfig', this.url,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
