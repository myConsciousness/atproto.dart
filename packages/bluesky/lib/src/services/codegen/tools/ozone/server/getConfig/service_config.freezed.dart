...
mixin _$ServiceConfig {
  ...
  int get hashCode => Object.hash(
      runtimeType, $type, url, const DeepCollectionEquality().hash($unknown));
...
extension ServiceConfigPatterns on ServiceConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ServiceConfig value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, @AtUriConverter() AtUri? url,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ServiceConfig() when $default != null:
        return $default(_that.$type, _that.url, _that.$unknown);
      case _:
        return orElse();
    }
  }
