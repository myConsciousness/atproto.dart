...
class _$ModerationGetEventInputCopyWithImpl<$Res>
  ...
  _$ModerationGetEventInputCopyWithImpl(this._self, this._then);
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetEventInput(
...
class _ModerationGetEventInput implements ModerationGetEventInput {
  const _ModerationGetEventInput({required this.id,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
class __$ModerationGetEventInputCopyWithImpl<$Res>
  ...
  __$ModerationGetEventInputCopyWithImpl(this._self, this._then);
