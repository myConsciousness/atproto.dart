...
mixin _$CommunicationListTemplatesOutput {
  ...
  $CommunicationListTemplatesOutputCopyWith<CommunicationListTemplatesOutput>
      get copyWith => _$CommunicationListTemplatesOutputCopyWithImpl<
              CommunicationListTemplatesOutput>(
          this as CommunicationListTemplatesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CommunicationListTemplatesOutput &&
            const DeepCollectionEquality()
                .equals(other.communicationTemplates, communicationTemplates) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(communicationTemplates),
...
abstract mixin class $CommunicationListTemplatesOutputCopyWith<$Res> {
  factory $CommunicationListTemplatesOutputCopyWith(
          ...
          $Res Function(CommunicationListTemplatesOutput) _then) =
      _$CommunicationListTemplatesOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension CommunicationListTemplatesOutputPatterns
    on CommunicationListTemplatesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CommunicationListTemplatesOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _CommunicationListTemplatesOutput() when $default != null:
        return $default(_that.communicationTemplates, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _CommunicationListTemplatesOutput
    implements CommunicationListTemplatesOutput {
  const _CommunicationListTemplatesOutput(
      {@TemplateViewConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CommunicationListTemplatesOutputCopyWith<_CommunicationListTemplatesOutput>
      get copyWith => __$CommunicationListTemplatesOutputCopyWithImpl<
          _CommunicationListTemplatesOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CommunicationListTemplatesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CommunicationListTemplatesOutput &&
...
/// @nodoc
abstract mixin class _$CommunicationListTemplatesOutputCopyWith<$Res>
    implements $CommunicationListTemplatesOutputCopyWith<$Res> {
  factory _$CommunicationListTemplatesOutputCopyWith(
          _CommunicationListTemplatesOutput value,
          $Res Function(_CommunicationListTemplatesOutput) _then) =
      __$CommunicationListTemplatesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@TemplateViewConverter() List<TemplateView> communicationTemplates,
