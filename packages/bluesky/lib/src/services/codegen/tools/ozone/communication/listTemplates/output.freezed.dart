...
@pragma('vm:prefer-inline') @override $Res call({Object? communicationTemplates = null,Object? $unknown = freezed,}) {
  return _then(CommunicationListTemplatesOutput(
...
class _CommunicationListTemplatesOutput implements CommunicationListTemplatesOutput {
  const _CommunicationListTemplatesOutput({@TemplateViewConverter() required  List<TemplateView> communicationTemplates,  Map<String, dynamic>? $unknown}): _communicationTemplates = communicationTemplates,_$unknown = $unknown;
