...
@pragma('vm:prefer-inline') @override $Res call({Object? activity = null,Object? $unknown = freezed,}) {
  return _then(ReportCreateActivityOutput(
...
class _ReportCreateActivityOutput implements ReportCreateActivityOutput {
  const _ReportCreateActivityOutput({@ReportActivityViewConverter() required this.activity,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
