...
@pragma('vm:prefer-inline') @override $Res call({Object? subjects = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetSubjectsOutput(
...
class _ModerationGetSubjectsOutput implements ModerationGetSubjectsOutput {
  const _ModerationGetSubjectsOutput({@SubjectViewConverter() required  List<SubjectView> subjects,  Map<String, dynamic>? $unknown}): _subjects = subjects,_$unknown = $unknown;
