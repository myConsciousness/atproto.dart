...
mixin _$ModerationGetSubjectsOutput {
  ...
  $ModerationGetSubjectsOutputCopyWith<ModerationGetSubjectsOutput>
      get copyWith => _$ModerationGetSubjectsOutputCopyWithImpl<
              ModerationGetSubjectsOutput>(
          this as ModerationGetSubjectsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetSubjectsOutput &&
...
abstract mixin class $ModerationGetSubjectsOutputCopyWith<$Res> {
  factory $ModerationGetSubjectsOutputCopyWith(
          ...
          $Res Function(ModerationGetSubjectsOutput) _then) =
      _$ModerationGetSubjectsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ModerationGetSubjectsOutputPatterns on ModerationGetSubjectsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetSubjectsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@SubjectViewConverter() List<SubjectView> subjects,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ModerationGetSubjectsOutput() when $default != null:
        return $default(_that.subjects, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModerationGetSubjectsOutput implements ModerationGetSubjectsOutput {
  const _ModerationGetSubjectsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetSubjectsOutputCopyWith<_ModerationGetSubjectsOutput>
      get copyWith => __$ModerationGetSubjectsOutputCopyWithImpl<
          _ModerationGetSubjectsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetSubjectsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetSubjectsOutput &&
...
/// @nodoc
abstract mixin class _$ModerationGetSubjectsOutputCopyWith<$Res>
    implements $ModerationGetSubjectsOutputCopyWith<$Res> {
  factory _$ModerationGetSubjectsOutputCopyWith(
          _ModerationGetSubjectsOutput value,
          $Res Function(_ModerationGetSubjectsOutput) _then) =
      __$ModerationGetSubjectsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SubjectViewConverter() List<SubjectView> subjects,
