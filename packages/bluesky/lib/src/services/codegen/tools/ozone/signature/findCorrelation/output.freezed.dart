...
@pragma('vm:prefer-inline') @override $Res call({Object? details = null,Object? $unknown = freezed,}) {
  return _then(SignatureFindCorrelationOutput(
...
class _SignatureFindCorrelationOutput implements SignatureFindCorrelationOutput {
  const _SignatureFindCorrelationOutput({@SigDetailConverter() required  List<SigDetail> details,  Map<String, dynamic>? $unknown}): _details = details,_$unknown = $unknown;
