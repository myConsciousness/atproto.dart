...
mixin _$SignatureFindCorrelationOutput {
  ...
  $SignatureFindCorrelationOutputCopyWith<SignatureFindCorrelationOutput>
      get copyWith => _$SignatureFindCorrelationOutputCopyWithImpl<
              SignatureFindCorrelationOutput>(
          this as SignatureFindCorrelationOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignatureFindCorrelationOutput &&
...
abstract mixin class $SignatureFindCorrelationOutputCopyWith<$Res> {
  factory $SignatureFindCorrelationOutputCopyWith(
          ...
          $Res Function(SignatureFindCorrelationOutput) _then) =
      _$SignatureFindCorrelationOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension SignatureFindCorrelationOutputPatterns
    on SignatureFindCorrelationOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignatureFindCorrelationOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@SigDetailConverter() List<SigDetail> details,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SignatureFindCorrelationOutput() when $default != null:
        return $default(_that.details, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _SignatureFindCorrelationOutput
    implements SignatureFindCorrelationOutput {
  const _SignatureFindCorrelationOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SignatureFindCorrelationOutputCopyWith<_SignatureFindCorrelationOutput>
      get copyWith => __$SignatureFindCorrelationOutputCopyWithImpl<
          _SignatureFindCorrelationOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SignatureFindCorrelationOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SignatureFindCorrelationOutput &&
...
/// @nodoc
abstract mixin class _$SignatureFindCorrelationOutputCopyWith<$Res>
    implements $SignatureFindCorrelationOutputCopyWith<$Res> {
  factory _$SignatureFindCorrelationOutputCopyWith(
          _SignatureFindCorrelationOutput value,
          $Res Function(_SignatureFindCorrelationOutput) _then) =
      __$SignatureFindCorrelationOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SigDetailConverter() List<SigDetail> details,
