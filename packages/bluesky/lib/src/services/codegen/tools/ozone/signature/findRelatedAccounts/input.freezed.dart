...
mixin _$SignatureFindRelatedAccountsInput {
  ...
  $SignatureFindRelatedAccountsInputCopyWith<SignatureFindRelatedAccountsInput>
      get copyWith => _$SignatureFindRelatedAccountsInputCopyWithImpl<
              SignatureFindRelatedAccountsInput>(
          this as SignatureFindRelatedAccountsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignatureFindRelatedAccountsInput &&
...
abstract mixin class $SignatureFindRelatedAccountsInputCopyWith<$Res> {
  factory $SignatureFindRelatedAccountsInputCopyWith(
          ...
          $Res Function(SignatureFindRelatedAccountsInput) _then) =
      _$SignatureFindRelatedAccountsInputCopyWithImpl;
  @useResult
  $Res call(
...
extension SignatureFindRelatedAccountsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SignatureFindRelatedAccountsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String did, String? cursor, int limit,
    ...
    switch (_that) {
      case _SignatureFindRelatedAccountsInput() when $default != null:
        return $default(_that.did, _that.cursor, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _SignatureFindRelatedAccountsInput
    implements SignatureFindRelatedAccountsInput {
  const _SignatureFindRelatedAccountsInput(
      {required this.did,
      this.cursor,
      this.limit = 50,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SignatureFindRelatedAccountsInputCopyWith<
          _SignatureFindRelatedAccountsInput>
      get copyWith => __$SignatureFindRelatedAccountsInputCopyWithImpl<
          _SignatureFindRelatedAccountsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SignatureFindRelatedAccountsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SignatureFindRelatedAccountsInput &&
            (identical(other.did, did) || other.did == did) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$SignatureFindRelatedAccountsInputCopyWith<$Res>
    implements $SignatureFindRelatedAccountsInputCopyWith<$Res> {
  factory _$SignatureFindRelatedAccountsInputCopyWith(
          _SignatureFindRelatedAccountsInput value,
          $Res Function(_SignatureFindRelatedAccountsInput) _then) =
      __$SignatureFindRelatedAccountsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String did, String? cursor, int limit, Map<String, dynamic>? $unknown});
