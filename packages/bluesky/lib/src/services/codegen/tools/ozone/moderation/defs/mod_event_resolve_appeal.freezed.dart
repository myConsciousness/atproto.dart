...
mixin _$ModEventResolveAppeal {
  ...
  $ModEventResolveAppealCopyWith<ModEventResolveAppeal> get copyWith =>
      _$ModEventResolveAppealCopyWithImpl<ModEventResolveAppeal>(
          this as ModEventResolveAppeal, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModEventResolveAppeal &&
...
abstract mixin class $ModEventResolveAppealCopyWith<$Res> {
  factory $ModEventResolveAppealCopyWith(ModEventResolveAppeal value,
          $Res Function(ModEventResolveAppeal) _then) =
      _$ModEventResolveAppealCopyWithImpl;
  @useResult
...
extension ModEventResolveAppealPatterns on ModEventResolveAppeal {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventResolveAppeal value)? $default, {
...
class _ModEventResolveAppeal implements ModEventResolveAppeal {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventResolveAppealCopyWith<_ModEventResolveAppeal> get copyWith =>
      __$ModEventResolveAppealCopyWithImpl<_ModEventResolveAppeal>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventResolveAppealToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModEventResolveAppeal &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
...
/// @nodoc
abstract mixin class _$ModEventResolveAppealCopyWith<$Res>
    implements $ModEventResolveAppealCopyWith<$Res> {
  factory _$ModEventResolveAppealCopyWith(_ModEventResolveAppeal value,
          $Res Function(_ModEventResolveAppeal) _then) =
      __$ModEventResolveAppealCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String? comment, Map<String, dynamic>? $unknown});
}
