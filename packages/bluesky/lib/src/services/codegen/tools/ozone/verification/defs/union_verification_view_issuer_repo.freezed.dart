  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewIssuerRepo &&
...
class $UVerificationViewIssuerRepoCopyWith<$Res> {
  $UVerificationViewIssuerRepoCopyWith(UVerificationViewIssuerRepo _,
      $Res Function(UVerificationViewIssuerRepo) __);
}
...
extension UVerificationViewIssuerRepoPatterns on UVerificationViewIssuerRepo {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case UVerificationViewIssuerRepoRepoViewDetail()
          when repoViewDetail != null:
        return repoViewDetail(_that);
      case UVerificationViewIssuerRepoRepoViewNotFound()
          when repoViewNotFound != null:
        return repoViewNotFound(_that);
      case UVerificationViewIssuerRepoUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UVerificationViewIssuerRepoRepoViewNotFound():
        return repoViewNotFound(_that);
      case UVerificationViewIssuerRepoUnknown():
        return unknown(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case UVerificationViewIssuerRepoRepoViewDetail()
          when repoViewDetail != null:
        return repoViewDetail(_that.data);
      case UVerificationViewIssuerRepoRepoViewNotFound()
          when repoViewNotFound != null:
...
class UVerificationViewIssuerRepoRepoViewDetail
    extends UVerificationViewIssuerRepo {
  const UVerificationViewIssuerRepoRepoViewDetail({required this.data})
      : super._();
  ...
  $UVerificationViewIssuerRepoRepoViewDetailCopyWith<
          UVerificationViewIssuerRepoRepoViewDetail>
      get copyWith => _$UVerificationViewIssuerRepoRepoViewDetailCopyWithImpl<
          UVerificationViewIssuerRepoRepoViewDetail>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewIssuerRepoRepoViewDetail &&
...
/// @nodoc
abstract mixin class $UVerificationViewIssuerRepoRepoViewDetailCopyWith<$Res>
    implements $UVerificationViewIssuerRepoCopyWith<$Res> {
  factory $UVerificationViewIssuerRepoRepoViewDetailCopyWith(
          UVerificationViewIssuerRepoRepoViewDetail value,
          $Res Function(UVerificationViewIssuerRepoRepoViewDetail) _then) =
      _$UVerificationViewIssuerRepoRepoViewDetailCopyWithImpl;
  @useResult
...
class UVerificationViewIssuerRepoRepoViewNotFound
    extends UVerificationViewIssuerRepo {
  const UVerificationViewIssuerRepoRepoViewNotFound({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UVerificationViewIssuerRepoRepoViewNotFoundCopyWith<
          UVerificationViewIssuerRepoRepoViewNotFound>
      get copyWith => _$UVerificationViewIssuerRepoRepoViewNotFoundCopyWithImpl<
          UVerificationViewIssuerRepoRepoViewNotFound>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewIssuerRepoRepoViewNotFound &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UVerificationViewIssuerRepoRepoViewNotFoundCopyWith<$Res>
    implements $UVerificationViewIssuerRepoCopyWith<$Res> {
  factory $UVerificationViewIssuerRepoRepoViewNotFoundCopyWith(
          UVerificationViewIssuerRepoRepoViewNotFound value,
          $Res Function(UVerificationViewIssuerRepoRepoViewNotFound) _then) =
      _$UVerificationViewIssuerRepoRepoViewNotFoundCopyWithImpl;
  @useResult
...
class UVerificationViewIssuerRepoUnknown extends UVerificationViewIssuerRepo {
  const UVerificationViewIssuerRepoUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UVerificationViewIssuerRepoUnknownCopyWith<
          UVerificationViewIssuerRepoUnknown>
      get copyWith => _$UVerificationViewIssuerRepoUnknownCopyWithImpl<
          UVerificationViewIssuerRepoUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UVerificationViewIssuerRepoUnknown &&
...
/// @nodoc
abstract mixin class $UVerificationViewIssuerRepoUnknownCopyWith<$Res>
    implements $UVerificationViewIssuerRepoCopyWith<$Res> {
  factory $UVerificationViewIssuerRepoUnknownCopyWith(
          UVerificationViewIssuerRepoUnknown value,
          $Res Function(UVerificationViewIssuerRepoUnknown) _then) =
      _$UVerificationViewIssuerRepoUnknownCopyWithImpl;
  @useResult
