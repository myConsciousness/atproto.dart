...
mixin _$VerificationGrantVerificationsOutput {
  ...
  $VerificationGrantVerificationsOutputCopyWith<
      ...
      get copyWith => _$VerificationGrantVerificationsOutputCopyWithImpl<
              VerificationGrantVerificationsOutput>(
          this as VerificationGrantVerificationsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationGrantVerificationsOutput &&
            const DeepCollectionEquality()
                .equals(other.verifications, verifications) &&
            const DeepCollectionEquality()
                .equals(other.failedVerifications, failedVerifications) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(failedVerifications),
...
abstract mixin class $VerificationGrantVerificationsOutputCopyWith<$Res> {
  factory $VerificationGrantVerificationsOutputCopyWith(
          ...
          $Res Function(VerificationGrantVerificationsOutput) _then) =
      _$VerificationGrantVerificationsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension VerificationGrantVerificationsOutputPatterns
    on VerificationGrantVerificationsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationGrantVerificationsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VerificationGrantVerificationsOutput() when $default != null:
        return $default(
            _that.verifications, _that.failedVerifications, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _VerificationGrantVerificationsOutput
    implements VerificationGrantVerificationsOutput {
  const _VerificationGrantVerificationsOutput(
      {@VerificationViewConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationGrantVerificationsOutputCopyWith<
          _VerificationGrantVerificationsOutput>
      get copyWith => __$VerificationGrantVerificationsOutputCopyWithImpl<
          _VerificationGrantVerificationsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationGrantVerificationsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationGrantVerificationsOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$VerificationGrantVerificationsOutputCopyWith<$Res>
    implements $VerificationGrantVerificationsOutputCopyWith<$Res> {
  factory _$VerificationGrantVerificationsOutputCopyWith(
          _VerificationGrantVerificationsOutput value,
          $Res Function(_VerificationGrantVerificationsOutput) _then) =
      __$VerificationGrantVerificationsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@VerificationViewConverter() List<VerificationView> verifications,
