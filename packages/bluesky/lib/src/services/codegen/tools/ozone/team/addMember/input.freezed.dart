...
@pragma('vm:prefer-inline') @override $Res call({Object? did = null,Object? role = null,Object? $unknown = freezed,}) {
  return _then(TeamAddMemberInput(
...
class _TeamAddMemberInput implements TeamAddMemberInput {
  const _TeamAddMemberInput({required this.did, @TeamAddMemberRoleConverter() required this.role,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
