...
mixin _$ModEventUnmuteReporter {
  ...
  $ModEventUnmuteReporterCopyWith<ModEventUnmuteReporter> get copyWith =>
      _$ModEventUnmuteReporterCopyWithImpl<ModEventUnmuteReporter>(
          this as ModEventUnmuteReporter, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModEventUnmuteReporter &&
...
abstract mixin class $ModEventUnmuteReporterCopyWith<$Res> {
  factory $ModEventUnmuteReporterCopyWith(ModEventUnmuteReporter value,
          $Res Function(ModEventUnmuteReporter) _then) =
      _$ModEventUnmuteReporterCopyWithImpl;
  @useResult
...
extension ModEventUnmuteReporterPatterns on ModEventUnmuteReporter {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventUnmuteReporter value)? $default, {
...
class _ModEventUnmuteReporter implements ModEventUnmuteReporter {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventUnmuteReporterCopyWith<_ModEventUnmuteReporter> get copyWith =>
      __$ModEventUnmuteReporterCopyWithImpl<_ModEventUnmuteReporter>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventUnmuteReporterToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModEventUnmuteReporter &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
...
/// @nodoc
abstract mixin class _$ModEventUnmuteReporterCopyWith<$Res>
    implements $ModEventUnmuteReporterCopyWith<$Res> {
  factory _$ModEventUnmuteReporterCopyWith(_ModEventUnmuteReporter value,
          $Res Function(_ModEventUnmuteReporter) _then) =
      __$ModEventUnmuteReporterCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String? comment, Map<String, dynamic>? $unknown});
}
