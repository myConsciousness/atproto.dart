...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? comment = freezed,Object? $unknown = freezed,}) {
  return _then(ModEventUnmuteReporter(
...
class _ModEventUnmuteReporter implements ModEventUnmuteReporter {
  const _ModEventUnmuteReporter({this.$type = 'tools.ozone.moderation.defs#modEventUnmuteReporter', this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
