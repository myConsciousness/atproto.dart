...
mixin _$USubjectViewProfile {
  ...
  $USubjectViewProfileCopyWith<USubjectViewProfile> get copyWith =>
      _$USubjectViewProfileCopyWithImpl<USubjectViewProfile>(
          this as USubjectViewProfile, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectViewProfile &&
...
abstract mixin class $USubjectViewProfileCopyWith<$Res> {
  factory $USubjectViewProfileCopyWith(
          USubjectViewProfile value, $Res Function(USubjectViewProfile) _then) =
      _$USubjectViewProfileCopyWithImpl;
  @useResult
...
extension USubjectViewProfilePatterns on USubjectViewProfile {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(USubjectViewProfileUnknown value)? unknown,
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(USubjectViewProfileUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
...
class USubjectViewProfileUnknown extends USubjectViewProfile {
  const USubjectViewProfileUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $USubjectViewProfileUnknownCopyWith<USubjectViewProfileUnknown>
      get copyWith =>
          _$USubjectViewProfileUnknownCopyWithImpl<USubjectViewProfileUnknown>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectViewProfileUnknown &&
...
/// @nodoc
abstract mixin class $USubjectViewProfileUnknownCopyWith<$Res>
    implements $USubjectViewProfileCopyWith<$Res> {
  factory $USubjectViewProfileUnknownCopyWith(USubjectViewProfileUnknown value,
          $Res Function(USubjectViewProfileUnknown) _then) =
      _$USubjectViewProfileUnknownCopyWithImpl;
  @override
  @useResult
  $Res call({Map<String, dynamic> data});
}
