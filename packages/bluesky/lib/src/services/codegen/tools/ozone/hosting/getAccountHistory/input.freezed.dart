...
mixin _$HostingGetAccountHistoryInput {
  ...
  $HostingGetAccountHistoryInputCopyWith<HostingGetAccountHistoryInput>
      get copyWith => _$HostingGetAccountHistoryInputCopyWithImpl<
              HostingGetAccountHistoryInput>(
          this as HostingGetAccountHistoryInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is HostingGetAccountHistoryInput &&
...
abstract mixin class $HostingGetAccountHistoryInputCopyWith<$Res> {
  factory $HostingGetAccountHistoryInputCopyWith(
          ...
          $Res Function(HostingGetAccountHistoryInput) _then) =
      _$HostingGetAccountHistoryInputCopyWithImpl;
  @useResult
  $Res call(
      {String did,
      @HostingGetAccountHistoryEventsConverter()
...
extension HostingGetAccountHistoryInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HostingGetAccountHistoryInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _HostingGetAccountHistoryInput() when $default != null:
        return $default(
            _that.did, _that.events, _that.cursor, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _HostingGetAccountHistoryInput implements HostingGetAccountHistoryInput {
  const _HostingGetAccountHistoryInput(
      {required this.did,
      @HostingGetAccountHistoryEventsConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HostingGetAccountHistoryInputCopyWith<_HostingGetAccountHistoryInput>
      get copyWith => __$HostingGetAccountHistoryInputCopyWithImpl<
          _HostingGetAccountHistoryInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$HostingGetAccountHistoryInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _HostingGetAccountHistoryInput &&
            (identical(other.did, did) || other.did == did) &&
...
/// @nodoc
abstract mixin class _$HostingGetAccountHistoryInputCopyWith<$Res>
    implements $HostingGetAccountHistoryInputCopyWith<$Res> {
  factory _$HostingGetAccountHistoryInputCopyWith(
          _HostingGetAccountHistoryInput value,
          $Res Function(_HostingGetAccountHistoryInput) _then) =
      __$HostingGetAccountHistoryInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String did,
