...
@pragma('vm:prefer-inline') @override $Res call({Object? timeline = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetAccountTimelineOutput(
...
class _ModerationGetAccountTimelineOutput implements ModerationGetAccountTimelineOutput {
  const _ModerationGetAccountTimelineOutput({@TimelineItemConverter() required  List<TimelineItem> timeline,  Map<String, dynamic>? $unknown}): _timeline = timeline,_$unknown = $unknown;
