...
@pragma('vm:prefer-inline') @override $Res call({Object? revokedVerifications = null,Object? failedRevocations = null,Object? $unknown = freezed,}) {
  return _then(VerificationRevokeVerificationsOutput(
...
class _VerificationRevokeVerificationsOutput implements VerificationRevokeVerificationsOutput {
  const _VerificationRevokeVerificationsOutput({@AtUriConverter() required  List<AtUri> revokedVerifications, @RevokeErrorConverter() required  List<RevokeError> failedRevocations,  Map<String, dynamic>? $unknown}): _revokedVerifications = revokedVerifications,_failedRevocations = failedRevocations,_$unknown = $unknown;
