...
mixin _$VerificationRevokeVerificationsOutput {
  ...
  $VerificationRevokeVerificationsOutputCopyWith<
      ...
      get copyWith => _$VerificationRevokeVerificationsOutputCopyWithImpl<
              VerificationRevokeVerificationsOutput>(
          this as VerificationRevokeVerificationsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VerificationRevokeVerificationsOutput &&
            const DeepCollectionEquality()
                .equals(other.revokedVerifications, revokedVerifications) &&
            const DeepCollectionEquality()
                .equals(other.failedRevocations, failedRevocations) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(revokedVerifications),
      const DeepCollectionEquality().hash(failedRevocations),
...
abstract mixin class $VerificationRevokeVerificationsOutputCopyWith<$Res> {
  factory $VerificationRevokeVerificationsOutputCopyWith(
          ...
          $Res Function(VerificationRevokeVerificationsOutput) _then) =
      _$VerificationRevokeVerificationsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension VerificationRevokeVerificationsOutputPatterns
    on VerificationRevokeVerificationsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VerificationRevokeVerificationsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VerificationRevokeVerificationsOutput() when $default != null:
        return $default(_that.revokedVerifications, _that.failedRevocations,
            _that.$unknown);
      case _:
        return orElse();
    }
...
/// @nodoc
@JsonSerializable()
class _VerificationRevokeVerificationsOutput
    implements VerificationRevokeVerificationsOutput {
  const _VerificationRevokeVerificationsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VerificationRevokeVerificationsOutputCopyWith<
          _VerificationRevokeVerificationsOutput>
      get copyWith => __$VerificationRevokeVerificationsOutputCopyWithImpl<
          _VerificationRevokeVerificationsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VerificationRevokeVerificationsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VerificationRevokeVerificationsOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$VerificationRevokeVerificationsOutputCopyWith<$Res>
    implements $VerificationRevokeVerificationsOutputCopyWith<$Res> {
  factory _$VerificationRevokeVerificationsOutputCopyWith(
          _VerificationRevokeVerificationsOutput value,
          $Res Function(_VerificationRevokeVerificationsOutput) _then) =
      __$VerificationRevokeVerificationsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String> revokedVerifications,
...
class __$VerificationRevokeVerificationsOutputCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_VerificationRevokeVerificationsOutput(
      revokedVerifications: null == revokedVerifications
          ? _self._revokedVerifications
          : revokedVerifications // ignore: cast_nullable_to_non_nullable
              as List<String>,
      failedRevocations: null == failedRevocations
          ? _self._failedRevocations
          : failedRevocations // ignore: cast_nullable_to_non_nullable
              as List<RevokeError>,
      $unknown: freezed == $unknown
          ? _self._$unknown
