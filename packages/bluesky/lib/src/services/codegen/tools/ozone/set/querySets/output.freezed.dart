...
mixin _$SetQuerySetsOutput {
  ...
  $SetQuerySetsOutputCopyWith<SetQuerySetsOutput> get copyWith =>
      _$SetQuerySetsOutputCopyWithImpl<SetQuerySetsOutput>(
          this as SetQuerySetsOutput, _$identity);
...
abstract mixin class $SetQuerySetsOutputCopyWith<$Res> {
  factory $SetQuerySetsOutputCopyWith(
          SetQuerySetsOutput value, $Res Function(SetQuerySetsOutput) _then) =
      _$SetQuerySetsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension SetQuerySetsOutputPatterns on SetQuerySetsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SetQuerySetsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@SetViewConverter() List<SetView> sets, String? cursor,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SetQuerySetsOutput() when $default != null:
        return $default(_that.sets, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SetQuerySetsOutput implements SetQuerySetsOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SetQuerySetsOutputCopyWith<_SetQuerySetsOutput> get copyWith =>
      __$SetQuerySetsOutputCopyWithImpl<_SetQuerySetsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SetQuerySetsOutputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SetQuerySetsOutputCopyWith<$Res>
    implements $SetQuerySetsOutputCopyWith<$Res> {
  factory _$SetQuerySetsOutputCopyWith(
          _SetQuerySetsOutput value, $Res Function(_SetQuerySetsOutput) _then) =
      __$SetQuerySetsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SetViewConverter() List<SetView> sets,
