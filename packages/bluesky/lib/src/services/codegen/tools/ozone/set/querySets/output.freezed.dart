...
@pragma('vm:prefer-inline') @override $Res call({Object? sets = null,Object? cursor = freezed,Object? $unknown = freezed,}) {
  return _then(SetQuerySetsOutput(
...
class _SetQuerySetsOutput implements SetQuerySetsOutput {
  const _SetQuerySetsOutput({@SetViewConverter() required  List<SetView> sets, this.cursor,  Map<String, dynamic>? $unknown}): _sets = sets,_$unknown = $unknown;
