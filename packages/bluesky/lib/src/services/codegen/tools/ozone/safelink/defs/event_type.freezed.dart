...
extension EventTypePatterns on EventType {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case EventTypeUnknown() when unknown != null:
...
class EventTypeKnownValue extends EventType {
  ...
  $EventTypeKnownValueCopyWith<EventTypeKnownValue> get copyWith =>
      _$EventTypeKnownValueCopyWithImpl<EventTypeKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EventTypeKnownValue &&
...
/// @nodoc
abstract mixin class $EventTypeKnownValueCopyWith<$Res>
    implements $EventTypeCopyWith<$Res> {
  factory $EventTypeKnownValueCopyWith(
          EventTypeKnownValue value, $Res Function(EventTypeKnownValue) _then) =
      _$EventTypeKnownValueCopyWithImpl;
  @useResult
...
class EventTypeUnknown extends EventType {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $EventTypeUnknownCopyWith<EventTypeUnknown> get copyWith =>
      _$EventTypeUnknownCopyWithImpl<EventTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EventTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $EventTypeUnknownCopyWith<$Res>
    implements $EventTypeCopyWith<$Res> {
  factory $EventTypeUnknownCopyWith(
          EventTypeUnknown value, $Res Function(EventTypeUnknown) _then) =
      _$EventTypeUnknownCopyWithImpl;
  @useResult
