...
class _ModEventUnmute implements ModEventUnmute {
  const _ModEventUnmute({this.$type = 'tools.ozone.moderation.defs#modEventUnmute', this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
