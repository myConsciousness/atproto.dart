...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? status = null,Object? access = freezed,Object? comment = null,Object? $unknown = freezed,}) {
  return _then(AgeAssuranceOverrideEvent(
...
class _AgeAssuranceOverrideEvent implements AgeAssuranceOverrideEvent {
  const _AgeAssuranceOverrideEvent({this.$type = 'tools.ozone.moderation.defs#ageAssuranceOverrideEvent', @AgeAssuranceOverrideEventStatusConverter() required this.status, @AccessConverter() this.access, required this.comment,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
