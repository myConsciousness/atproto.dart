...
mixin _$ModEventPriorityScore {
  ...
  $ModEventPriorityScoreCopyWith<ModEventPriorityScore> get copyWith =>
      _$ModEventPriorityScoreCopyWithImpl<ModEventPriorityScore>(
          this as ModEventPriorityScore, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModEventPriorityScore &&
...
abstract mixin class $ModEventPriorityScoreCopyWith<$Res> {
  factory $ModEventPriorityScoreCopyWith(ModEventPriorityScore value,
          $Res Function(ModEventPriorityScore) _then) =
      _$ModEventPriorityScoreCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String? comment,
...
extension ModEventPriorityScorePatterns on ModEventPriorityScore {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventPriorityScore value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String? comment, int score,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ModEventPriorityScore() when $default != null:
        return $default(
            _that.$type, _that.comment, _that.score, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModEventPriorityScore implements ModEventPriorityScore {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventPriorityScoreCopyWith<_ModEventPriorityScore> get copyWith =>
      __$ModEventPriorityScoreCopyWithImpl<_ModEventPriorityScore>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventPriorityScoreToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModEventPriorityScore &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
            (identical(other.score, score) || other.score == score) &&
...
/// @nodoc
abstract mixin class _$ModEventPriorityScoreCopyWith<$Res>
    implements $ModEventPriorityScoreCopyWith<$Res> {
  factory _$ModEventPriorityScoreCopyWith(_ModEventPriorityScore value,
          $Res Function(_ModEventPriorityScore) _then) =
      __$ModEventPriorityScoreCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
