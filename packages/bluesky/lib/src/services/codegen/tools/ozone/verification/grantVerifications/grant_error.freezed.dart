...
class _GrantError implements GrantError {
  const _GrantError({this.$type = 'tools.ozone.verification.grantVerifications#grantError', required this.error, required this.subject,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
