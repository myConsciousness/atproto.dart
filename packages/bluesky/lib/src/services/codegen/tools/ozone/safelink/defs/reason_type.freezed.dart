...
extension ReasonTypePatterns on ReasonType {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ReasonTypeUnknown() when unknown != null:
...
class ReasonTypeKnownValue extends ReasonType {
  ...
  $ReasonTypeKnownValueCopyWith<ReasonTypeKnownValue> get copyWith =>
      _$ReasonTypeKnownValueCopyWithImpl<ReasonTypeKnownValue>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $ReasonTypeKnownValueCopyWith<$Res>
    implements $ReasonTypeCopyWith<$Res> {
  factory $ReasonTypeKnownValueCopyWith(ReasonTypeKnownValue value,
          $Res Function(ReasonTypeKnownValue) _then) =
      _$ReasonTypeKnownValueCopyWithImpl;
  @useResult
...
class ReasonTypeUnknown extends ReasonType {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ReasonTypeUnknownCopyWith<ReasonTypeUnknown> get copyWith =>
      _$ReasonTypeUnknownCopyWithImpl<ReasonTypeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ReasonTypeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ReasonTypeUnknownCopyWith<$Res>
    implements $ReasonTypeCopyWith<$Res> {
  factory $ReasonTypeUnknownCopyWith(
          ReasonTypeUnknown value, $Res Function(ReasonTypeUnknown) _then) =
      _$ReasonTypeUnknownCopyWithImpl;
  @useResult
