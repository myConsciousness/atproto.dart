...
@pragma('vm:prefer-inline') @override $Res call({Object? report = null,Object? $unknown = freezed,}) {
  return _then(ReportGetLatestReportOutput(
...
class _ReportGetLatestReportOutput implements ReportGetLatestReportOutput {
  const _ReportGetLatestReportOutput({@ReportViewConverter() required this.report,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
