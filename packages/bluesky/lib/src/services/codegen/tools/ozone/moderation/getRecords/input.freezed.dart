...
@pragma('vm:prefer-inline') @override $Res call({Object? uris = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetRecordsInput(
...
class _ModerationGetRecordsInput implements ModerationGetRecordsInput {
  const _ModerationGetRecordsInput({@AtUriConverter() required  List<AtUri> uris,  Map<String, dynamic>? $unknown}): _uris = uris,_$unknown = $unknown;
