...
mixin _$ModerationGetRecordsInput {
  ...
  $ModerationGetRecordsInputCopyWith<ModerationGetRecordsInput> get copyWith =>
      _$ModerationGetRecordsInputCopyWithImpl<ModerationGetRecordsInput>(
          this as ModerationGetRecordsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetRecordsInput &&
...
abstract mixin class $ModerationGetRecordsInputCopyWith<$Res> {
  factory $ModerationGetRecordsInputCopyWith(ModerationGetRecordsInput value,
          $Res Function(ModerationGetRecordsInput) _then) =
      _$ModerationGetRecordsInputCopyWithImpl;
  @useResult
...
extension ModerationGetRecordsInputPatterns on ModerationGetRecordsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetRecordsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> uris, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ModerationGetRecordsInput() when $default != null:
        return $default(_that.uris, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModerationGetRecordsInput implements ModerationGetRecordsInput {
  const _ModerationGetRecordsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetRecordsInputCopyWith<_ModerationGetRecordsInput>
      get copyWith =>
          __$ModerationGetRecordsInputCopyWithImpl<_ModerationGetRecordsInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetRecordsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetRecordsInput &&
...
/// @nodoc
abstract mixin class _$ModerationGetRecordsInputCopyWith<$Res>
    implements $ModerationGetRecordsInputCopyWith<$Res> {
  factory _$ModerationGetRecordsInputCopyWith(_ModerationGetRecordsInput value,
          $Res Function(_ModerationGetRecordsInput) _then) =
      __$ModerationGetRecordsInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> uris, Map<String, dynamic>? $unknown});
}
