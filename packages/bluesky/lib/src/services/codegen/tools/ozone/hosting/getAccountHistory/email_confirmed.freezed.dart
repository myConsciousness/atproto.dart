...
class _EmailConfirmed implements EmailConfirmed {
  const _EmailConfirmed({this.$type = 'tools.ozone.hosting.getAccountHistory#emailConfirmed', required this.email,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
