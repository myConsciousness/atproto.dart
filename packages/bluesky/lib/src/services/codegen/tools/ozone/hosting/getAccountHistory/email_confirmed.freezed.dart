...
mixin _$EmailConfirmed {
  ...
  $EmailConfirmedCopyWith<EmailConfirmed> get copyWith =>
      _$EmailConfirmedCopyWithImpl<EmailConfirmed>(
          this as EmailConfirmed, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, $type, email, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $EmailConfirmedCopyWith<$Res> {
  factory $EmailConfirmedCopyWith(
          EmailConfirmed value, $Res Function(EmailConfirmed) _then) =
      _$EmailConfirmedCopyWithImpl;
  @useResult
...
extension EmailConfirmedPatterns on EmailConfirmed {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EmailConfirmed value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _EmailConfirmed() when $default != null:
        return $default(_that.$type, _that.email, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String $type, String email, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _EmailConfirmed implements EmailConfirmed {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EmailConfirmedCopyWith<_EmailConfirmed> get copyWith =>
      __$EmailConfirmedCopyWithImpl<_EmailConfirmed>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EmailConfirmedToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$EmailConfirmedCopyWith<$Res>
    implements $EmailConfirmedCopyWith<$Res> {
  factory _$EmailConfirmedCopyWith(
          _EmailConfirmed value, $Res Function(_EmailConfirmed) _then) =
      __$EmailConfirmedCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String email, Map<String, dynamic>? $unknown});
}
