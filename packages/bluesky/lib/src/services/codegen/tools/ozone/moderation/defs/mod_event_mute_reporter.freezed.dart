...
mixin _$ModEventMuteReporter {
  ...
  $ModEventMuteReporterCopyWith<ModEventMuteReporter> get copyWith =>
      _$ModEventMuteReporterCopyWithImpl<ModEventMuteReporter>(
          this as ModEventMuteReporter, _$identity);
...
abstract mixin class $ModEventMuteReporterCopyWith<$Res> {
  factory $ModEventMuteReporterCopyWith(ModEventMuteReporter value,
          $Res Function(ModEventMuteReporter) _then) =
      _$ModEventMuteReporterCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String? comment,
...
extension ModEventMuteReporterPatterns on ModEventMuteReporter {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModEventMuteReporter value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String? comment, int? durationInHours,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ModEventMuteReporter() when $default != null:
        return $default(
            _that.$type, _that.comment, _that.durationInHours, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ModEventMuteReporter implements ModEventMuteReporter {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModEventMuteReporterCopyWith<_ModEventMuteReporter> get copyWith =>
      __$ModEventMuteReporterCopyWithImpl<_ModEventMuteReporter>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModEventMuteReporterToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModEventMuteReporter &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.comment, comment) || other.comment == comment) &&
            (identical(other.durationInHours, durationInHours) ||
                other.durationInHours == durationInHours) &&
...
/// @nodoc
abstract mixin class _$ModEventMuteReporterCopyWith<$Res>
    implements $ModEventMuteReporterCopyWith<$Res> {
  factory _$ModEventMuteReporterCopyWith(_ModEventMuteReporter value,
          $Res Function(_ModEventMuteReporter) _then) =
      __$ModEventMuteReporterCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
