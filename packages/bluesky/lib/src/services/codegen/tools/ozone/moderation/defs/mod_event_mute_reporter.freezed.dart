...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? comment = freezed,Object? durationInHours = freezed,Object? $unknown = freezed,}) {
  return _then(ModEventMuteReporter(
...
class _ModEventMuteReporter implements ModEventMuteReporter {
  const _ModEventMuteReporter({this.$type = 'tools.ozone.moderation.defs#modEventMuteReporter', this.comment, this.durationInHours,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
