...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? subjectStatuses = null,Object? $unknown = freezed,}) {
  return _then(ModerationQueryStatusesOutput(
...
class _ModerationQueryStatusesOutput implements ModerationQueryStatusesOutput {
  const _ModerationQueryStatusesOutput({this.cursor, @SubjectStatusViewConverter() required  List<SubjectStatusView> subjectStatuses,  Map<String, dynamic>? $unknown}): _subjectStatuses = subjectStatuses,_$unknown = $unknown;
