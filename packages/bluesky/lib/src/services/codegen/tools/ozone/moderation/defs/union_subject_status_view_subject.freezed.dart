  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectStatusViewSubject &&
...
class $USubjectStatusViewSubjectCopyWith<$Res> {
  $USubjectStatusViewSubjectCopyWith(
      USubjectStatusViewSubject _, $Res Function(USubjectStatusViewSubject) __);
}
...
extension USubjectStatusViewSubjectPatterns on USubjectStatusViewSubject {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case USubjectStatusViewSubjectRepoStrongRef() when repoStrongRef != null:
        return repoStrongRef(_that);
      case USubjectStatusViewSubjectMessageRef() when messageRef != null:
        return messageRef(_that);
      case USubjectStatusViewSubjectUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case USubjectStatusViewSubjectRepoRef():
        return repoRef(_that);
      case USubjectStatusViewSubjectRepoStrongRef():
        return repoStrongRef(_that);
      case USubjectStatusViewSubjectMessageRef():
        return messageRef(_that);
      case USubjectStatusViewSubjectUnknown():
        return unknown(_that);
      case _:
...
class USubjectStatusViewSubjectRepoRef extends USubjectStatusViewSubject {
  ...
  $USubjectStatusViewSubjectRepoRefCopyWith<USubjectStatusViewSubjectRepoRef>
      get copyWith => _$USubjectStatusViewSubjectRepoRefCopyWithImpl<
          USubjectStatusViewSubjectRepoRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectStatusViewSubjectRepoRef &&
...
/// @nodoc
abstract mixin class $USubjectStatusViewSubjectRepoRefCopyWith<$Res>
    implements $USubjectStatusViewSubjectCopyWith<$Res> {
  factory $USubjectStatusViewSubjectRepoRefCopyWith(
          USubjectStatusViewSubjectRepoRef value,
          $Res Function(USubjectStatusViewSubjectRepoRef) _then) =
      _$USubjectStatusViewSubjectRepoRefCopyWithImpl;
  @useResult
...
class USubjectStatusViewSubjectRepoStrongRef extends USubjectStatusViewSubject {
  const USubjectStatusViewSubjectRepoStrongRef({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $USubjectStatusViewSubjectRepoStrongRefCopyWith<
          USubjectStatusViewSubjectRepoStrongRef>
      get copyWith => _$USubjectStatusViewSubjectRepoStrongRefCopyWithImpl<
          USubjectStatusViewSubjectRepoStrongRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectStatusViewSubjectRepoStrongRef &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $USubjectStatusViewSubjectRepoStrongRefCopyWith<$Res>
    implements $USubjectStatusViewSubjectCopyWith<$Res> {
  factory $USubjectStatusViewSubjectRepoStrongRefCopyWith(
          USubjectStatusViewSubjectRepoStrongRef value,
          $Res Function(USubjectStatusViewSubjectRepoStrongRef) _then) =
      _$USubjectStatusViewSubjectRepoStrongRefCopyWithImpl;
  @useResult
...
class USubjectStatusViewSubjectMessageRef extends USubjectStatusViewSubject {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $USubjectStatusViewSubjectMessageRefCopyWith<
          USubjectStatusViewSubjectMessageRef>
      get copyWith => _$USubjectStatusViewSubjectMessageRefCopyWithImpl<
          USubjectStatusViewSubjectMessageRef>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectStatusViewSubjectMessageRef &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $USubjectStatusViewSubjectMessageRefCopyWith<$Res>
    implements $USubjectStatusViewSubjectCopyWith<$Res> {
  factory $USubjectStatusViewSubjectMessageRefCopyWith(
          USubjectStatusViewSubjectMessageRef value,
          $Res Function(USubjectStatusViewSubjectMessageRef) _then) =
      _$USubjectStatusViewSubjectMessageRefCopyWithImpl;
  @useResult
...
class USubjectStatusViewSubjectUnknown extends USubjectStatusViewSubject {
  const USubjectStatusViewSubjectUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $USubjectStatusViewSubjectUnknownCopyWith<USubjectStatusViewSubjectUnknown>
      get copyWith => _$USubjectStatusViewSubjectUnknownCopyWithImpl<
          USubjectStatusViewSubjectUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is USubjectStatusViewSubjectUnknown &&
...
/// @nodoc
abstract mixin class $USubjectStatusViewSubjectUnknownCopyWith<$Res>
    implements $USubjectStatusViewSubjectCopyWith<$Res> {
  factory $USubjectStatusViewSubjectUnknownCopyWith(
          USubjectStatusViewSubjectUnknown value,
          $Res Function(USubjectStatusViewSubjectUnknown) _then) =
      _$USubjectStatusViewSubjectUnknownCopyWithImpl;
  @useResult
