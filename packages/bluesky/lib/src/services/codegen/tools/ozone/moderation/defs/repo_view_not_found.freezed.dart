...
class _RepoViewNotFound implements RepoViewNotFound {
  const _RepoViewNotFound({this.$type = 'tools.ozone.moderation.defs#repoViewNotFound', required this.did,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
