...
class _SkeletonFeedPost implements SkeletonFeedPost {
  const _SkeletonFeedPost({this.$type = 'app.bsky.feed.defs#skeletonFeedPost', @AtUriConverter() required this.post, @USkeletonFeedPostReasonConverter() this.reason, this.feedContext,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
