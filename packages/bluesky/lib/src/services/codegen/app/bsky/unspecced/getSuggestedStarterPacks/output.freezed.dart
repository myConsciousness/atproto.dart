...
mixin _$UnspeccedGetSuggestedStarterPacksOutput {
  ...
  $UnspeccedGetSuggestedStarterPacksOutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetSuggestedStarterPacksOutputCopyWithImpl<
              UnspeccedGetSuggestedStarterPacksOutput>(
          this as UnspeccedGetSuggestedStarterPacksOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestedStarterPacksOutput &&
...
abstract mixin class $UnspeccedGetSuggestedStarterPacksOutputCopyWith<$Res> {
  factory $UnspeccedGetSuggestedStarterPacksOutputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestedStarterPacksOutput) _then) =
...
extension UnspeccedGetSuggestedStarterPacksOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedStarterPacksOutput value)?
        $default, {
  ...
  TResult map<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedStarterPacksOutput value) $default,
  ) {
    final _that = this;
    switch (_that) {
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestedStarterPacksOutput
    implements UnspeccedGetSuggestedStarterPacksOutput {
  const _UnspeccedGetSuggestedStarterPacksOutput(
      {@StarterPackViewConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestedStarterPacksOutputCopyWith<
          _UnspeccedGetSuggestedStarterPacksOutput>
      get copyWith => __$UnspeccedGetSuggestedStarterPacksOutputCopyWithImpl<
          _UnspeccedGetSuggestedStarterPacksOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestedStarterPacksOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestedStarterPacksOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestedStarterPacksOutputCopyWith<$Res>
    implements $UnspeccedGetSuggestedStarterPacksOutputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestedStarterPacksOutputCopyWith(
          _UnspeccedGetSuggestedStarterPacksOutput value,
          $Res Function(_UnspeccedGetSuggestedStarterPacksOutput) _then) =
      __$UnspeccedGetSuggestedStarterPacksOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@StarterPackViewConverter() List<StarterPackView> starterPacks,
