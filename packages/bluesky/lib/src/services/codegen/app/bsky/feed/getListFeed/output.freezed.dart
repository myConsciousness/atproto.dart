...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feed = null,Object? $unknown = freezed,}) {
  return _then(FeedGetListFeedOutput(
...
class _FeedGetListFeedOutput implements FeedGetListFeedOutput {
  const _FeedGetListFeedOutput({this.cursor, @FeedViewPostConverter() required  List<FeedViewPost> feed,  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
