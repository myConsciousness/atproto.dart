...
mixin _$GraphGetKnownFollowersInput {
  ...
  $GraphGetKnownFollowersInputCopyWith<GraphGetKnownFollowersInput>
      get copyWith => _$GraphGetKnownFollowersInputCopyWithImpl<
              GraphGetKnownFollowersInput>(
          this as GraphGetKnownFollowersInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetKnownFollowersInput &&
...
abstract mixin class $GraphGetKnownFollowersInputCopyWith<$Res> {
  factory $GraphGetKnownFollowersInputCopyWith(
          ...
          $Res Function(GraphGetKnownFollowersInput) _then) =
      _$GraphGetKnownFollowersInputCopyWithImpl;
  @useResult
  $Res call(
      {String actor,
      int limit,
...
extension GraphGetKnownFollowersInputPatterns on GraphGetKnownFollowersInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetKnownFollowersInput value)? $default, {
...
class _GraphGetKnownFollowersInput implements GraphGetKnownFollowersInput {
  const _GraphGetKnownFollowersInput(
      {required this.actor,
      this.limit = 50,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetKnownFollowersInputCopyWith<_GraphGetKnownFollowersInput>
      get copyWith => __$GraphGetKnownFollowersInputCopyWithImpl<
          _GraphGetKnownFollowersInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetKnownFollowersInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetKnownFollowersInput &&
            (identical(other.actor, actor) || other.actor == actor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetKnownFollowersInputCopyWith<$Res>
    implements $GraphGetKnownFollowersInputCopyWith<$Res> {
  factory _$GraphGetKnownFollowersInputCopyWith(
          _GraphGetKnownFollowersInput value,
          $Res Function(_GraphGetKnownFollowersInput) _then) =
      __$GraphGetKnownFollowersInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String actor,
