...
mixin _$NotificationPutPreferencesV2Input {
  ...
  $NotificationPutPreferencesV2InputCopyWith<NotificationPutPreferencesV2Input>
      get copyWith => _$NotificationPutPreferencesV2InputCopyWithImpl<
              NotificationPutPreferencesV2Input>(
          this as NotificationPutPreferencesV2Input, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationPutPreferencesV2Input &&
...
abstract mixin class $NotificationPutPreferencesV2InputCopyWith<$Res> {
  factory $NotificationPutPreferencesV2InputCopyWith(
          ...
          $Res Function(NotificationPutPreferencesV2Input) _then) =
      _$NotificationPutPreferencesV2InputCopyWithImpl;
  @useResult
  $Res call(
...
extension NotificationPutPreferencesV2InputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationPutPreferencesV2Input value)? $default, {
    ...
    switch (_that) {
      case _NotificationPutPreferencesV2Input() when $default != null:
        return $default(
            ...
            _that.reply,
            _that.repost,
            _that.repostViaRepost,
            _that.starterpackJoined,
            _that.subscribedPost,
            _that.unverified,
            _that.verified,
            _that.$unknown);
      case _:
...
/// @nodoc
@JsonSerializable()
class _NotificationPutPreferencesV2Input
    implements NotificationPutPreferencesV2Input {
  const _NotificationPutPreferencesV2Input(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationPutPreferencesV2InputCopyWith<
          _NotificationPutPreferencesV2Input>
      get copyWith => __$NotificationPutPreferencesV2InputCopyWithImpl<
          _NotificationPutPreferencesV2Input>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationPutPreferencesV2InputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationPutPreferencesV2Input &&
            (identical(other.chat, chat) || other.chat == chat) &&
            (identical(other.follow, follow) || other.follow == follow) &&
            (identical(other.like, like) || other.like == like) &&
            (identical(other.likeViaRepost, likeViaRepost) ||
...
/// @nodoc
abstract mixin class _$NotificationPutPreferencesV2InputCopyWith<$Res>
    implements $NotificationPutPreferencesV2InputCopyWith<$Res> {
  factory _$NotificationPutPreferencesV2InputCopyWith(
          _NotificationPutPreferencesV2Input value,
          $Res Function(_NotificationPutPreferencesV2Input) _then) =
      __$NotificationPutPreferencesV2InputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ChatPreferenceConverter() ChatPreference? chat,
