...
class _RichtextFacetTag implements RichtextFacetTag {
  const _RichtextFacetTag({this.$type = 'app.bsky.richtext.facet#tag', required this.tag,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
