...
@pragma('vm:prefer-inline') @override $Res call({Object? actors = null,Object? recIdStr = freezed,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetSuggestedUsersForSeeMoreOutput(
...
class _UnspeccedGetSuggestedUsersForSeeMoreOutput implements UnspeccedGetSuggestedUsersForSeeMoreOutput {
  const _UnspeccedGetSuggestedUsersForSeeMoreOutput({@ProfileViewConverter() required  List<ProfileView> actors, this.recIdStr,  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
