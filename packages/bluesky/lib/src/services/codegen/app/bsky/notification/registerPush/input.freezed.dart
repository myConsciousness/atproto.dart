...
@pragma('vm:prefer-inline') @override $Res call({Object? serviceDid = null,Object? token = null,Object? platform = null,Object? appId = null,Object? ageRestricted = freezed,Object? $unknown = freezed,}) {
  return _then(NotificationRegisterPushInput(
...
class _NotificationRegisterPushInput implements NotificationRegisterPushInput {
  const _NotificationRegisterPushInput({required this.serviceDid, required this.token, @NotificationRegisterPushPlatformConverter() required this.platform, required this.appId, this.ageRestricted,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
