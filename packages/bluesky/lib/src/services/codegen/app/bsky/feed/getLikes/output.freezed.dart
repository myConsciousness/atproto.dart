...
@pragma('vm:prefer-inline') @override $Res call({Object? uri = null,Object? cid = freezed,Object? cursor = freezed,Object? likes = null,Object? $unknown = freezed,}) {
  return _then(FeedGetLikesOutput(
...
class _FeedGetLikesOutput implements FeedGetLikesOutput {
  const _FeedGetLikesOutput({@AtUriConverter() required this.uri, this.cid, this.cursor, @LikeConverter() required  List<Like> likes,  Map<String, dynamic>? $unknown}): _likes = likes,_$unknown = $unknown;
