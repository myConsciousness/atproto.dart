...
@pragma('vm:prefer-inline') @override $Res call({Object? actor = null,Object? limit = null,Object? cursor = freezed,Object? purposes = freezed,Object? $unknown = freezed,}) {
  return _then(GraphGetListsInput(
...
class _GraphGetListsInput implements GraphGetListsInput {
  const _GraphGetListsInput({required this.actor, this.limit = 50, this.cursor, @GraphGetListsPurposesConverter()  List<GraphGetListsPurposes>? purposes,  Map<String, dynamic>? $unknown}): _purposes = purposes,_$unknown = $unknown;
