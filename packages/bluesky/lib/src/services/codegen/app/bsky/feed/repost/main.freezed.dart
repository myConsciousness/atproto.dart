...
class _FeedRepostRecord implements FeedRepostRecord {
  const _FeedRepostRecord({this.$type = 'app.bsky.feed.repost', @RepoStrongRefConverter() required this.subject, @JsonKey(toJson: iso8601) required this.createdAt, @RepoStrongRefConverter() this.via, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
