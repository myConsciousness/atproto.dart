...
class _BlockedPost implements BlockedPost {
  const _BlockedPost({this.$type = 'app.bsky.feed.defs#blockedPost', @AtUriConverter() required this.uri, required this.blocked, @BlockedAuthorConverter() required this.author,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
