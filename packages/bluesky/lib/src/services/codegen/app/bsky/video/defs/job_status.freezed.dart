...
class _JobStatus implements JobStatus {
  const _JobStatus({this.$type = 'app.bsky.video.defs#jobStatus', required this.jobId, required this.did, @JobStatusStateConverter() required this.state, this.progress, @BlobConverter() this.blob, this.error, this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
