...
mixin _$FeedGetSuggestedFeedsInput {
  ...
  $FeedGetSuggestedFeedsInputCopyWith<FeedGetSuggestedFeedsInput>
      get copyWith =>
          _$FeedGetSuggestedFeedsInputCopyWithImpl<FeedGetSuggestedFeedsInput>(
              this as FeedGetSuggestedFeedsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetSuggestedFeedsInput &&
...
abstract mixin class $FeedGetSuggestedFeedsInputCopyWith<$Res> {
  factory $FeedGetSuggestedFeedsInputCopyWith(FeedGetSuggestedFeedsInput value,
          $Res Function(FeedGetSuggestedFeedsInput) _then) =
      _$FeedGetSuggestedFeedsInputCopyWithImpl;
  @useResult
...
extension FeedGetSuggestedFeedsInputPatterns on FeedGetSuggestedFeedsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetSuggestedFeedsInput value)? $default, {
...
class _FeedGetSuggestedFeedsInput implements FeedGetSuggestedFeedsInput {
  const _FeedGetSuggestedFeedsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetSuggestedFeedsInputCopyWith<_FeedGetSuggestedFeedsInput>
      get copyWith => __$FeedGetSuggestedFeedsInputCopyWithImpl<
          _FeedGetSuggestedFeedsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetSuggestedFeedsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetSuggestedFeedsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetSuggestedFeedsInputCopyWith<$Res>
    implements $FeedGetSuggestedFeedsInputCopyWith<$Res> {
  factory _$FeedGetSuggestedFeedsInputCopyWith(
          _FeedGetSuggestedFeedsInput value,
          $Res Function(_FeedGetSuggestedFeedsInput) _then) =
      __$FeedGetSuggestedFeedsInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
