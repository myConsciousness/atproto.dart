...
mixin _$UnspeccedGetSuggestionsSkeletonInput {
  ...
  $UnspeccedGetSuggestionsSkeletonInputCopyWith<
      ...
      get copyWith => _$UnspeccedGetSuggestionsSkeletonInputCopyWithImpl<
              UnspeccedGetSuggestionsSkeletonInput>(
          this as UnspeccedGetSuggestionsSkeletonInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestionsSkeletonInput &&
  ...
  int get hashCode => Object.hash(runtimeType, viewer, limit, cursor,
      relativeToDid, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $UnspeccedGetSuggestionsSkeletonInputCopyWith<$Res> {
  factory $UnspeccedGetSuggestionsSkeletonInputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestionsSkeletonInput) _then) =
      _$UnspeccedGetSuggestionsSkeletonInputCopyWithImpl;
  @useResult
  $Res call(
      {String? viewer,
      int limit,
...
extension UnspeccedGetSuggestionsSkeletonInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestionsSkeletonInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? viewer, int limit, String? cursor,
            String? relativeToDid, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UnspeccedGetSuggestionsSkeletonInput() when $default != null:
        return $default(_that.viewer, _that.limit, _that.cursor,
            _that.relativeToDid, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestionsSkeletonInput
    implements UnspeccedGetSuggestionsSkeletonInput {
  const _UnspeccedGetSuggestionsSkeletonInput(
      {this.viewer,
      this.limit = 50,
      this.cursor,
      this.relativeToDid,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestionsSkeletonInputCopyWith<
          _UnspeccedGetSuggestionsSkeletonInput>
      get copyWith => __$UnspeccedGetSuggestionsSkeletonInputCopyWithImpl<
          _UnspeccedGetSuggestionsSkeletonInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestionsSkeletonInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestionsSkeletonInput &&
            (identical(other.viewer, viewer) || other.viewer == viewer) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.relativeToDid, relativeToDid) ||
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestionsSkeletonInputCopyWith<$Res>
    implements $UnspeccedGetSuggestionsSkeletonInputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestionsSkeletonInputCopyWith(
          _UnspeccedGetSuggestionsSkeletonInput value,
          $Res Function(_UnspeccedGetSuggestionsSkeletonInput) _then) =
      __$UnspeccedGetSuggestionsSkeletonInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? viewer,
