...
class _FeedGetFeedInput implements FeedGetFeedInput {
  const _FeedGetFeedInput({@AtUriConverter() required this.feed, this.limit = 50, this.cursor,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
