...
@pragma('vm:prefer-inline') @override $Res call({Object? feeds = null,Object? $unknown = freezed,}) {
  return _then(FeedGetFeedGeneratorsInput(
...
class _FeedGetFeedGeneratorsInput implements FeedGetFeedGeneratorsInput {
  const _FeedGetFeedGeneratorsInput({@AtUriConverter() required  List<AtUri> feeds,  Map<String, dynamic>? $unknown}): _feeds = feeds,_$unknown = $unknown;
