...
mixin _$UnspeccedInitAgeAssuranceInput {
  ...
  $UnspeccedInitAgeAssuranceInputCopyWith<UnspeccedInitAgeAssuranceInput>
      get copyWith => _$UnspeccedInitAgeAssuranceInputCopyWithImpl<
              UnspeccedInitAgeAssuranceInput>(
          this as UnspeccedInitAgeAssuranceInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedInitAgeAssuranceInput &&
...
abstract mixin class $UnspeccedInitAgeAssuranceInputCopyWith<$Res> {
  factory $UnspeccedInitAgeAssuranceInputCopyWith(
          ...
          $Res Function(UnspeccedInitAgeAssuranceInput) _then) =
      _$UnspeccedInitAgeAssuranceInputCopyWithImpl;
  @useResult
  $Res call(
      {String email,
      String language,
...
extension UnspeccedInitAgeAssuranceInputPatterns
    on UnspeccedInitAgeAssuranceInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedInitAgeAssuranceInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String email, String language, String countryCode,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedInitAgeAssuranceInput() when $default != null:
        return $default(
            _that.email, _that.language, _that.countryCode, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedInitAgeAssuranceInput
    implements UnspeccedInitAgeAssuranceInput {
  const _UnspeccedInitAgeAssuranceInput(
      {required this.email,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedInitAgeAssuranceInputCopyWith<_UnspeccedInitAgeAssuranceInput>
      get copyWith => __$UnspeccedInitAgeAssuranceInputCopyWithImpl<
          _UnspeccedInitAgeAssuranceInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedInitAgeAssuranceInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedInitAgeAssuranceInput &&
            (identical(other.email, email) || other.email == email) &&
            (identical(other.language, language) ||
                other.language == language) &&
            (identical(other.countryCode, countryCode) ||
...
/// @nodoc
abstract mixin class _$UnspeccedInitAgeAssuranceInputCopyWith<$Res>
    implements $UnspeccedInitAgeAssuranceInputCopyWith<$Res> {
  factory _$UnspeccedInitAgeAssuranceInputCopyWith(
          _UnspeccedInitAgeAssuranceInput value,
          $Res Function(_UnspeccedInitAgeAssuranceInput) _then) =
      __$UnspeccedInitAgeAssuranceInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String email,
