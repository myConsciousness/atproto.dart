...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? date = null,Object? access = null,Object? $unknown = freezed,}) {
  return _then(ConfigRegionRuleIfAccountOlderThan(
...
class _ConfigRegionRuleIfAccountOlderThan implements ConfigRegionRuleIfAccountOlderThan {
  const _ConfigRegionRuleIfAccountOlderThan({this.$type = 'app.bsky.ageassurance.defs#configRegionRuleIfAccountOlderThan', @JsonKey(toJson: iso8601) required this.date, @AccessConverter() required this.access,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
