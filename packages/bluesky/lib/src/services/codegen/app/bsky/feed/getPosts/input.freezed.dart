...
@pragma('vm:prefer-inline') @override $Res call({Object? uris = null,Object? $unknown = freezed,}) {
  return _then(FeedGetPostsInput(
...
class _FeedGetPostsInput implements FeedGetPostsInput {
  const _FeedGetPostsInput({@AtUriConverter() required  List<AtUri> uris,  Map<String, dynamic>? $unknown}): _uris = uris,_$unknown = $unknown;
