...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? age = null,Object? access = null,Object? $unknown = freezed,}) {
  return _then(ConfigRegionRuleIfDeclaredOverAge(
...
class _ConfigRegionRuleIfDeclaredOverAge implements ConfigRegionRuleIfDeclaredOverAge {
  const _ConfigRegionRuleIfDeclaredOverAge({this.$type = 'app.bsky.ageassurance.defs#configRegionRuleIfDeclaredOverAge', required this.age, @AccessConverter() required this.access,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
