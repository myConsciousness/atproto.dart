...
class _StateMetadata implements StateMetadata {
  const _StateMetadata({this.$type = 'app.bsky.ageassurance.defs#stateMetadata', @JsonKey(toJson: iso8601) this.accountCreatedAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
