...
class _Preference implements Preference {
  const _Preference({this.$type = 'app.bsky.notification.defs#preference', required this.list, required this.push,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
