...
class _EmbedGallery implements EmbedGallery {
  const _EmbedGallery({this.$type = 'app.bsky.embed.gallery', @UEmbedGalleryItemsConverter() required  List<UEmbedGalleryItems> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
