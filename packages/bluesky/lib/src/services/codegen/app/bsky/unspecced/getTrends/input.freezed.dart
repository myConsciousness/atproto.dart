...
class _$UnspeccedGetTrendsInputCopyWithImpl<$Res>
  ...
  _$UnspeccedGetTrendsInputCopyWithImpl(this._self, this._then);
...
@pragma('vm:prefer-inline') @override $Res call({Object? limit = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetTrendsInput(
...
class _UnspeccedGetTrendsInput implements UnspeccedGetTrendsInput {
  const _UnspeccedGetTrendsInput({this.limit = 10,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
class __$UnspeccedGetTrendsInputCopyWithImpl<$Res>
  ...
  __$UnspeccedGetTrendsInputCopyWithImpl(this._self, this._then);
