...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feeds = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetPopularFeedGeneratorsOutput(
...
class _UnspeccedGetPopularFeedGeneratorsOutput implements UnspeccedGetPopularFeedGeneratorsOutput {
  const _UnspeccedGetPopularFeedGeneratorsOutput({this.cursor, @GeneratorViewConverter() required  List<GeneratorView> feeds,  Map<String, dynamic>? $unknown}): _feeds = feeds,_$unknown = $unknown;
