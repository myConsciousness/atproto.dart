...
mixin _$UnspeccedGetPopularFeedGeneratorsOutput {
  ...
  $UnspeccedGetPopularFeedGeneratorsOutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetPopularFeedGeneratorsOutputCopyWithImpl<
              UnspeccedGetPopularFeedGeneratorsOutput>(
          this as UnspeccedGetPopularFeedGeneratorsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPopularFeedGeneratorsOutput &&
...
abstract mixin class $UnspeccedGetPopularFeedGeneratorsOutputCopyWith<$Res> {
  factory $UnspeccedGetPopularFeedGeneratorsOutputCopyWith(
          ...
          $Res Function(UnspeccedGetPopularFeedGeneratorsOutput) _then) =
...
extension UnspeccedGetPopularFeedGeneratorsOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetPopularFeedGeneratorsOutput value)?
        $default, {
  ...
  TResult map<TResult extends Object?>(
    TResult Function(_UnspeccedGetPopularFeedGeneratorsOutput value) $default,
  ) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UnspeccedGetPopularFeedGeneratorsOutput() when $default != null:
        return $default(_that.cursor, _that.feeds, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetPopularFeedGeneratorsOutput
    implements UnspeccedGetPopularFeedGeneratorsOutput {
  const _UnspeccedGetPopularFeedGeneratorsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetPopularFeedGeneratorsOutputCopyWith<
          _UnspeccedGetPopularFeedGeneratorsOutput>
      get copyWith => __$UnspeccedGetPopularFeedGeneratorsOutputCopyWithImpl<
          _UnspeccedGetPopularFeedGeneratorsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetPopularFeedGeneratorsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetPopularFeedGeneratorsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetPopularFeedGeneratorsOutputCopyWith<$Res>
    implements $UnspeccedGetPopularFeedGeneratorsOutputCopyWith<$Res> {
  factory _$UnspeccedGetPopularFeedGeneratorsOutputCopyWith(
          _UnspeccedGetPopularFeedGeneratorsOutput value,
          $Res Function(_UnspeccedGetPopularFeedGeneratorsOutput) _then) =
      __$UnspeccedGetPopularFeedGeneratorsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
