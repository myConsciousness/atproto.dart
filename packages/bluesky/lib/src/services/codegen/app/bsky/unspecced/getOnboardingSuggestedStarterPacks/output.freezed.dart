...
@pragma('vm:prefer-inline') @override $Res call({Object? starterPacks = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetOnboardingSuggestedStarterPacksOutput(
...
class _UnspeccedGetOnboardingSuggestedStarterPacksOutput implements UnspeccedGetOnboardingSuggestedStarterPacksOutput {
  const _UnspeccedGetOnboardingSuggestedStarterPacksOutput({@StarterPackViewConverter() required  List<StarterPackView> starterPacks,  Map<String, dynamic>? $unknown}): _starterPacks = starterPacks,_$unknown = $unknown;
