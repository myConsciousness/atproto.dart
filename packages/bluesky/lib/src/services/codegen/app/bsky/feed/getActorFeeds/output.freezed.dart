...
mixin _$FeedGetActorFeedsOutput {
  ...
  $FeedGetActorFeedsOutputCopyWith<FeedGetActorFeedsOutput> get copyWith =>
      _$FeedGetActorFeedsOutputCopyWithImpl<FeedGetActorFeedsOutput>(
          this as FeedGetActorFeedsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetActorFeedsOutput &&
...
abstract mixin class $FeedGetActorFeedsOutputCopyWith<$Res> {
  factory $FeedGetActorFeedsOutputCopyWith(FeedGetActorFeedsOutput value,
          $Res Function(FeedGetActorFeedsOutput) _then) =
      _$FeedGetActorFeedsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension FeedGetActorFeedsOutputPatterns on FeedGetActorFeedsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetActorFeedsOutput value)? $default, {
...
class _FeedGetActorFeedsOutput implements FeedGetActorFeedsOutput {
  const _FeedGetActorFeedsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetActorFeedsOutputCopyWith<_FeedGetActorFeedsOutput> get copyWith =>
      __$FeedGetActorFeedsOutputCopyWithImpl<_FeedGetActorFeedsOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetActorFeedsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetActorFeedsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetActorFeedsOutputCopyWith<$Res>
    implements $FeedGetActorFeedsOutputCopyWith<$Res> {
  factory _$FeedGetActorFeedsOutputCopyWith(_FeedGetActorFeedsOutput value,
          $Res Function(_FeedGetActorFeedsOutput) _then) =
      __$FeedGetActorFeedsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
