...
class _Config implements Config {
  const _Config({this.$type = 'app.bsky.ageassurance.defs#config', @ConfigRegionConverter() required  List<ConfigRegion> regions,  Map<String, dynamic>? $unknown}): _regions = regions,_$unknown = $unknown;
