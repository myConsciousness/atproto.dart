...
mixin _$UnspeccedGetTrendsOutput {
  ...
  $UnspeccedGetTrendsOutputCopyWith<UnspeccedGetTrendsOutput> get copyWith =>
      _$UnspeccedGetTrendsOutputCopyWithImpl<UnspeccedGetTrendsOutput>(
          this as UnspeccedGetTrendsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetTrendsOutput &&
...
abstract mixin class $UnspeccedGetTrendsOutputCopyWith<$Res> {
  factory $UnspeccedGetTrendsOutputCopyWith(UnspeccedGetTrendsOutput value,
          $Res Function(UnspeccedGetTrendsOutput) _then) =
      _$UnspeccedGetTrendsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension UnspeccedGetTrendsOutputPatterns on UnspeccedGetTrendsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetTrendsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@TrendViewConverter() List<TrendView> trends,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
...
class _UnspeccedGetTrendsOutput implements UnspeccedGetTrendsOutput {
  const _UnspeccedGetTrendsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetTrendsOutputCopyWith<_UnspeccedGetTrendsOutput> get copyWith =>
      __$UnspeccedGetTrendsOutputCopyWithImpl<_UnspeccedGetTrendsOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetTrendsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetTrendsOutput &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetTrendsOutputCopyWith<$Res>
    implements $UnspeccedGetTrendsOutputCopyWith<$Res> {
  factory _$UnspeccedGetTrendsOutputCopyWith(_UnspeccedGetTrendsOutput value,
          $Res Function(_UnspeccedGetTrendsOutput) _then) =
      __$UnspeccedGetTrendsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@TrendViewConverter() List<TrendView> trends,
