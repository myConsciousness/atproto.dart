...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? blocks = null,Object? $unknown = freezed,}) {
  return _then(GraphGetBlocksOutput(
...
class _GraphGetBlocksOutput implements GraphGetBlocksOutput {
  const _GraphGetBlocksOutput({this.cursor, @ProfileViewConverter() required  List<ProfileView> blocks,  Map<String, dynamic>? $unknown}): _blocks = blocks,_$unknown = $unknown;
