...
class _EmbedRecord implements EmbedRecord {
  const _EmbedRecord({this.$type = 'app.bsky.embed.record', @RepoStrongRefConverter() required this.record,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
