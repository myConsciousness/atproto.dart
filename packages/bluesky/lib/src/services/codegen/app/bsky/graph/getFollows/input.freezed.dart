...
mixin _$GraphGetFollowsInput {
  ...
  $GraphGetFollowsInputCopyWith<GraphGetFollowsInput> get copyWith =>
      _$GraphGetFollowsInputCopyWithImpl<GraphGetFollowsInput>(
          this as GraphGetFollowsInput, _$identity);
...
abstract mixin class $GraphGetFollowsInputCopyWith<$Res> {
  factory $GraphGetFollowsInputCopyWith(GraphGetFollowsInput value,
          $Res Function(GraphGetFollowsInput) _then) =
      _$GraphGetFollowsInputCopyWithImpl;
  @useResult
  $Res call(
      {String actor,
      int limit,
...
extension GraphGetFollowsInputPatterns on GraphGetFollowsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetFollowsInput value)? $default, {
...
class _GraphGetFollowsInput implements GraphGetFollowsInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetFollowsInputCopyWith<_GraphGetFollowsInput> get copyWith =>
      __$GraphGetFollowsInputCopyWithImpl<_GraphGetFollowsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetFollowsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetFollowsInput &&
            (identical(other.actor, actor) || other.actor == actor) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetFollowsInputCopyWith<$Res>
    implements $GraphGetFollowsInputCopyWith<$Res> {
  factory _$GraphGetFollowsInputCopyWith(_GraphGetFollowsInput value,
          $Res Function(_GraphGetFollowsInput) _then) =
      __$GraphGetFollowsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String actor,
