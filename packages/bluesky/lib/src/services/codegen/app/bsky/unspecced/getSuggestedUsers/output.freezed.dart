...
class _UnspeccedGetSuggestedUsersOutput implements UnspeccedGetSuggestedUsersOutput {
  const _UnspeccedGetSuggestedUsersOutput({@ProfileViewConverter() required final  List<ProfileView> actors, this.recIdStr, final  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
