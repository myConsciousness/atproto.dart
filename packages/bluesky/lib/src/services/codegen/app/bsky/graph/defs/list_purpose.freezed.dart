...
extension ListPurposePatterns on ListPurpose {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ListPurposeUnknown() when unknown != null:
...
class ListPurposeKnownValue extends ListPurpose {
  ...
  $ListPurposeKnownValueCopyWith<ListPurposeKnownValue> get copyWith =>
      _$ListPurposeKnownValueCopyWithImpl<ListPurposeKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ListPurposeKnownValue &&
...
/// @nodoc
abstract mixin class $ListPurposeKnownValueCopyWith<$Res>
    implements $ListPurposeCopyWith<$Res> {
  factory $ListPurposeKnownValueCopyWith(ListPurposeKnownValue value,
          $Res Function(ListPurposeKnownValue) _then) =
      _$ListPurposeKnownValueCopyWithImpl;
  @useResult
...
class ListPurposeUnknown extends ListPurpose {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ListPurposeUnknownCopyWith<ListPurposeUnknown> get copyWith =>
      _$ListPurposeUnknownCopyWithImpl<ListPurposeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ListPurposeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ListPurposeUnknownCopyWith<$Res>
    implements $ListPurposeCopyWith<$Res> {
  factory $ListPurposeUnknownCopyWith(
          ListPurposeUnknown value, $Res Function(ListPurposeUnknown) _then) =
      _$ListPurposeUnknownCopyWithImpl;
  @useResult
