...
@pragma('vm:prefer-inline') @override $Res call({Object? preferences = null,Object? $unknown = freezed,}) {
  return _then(NotificationPutPreferencesV2Output(
...
class _NotificationPutPreferencesV2Output implements NotificationPutPreferencesV2Output {
  const _NotificationPutPreferencesV2Output({@PreferencesConverter() required this.preferences,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
