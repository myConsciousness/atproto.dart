...
mixin _$NotificationPutPreferencesV2Output {
  ...
  $NotificationPutPreferencesV2OutputCopyWith<
      ...
      get copyWith => _$NotificationPutPreferencesV2OutputCopyWithImpl<
              NotificationPutPreferencesV2Output>(
          this as NotificationPutPreferencesV2Output, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationPutPreferencesV2Output &&
  ...
  int get hashCode => Object.hash(
      runtimeType, preferences, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $NotificationPutPreferencesV2OutputCopyWith<$Res> {
  factory $NotificationPutPreferencesV2OutputCopyWith(
          ...
          $Res Function(NotificationPutPreferencesV2Output) _then) =
      _$NotificationPutPreferencesV2OutputCopyWithImpl;
  @useResult
  $Res call(
...
extension NotificationPutPreferencesV2OutputPatterns
    on NotificationPutPreferencesV2Output {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationPutPreferencesV2Output value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@PreferencesConverter() Preferences preferences,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _NotificationPutPreferencesV2Output() when $default != null:
        return $default(_that.preferences, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationPutPreferencesV2Output
    implements NotificationPutPreferencesV2Output {
  const _NotificationPutPreferencesV2Output(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationPutPreferencesV2OutputCopyWith<
          _NotificationPutPreferencesV2Output>
      get copyWith => __$NotificationPutPreferencesV2OutputCopyWithImpl<
          _NotificationPutPreferencesV2Output>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationPutPreferencesV2OutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationPutPreferencesV2Output &&
            (identical(other.preferences, preferences) ||
                other.preferences == preferences) &&
...
/// @nodoc
abstract mixin class _$NotificationPutPreferencesV2OutputCopyWith<$Res>
    implements $NotificationPutPreferencesV2OutputCopyWith<$Res> {
  factory _$NotificationPutPreferencesV2OutputCopyWith(
          _NotificationPutPreferencesV2Output value,
          $Res Function(_NotificationPutPreferencesV2Output) _then) =
      __$NotificationPutPreferencesV2OutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@PreferencesConverter() Preferences preferences,
