...
class $NotificationReasonCopyWith<$Res> {
  $NotificationReasonCopyWith(
      NotificationReason _, $Res Function(NotificationReason) __);
}
...
extension NotificationReasonPatterns on NotificationReason {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case NotificationReasonUnknown() when unknown != null:
...
class NotificationReasonKnownValue extends NotificationReason {
  ...
  $NotificationReasonKnownValueCopyWith<NotificationReasonKnownValue>
      get copyWith => _$NotificationReasonKnownValueCopyWithImpl<
          NotificationReasonKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationReasonKnownValue &&
...
/// @nodoc
abstract mixin class $NotificationReasonKnownValueCopyWith<$Res>
    implements $NotificationReasonCopyWith<$Res> {
  factory $NotificationReasonKnownValueCopyWith(
          NotificationReasonKnownValue value,
          $Res Function(NotificationReasonKnownValue) _then) =
      _$NotificationReasonKnownValueCopyWithImpl;
  @useResult
...
class NotificationReasonUnknown extends NotificationReason {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $NotificationReasonUnknownCopyWith<NotificationReasonUnknown> get copyWith =>
      _$NotificationReasonUnknownCopyWithImpl<NotificationReasonUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationReasonUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $NotificationReasonUnknownCopyWith<$Res>
    implements $NotificationReasonCopyWith<$Res> {
  factory $NotificationReasonUnknownCopyWith(NotificationReasonUnknown value,
          $Res Function(NotificationReasonUnknown) _then) =
      _$NotificationReasonUnknownCopyWithImpl;
  @useResult
