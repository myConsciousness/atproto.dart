...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? actors = null,Object? recIdStr = freezed,Object? $unknown = freezed,}) {
  return _then(ActorGetSuggestionsOutput(
...
class _ActorGetSuggestionsOutput implements ActorGetSuggestionsOutput {
  const _ActorGetSuggestionsOutput({this.cursor, @ProfileViewConverter() required  List<ProfileView> actors, this.recIdStr,  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
