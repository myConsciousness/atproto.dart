...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? lists = null,Object? $unknown = freezed,}) {
  return _then(GraphGetListsOutput(
...
class _GraphGetListsOutput implements GraphGetListsOutput {
  const _GraphGetListsOutput({this.cursor, @ListViewConverter() required  List<ListView> lists,  Map<String, dynamic>? $unknown}): _lists = lists,_$unknown = $unknown;
