...
mixin _$FeedGetActorLikesOutput {
  ...
  $FeedGetActorLikesOutputCopyWith<FeedGetActorLikesOutput> get copyWith =>
      _$FeedGetActorLikesOutputCopyWithImpl<FeedGetActorLikesOutput>(
          this as FeedGetActorLikesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetActorLikesOutput &&
...
abstract mixin class $FeedGetActorLikesOutputCopyWith<$Res> {
  factory $FeedGetActorLikesOutputCopyWith(FeedGetActorLikesOutput value,
          $Res Function(FeedGetActorLikesOutput) _then) =
      _$FeedGetActorLikesOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension FeedGetActorLikesOutputPatterns on FeedGetActorLikesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetActorLikesOutput value)? $default, {
...
class _FeedGetActorLikesOutput implements FeedGetActorLikesOutput {
  const _FeedGetActorLikesOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetActorLikesOutputCopyWith<_FeedGetActorLikesOutput> get copyWith =>
      __$FeedGetActorLikesOutputCopyWithImpl<_FeedGetActorLikesOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetActorLikesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetActorLikesOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetActorLikesOutputCopyWith<$Res>
    implements $FeedGetActorLikesOutputCopyWith<$Res> {
  factory _$FeedGetActorLikesOutputCopyWith(_FeedGetActorLikesOutput value,
          $Res Function(_FeedGetActorLikesOutput) _then) =
      __$FeedGetActorLikesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
