...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? thumb = null,Object? fullsize = null,Object? alt = null,Object? aspectRatio = freezed,Object? $unknown = freezed,}) {
  return _then(EmbedImagesViewImage(
...
class _EmbedImagesViewImage implements EmbedImagesViewImage {
  const _EmbedImagesViewImage({this.$type = 'app.bsky.embed.images#viewImage', required this.thumb, required this.fullsize, required this.alt, @AspectRatioConverter() this.aspectRatio,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
