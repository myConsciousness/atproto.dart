...
@pragma('vm:prefer-inline') @override $Res call({Object? uri = null,Object? cid = null,Object? $unknown = freezed,}) {
  return _then(BookmarkCreateBookmarkInput(
...
class _BookmarkCreateBookmarkInput implements BookmarkCreateBookmarkInput {
  const _BookmarkCreateBookmarkInput({@AtUriConverter() required this.uri, required this.cid,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
