...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? author = null,Object? $unknown = freezed,}) {
  return _then(ThreadItemBlocked(
...
class _ThreadItemBlocked implements ThreadItemBlocked {
  const _ThreadItemBlocked({this.$type = 'app.bsky.unspecced.defs#threadItemBlocked', @BlockedAuthorConverter() required this.author,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
