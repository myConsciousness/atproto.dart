  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UThreadViewPostParent &&
...
class $UThreadViewPostParentCopyWith<$Res> {
  $UThreadViewPostParentCopyWith(
      UThreadViewPostParent _, $Res Function(UThreadViewPostParent) __);
}
...
extension UThreadViewPostParentPatterns on UThreadViewPostParent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UThreadViewPostParentNotFoundPost() when notFoundPost != null:
        return notFoundPost(_that);
      case UThreadViewPostParentBlockedPost() when blockedPost != null:
        return blockedPost(_that);
      case UThreadViewPostParentUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UThreadViewPostParentThreadViewPost():
        return threadViewPost(_that);
      case UThreadViewPostParentNotFoundPost():
        return notFoundPost(_that);
      case UThreadViewPostParentBlockedPost():
        return blockedPost(_that);
      case UThreadViewPostParentUnknown():
        return unknown(_that);
      case _:
...
class UThreadViewPostParentThreadViewPost extends UThreadViewPostParent {
  ...
  $UThreadViewPostParentThreadViewPostCopyWith<
          UThreadViewPostParentThreadViewPost>
      get copyWith => _$UThreadViewPostParentThreadViewPostCopyWithImpl<
          UThreadViewPostParentThreadViewPost>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UThreadViewPostParentThreadViewPost &&
...
/// @nodoc
abstract mixin class $UThreadViewPostParentThreadViewPostCopyWith<$Res>
    implements $UThreadViewPostParentCopyWith<$Res> {
  factory $UThreadViewPostParentThreadViewPostCopyWith(
          UThreadViewPostParentThreadViewPost value,
          $Res Function(UThreadViewPostParentThreadViewPost) _then) =
      _$UThreadViewPostParentThreadViewPostCopyWithImpl;
  @useResult
...
class UThreadViewPostParentNotFoundPost extends UThreadViewPostParent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UThreadViewPostParentNotFoundPostCopyWith<UThreadViewPostParentNotFoundPost>
      get copyWith => _$UThreadViewPostParentNotFoundPostCopyWithImpl<
          UThreadViewPostParentNotFoundPost>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UThreadViewPostParentNotFoundPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UThreadViewPostParentNotFoundPostCopyWith<$Res>
    implements $UThreadViewPostParentCopyWith<$Res> {
  factory $UThreadViewPostParentNotFoundPostCopyWith(
          UThreadViewPostParentNotFoundPost value,
          $Res Function(UThreadViewPostParentNotFoundPost) _then) =
      _$UThreadViewPostParentNotFoundPostCopyWithImpl;
  @useResult
...
class UThreadViewPostParentBlockedPost extends UThreadViewPostParent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UThreadViewPostParentBlockedPostCopyWith<UThreadViewPostParentBlockedPost>
      get copyWith => _$UThreadViewPostParentBlockedPostCopyWithImpl<
          UThreadViewPostParentBlockedPost>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UThreadViewPostParentBlockedPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UThreadViewPostParentBlockedPostCopyWith<$Res>
    implements $UThreadViewPostParentCopyWith<$Res> {
  factory $UThreadViewPostParentBlockedPostCopyWith(
          UThreadViewPostParentBlockedPost value,
          $Res Function(UThreadViewPostParentBlockedPost) _then) =
      _$UThreadViewPostParentBlockedPostCopyWithImpl;
  @useResult
...
class UThreadViewPostParentUnknown extends UThreadViewPostParent {
  const UThreadViewPostParentUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UThreadViewPostParentUnknownCopyWith<UThreadViewPostParentUnknown>
      get copyWith => _$UThreadViewPostParentUnknownCopyWithImpl<
          UThreadViewPostParentUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UThreadViewPostParentUnknown &&
...
/// @nodoc
abstract mixin class $UThreadViewPostParentUnknownCopyWith<$Res>
    implements $UThreadViewPostParentCopyWith<$Res> {
  factory $UThreadViewPostParentUnknownCopyWith(
          UThreadViewPostParentUnknown value,
          $Res Function(UThreadViewPostParentUnknown) _then) =
      _$UThreadViewPostParentUnknownCopyWithImpl;
  @useResult
