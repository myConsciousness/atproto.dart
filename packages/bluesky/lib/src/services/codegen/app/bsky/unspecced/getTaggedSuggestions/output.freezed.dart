...
mixin _$UnspeccedGetTaggedSuggestionsOutput {
  ...
  $UnspeccedGetTaggedSuggestionsOutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetTaggedSuggestionsOutputCopyWithImpl<
              UnspeccedGetTaggedSuggestionsOutput>(
          this as UnspeccedGetTaggedSuggestionsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetTaggedSuggestionsOutput &&
...
abstract mixin class $UnspeccedGetTaggedSuggestionsOutputCopyWith<$Res> {
  factory $UnspeccedGetTaggedSuggestionsOutputCopyWith(
          ...
          $Res Function(UnspeccedGetTaggedSuggestionsOutput) _then) =
      _$UnspeccedGetTaggedSuggestionsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension UnspeccedGetTaggedSuggestionsOutputPatterns
    on UnspeccedGetTaggedSuggestionsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetTaggedSuggestionsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@SuggestionConverter() List<Suggestion> suggestions,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetTaggedSuggestionsOutput() when $default != null:
        return $default(_that.suggestions, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetTaggedSuggestionsOutput
    implements UnspeccedGetTaggedSuggestionsOutput {
  const _UnspeccedGetTaggedSuggestionsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetTaggedSuggestionsOutputCopyWith<
          _UnspeccedGetTaggedSuggestionsOutput>
      get copyWith => __$UnspeccedGetTaggedSuggestionsOutputCopyWithImpl<
          _UnspeccedGetTaggedSuggestionsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetTaggedSuggestionsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetTaggedSuggestionsOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$UnspeccedGetTaggedSuggestionsOutputCopyWith<$Res>
    implements $UnspeccedGetTaggedSuggestionsOutputCopyWith<$Res> {
  factory _$UnspeccedGetTaggedSuggestionsOutputCopyWith(
          _UnspeccedGetTaggedSuggestionsOutput value,
          $Res Function(_UnspeccedGetTaggedSuggestionsOutput) _then) =
      __$UnspeccedGetTaggedSuggestionsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SuggestionConverter() List<Suggestion> suggestions,
