...
@pragma('vm:prefer-inline') @override $Res call({Object? suggestions = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetTaggedSuggestionsOutput(
...
class _UnspeccedGetTaggedSuggestionsOutput implements UnspeccedGetTaggedSuggestionsOutput {
  const _UnspeccedGetTaggedSuggestionsOutput({@SuggestionConverter() required  List<Suggestion> suggestions,  Map<String, dynamic>? $unknown}): _suggestions = suggestions,_$unknown = $unknown;
