...
@pragma('vm:prefer-inline') @override $Res call({Object? subject = null,Object? cursor = freezed,Object? follows = null,Object? $unknown = freezed,}) {
  return _then(GraphGetFollowsOutput(
...
class _GraphGetFollowsOutput implements GraphGetFollowsOutput {
  const _GraphGetFollowsOutput({@ProfileViewConverter() required this.subject, this.cursor, @ProfileViewConverter() required  List<ProfileView> follows,  Map<String, dynamic>? $unknown}): _follows = follows,_$unknown = $unknown;
