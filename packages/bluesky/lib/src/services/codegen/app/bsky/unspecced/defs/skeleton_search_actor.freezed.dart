...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? did = null,Object? $unknown = freezed,}) {
  return _then(SkeletonSearchActor(
...
class _SkeletonSearchActor implements SkeletonSearchActor {
  const _SkeletonSearchActor({this.$type = 'app.bsky.unspecced.defs#skeletonSearchActor', required this.did,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
