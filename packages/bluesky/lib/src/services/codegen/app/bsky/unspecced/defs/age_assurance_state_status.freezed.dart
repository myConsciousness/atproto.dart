  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AgeAssuranceStateStatus &&
...
class $AgeAssuranceStateStatusCopyWith<$Res> {
  $AgeAssuranceStateStatusCopyWith(
      AgeAssuranceStateStatus _, $Res Function(AgeAssuranceStateStatus) __);
}
...
extension AgeAssuranceStateStatusPatterns on AgeAssuranceStateStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case AgeAssuranceStateStatusUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case AgeAssuranceStateStatusKnownValue():
        return knownValue(_that);
      case AgeAssuranceStateStatusUnknown():
        return unknown(_that);
      case _:
...
class AgeAssuranceStateStatusKnownValue extends AgeAssuranceStateStatus {
  ...
  $AgeAssuranceStateStatusKnownValueCopyWith<AgeAssuranceStateStatusKnownValue>
      get copyWith => _$AgeAssuranceStateStatusKnownValueCopyWithImpl<
          AgeAssuranceStateStatusKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AgeAssuranceStateStatusKnownValue &&
...
/// @nodoc
abstract mixin class $AgeAssuranceStateStatusKnownValueCopyWith<$Res>
    implements $AgeAssuranceStateStatusCopyWith<$Res> {
  factory $AgeAssuranceStateStatusKnownValueCopyWith(
          AgeAssuranceStateStatusKnownValue value,
          $Res Function(AgeAssuranceStateStatusKnownValue) _then) =
      _$AgeAssuranceStateStatusKnownValueCopyWithImpl;
  @useResult
...
class AgeAssuranceStateStatusUnknown extends AgeAssuranceStateStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AgeAssuranceStateStatusUnknownCopyWith<AgeAssuranceStateStatusUnknown>
      get copyWith => _$AgeAssuranceStateStatusUnknownCopyWithImpl<
          AgeAssuranceStateStatusUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AgeAssuranceStateStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $AgeAssuranceStateStatusUnknownCopyWith<$Res>
    implements $AgeAssuranceStateStatusCopyWith<$Res> {
  factory $AgeAssuranceStateStatusUnknownCopyWith(
          AgeAssuranceStateStatusUnknown value,
          $Res Function(AgeAssuranceStateStatusUnknown) _then) =
      _$AgeAssuranceStateStatusUnknownCopyWithImpl;
  @useResult
