...
mixin _$GraphGetStarterPackOutput {
  ...
  $GraphGetStarterPackOutputCopyWith<GraphGetStarterPackOutput> get copyWith =>
      _$GraphGetStarterPackOutputCopyWithImpl<GraphGetStarterPackOutput>(
          this as GraphGetStarterPackOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetStarterPackOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, starterPack, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $GraphGetStarterPackOutputCopyWith<$Res> {
  factory $GraphGetStarterPackOutputCopyWith(GraphGetStarterPackOutput value,
          $Res Function(GraphGetStarterPackOutput) _then) =
      _$GraphGetStarterPackOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetStarterPackOutputPatterns on GraphGetStarterPackOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetStarterPackOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@StarterPackViewConverter() StarterPackView starterPack,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _GraphGetStarterPackOutput() when $default != null:
        return $default(_that.starterPack, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphGetStarterPackOutput implements GraphGetStarterPackOutput {
  const _GraphGetStarterPackOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetStarterPackOutputCopyWith<_GraphGetStarterPackOutput>
      get copyWith =>
          __$GraphGetStarterPackOutputCopyWithImpl<_GraphGetStarterPackOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetStarterPackOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetStarterPackOutput &&
            (identical(other.starterPack, starterPack) ||
                other.starterPack == starterPack) &&
...
/// @nodoc
abstract mixin class _$GraphGetStarterPackOutputCopyWith<$Res>
    implements $GraphGetStarterPackOutputCopyWith<$Res> {
  factory _$GraphGetStarterPackOutputCopyWith(_GraphGetStarterPackOutput value,
          $Res Function(_GraphGetStarterPackOutput) _then) =
      __$GraphGetStarterPackOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@StarterPackViewConverter() StarterPackView starterPack,
