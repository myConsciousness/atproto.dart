...
@pragma('vm:prefer-inline') @override $Res call({Object? starterPack = null,Object? $unknown = freezed,}) {
  return _then(GraphGetStarterPackOutput(
...
class _GraphGetStarterPackOutput implements GraphGetStarterPackOutput {
  const _GraphGetStarterPackOutput({@StarterPackViewConverter() required this.starterPack,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
