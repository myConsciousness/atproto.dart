...
mixin _$GraphGetRelationshipsOutput {
  ...
  $GraphGetRelationshipsOutputCopyWith<GraphGetRelationshipsOutput>
      get copyWith => _$GraphGetRelationshipsOutputCopyWithImpl<
              GraphGetRelationshipsOutput>(
          this as GraphGetRelationshipsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetRelationshipsOutput &&
...
abstract mixin class $GraphGetRelationshipsOutputCopyWith<$Res> {
  factory $GraphGetRelationshipsOutputCopyWith(
          ...
          $Res Function(GraphGetRelationshipsOutput) _then) =
      _$GraphGetRelationshipsOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? actor,
      @UGraphGetRelationshipsRelationshipsConverter()
...
extension GraphGetRelationshipsOutputPatterns on GraphGetRelationshipsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetRelationshipsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _GraphGetRelationshipsOutput() when $default != null:
        return $default(_that.actor, _that.relationships, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphGetRelationshipsOutput implements GraphGetRelationshipsOutput {
  const _GraphGetRelationshipsOutput(
      {this.actor,
      @UGraphGetRelationshipsRelationshipsConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetRelationshipsOutputCopyWith<_GraphGetRelationshipsOutput>
      get copyWith => __$GraphGetRelationshipsOutputCopyWithImpl<
          _GraphGetRelationshipsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetRelationshipsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetRelationshipsOutput &&
            (identical(other.actor, actor) || other.actor == actor) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$GraphGetRelationshipsOutputCopyWith<$Res>
    implements $GraphGetRelationshipsOutputCopyWith<$Res> {
  factory _$GraphGetRelationshipsOutputCopyWith(
          _GraphGetRelationshipsOutput value,
          $Res Function(_GraphGetRelationshipsOutput) _then) =
      __$GraphGetRelationshipsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? actor,
