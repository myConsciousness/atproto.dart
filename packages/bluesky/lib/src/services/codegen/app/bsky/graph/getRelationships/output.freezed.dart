...
@pragma('vm:prefer-inline') @override $Res call({Object? actor = freezed,Object? relationships = null,Object? $unknown = freezed,}) {
  return _then(GraphGetRelationshipsOutput(
...
class _GraphGetRelationshipsOutput implements GraphGetRelationshipsOutput {
  const _GraphGetRelationshipsOutput({this.actor, @UGraphGetRelationshipsRelationshipsConverter() required  List<UGraphGetRelationshipsRelationships> relationships,  Map<String, dynamic>? $unknown}): _relationships = relationships,_$unknown = $unknown;
