...
mixin _$LabelerServiceRecord {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.reasonTypes, reasonTypes) &&
            const DeepCollectionEquality()
                .equals(other.subjectTypes, subjectTypes) &&
            const DeepCollectionEquality()
                .equals(other.subjectCollections, subjectCollections) &&
  ...
  int get hashCode => Object.hash(
      ...
      labels,
      createdAt,
      const DeepCollectionEquality().hash(reasonTypes),
      const DeepCollectionEquality().hash(subjectTypes),
      const DeepCollectionEquality().hash(subjectCollections),
...
extension LabelerServiceRecordPatterns on LabelerServiceRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LabelerServiceRecord value)? $default, {
