...
class _KnownFollowers implements KnownFollowers {
  const _KnownFollowers({this.$type = 'app.bsky.actor.defs#knownFollowers', required this.count, @ProfileViewBasicConverter() required  List<ProfileViewBasic> followers,  Map<String, dynamic>? $unknown}): _followers = followers,_$unknown = $unknown;
