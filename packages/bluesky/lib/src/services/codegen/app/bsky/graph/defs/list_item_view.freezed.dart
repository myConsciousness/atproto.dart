...
class _ListItemView implements ListItemView {
  const _ListItemView({this.$type = 'app.bsky.graph.defs#listItemView', @AtUriConverter() required this.uri, @ProfileViewConverter() required this.subject,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
