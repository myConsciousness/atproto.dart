...
@pragma('vm:prefer-inline') @override $Res call({Object? starterPacks = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetSuggestedStarterPacksSkeletonOutput(
...
class _UnspeccedGetSuggestedStarterPacksSkeletonOutput implements UnspeccedGetSuggestedStarterPacksSkeletonOutput {
  const _UnspeccedGetSuggestedStarterPacksSkeletonOutput({@AtUriConverter() required  List<AtUri> starterPacks,  Map<String, dynamic>? $unknown}): _starterPacks = starterPacks,_$unknown = $unknown;
