...
class _LabelerPolicies implements LabelerPolicies {
  const _LabelerPolicies({this.$type = 'app.bsky.labeler.defs#labelerPolicies', @LabelValueConverter() required  List<LabelValue> labelValues, @LabelValueDefinitionConverter()  List<LabelValueDefinition>? labelValueDefinitions,  Map<String, dynamic>? $unknown}): _labelValues = labelValues,_labelValueDefinitions = labelValueDefinitions,_$unknown = $unknown;
