...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? age = null,Object? access = null,Object? $unknown = freezed,}) {
  return _then(ConfigRegionRuleIfAssuredOverAge(
...
class _ConfigRegionRuleIfAssuredOverAge implements ConfigRegionRuleIfAssuredOverAge {
  const _ConfigRegionRuleIfAssuredOverAge({this.$type = 'app.bsky.ageassurance.defs#configRegionRuleIfAssuredOverAge', required this.age, @AccessConverter() required this.access,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
