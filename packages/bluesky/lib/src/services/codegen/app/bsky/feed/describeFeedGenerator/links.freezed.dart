...
mixin _$Links {
  ...
  int get hashCode => Object.hash(runtimeType, $type, privacyPolicy,
      termsOfService, const DeepCollectionEquality().hash($unknown));
...
extension LinksPatterns on Links {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Links value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String? privacyPolicy,
            String? termsOfService, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Links() when $default != null:
        return $default(_that.$type, _that.privacyPolicy, _that.termsOfService,
            _that.$unknown);
      case _:
        return orElse();
    }
