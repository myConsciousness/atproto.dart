...
mixin _$GraphStarterpackRecord {
  ...
  $GraphStarterpackRecordCopyWith<GraphStarterpackRecord> get copyWith =>
      _$GraphStarterpackRecordCopyWithImpl<GraphStarterpackRecord>(
          this as GraphStarterpackRecord, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphStarterpackRecord &&
...
abstract mixin class $GraphStarterpackRecordCopyWith<$Res> {
  factory $GraphStarterpackRecordCopyWith(GraphStarterpackRecord value,
          $Res Function(GraphStarterpackRecord) _then) =
      _$GraphStarterpackRecordCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String name,
...
extension GraphStarterpackRecordPatterns on GraphStarterpackRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphStarterpackRecord value)? $default, {
...
class _GraphStarterpackRecord implements GraphStarterpackRecord {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphStarterpackRecordCopyWith<_GraphStarterpackRecord> get copyWith =>
      __$GraphStarterpackRecordCopyWithImpl<_GraphStarterpackRecord>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphStarterpackRecordToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphStarterpackRecord &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
...
/// @nodoc
abstract mixin class _$GraphStarterpackRecordCopyWith<$Res>
    implements $GraphStarterpackRecordCopyWith<$Res> {
  factory _$GraphStarterpackRecordCopyWith(_GraphStarterpackRecord value,
          $Res Function(_GraphStarterpackRecord) _then) =
      __$GraphStarterpackRecordCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
