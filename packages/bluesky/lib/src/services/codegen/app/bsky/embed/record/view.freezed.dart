...
class _EmbedRecordView implements EmbedRecordView {
  const _EmbedRecordView({this.$type = 'app.bsky.embed.record#view', @UEmbedRecordViewRecordConverter() required this.record,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
