...
class _ThreadItemPost implements ThreadItemPost {
  const _ThreadItemPost({this.$type = 'app.bsky.unspecced.defs#threadItemPost', @PostViewConverter() required this.post, required this.moreParents, required this.moreReplies, required this.opThread, required this.hiddenByThreadgate, required this.mutedByViewer,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
