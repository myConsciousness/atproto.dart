...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? $unknown = freezed,}) {
  return _then(DraftEmbedExternal(
...
class _DraftEmbedExternal implements DraftEmbedExternal {
  const _DraftEmbedExternal({this.$type = 'app.bsky.draft.defs#draftEmbedExternal', required this.uri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
