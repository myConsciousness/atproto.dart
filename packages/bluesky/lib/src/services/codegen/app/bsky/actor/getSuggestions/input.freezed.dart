...
mixin _$ActorGetSuggestionsInput {
  ...
  $ActorGetSuggestionsInputCopyWith<ActorGetSuggestionsInput> get copyWith =>
      _$ActorGetSuggestionsInputCopyWithImpl<ActorGetSuggestionsInput>(
          this as ActorGetSuggestionsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorGetSuggestionsInput &&
...
abstract mixin class $ActorGetSuggestionsInputCopyWith<$Res> {
  factory $ActorGetSuggestionsInputCopyWith(ActorGetSuggestionsInput value,
          $Res Function(ActorGetSuggestionsInput) _then) =
      _$ActorGetSuggestionsInputCopyWithImpl;
  @useResult
...
extension ActorGetSuggestionsInputPatterns on ActorGetSuggestionsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorGetSuggestionsInput value)? $default, {
...
class _ActorGetSuggestionsInput implements ActorGetSuggestionsInput {
  const _ActorGetSuggestionsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorGetSuggestionsInputCopyWith<_ActorGetSuggestionsInput> get copyWith =>
      __$ActorGetSuggestionsInputCopyWithImpl<_ActorGetSuggestionsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorGetSuggestionsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorGetSuggestionsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$ActorGetSuggestionsInputCopyWith<$Res>
    implements $ActorGetSuggestionsInputCopyWith<$Res> {
  factory _$ActorGetSuggestionsInputCopyWith(_ActorGetSuggestionsInput value,
          $Res Function(_ActorGetSuggestionsInput) _then) =
      __$ActorGetSuggestionsInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
