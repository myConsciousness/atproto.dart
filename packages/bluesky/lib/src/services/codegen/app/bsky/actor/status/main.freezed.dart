...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? status = null,Object? embed = freezed,Object? durationMinutes = freezed,Object? createdAt = null,Object? $unknown = freezed,}) {
  return _then(ActorStatusRecord(
...
class _ActorStatusRecord implements ActorStatusRecord {
  const _ActorStatusRecord({this.$type = 'app.bsky.actor.status', @ActorStatusStatusConverter() required this.status, @UActorStatusEmbedConverter() this.embed, this.durationMinutes, @JsonKey(toJson: iso8601) required this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
