...
mixin _$NotificationListNotificationsInput {
  ...
  $NotificationListNotificationsInputCopyWith<
      ...
      get copyWith => _$NotificationListNotificationsInputCopyWithImpl<
              NotificationListNotificationsInput>(
          this as NotificationListNotificationsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationListNotificationsInput &&
...
abstract mixin class $NotificationListNotificationsInputCopyWith<$Res> {
  factory $NotificationListNotificationsInputCopyWith(
          ...
          $Res Function(NotificationListNotificationsInput) _then) =
      _$NotificationListNotificationsInputCopyWithImpl;
  @useResult
  $Res call(
      {List<String>? reasons,
      int limit,
...
extension NotificationListNotificationsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationListNotificationsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String>? reasons, int limit, bool? priority,
            String? cursor, DateTime? seenAt, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NotificationListNotificationsInput() when $default != null:
        return $default(_that.reasons, _that.limit, _that.priority,
            _that.cursor, _that.seenAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationListNotificationsInput
    implements NotificationListNotificationsInput {
  const _NotificationListNotificationsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationListNotificationsInputCopyWith<
          _NotificationListNotificationsInput>
      get copyWith => __$NotificationListNotificationsInputCopyWithImpl<
          _NotificationListNotificationsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationListNotificationsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationListNotificationsInput &&
...
/// @nodoc
abstract mixin class _$NotificationListNotificationsInputCopyWith<$Res>
    implements $NotificationListNotificationsInputCopyWith<$Res> {
  factory _$NotificationListNotificationsInputCopyWith(
          _NotificationListNotificationsInput value,
          $Res Function(_NotificationListNotificationsInput) _then) =
      __$NotificationListNotificationsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String>? reasons,
