...
class _DraftWithId implements DraftWithId {
  const _DraftWithId({this.$type = 'app.bsky.draft.defs#draftWithId', required this.id, @DraftConverter() required this.draft,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
