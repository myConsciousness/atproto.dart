...
mixin _$NotificationGetUnreadCountOutput {
  ...
  $NotificationGetUnreadCountOutputCopyWith<NotificationGetUnreadCountOutput>
      get copyWith => _$NotificationGetUnreadCountOutputCopyWithImpl<
              NotificationGetUnreadCountOutput>(
          this as NotificationGetUnreadCountOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationGetUnreadCountOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, count, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $NotificationGetUnreadCountOutputCopyWith<$Res> {
  factory $NotificationGetUnreadCountOutputCopyWith(
          ...
          $Res Function(NotificationGetUnreadCountOutput) _then) =
      _$NotificationGetUnreadCountOutputCopyWithImpl;
  @useResult
...
extension NotificationGetUnreadCountOutputPatterns
    on NotificationGetUnreadCountOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationGetUnreadCountOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int count, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NotificationGetUnreadCountOutput() when $default != null:
        return $default(_that.count, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationGetUnreadCountOutput
    implements NotificationGetUnreadCountOutput {
  const _NotificationGetUnreadCountOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationGetUnreadCountOutputCopyWith<_NotificationGetUnreadCountOutput>
      get copyWith => __$NotificationGetUnreadCountOutputCopyWithImpl<
          _NotificationGetUnreadCountOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationGetUnreadCountOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationGetUnreadCountOutput &&
            (identical(other.count, count) || other.count == count) &&
...
/// @nodoc
abstract mixin class _$NotificationGetUnreadCountOutputCopyWith<$Res>
    implements $NotificationGetUnreadCountOutputCopyWith<$Res> {
  factory _$NotificationGetUnreadCountOutputCopyWith(
          _NotificationGetUnreadCountOutput value,
          $Res Function(_NotificationGetUnreadCountOutput) _then) =
      __$NotificationGetUnreadCountOutputCopyWithImpl;
  @override
  @useResult
  $Res call({int count, Map<String, dynamic>? $unknown});
}
