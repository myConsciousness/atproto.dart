...
@pragma('vm:prefer-inline') @override $Res call({Object? matchesAndContactIndexes = null,Object? $unknown = freezed,}) {
  return _then(ContactImportContactsOutput(
...
class _ContactImportContactsOutput implements ContactImportContactsOutput {
  const _ContactImportContactsOutput({@MatchAndContactIndexConverter() required  List<MatchAndContactIndex> matchesAndContactIndexes,  Map<String, dynamic>? $unknown}): _matchesAndContactIndexes = matchesAndContactIndexes,_$unknown = $unknown;
