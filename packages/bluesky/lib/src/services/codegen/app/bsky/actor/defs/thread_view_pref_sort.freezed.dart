...
class $ThreadViewPrefSortCopyWith<$Res> {
  $ThreadViewPrefSortCopyWith(
      ThreadViewPrefSort _, $Res Function(ThreadViewPrefSort) __);
}
...
extension ThreadViewPrefSortPatterns on ThreadViewPrefSort {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ThreadViewPrefSortUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ThreadViewPrefSortKnownValue():
        return knownValue(_that);
      case ThreadViewPrefSortUnknown():
        return unknown(_that);
      case _:
...
class ThreadViewPrefSortKnownValue extends ThreadViewPrefSort {
  ...
  $ThreadViewPrefSortKnownValueCopyWith<ThreadViewPrefSortKnownValue>
      get copyWith => _$ThreadViewPrefSortKnownValueCopyWithImpl<
          ThreadViewPrefSortKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ThreadViewPrefSortKnownValue &&
...
/// @nodoc
abstract mixin class $ThreadViewPrefSortKnownValueCopyWith<$Res>
    implements $ThreadViewPrefSortCopyWith<$Res> {
  factory $ThreadViewPrefSortKnownValueCopyWith(
          ThreadViewPrefSortKnownValue value,
          $Res Function(ThreadViewPrefSortKnownValue) _then) =
      _$ThreadViewPrefSortKnownValueCopyWithImpl;
  @useResult
...
class ThreadViewPrefSortUnknown extends ThreadViewPrefSort {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ThreadViewPrefSortUnknownCopyWith<ThreadViewPrefSortUnknown> get copyWith =>
      _$ThreadViewPrefSortUnknownCopyWithImpl<ThreadViewPrefSortUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ThreadViewPrefSortUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ThreadViewPrefSortUnknownCopyWith<$Res>
    implements $ThreadViewPrefSortCopyWith<$Res> {
  factory $ThreadViewPrefSortUnknownCopyWith(ThreadViewPrefSortUnknown value,
          $Res Function(ThreadViewPrefSortUnknown) _then) =
      _$ThreadViewPrefSortUnknownCopyWithImpl;
  @useResult
