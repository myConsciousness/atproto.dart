...
mixin _$FeedSendInteractionsInput {
  ...
  $FeedSendInteractionsInputCopyWith<FeedSendInteractionsInput> get copyWith =>
      _$FeedSendInteractionsInputCopyWithImpl<FeedSendInteractionsInput>(
          this as FeedSendInteractionsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedSendInteractionsInput &&
...
abstract mixin class $FeedSendInteractionsInputCopyWith<$Res> {
  factory $FeedSendInteractionsInputCopyWith(FeedSendInteractionsInput value,
          $Res Function(FeedSendInteractionsInput) _then) =
      _$FeedSendInteractionsInputCopyWithImpl;
  @useResult
  $Res call(
...
extension FeedSendInteractionsInputPatterns on FeedSendInteractionsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedSendInteractionsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@InteractionConverter() List<Interaction> interactions,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _FeedSendInteractionsInput() when $default != null:
        return $default(_that.interactions, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedSendInteractionsInput implements FeedSendInteractionsInput {
  const _FeedSendInteractionsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedSendInteractionsInputCopyWith<_FeedSendInteractionsInput>
      get copyWith =>
          __$FeedSendInteractionsInputCopyWithImpl<_FeedSendInteractionsInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedSendInteractionsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedSendInteractionsInput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$FeedSendInteractionsInputCopyWith<$Res>
    implements $FeedSendInteractionsInputCopyWith<$Res> {
  factory _$FeedSendInteractionsInputCopyWith(_FeedSendInteractionsInput value,
          $Res Function(_FeedSendInteractionsInput) _then) =
      __$FeedSendInteractionsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@InteractionConverter() List<Interaction> interactions,
