...
class _ListViewBasic implements ListViewBasic {
  const _ListViewBasic({this.$type = 'app.bsky.graph.defs#listViewBasic', @AtUriConverter() required this.uri, required this.cid, required this.name, @ListPurposeConverter() required this.purpose, this.avatar, this.listItemCount, @LabelConverter()  List<Label>? labels, @ListViewerStateConverter() this.viewer, @JsonKey(toJson: iso8601) this.indexedAt,  Map<String, dynamic>? $unknown}): _labels = labels,_$unknown = $unknown;
