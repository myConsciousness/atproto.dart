...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? starterPack = null,Object? listItem = freezed,Object? $unknown = freezed,}) {
  return _then(StarterPackWithMembership(
...
class _StarterPackWithMembership implements StarterPackWithMembership {
  const _StarterPackWithMembership({this.$type = 'app.bsky.graph.getStarterPacksWithMembership#starterPackWithMembership', @StarterPackViewConverter() required this.starterPack, @ListItemViewConverter() this.listItem,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
