...
extension ThreadContextPatterns on ThreadContext {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ThreadContext value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String? rootAuthorLike,
    ...
    switch (_that) {
      case _ThreadContext() when $default != null:
        return $default(_that.$type, _that.rootAuthorLike, _that.$unknown);
      case _:
        return orElse();
    }
  }
