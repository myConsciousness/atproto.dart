...
mixin _$GraphSearchStarterPacksInput {
  ...
  $GraphSearchStarterPacksInputCopyWith<GraphSearchStarterPacksInput>
      get copyWith => _$GraphSearchStarterPacksInputCopyWithImpl<
              GraphSearchStarterPacksInput>(
          this as GraphSearchStarterPacksInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphSearchStarterPacksInput &&
...
abstract mixin class $GraphSearchStarterPacksInputCopyWith<$Res> {
  factory $GraphSearchStarterPacksInputCopyWith(
          ...
          $Res Function(GraphSearchStarterPacksInput) _then) =
      _$GraphSearchStarterPacksInputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphSearchStarterPacksInputPatterns on GraphSearchStarterPacksInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphSearchStarterPacksInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String q, int limit, String? cursor,
    ...
    switch (_that) {
      case _GraphSearchStarterPacksInput() when $default != null:
        return $default(_that.q, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphSearchStarterPacksInput implements GraphSearchStarterPacksInput {
  const _GraphSearchStarterPacksInput(
      {required this.q,
      this.limit = 25,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphSearchStarterPacksInputCopyWith<_GraphSearchStarterPacksInput>
      get copyWith => __$GraphSearchStarterPacksInputCopyWithImpl<
          _GraphSearchStarterPacksInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphSearchStarterPacksInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphSearchStarterPacksInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphSearchStarterPacksInputCopyWith<$Res>
    implements $GraphSearchStarterPacksInputCopyWith<$Res> {
  factory _$GraphSearchStarterPacksInputCopyWith(
          _GraphSearchStarterPacksInput value,
          $Res Function(_GraphSearchStarterPacksInput) _then) =
      __$GraphSearchStarterPacksInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String q, int limit, String? cursor, Map<String, dynamic>? $unknown});
