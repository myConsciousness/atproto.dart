...
mixin _$VideoUploadVideoOutput {
  ...
  $VideoUploadVideoOutputCopyWith<VideoUploadVideoOutput> get copyWith =>
      _$VideoUploadVideoOutputCopyWithImpl<VideoUploadVideoOutput>(
          this as VideoUploadVideoOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VideoUploadVideoOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, jobStatus, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $VideoUploadVideoOutputCopyWith<$Res> {
  factory $VideoUploadVideoOutputCopyWith(VideoUploadVideoOutput value,
          $Res Function(VideoUploadVideoOutput) _then) =
      _$VideoUploadVideoOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension VideoUploadVideoOutputPatterns on VideoUploadVideoOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VideoUploadVideoOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JobStatusConverter() JobStatus jobStatus,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _VideoUploadVideoOutput() when $default != null:
        return $default(_that.jobStatus, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _VideoUploadVideoOutput implements VideoUploadVideoOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VideoUploadVideoOutputCopyWith<_VideoUploadVideoOutput> get copyWith =>
      __$VideoUploadVideoOutputCopyWithImpl<_VideoUploadVideoOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VideoUploadVideoOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VideoUploadVideoOutput &&
            (identical(other.jobStatus, jobStatus) ||
                other.jobStatus == jobStatus) &&
...
/// @nodoc
abstract mixin class _$VideoUploadVideoOutputCopyWith<$Res>
    implements $VideoUploadVideoOutputCopyWith<$Res> {
  factory _$VideoUploadVideoOutputCopyWith(_VideoUploadVideoOutput value,
          $Res Function(_VideoUploadVideoOutput) _then) =
      __$VideoUploadVideoOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JobStatusConverter() JobStatus jobStatus,
