...
mixin _$Relationship {
  ...
  int get hashCode => Object.hash(runtimeType, $type, did, following,
      followedBy, const DeepCollectionEquality().hash($unknown));
...
extension RelationshipPatterns on Relationship {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String did, String? following,
            String? followedBy, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Relationship() when $default != null:
        return $default(_that.$type, _that.did, _that.following,
            _that.followedBy, _that.$unknown);
      case _:
        return orElse();
    }
  }
