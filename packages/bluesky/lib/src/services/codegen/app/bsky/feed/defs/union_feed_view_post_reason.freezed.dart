...
class $UFeedViewPostReasonCopyWith<$Res> {
  $UFeedViewPostReasonCopyWith(
      UFeedViewPostReason _, $Res Function(UFeedViewPostReason) __);
}
...
extension UFeedViewPostReasonPatterns on UFeedViewPostReason {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(UFeedViewPostReasonReasonPin value)? reasonPin,
    ...
    switch (_that) {
      case UFeedViewPostReasonReasonRepost() when reasonRepost != null:
        return reasonRepost(_that);
      case UFeedViewPostReasonReasonPin() when reasonPin != null:
        return reasonPin(_that);
      case UFeedViewPostReasonUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(UFeedViewPostReasonReasonRepost value)
        reasonRepost,
    required TResult Function(UFeedViewPostReasonReasonPin value) reasonPin,
    ...
    switch (_that) {
      case UFeedViewPostReasonReasonRepost():
        return reasonRepost(_that);
      case UFeedViewPostReasonReasonPin():
        return reasonPin(_that);
      case UFeedViewPostReasonUnknown():
        return unknown(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(ReasonPin data)? reasonPin,
    ...
    switch (_that) {
      case UFeedViewPostReasonReasonRepost() when reasonRepost != null:
        return reasonRepost(_that.data);
      case UFeedViewPostReasonReasonPin() when reasonPin != null:
        return reasonPin(_that.data);
      case UFeedViewPostReasonUnknown() when unknown != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ReasonPin data) reasonPin,
...
class UFeedViewPostReasonReasonRepost extends UFeedViewPostReason {
  ...
  $UFeedViewPostReasonReasonRepostCopyWith<UFeedViewPostReasonReasonRepost>
      get copyWith => _$UFeedViewPostReasonReasonRepostCopyWithImpl<
          UFeedViewPostReasonReasonRepost>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UFeedViewPostReasonReasonRepost &&
...
/// @nodoc
abstract mixin class $UFeedViewPostReasonReasonRepostCopyWith<$Res>
    implements $UFeedViewPostReasonCopyWith<$Res> {
  factory $UFeedViewPostReasonReasonRepostCopyWith(
          UFeedViewPostReasonReasonRepost value,
          $Res Function(UFeedViewPostReasonReasonRepost) _then) =
      _$UFeedViewPostReasonReasonRepostCopyWithImpl;
  @useResult
...
class UFeedViewPostReasonReasonPin extends UFeedViewPostReason {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UFeedViewPostReasonReasonPinCopyWith<UFeedViewPostReasonReasonPin>
      get copyWith => _$UFeedViewPostReasonReasonPinCopyWithImpl<
          UFeedViewPostReasonReasonPin>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UFeedViewPostReasonReasonPin &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UFeedViewPostReasonReasonPinCopyWith<$Res>
    implements $UFeedViewPostReasonCopyWith<$Res> {
  factory $UFeedViewPostReasonReasonPinCopyWith(
          UFeedViewPostReasonReasonPin value,
          $Res Function(UFeedViewPostReasonReasonPin) _then) =
      _$UFeedViewPostReasonReasonPinCopyWithImpl;
  @useResult
...
class UFeedViewPostReasonUnknown extends UFeedViewPostReason {
  const UFeedViewPostReasonUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UFeedViewPostReasonUnknownCopyWith<UFeedViewPostReasonUnknown>
      get copyWith =>
          _$UFeedViewPostReasonUnknownCopyWithImpl<UFeedViewPostReasonUnknown>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UFeedViewPostReasonUnknown &&
...
/// @nodoc
abstract mixin class $UFeedViewPostReasonUnknownCopyWith<$Res>
    implements $UFeedViewPostReasonCopyWith<$Res> {
  factory $UFeedViewPostReasonUnknownCopyWith(UFeedViewPostReasonUnknown value,
          $Res Function(UFeedViewPostReasonUnknown) _then) =
      _$UFeedViewPostReasonUnknownCopyWithImpl;
  @useResult
