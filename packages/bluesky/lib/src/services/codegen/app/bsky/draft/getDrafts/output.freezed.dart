...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? drafts = null,Object? $unknown = freezed,}) {
  return _then(DraftGetDraftsOutput(
...
class _DraftGetDraftsOutput implements DraftGetDraftsOutput {
  const _DraftGetDraftsOutput({this.cursor, @DraftViewConverter() required  List<DraftView> drafts,  Map<String, dynamic>? $unknown}): _drafts = drafts,_$unknown = $unknown;
