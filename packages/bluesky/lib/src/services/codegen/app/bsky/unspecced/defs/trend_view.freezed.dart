...
mixin _$TrendView {
 ...
 String get $type; String get topic; String get displayName; String? get description; String get link;@JsonKey(toJson: iso8601) DateTime get startedAt; int get postCount;@TrendViewStatusConverter() TrendViewStatus? get status; String? get category;@ProfileViewBasicConverter() List<ProfileViewBasic> get actors; Map<String, dynamic>? get $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,topic,displayName,description,link,startedAt,postCount,status,category,const DeepCollectionEquality().hash(actors),const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type, String topic, String displayName, String? description, String link,@JsonKey(toJson: iso8601) DateTime startedAt, int postCount,@TrendViewStatusConverter() TrendViewStatus? status, String? category,@ProfileViewBasicConverter() List<ProfileViewBasic> actors, Map<String, dynamic>? $unknown
});
...
/// Create a copy of TrendView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? topic = null,Object? displayName = null,Object? description = freezed,Object? link = null,Object? startedAt = null,Object? postCount = null,Object? status = freezed,Object? category = freezed,Object? actors = null,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String topic,  String displayName,  String? description,  String link, @JsonKey(toJson: iso8601)  DateTime startedAt,  int postCount, @TrendViewStatusConverter()  TrendViewStatus? status,  String? category, @ProfileViewBasicConverter()  List<ProfileViewBasic> actors,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrendView() when $default != null:
return $default(_that.$type,_that.topic,_that.displayName,_that.description,_that.link,_that.startedAt,_that.postCount,_that.status,_that.category,_that.actors,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String topic,  String displayName,  String? description,  String link, @JsonKey(toJson: iso8601)  DateTime startedAt,  int postCount, @TrendViewStatusConverter()  TrendViewStatus? status,  String? category, @ProfileViewBasicConverter()  List<ProfileViewBasic> actors,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _TrendView():
return $default(_that.$type,_that.topic,_that.displayName,_that.description,_that.link,_that.startedAt,_that.postCount,_that.status,_that.category,_that.actors,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String topic,  String displayName,  String? description,  String link, @JsonKey(toJson: iso8601)  DateTime startedAt,  int postCount, @TrendViewStatusConverter()  TrendViewStatus? status,  String? category, @ProfileViewBasicConverter()  List<ProfileViewBasic> actors,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _TrendView() when $default != null:
return $default(_that.$type,_that.topic,_that.displayName,_that.description,_that.link,_that.startedAt,_that.postCount,_that.status,_that.category,_that.actors,_that.$unknown);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,topic,displayName,description,link,startedAt,postCount,status,category,const DeepCollectionEquality().hash(_actors),const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of TrendView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? topic = null,Object? displayName = null,Object? description = freezed,Object? link = null,Object? startedAt = null,Object? postCount = null,Object? status = freezed,Object? category = freezed,Object? actors = null,Object? $unknown = freezed,}) {
