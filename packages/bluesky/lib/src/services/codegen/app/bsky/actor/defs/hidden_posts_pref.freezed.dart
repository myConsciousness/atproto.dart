...
class _HiddenPostsPref implements HiddenPostsPref {
  const _HiddenPostsPref({this.$type = 'app.bsky.actor.defs#hiddenPostsPref', @AtUriConverter() required  List<AtUri> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
