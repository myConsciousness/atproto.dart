...
mixin _$UnspeccedSearchStarterPacksSkeletonInput {
  ...
  $UnspeccedSearchStarterPacksSkeletonInputCopyWith<
      ...
      get copyWith => _$UnspeccedSearchStarterPacksSkeletonInputCopyWithImpl<
              UnspeccedSearchStarterPacksSkeletonInput>(
          this as UnspeccedSearchStarterPacksSkeletonInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedSearchStarterPacksSkeletonInput &&
...
abstract mixin class $UnspeccedSearchStarterPacksSkeletonInputCopyWith<$Res> {
  factory $UnspeccedSearchStarterPacksSkeletonInputCopyWith(
          ...
          $Res Function(UnspeccedSearchStarterPacksSkeletonInput) _then) =
...
extension UnspeccedSearchStarterPacksSkeletonInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedSearchStarterPacksSkeletonInput value)?
        $default, {
  ...
  TResult map<TResult extends Object?>(
    TResult Function(_UnspeccedSearchStarterPacksSkeletonInput value) $default,
  ) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String q, String? viewer, int limit, String? cursor,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedSearchStarterPacksSkeletonInput() when $default != null:
        return $default(
            _that.q, _that.viewer, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedSearchStarterPacksSkeletonInput
    implements UnspeccedSearchStarterPacksSkeletonInput {
  const _UnspeccedSearchStarterPacksSkeletonInput(
      {required this.q,
      this.viewer,
      this.limit = 25,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedSearchStarterPacksSkeletonInputCopyWith<
          _UnspeccedSearchStarterPacksSkeletonInput>
      get copyWith => __$UnspeccedSearchStarterPacksSkeletonInputCopyWithImpl<
          _UnspeccedSearchStarterPacksSkeletonInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedSearchStarterPacksSkeletonInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedSearchStarterPacksSkeletonInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.viewer, viewer) || other.viewer == viewer) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$UnspeccedSearchStarterPacksSkeletonInputCopyWith<$Res>
    implements $UnspeccedSearchStarterPacksSkeletonInputCopyWith<$Res> {
  factory _$UnspeccedSearchStarterPacksSkeletonInputCopyWith(
          _UnspeccedSearchStarterPacksSkeletonInput value,
          $Res Function(_UnspeccedSearchStarterPacksSkeletonInput) _then) =
      __$UnspeccedSearchStarterPacksSkeletonInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String q,
