...
class _DraftEmbedImage implements DraftEmbedImage {
  const _DraftEmbedImage({this.$type = 'app.bsky.draft.defs#draftEmbedImage', @DraftEmbedLocalRefConverter() required this.localRef, this.alt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
