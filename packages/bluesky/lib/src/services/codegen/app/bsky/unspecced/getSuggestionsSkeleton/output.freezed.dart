...
mixin _$UnspeccedGetSuggestionsSkeletonOutput {
  ...
  $UnspeccedGetSuggestionsSkeletonOutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetSuggestionsSkeletonOutputCopyWithImpl<
              UnspeccedGetSuggestionsSkeletonOutput>(
          this as UnspeccedGetSuggestionsSkeletonOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestionsSkeletonOutput &&
...
abstract mixin class $UnspeccedGetSuggestionsSkeletonOutputCopyWith<$Res> {
  factory $UnspeccedGetSuggestionsSkeletonOutputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestionsSkeletonOutput) _then) =
      _$UnspeccedGetSuggestionsSkeletonOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension UnspeccedGetSuggestionsSkeletonOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestionsSkeletonOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UnspeccedGetSuggestionsSkeletonOutput() when $default != null:
        return $default(_that.cursor, _that.actors, _that.relativeToDid,
            _that.recId, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestionsSkeletonOutput
    implements UnspeccedGetSuggestionsSkeletonOutput {
  const _UnspeccedGetSuggestionsSkeletonOutput(
      {this.cursor,
      @SkeletonSearchActorConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestionsSkeletonOutputCopyWith<
          _UnspeccedGetSuggestionsSkeletonOutput>
      get copyWith => __$UnspeccedGetSuggestionsSkeletonOutputCopyWithImpl<
          _UnspeccedGetSuggestionsSkeletonOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestionsSkeletonOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestionsSkeletonOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestionsSkeletonOutputCopyWith<$Res>
    implements $UnspeccedGetSuggestionsSkeletonOutputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestionsSkeletonOutputCopyWith(
          _UnspeccedGetSuggestionsSkeletonOutput value,
          $Res Function(_UnspeccedGetSuggestionsSkeletonOutput) _then) =
      __$UnspeccedGetSuggestionsSkeletonOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
