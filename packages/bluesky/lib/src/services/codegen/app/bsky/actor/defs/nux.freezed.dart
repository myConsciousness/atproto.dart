...
mixin _$Nux {
  ...
  int get hashCode => Object.hash(runtimeType, $type, id, completed, data,
      expiresAt, const DeepCollectionEquality().hash($unknown));
...
extension NuxPatterns on Nux {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Nux value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String id, bool completed, String? data,
            DateTime? expiresAt, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Nux() when $default != null:
        return $default(_that.$type, _that.id, _that.completed, _that.data,
            _that.expiresAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
