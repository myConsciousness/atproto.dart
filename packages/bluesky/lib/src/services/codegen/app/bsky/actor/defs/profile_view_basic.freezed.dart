...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,did,handle,displayName,pronouns,avatar,associated,viewer,const DeepCollectionEquality().hash(labels),createdAt,verification,status,const DeepCollectionEquality().hash($unknown));

@override
String toString() {
  return 'ProfileViewBasic(\$type: ${$type}, did: $did, handle: $handle, displayName: $displayName, pronouns: $pronouns, avatar: $avatar, associated: $associated, viewer: $viewer, labels: $labels, createdAt: $createdAt, verification: $verification, status: $status, \$unknown: ${$unknown})';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,did,handle,displayName,pronouns,avatar,associated,viewer,const DeepCollectionEquality().hash(_labels),createdAt,verification,status,const DeepCollectionEquality().hash(_$unknown));
