...
@pragma('vm:prefer-inline') @override $Res call({Object? posts = null,Object? $unknown = freezed,}) {
  return _then(FeedGetPostsOutput(
...
class _FeedGetPostsOutput implements FeedGetPostsOutput {
  const _FeedGetPostsOutput({@PostViewConverter() required  List<PostView> posts,  Map<String, dynamic>? $unknown}): _posts = posts,_$unknown = $unknown;
