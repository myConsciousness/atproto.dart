...
class $UReplyRefParentCopyWith<$Res> {
  $UReplyRefParentCopyWith(
      UReplyRefParent _, $Res Function(UReplyRefParent) __);
}
...
extension UReplyRefParentPatterns on UReplyRefParent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UReplyRefParentNotFoundPost() when notFoundPost != null:
        return notFoundPost(_that);
      case UReplyRefParentBlockedPost() when blockedPost != null:
        return blockedPost(_that);
      case UReplyRefParentUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UReplyRefParentPostView():
        return postView(_that);
      case UReplyRefParentNotFoundPost():
        return notFoundPost(_that);
      case UReplyRefParentBlockedPost():
        return blockedPost(_that);
      case UReplyRefParentUnknown():
        return unknown(_that);
      case _:
...
class UReplyRefParentPostView extends UReplyRefParent {
  ...
  $UReplyRefParentPostViewCopyWith<UReplyRefParentPostView> get copyWith =>
      _$UReplyRefParentPostViewCopyWithImpl<UReplyRefParentPostView>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefParentPostView &&
...
/// @nodoc
abstract mixin class $UReplyRefParentPostViewCopyWith<$Res>
    implements $UReplyRefParentCopyWith<$Res> {
  factory $UReplyRefParentPostViewCopyWith(UReplyRefParentPostView value,
          $Res Function(UReplyRefParentPostView) _then) =
      _$UReplyRefParentPostViewCopyWithImpl;
  @useResult
...
class UReplyRefParentNotFoundPost extends UReplyRefParent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefParentNotFoundPostCopyWith<UReplyRefParentNotFoundPost>
      get copyWith => _$UReplyRefParentNotFoundPostCopyWithImpl<
          UReplyRefParentNotFoundPost>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefParentNotFoundPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UReplyRefParentNotFoundPostCopyWith<$Res>
    implements $UReplyRefParentCopyWith<$Res> {
  factory $UReplyRefParentNotFoundPostCopyWith(
          UReplyRefParentNotFoundPost value,
          $Res Function(UReplyRefParentNotFoundPost) _then) =
      _$UReplyRefParentNotFoundPostCopyWithImpl;
  @useResult
...
class UReplyRefParentBlockedPost extends UReplyRefParent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefParentBlockedPostCopyWith<UReplyRefParentBlockedPost>
      get copyWith =>
          _$UReplyRefParentBlockedPostCopyWithImpl<UReplyRefParentBlockedPost>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefParentBlockedPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UReplyRefParentBlockedPostCopyWith<$Res>
    implements $UReplyRefParentCopyWith<$Res> {
  factory $UReplyRefParentBlockedPostCopyWith(UReplyRefParentBlockedPost value,
          $Res Function(UReplyRefParentBlockedPost) _then) =
      _$UReplyRefParentBlockedPostCopyWithImpl;
  @useResult
...
class UReplyRefParentUnknown extends UReplyRefParent {
  const UReplyRefParentUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefParentUnknownCopyWith<UReplyRefParentUnknown> get copyWith =>
      _$UReplyRefParentUnknownCopyWithImpl<UReplyRefParentUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefParentUnknown &&
...
/// @nodoc
abstract mixin class $UReplyRefParentUnknownCopyWith<$Res>
    implements $UReplyRefParentCopyWith<$Res> {
  factory $UReplyRefParentUnknownCopyWith(UReplyRefParentUnknown value,
          $Res Function(UReplyRefParentUnknown) _then) =
      _$UReplyRefParentUnknownCopyWithImpl;
  @useResult
