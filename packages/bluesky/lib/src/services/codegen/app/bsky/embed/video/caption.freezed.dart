...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? lang = null,Object? file = null,Object? $unknown = freezed,}) {
  return _then(EmbedVideoCaption(
...
class _EmbedVideoCaption implements EmbedVideoCaption {
  const _EmbedVideoCaption({this.$type = 'app.bsky.embed.video#caption', required this.lang, @BlobConverter() required this.file,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
