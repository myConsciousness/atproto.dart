...
extension EmbedVideoCaptionPatterns on EmbedVideoCaption {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EmbedVideoCaption value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String lang, @BlobConverter() Blob file,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _EmbedVideoCaption() when $default != null:
        return $default(_that.$type, _that.lang, _that.file, _that.$unknown);
      case _:
        return orElse();
    }
  }
