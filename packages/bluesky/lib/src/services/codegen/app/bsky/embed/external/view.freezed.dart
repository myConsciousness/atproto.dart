...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? external = null,Object? $unknown = freezed,}) {
  return _then(EmbedExternalView(
...
class _EmbedExternalView implements EmbedExternalView {
  const _EmbedExternalView({this.$type = 'app.bsky.embed.external#view', @EmbedExternalViewExternalConverter() required this.external,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
