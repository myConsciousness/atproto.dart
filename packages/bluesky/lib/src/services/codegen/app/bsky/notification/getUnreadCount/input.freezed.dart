...
mixin _$NotificationGetUnreadCountInput {
  ...
  $NotificationGetUnreadCountInputCopyWith<NotificationGetUnreadCountInput>
      get copyWith => _$NotificationGetUnreadCountInputCopyWithImpl<
              NotificationGetUnreadCountInput>(
          this as NotificationGetUnreadCountInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationGetUnreadCountInput &&
...
abstract mixin class $NotificationGetUnreadCountInputCopyWith<$Res> {
  factory $NotificationGetUnreadCountInputCopyWith(
          ...
          $Res Function(NotificationGetUnreadCountInput) _then) =
      _$NotificationGetUnreadCountInputCopyWithImpl;
  @useResult
...
extension NotificationGetUnreadCountInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationGetUnreadCountInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NotificationGetUnreadCountInput() when $default != null:
        return $default(_that.priority, _that.seenAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationGetUnreadCountInput
    implements NotificationGetUnreadCountInput {
  const _NotificationGetUnreadCountInput(
      {this.priority, this.seenAt, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _NotificationGetUnreadCountInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationGetUnreadCountInputCopyWith<_NotificationGetUnreadCountInput>
      get copyWith => __$NotificationGetUnreadCountInputCopyWithImpl<
          _NotificationGetUnreadCountInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationGetUnreadCountInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationGetUnreadCountInput &&
            (identical(other.priority, priority) ||
                other.priority == priority) &&
            (identical(other.seenAt, seenAt) || other.seenAt == seenAt) &&
...
/// @nodoc
abstract mixin class _$NotificationGetUnreadCountInputCopyWith<$Res>
    implements $NotificationGetUnreadCountInputCopyWith<$Res> {
  factory _$NotificationGetUnreadCountInputCopyWith(
          _NotificationGetUnreadCountInput value,
          $Res Function(_NotificationGetUnreadCountInput) _then) =
      __$NotificationGetUnreadCountInputCopyWithImpl;
  @override
  @useResult
  $Res call({bool? priority, DateTime? seenAt, Map<String, dynamic>? $unknown});
}
