...
mixin _$FeedGetFeedSkeletonOutput {
  ...
  $FeedGetFeedSkeletonOutputCopyWith<FeedGetFeedSkeletonOutput> get copyWith =>
      _$FeedGetFeedSkeletonOutputCopyWithImpl<FeedGetFeedSkeletonOutput>(
          this as FeedGetFeedSkeletonOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetFeedSkeletonOutput &&
...
abstract mixin class $FeedGetFeedSkeletonOutputCopyWith<$Res> {
  factory $FeedGetFeedSkeletonOutputCopyWith(FeedGetFeedSkeletonOutput value,
          $Res Function(FeedGetFeedSkeletonOutput) _then) =
      _$FeedGetFeedSkeletonOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension FeedGetFeedSkeletonOutputPatterns on FeedGetFeedSkeletonOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetFeedSkeletonOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _FeedGetFeedSkeletonOutput() when $default != null:
        return $default(_that.cursor, _that.feed, _that.reqId, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetFeedSkeletonOutput implements FeedGetFeedSkeletonOutput {
  const _FeedGetFeedSkeletonOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetFeedSkeletonOutputCopyWith<_FeedGetFeedSkeletonOutput>
      get copyWith =>
          __$FeedGetFeedSkeletonOutputCopyWithImpl<_FeedGetFeedSkeletonOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetFeedSkeletonOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetFeedSkeletonOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetFeedSkeletonOutputCopyWith<$Res>
    implements $FeedGetFeedSkeletonOutputCopyWith<$Res> {
  factory _$FeedGetFeedSkeletonOutputCopyWith(_FeedGetFeedSkeletonOutput value,
          $Res Function(_FeedGetFeedSkeletonOutput) _then) =
      __$FeedGetFeedSkeletonOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
