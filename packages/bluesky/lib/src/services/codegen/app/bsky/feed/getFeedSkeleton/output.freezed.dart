...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feed = null,Object? reqId = freezed,Object? $unknown = freezed,}) {
  return _then(FeedGetFeedSkeletonOutput(
...
class _FeedGetFeedSkeletonOutput implements FeedGetFeedSkeletonOutput {
  const _FeedGetFeedSkeletonOutput({this.cursor, @SkeletonFeedPostConverter() required  List<SkeletonFeedPost> feed, this.reqId,  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
