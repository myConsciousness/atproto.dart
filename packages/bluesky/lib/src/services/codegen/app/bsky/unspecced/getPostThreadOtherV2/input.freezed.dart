...
mixin _$UnspeccedGetPostThreadOtherV2Input {
  ...
  $UnspeccedGetPostThreadOtherV2InputCopyWith<
      ...
      get copyWith => _$UnspeccedGetPostThreadOtherV2InputCopyWithImpl<
              UnspeccedGetPostThreadOtherV2Input>(
          this as UnspeccedGetPostThreadOtherV2Input, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPostThreadOtherV2Input &&
...
abstract mixin class $UnspeccedGetPostThreadOtherV2InputCopyWith<$Res> {
  factory $UnspeccedGetPostThreadOtherV2InputCopyWith(
          ...
          $Res Function(UnspeccedGetPostThreadOtherV2Input) _then) =
      _$UnspeccedGetPostThreadOtherV2InputCopyWithImpl;
  @useResult
  $Res call(
      {String anchor,
...
extension UnspeccedGetPostThreadOtherV2InputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetPostThreadOtherV2Input value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String anchor, bool prioritizeFollowedUsers,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetPostThreadOtherV2Input() when $default != null:
        return $default(
            _that.anchor, _that.prioritizeFollowedUsers, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetPostThreadOtherV2Input
    implements UnspeccedGetPostThreadOtherV2Input {
  const _UnspeccedGetPostThreadOtherV2Input(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetPostThreadOtherV2InputCopyWith<
          _UnspeccedGetPostThreadOtherV2Input>
      get copyWith => __$UnspeccedGetPostThreadOtherV2InputCopyWithImpl<
          _UnspeccedGetPostThreadOtherV2Input>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetPostThreadOtherV2InputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetPostThreadOtherV2Input &&
            (identical(other.anchor, anchor) || other.anchor == anchor) &&
            (identical(
                    other.prioritizeFollowedUsers, prioritizeFollowedUsers) ||
                other.prioritizeFollowedUsers == prioritizeFollowedUsers) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetPostThreadOtherV2InputCopyWith<$Res>
    implements $UnspeccedGetPostThreadOtherV2InputCopyWith<$Res> {
  factory _$UnspeccedGetPostThreadOtherV2InputCopyWith(
          _UnspeccedGetPostThreadOtherV2Input value,
          $Res Function(_UnspeccedGetPostThreadOtherV2Input) _then) =
      __$UnspeccedGetPostThreadOtherV2InputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String anchor,
