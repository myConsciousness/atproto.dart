...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? match = null,Object? contactIndex = null,Object? $unknown = freezed,}) {
  return _then(MatchAndContactIndex(
...
class _MatchAndContactIndex implements MatchAndContactIndex {
  const _MatchAndContactIndex({this.$type = 'app.bsky.contact.defs#matchAndContactIndex', @ProfileViewConverter() required this.match, required this.contactIndex,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
