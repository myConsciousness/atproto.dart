...
class _GraphBlockRecord implements GraphBlockRecord {
  const _GraphBlockRecord({this.$type = 'app.bsky.graph.block', required this.subject, @JsonKey(toJson: iso8601) required this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
