...
$EmbedRecordViewNotFoundCopyWith<EmbedRecordViewNotFound> get copyWith => _$EmbedRecordViewNotFoundCopyWithImpl<EmbedRecordViewNotFound>(this as EmbedRecordViewNotFound, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EmbedRecordViewNotFound&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.notFound, notFound) || other.notFound == notFound)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? notFound = null,Object? $unknown = freezed,}) {
  return _then(EmbedRecordViewNotFound(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmbedRecordViewNotFound value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmbedRecordViewNotFound value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmbedRecordViewNotFound value)?  $default,){
final _that = this;
switch (_that) {
case _EmbedRecordViewNotFound() when $default != null:
return $default(_that);case _:
...
class _EmbedRecordViewNotFound implements EmbedRecordViewNotFound {
  const _EmbedRecordViewNotFound({this.$type = 'app.bsky.embed.record#viewNotFound', @AtUriConverter() required this.uri, required this.notFound,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$EmbedRecordViewNotFoundCopyWith<_EmbedRecordViewNotFound> get copyWith => __$EmbedRecordViewNotFoundCopyWithImpl<_EmbedRecordViewNotFound>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EmbedRecordViewNotFoundToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmbedRecordViewNotFound&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.notFound, notFound) || other.notFound == notFound)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$EmbedRecordViewNotFoundCopyWith<$Res> implements $EmbedRecordViewNotFoundCopyWith<$Res> {
