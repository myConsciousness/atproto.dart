  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ContentLabelPrefVisibility &&
...
class $ContentLabelPrefVisibilityCopyWith<$Res> {
  $ContentLabelPrefVisibilityCopyWith(ContentLabelPrefVisibility _,
      $Res Function(ContentLabelPrefVisibility) __);
}
...
extension ContentLabelPrefVisibilityPatterns on ContentLabelPrefVisibility {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ContentLabelPrefVisibilityUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ContentLabelPrefVisibilityKnownValue():
        return knownValue(_that);
      case ContentLabelPrefVisibilityUnknown():
        return unknown(_that);
      case _:
...
class ContentLabelPrefVisibilityKnownValue extends ContentLabelPrefVisibility {
  ...
  $ContentLabelPrefVisibilityKnownValueCopyWith<
          ContentLabelPrefVisibilityKnownValue>
      get copyWith => _$ContentLabelPrefVisibilityKnownValueCopyWithImpl<
          ContentLabelPrefVisibilityKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ContentLabelPrefVisibilityKnownValue &&
...
/// @nodoc
abstract mixin class $ContentLabelPrefVisibilityKnownValueCopyWith<$Res>
    implements $ContentLabelPrefVisibilityCopyWith<$Res> {
  factory $ContentLabelPrefVisibilityKnownValueCopyWith(
          ContentLabelPrefVisibilityKnownValue value,
          $Res Function(ContentLabelPrefVisibilityKnownValue) _then) =
      _$ContentLabelPrefVisibilityKnownValueCopyWithImpl;
  @useResult
...
class ContentLabelPrefVisibilityUnknown extends ContentLabelPrefVisibility {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ContentLabelPrefVisibilityUnknownCopyWith<ContentLabelPrefVisibilityUnknown>
      get copyWith => _$ContentLabelPrefVisibilityUnknownCopyWithImpl<
          ContentLabelPrefVisibilityUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ContentLabelPrefVisibilityUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ContentLabelPrefVisibilityUnknownCopyWith<$Res>
    implements $ContentLabelPrefVisibilityCopyWith<$Res> {
  factory $ContentLabelPrefVisibilityUnknownCopyWith(
          ContentLabelPrefVisibilityUnknown value,
          $Res Function(ContentLabelPrefVisibilityUnknown) _then) =
      _$ContentLabelPrefVisibilityUnknownCopyWithImpl;
  @useResult
