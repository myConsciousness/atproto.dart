...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? threadgateAllowRules = freezed,Object? postgateEmbeddingRules = freezed,Object? $unknown = freezed,}) {
  return _then(PostInteractionSettingsPref(
...
class _PostInteractionSettingsPref implements PostInteractionSettingsPref {
  const _PostInteractionSettingsPref({this.$type = 'app.bsky.actor.defs#postInteractionSettingsPref', @UPostInteractionSettingsPrefThreadgateAllowRulesConverter()  List<UPostInteractionSettingsPrefThreadgateAllowRules>? threadgateAllowRules, @UPostInteractionSettingsPrefPostgateEmbeddingRulesConverter()  List<UPostInteractionSettingsPrefPostgateEmbeddingRules>? postgateEmbeddingRules,  Map<String, dynamic>? $unknown}): _threadgateAllowRules = threadgateAllowRules,_postgateEmbeddingRules = postgateEmbeddingRules,_$unknown = $unknown;
