...
mixin _$FilterablePreference {
  ...
  $FilterablePreferenceCopyWith<FilterablePreference> get copyWith =>
      _$FilterablePreferenceCopyWithImpl<FilterablePreference>(
          this as FilterablePreference, _$identity);
...
abstract mixin class $FilterablePreferenceCopyWith<$Res> {
  factory $FilterablePreferenceCopyWith(FilterablePreference value,
          $Res Function(FilterablePreference) _then) =
      _$FilterablePreferenceCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      @FilterablePreferenceIncludeConverter()
...
extension FilterablePreferencePatterns on FilterablePreference {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FilterablePreference value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _FilterablePreference() when $default != null:
        return $default(
            _that.$type, _that.include, _that.list, _that.push, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FilterablePreference implements FilterablePreference {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FilterablePreferenceCopyWith<_FilterablePreference> get copyWith =>
      __$FilterablePreferenceCopyWithImpl<_FilterablePreference>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FilterablePreferenceToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FilterablePreference &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.include, include) || other.include == include) &&
            (identical(other.list, list) || other.list == list) &&
            (identical(other.push, push) || other.push == push) &&
...
/// @nodoc
abstract mixin class _$FilterablePreferenceCopyWith<$Res>
    implements $FilterablePreferenceCopyWith<$Res> {
  factory _$FilterablePreferenceCopyWith(_FilterablePreference value,
          $Res Function(_FilterablePreference) _then) =
      __$FilterablePreferenceCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
