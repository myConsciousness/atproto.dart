...
@pragma('vm:prefer-inline') @override $Res call({Object? uri = null,Object? cid = freezed,Object? cursor = freezed,Object? posts = null,Object? $unknown = freezed,}) {
  return _then(FeedGetQuotesOutput(
...
class _FeedGetQuotesOutput implements FeedGetQuotesOutput {
  const _FeedGetQuotesOutput({@AtUriConverter() required this.uri, this.cid, this.cursor, @PostViewConverter() required  List<PostView> posts,  Map<String, dynamic>? $unknown}): _posts = posts,_$unknown = $unknown;
