...
mixin _$FeedSearchPostsInput {
  ...
  $FeedSearchPostsInputCopyWith<FeedSearchPostsInput> get copyWith =>
      _$FeedSearchPostsInputCopyWithImpl<FeedSearchPostsInput>(
          this as FeedSearchPostsInput, _$identity);
...
abstract mixin class $FeedSearchPostsInputCopyWith<$Res> {
  factory $FeedSearchPostsInputCopyWith(FeedSearchPostsInput value,
          $Res Function(FeedSearchPostsInput) _then) =
      _$FeedSearchPostsInputCopyWithImpl;
  @useResult
  $Res call(
      {String q,
...
extension FeedSearchPostsInputPatterns on FeedSearchPostsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedSearchPostsInput value)? $default, {
...
class _FeedSearchPostsInput implements FeedSearchPostsInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedSearchPostsInputCopyWith<_FeedSearchPostsInput> get copyWith =>
      __$FeedSearchPostsInputCopyWithImpl<_FeedSearchPostsInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedSearchPostsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedSearchPostsInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.sort, sort) || other.sort == sort) &&
            (identical(other.since, since) || other.since == since) &&
            (identical(other.until, until) || other.until == until) &&
...
/// @nodoc
abstract mixin class _$FeedSearchPostsInputCopyWith<$Res>
    implements $FeedSearchPostsInputCopyWith<$Res> {
  factory _$FeedSearchPostsInputCopyWith(_FeedSearchPostsInput value,
          $Res Function(_FeedSearchPostsInput) _then) =
      __$FeedSearchPostsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String q,
