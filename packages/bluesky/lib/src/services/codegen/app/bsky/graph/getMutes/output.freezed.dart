...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? mutes = null,Object? $unknown = freezed,}) {
  return _then(GraphGetMutesOutput(
...
class _GraphGetMutesOutput implements GraphGetMutesOutput {
  const _GraphGetMutesOutput({this.cursor, @ProfileViewConverter() required  List<ProfileView> mutes,  Map<String, dynamic>? $unknown}): _mutes = mutes,_$unknown = $unknown;
