...
class _LiveNowConfig implements LiveNowConfig {
  const _LiveNowConfig({this.$type = 'app.bsky.unspecced.getConfig#liveNowConfig', required this.did, required  List<String> domains,  Map<String, dynamic>? $unknown}): _domains = domains,_$unknown = $unknown;
