...
mixin _$StarterPackViewBasic {
 ...
 String get $type;@AtUriConverter() AtUri get uri; String get cid; Map<String, dynamic> get record;@ProfileViewBasicConverter() ProfileViewBasic get creator; int? get listItemCount; int? get joinedWeekCount; int? get joinedAllTimeCount;@LabelConverter() List<Label>? get labels;@JsonKey(toJson: iso8601) DateTime get indexedAt; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type,@AtUriConverter() AtUri uri, String cid, Map<String, dynamic> record,@ProfileViewBasicConverter() ProfileViewBasic creator, int? listItemCount, int? joinedWeekCount, int? joinedAllTimeCount,@LabelConverter() List<Label>? labels,@JsonKey(toJson: iso8601) DateTime indexedAt, Map<String, dynamic>? $unknown
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri uri,  String cid,  Map<String, dynamic> record, @ProfileViewBasicConverter()  ProfileViewBasic creator,  int? listItemCount,  int? joinedWeekCount,  int? joinedAllTimeCount, @LabelConverter()  List<Label>? labels, @JsonKey(toJson: iso8601)  DateTime indexedAt,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StarterPackViewBasic() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri uri,  String cid,  Map<String, dynamic> record, @ProfileViewBasicConverter()  ProfileViewBasic creator,  int? listItemCount,  int? joinedWeekCount,  int? joinedAllTimeCount, @LabelConverter()  List<Label>? labels, @JsonKey(toJson: iso8601)  DateTime indexedAt,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _StarterPackViewBasic():
return $default(_that.$type,_that.uri,_that.cid,_that.record,_that.creator,_that.listItemCount,_that.joinedWeekCount,_that.joinedAllTimeCount,_that.labels,_that.indexedAt,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
