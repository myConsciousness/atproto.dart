...
mixin _$UnspeccedGetPostThreadOtherV2Output {
  ...
  $UnspeccedGetPostThreadOtherV2OutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetPostThreadOtherV2OutputCopyWithImpl<
              UnspeccedGetPostThreadOtherV2Output>(
          this as UnspeccedGetPostThreadOtherV2Output, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPostThreadOtherV2Output &&
...
abstract mixin class $UnspeccedGetPostThreadOtherV2OutputCopyWith<$Res> {
  factory $UnspeccedGetPostThreadOtherV2OutputCopyWith(
          ...
          $Res Function(UnspeccedGetPostThreadOtherV2Output) _then) =
      _$UnspeccedGetPostThreadOtherV2OutputCopyWithImpl;
  @useResult
  $Res call(
...
extension UnspeccedGetPostThreadOtherV2OutputPatterns
    on UnspeccedGetPostThreadOtherV2Output {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetPostThreadOtherV2Output value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@ThreadItemConverter() List<ThreadItem> thread,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetPostThreadOtherV2Output() when $default != null:
        return $default(_that.thread, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetPostThreadOtherV2Output
    implements UnspeccedGetPostThreadOtherV2Output {
  const _UnspeccedGetPostThreadOtherV2Output(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetPostThreadOtherV2OutputCopyWith<
          _UnspeccedGetPostThreadOtherV2Output>
      get copyWith => __$UnspeccedGetPostThreadOtherV2OutputCopyWithImpl<
          _UnspeccedGetPostThreadOtherV2Output>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetPostThreadOtherV2OutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetPostThreadOtherV2Output &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetPostThreadOtherV2OutputCopyWith<$Res>
    implements $UnspeccedGetPostThreadOtherV2OutputCopyWith<$Res> {
  factory _$UnspeccedGetPostThreadOtherV2OutputCopyWith(
          _UnspeccedGetPostThreadOtherV2Output value,
          $Res Function(_UnspeccedGetPostThreadOtherV2Output) _then) =
      __$UnspeccedGetPostThreadOtherV2OutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ThreadItemConverter() List<ThreadItem> thread,
