...
@pragma('vm:prefer-inline') @override $Res call({Object? dids = null,Object? detailed = null,Object? $unknown = freezed,}) {
  return _then(LabelerGetServicesInput(
...
class _LabelerGetServicesInput implements LabelerGetServicesInput {
  const _LabelerGetServicesInput({required  List<String> dids, this.detailed = false,  Map<String, dynamic>? $unknown}): _dids = dids,_$unknown = $unknown;
