...
class _EmbedImagesView implements EmbedImagesView {
  const _EmbedImagesView({this.$type = 'app.bsky.embed.images#view', @EmbedImagesViewImageConverter() required  List<EmbedImagesViewImage> images,  Map<String, dynamic>? $unknown}): _images = images,_$unknown = $unknown;
