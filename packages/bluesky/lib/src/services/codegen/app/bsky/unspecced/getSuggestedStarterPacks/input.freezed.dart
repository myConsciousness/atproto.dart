...
$UnspeccedGetSuggestedStarterPacksInputCopyWith<UnspeccedGetSuggestedStarterPacksInput> get copyWith => _$UnspeccedGetSuggestedStarterPacksInputCopyWithImpl<UnspeccedGetSuggestedStarterPacksInput>(this as UnspeccedGetSuggestedStarterPacksInput, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnspeccedGetSuggestedStarterPacksInput&&(identical(other.limit, limit) || other.limit == limit)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
abstract mixin class $UnspeccedGetSuggestedStarterPacksInputCopyWith<$Res>  {
  factory $UnspeccedGetSuggestedStarterPacksInputCopyWith(UnspeccedGetSuggestedStarterPacksInput value, $Res Function(UnspeccedGetSuggestedStarterPacksInput) _then) = _$UnspeccedGetSuggestedStarterPacksInputCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? limit = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetSuggestedStarterPacksInput(
...
extension UnspeccedGetSuggestedStarterPacksInputPatterns on UnspeccedGetSuggestedStarterPacksInput {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnspeccedGetSuggestedStarterPacksInput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnspeccedGetSuggestedStarterPacksInput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnspeccedGetSuggestedStarterPacksInput value)?  $default,){
final _that = this;
switch (_that) {
case _UnspeccedGetSuggestedStarterPacksInput() when $default != null:
return $default(_that);case _:
...
class _UnspeccedGetSuggestedStarterPacksInput implements UnspeccedGetSuggestedStarterPacksInput {
  const _UnspeccedGetSuggestedStarterPacksInput({this.limit = 10,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$UnspeccedGetSuggestedStarterPacksInputCopyWith<_UnspeccedGetSuggestedStarterPacksInput> get copyWith => __$UnspeccedGetSuggestedStarterPacksInputCopyWithImpl<_UnspeccedGetSuggestedStarterPacksInput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UnspeccedGetSuggestedStarterPacksInputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnspeccedGetSuggestedStarterPacksInput&&(identical(other.limit, limit) || other.limit == limit)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestedStarterPacksInputCopyWith<$Res> implements $UnspeccedGetSuggestedStarterPacksInputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestedStarterPacksInputCopyWith(_UnspeccedGetSuggestedStarterPacksInput value, $Res Function(_UnspeccedGetSuggestedStarterPacksInput) _then) = __$UnspeccedGetSuggestedStarterPacksInputCopyWithImpl;
@override @useResult
$Res call({
 int limit, Map<String, dynamic>? $unknown
});
