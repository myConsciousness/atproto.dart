  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationUnregisterPushPlatform &&
...
class $NotificationUnregisterPushPlatformCopyWith<$Res> {
  $NotificationUnregisterPushPlatformCopyWith(
      NotificationUnregisterPushPlatform _,
      $Res Function(NotificationUnregisterPushPlatform) __);
}

/// Adds pattern-matching-related methods to [NotificationUnregisterPushPlatform].
extension NotificationUnregisterPushPlatformPatterns
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case NotificationUnregisterPushPlatformUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case NotificationUnregisterPushPlatformKnownValue():
        return knownValue(_that);
      case NotificationUnregisterPushPlatformUnknown():
        return unknown(_that);
      case _:
...
class NotificationUnregisterPushPlatformKnownValue
    extends NotificationUnregisterPushPlatform {
  const NotificationUnregisterPushPlatformKnownValue({required this.data})
      : super._();
  ...
  $NotificationUnregisterPushPlatformKnownValueCopyWith<
          NotificationUnregisterPushPlatformKnownValue>
      get copyWith =>
          _$NotificationUnregisterPushPlatformKnownValueCopyWithImpl<
              NotificationUnregisterPushPlatformKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationUnregisterPushPlatformKnownValue &&
...
/// @nodoc
abstract mixin class $NotificationUnregisterPushPlatformKnownValueCopyWith<$Res>
    implements $NotificationUnregisterPushPlatformCopyWith<$Res> {
  factory $NotificationUnregisterPushPlatformKnownValueCopyWith(
          NotificationUnregisterPushPlatformKnownValue value,
          $Res Function(NotificationUnregisterPushPlatformKnownValue) _then) =
      _$NotificationUnregisterPushPlatformKnownValueCopyWithImpl;
  @useResult
...
class NotificationUnregisterPushPlatformUnknown
    extends NotificationUnregisterPushPlatform {
  const NotificationUnregisterPushPlatformUnknown({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $NotificationUnregisterPushPlatformUnknownCopyWith<
          NotificationUnregisterPushPlatformUnknown>
      get copyWith => _$NotificationUnregisterPushPlatformUnknownCopyWithImpl<
          NotificationUnregisterPushPlatformUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationUnregisterPushPlatformUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $NotificationUnregisterPushPlatformUnknownCopyWith<$Res>
    implements $NotificationUnregisterPushPlatformCopyWith<$Res> {
  factory $NotificationUnregisterPushPlatformUnknownCopyWith(
          NotificationUnregisterPushPlatformUnknown value,
          $Res Function(NotificationUnregisterPushPlatformUnknown) _then) =
      _$NotificationUnregisterPushPlatformUnknownCopyWithImpl;
  @useResult
