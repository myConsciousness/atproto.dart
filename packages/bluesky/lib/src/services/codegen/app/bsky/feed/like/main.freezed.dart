...
class _FeedLikeRecord implements FeedLikeRecord {
  const _FeedLikeRecord({this.$type = 'app.bsky.feed.like', @RepoStrongRefConverter() required this.subject, @JsonKey(toJson: iso8601) required this.createdAt, @RepoStrongRefConverter() this.via,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
