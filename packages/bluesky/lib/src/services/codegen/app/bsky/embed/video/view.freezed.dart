...
mixin _$EmbedVideoView {
  ...
  int get hashCode => Object.hash(runtimeType, $type, cid, playlist, thumbnail,
      alt, aspectRatio, const DeepCollectionEquality().hash($unknown));
...
extension EmbedVideoViewPatterns on EmbedVideoView {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EmbedVideoView value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _EmbedVideoView() when $default != null:
        return $default(_that.$type, _that.cid, _that.playlist, _that.thumbnail,
            _that.alt, _that.aspectRatio, _that.$unknown);
      case _:
        return orElse();
    }
  }
