...
class $StatusViewStatusCopyWith<$Res> {
  $StatusViewStatusCopyWith(
      StatusViewStatus _, $Res Function(StatusViewStatus) __);
}
...
extension StatusViewStatusPatterns on StatusViewStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case StatusViewStatusUnknown() when unknown != null:
...
class StatusViewStatusKnownValue extends StatusViewStatus {
  ...
  $StatusViewStatusKnownValueCopyWith<StatusViewStatusKnownValue>
      get copyWith =>
          _$StatusViewStatusKnownValueCopyWithImpl<StatusViewStatusKnownValue>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StatusViewStatusKnownValue &&
...
/// @nodoc
abstract mixin class $StatusViewStatusKnownValueCopyWith<$Res>
    implements $StatusViewStatusCopyWith<$Res> {
  factory $StatusViewStatusKnownValueCopyWith(StatusViewStatusKnownValue value,
          $Res Function(StatusViewStatusKnownValue) _then) =
      _$StatusViewStatusKnownValueCopyWithImpl;
  @useResult
...
class StatusViewStatusUnknown extends StatusViewStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StatusViewStatusUnknownCopyWith<StatusViewStatusUnknown> get copyWith =>
      _$StatusViewStatusUnknownCopyWithImpl<StatusViewStatusUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StatusViewStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $StatusViewStatusUnknownCopyWith<$Res>
    implements $StatusViewStatusCopyWith<$Res> {
  factory $StatusViewStatusUnknownCopyWith(StatusViewStatusUnknown value,
          $Res Function(StatusViewStatusUnknown) _then) =
      _$StatusViewStatusUnknownCopyWithImpl;
  @useResult
