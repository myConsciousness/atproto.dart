...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? $unknown = freezed,}) {
  return _then(RichtextFacetLink(
...
class _RichtextFacetLink implements RichtextFacetLink {
  const _RichtextFacetLink({this.$type = 'app.bsky.richtext.facet#link', required this.uri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
