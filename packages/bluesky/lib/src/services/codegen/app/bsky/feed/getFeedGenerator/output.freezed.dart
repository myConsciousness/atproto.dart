...
@pragma('vm:prefer-inline') @override $Res call({Object? view = null,Object? isOnline = null,Object? isValid = null,Object? $unknown = freezed,}) {
  return _then(FeedGetFeedGeneratorOutput(
...
class _FeedGetFeedGeneratorOutput implements FeedGetFeedGeneratorOutput {
  const _FeedGetFeedGeneratorOutput({@GeneratorViewConverter() required this.view, required this.isOnline, required this.isValid,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
