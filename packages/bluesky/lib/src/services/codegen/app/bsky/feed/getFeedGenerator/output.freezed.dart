...
mixin _$FeedGetFeedGeneratorOutput {
  ...
  $FeedGetFeedGeneratorOutputCopyWith<FeedGetFeedGeneratorOutput>
      get copyWith =>
          _$FeedGetFeedGeneratorOutputCopyWithImpl<FeedGetFeedGeneratorOutput>(
              this as FeedGetFeedGeneratorOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetFeedGeneratorOutput &&
...
abstract mixin class $FeedGetFeedGeneratorOutputCopyWith<$Res> {
  factory $FeedGetFeedGeneratorOutputCopyWith(FeedGetFeedGeneratorOutput value,
          $Res Function(FeedGetFeedGeneratorOutput) _then) =
      _$FeedGetFeedGeneratorOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension FeedGetFeedGeneratorOutputPatterns on FeedGetFeedGeneratorOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetFeedGeneratorOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@GeneratorViewConverter() GeneratorView view,
            bool isOnline, bool isValid, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FeedGetFeedGeneratorOutput() when $default != null:
        return $default(
            _that.view, _that.isOnline, _that.isValid, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetFeedGeneratorOutput implements FeedGetFeedGeneratorOutput {
  const _FeedGetFeedGeneratorOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetFeedGeneratorOutputCopyWith<_FeedGetFeedGeneratorOutput>
      get copyWith => __$FeedGetFeedGeneratorOutputCopyWithImpl<
          _FeedGetFeedGeneratorOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetFeedGeneratorOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetFeedGeneratorOutput &&
            (identical(other.view, view) || other.view == view) &&
            (identical(other.isOnline, isOnline) ||
                other.isOnline == isOnline) &&
            (identical(other.isValid, isValid) || other.isValid == isValid) &&
...
/// @nodoc
abstract mixin class _$FeedGetFeedGeneratorOutputCopyWith<$Res>
    implements $FeedGetFeedGeneratorOutputCopyWith<$Res> {
  factory _$FeedGetFeedGeneratorOutputCopyWith(
          _FeedGetFeedGeneratorOutput value,
          $Res Function(_FeedGetFeedGeneratorOutput) _then) =
      __$FeedGetFeedGeneratorOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@GeneratorViewConverter() GeneratorView view,
