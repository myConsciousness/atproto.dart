...
mixin _$TrendingTopic {
  ...
  int get hashCode => Object.hash(runtimeType, $type, topic, displayName,
      description, link, const DeepCollectionEquality().hash($unknown));
...
extension TrendingTopicPatterns on TrendingTopic {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TrendingTopic value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String topic, String? displayName,
            String? description, String link, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TrendingTopic() when $default != null:
        return $default(_that.$type, _that.topic, _that.displayName,
            _that.description, _that.link, _that.$unknown);
      case _:
        return orElse();
    }
  }
