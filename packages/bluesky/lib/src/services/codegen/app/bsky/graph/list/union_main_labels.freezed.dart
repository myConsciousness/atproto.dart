...
class $UGraphListLabelsCopyWith<$Res> {
  $UGraphListLabelsCopyWith(
      UGraphListLabels _, $Res Function(UGraphListLabels) __);
}
...
extension UGraphListLabelsPatterns on UGraphListLabels {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(UGraphListLabelsSelfLabels value)? selfLabels,
    TResult Function(UGraphListLabelsUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case UGraphListLabelsUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(UGraphListLabelsSelfLabels value) selfLabels,
    required TResult Function(UGraphListLabelsUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case UGraphListLabelsSelfLabels():
        return selfLabels(_that);
      case UGraphListLabelsUnknown():
        return unknown(_that);
      case _:
...
class UGraphListLabelsSelfLabels extends UGraphListLabels {
  ...
  $UGraphListLabelsSelfLabelsCopyWith<UGraphListLabelsSelfLabels>
      get copyWith =>
          _$UGraphListLabelsSelfLabelsCopyWithImpl<UGraphListLabelsSelfLabels>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UGraphListLabelsSelfLabels &&
...
/// @nodoc
abstract mixin class $UGraphListLabelsSelfLabelsCopyWith<$Res>
    implements $UGraphListLabelsCopyWith<$Res> {
  factory $UGraphListLabelsSelfLabelsCopyWith(UGraphListLabelsSelfLabels value,
          $Res Function(UGraphListLabelsSelfLabels) _then) =
      _$UGraphListLabelsSelfLabelsCopyWithImpl;
  @useResult
...
class UGraphListLabelsUnknown extends UGraphListLabels {
  const UGraphListLabelsUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UGraphListLabelsUnknownCopyWith<UGraphListLabelsUnknown> get copyWith =>
      _$UGraphListLabelsUnknownCopyWithImpl<UGraphListLabelsUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UGraphListLabelsUnknown &&
...
/// @nodoc
abstract mixin class $UGraphListLabelsUnknownCopyWith<$Res>
    implements $UGraphListLabelsCopyWith<$Res> {
  factory $UGraphListLabelsUnknownCopyWith(UGraphListLabelsUnknown value,
          $Res Function(UGraphListLabelsUnknown) _then) =
      _$UGraphListLabelsUnknownCopyWithImpl;
  @useResult
