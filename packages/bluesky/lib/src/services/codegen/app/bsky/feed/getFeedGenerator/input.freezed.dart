...
mixin _$FeedGetFeedGeneratorInput {
  ...
  $FeedGetFeedGeneratorInputCopyWith<FeedGetFeedGeneratorInput> get copyWith =>
      _$FeedGetFeedGeneratorInputCopyWithImpl<FeedGetFeedGeneratorInput>(
          this as FeedGetFeedGeneratorInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetFeedGeneratorInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, feed, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $FeedGetFeedGeneratorInputCopyWith<$Res> {
  factory $FeedGetFeedGeneratorInputCopyWith(FeedGetFeedGeneratorInput value,
          $Res Function(FeedGetFeedGeneratorInput) _then) =
      _$FeedGetFeedGeneratorInputCopyWithImpl;
  @useResult
...
extension FeedGetFeedGeneratorInputPatterns on FeedGetFeedGeneratorInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetFeedGeneratorInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String feed, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FeedGetFeedGeneratorInput() when $default != null:
        return $default(_that.feed, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetFeedGeneratorInput implements FeedGetFeedGeneratorInput {
  const _FeedGetFeedGeneratorInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetFeedGeneratorInputCopyWith<_FeedGetFeedGeneratorInput>
      get copyWith =>
          __$FeedGetFeedGeneratorInputCopyWithImpl<_FeedGetFeedGeneratorInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetFeedGeneratorInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetFeedGeneratorInput &&
            (identical(other.feed, feed) || other.feed == feed) &&
...
/// @nodoc
abstract mixin class _$FeedGetFeedGeneratorInputCopyWith<$Res>
    implements $FeedGetFeedGeneratorInputCopyWith<$Res> {
  factory _$FeedGetFeedGeneratorInputCopyWith(_FeedGetFeedGeneratorInput value,
          $Res Function(_FeedGetFeedGeneratorInput) _then) =
      __$FeedGetFeedGeneratorInputCopyWithImpl;
  @override
  @useResult
  $Res call({String feed, Map<String, dynamic>? $unknown});
}
