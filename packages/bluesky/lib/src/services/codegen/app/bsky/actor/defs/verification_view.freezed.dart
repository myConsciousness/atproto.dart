...
mixin _$VerificationView {
  ...
  int get hashCode => Object.hash(runtimeType, $type, issuer, uri, isValid,
      createdAt, const DeepCollectionEquality().hash($unknown));
...
extension VerificationViewPatterns on VerificationView {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String issuer, String uri, bool isValid,
    ...
    switch (_that) {
      case _VerificationView() when $default != null:
        return $default(_that.$type, _that.issuer, _that.uri, _that.isValid,
            _that.createdAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
