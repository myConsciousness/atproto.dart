...
@pragma('vm:prefer-inline') @override $Res call({Object? actors = null,Object? recIdStr = freezed,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetSuggestedUsersForExploreOutput(
...
class _UnspeccedGetSuggestedUsersForExploreOutput implements UnspeccedGetSuggestedUsersForExploreOutput {
  const _UnspeccedGetSuggestedUsersForExploreOutput({@ProfileViewConverter() required  List<ProfileView> actors, this.recIdStr,  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
