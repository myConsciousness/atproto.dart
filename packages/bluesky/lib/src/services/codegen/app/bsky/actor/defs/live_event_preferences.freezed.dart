...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? hiddenFeedIds = freezed,Object? hideAllFeeds = null,Object? $unknown = freezed,}) {
  return _then(LiveEventPreferences(
...
class _LiveEventPreferences implements LiveEventPreferences {
  const _LiveEventPreferences({this.$type = 'app.bsky.actor.defs#liveEventPreferences',  List<String>? hiddenFeedIds, this.hideAllFeeds = false,  Map<String, dynamic>? $unknown}): _hiddenFeedIds = hiddenFeedIds,_$unknown = $unknown;
