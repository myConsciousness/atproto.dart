...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? title = null,Object? description = null,Object? thumb = freezed,Object? associatedRefs = freezed,Object? $unknown = freezed,}) {
  return _then(EmbedExternalExternal(
...
class _EmbedExternalExternal implements EmbedExternalExternal {
  const _EmbedExternalExternal({this.$type = 'app.bsky.embed.external#external', required this.uri, required this.title, required this.description, @BlobConverter() this.thumb, @RepoStrongRefConverter()  List<RepoStrongRef>? associatedRefs,  Map<String, dynamic>? $unknown}): _associatedRefs = associatedRefs,_$unknown = $unknown;
