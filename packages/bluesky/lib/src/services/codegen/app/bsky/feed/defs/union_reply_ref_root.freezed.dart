...
extension UReplyRefRootPatterns on UReplyRefRoot {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UReplyRefRootNotFoundPost() when notFoundPost != null:
        return notFoundPost(_that);
      case UReplyRefRootBlockedPost() when blockedPost != null:
        return blockedPost(_that);
      case UReplyRefRootUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UReplyRefRootPostView():
        return postView(_that);
      case UReplyRefRootNotFoundPost():
        return notFoundPost(_that);
      case UReplyRefRootBlockedPost():
        return blockedPost(_that);
      case UReplyRefRootUnknown():
        return unknown(_that);
      case _:
...
class UReplyRefRootPostView extends UReplyRefRoot {
  ...
  $UReplyRefRootPostViewCopyWith<UReplyRefRootPostView> get copyWith =>
      _$UReplyRefRootPostViewCopyWithImpl<UReplyRefRootPostView>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefRootPostView &&
...
/// @nodoc
abstract mixin class $UReplyRefRootPostViewCopyWith<$Res>
    implements $UReplyRefRootCopyWith<$Res> {
  factory $UReplyRefRootPostViewCopyWith(UReplyRefRootPostView value,
          $Res Function(UReplyRefRootPostView) _then) =
      _$UReplyRefRootPostViewCopyWithImpl;
  @useResult
...
class UReplyRefRootNotFoundPost extends UReplyRefRoot {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefRootNotFoundPostCopyWith<UReplyRefRootNotFoundPost> get copyWith =>
      _$UReplyRefRootNotFoundPostCopyWithImpl<UReplyRefRootNotFoundPost>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefRootNotFoundPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UReplyRefRootNotFoundPostCopyWith<$Res>
    implements $UReplyRefRootCopyWith<$Res> {
  factory $UReplyRefRootNotFoundPostCopyWith(UReplyRefRootNotFoundPost value,
          $Res Function(UReplyRefRootNotFoundPost) _then) =
      _$UReplyRefRootNotFoundPostCopyWithImpl;
  @useResult
...
class UReplyRefRootBlockedPost extends UReplyRefRoot {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefRootBlockedPostCopyWith<UReplyRefRootBlockedPost> get copyWith =>
      _$UReplyRefRootBlockedPostCopyWithImpl<UReplyRefRootBlockedPost>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UReplyRefRootBlockedPost &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UReplyRefRootBlockedPostCopyWith<$Res>
    implements $UReplyRefRootCopyWith<$Res> {
  factory $UReplyRefRootBlockedPostCopyWith(UReplyRefRootBlockedPost value,
          $Res Function(UReplyRefRootBlockedPost) _then) =
      _$UReplyRefRootBlockedPostCopyWithImpl;
  @useResult
...
class UReplyRefRootUnknown extends UReplyRefRoot {
  const UReplyRefRootUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UReplyRefRootUnknownCopyWith<UReplyRefRootUnknown> get copyWith =>
      _$UReplyRefRootUnknownCopyWithImpl<UReplyRefRootUnknown>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $UReplyRefRootUnknownCopyWith<$Res>
    implements $UReplyRefRootCopyWith<$Res> {
  factory $UReplyRefRootUnknownCopyWith(UReplyRefRootUnknown value,
          $Res Function(UReplyRefRootUnknown) _then) =
      _$UReplyRefRootUnknownCopyWithImpl;
  @useResult
