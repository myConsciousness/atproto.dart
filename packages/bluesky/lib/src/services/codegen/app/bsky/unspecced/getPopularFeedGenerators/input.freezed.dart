...
mixin _$UnspeccedGetPopularFeedGeneratorsInput {
  ...
  $UnspeccedGetPopularFeedGeneratorsInputCopyWith<
      ...
      get copyWith => _$UnspeccedGetPopularFeedGeneratorsInputCopyWithImpl<
              UnspeccedGetPopularFeedGeneratorsInput>(
          this as UnspeccedGetPopularFeedGeneratorsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPopularFeedGeneratorsInput &&
...
abstract mixin class $UnspeccedGetPopularFeedGeneratorsInputCopyWith<$Res> {
  factory $UnspeccedGetPopularFeedGeneratorsInputCopyWith(
          ...
          $Res Function(UnspeccedGetPopularFeedGeneratorsInput) _then) =
      _$UnspeccedGetPopularFeedGeneratorsInputCopyWithImpl;
  @useResult
  $Res call(
      {int limit,
      String? cursor,
...
extension UnspeccedGetPopularFeedGeneratorsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetPopularFeedGeneratorsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int limit, String? cursor, String? query,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetPopularFeedGeneratorsInput() when $default != null:
        return $default(_that.limit, _that.cursor, _that.query, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetPopularFeedGeneratorsInput
    implements UnspeccedGetPopularFeedGeneratorsInput {
  const _UnspeccedGetPopularFeedGeneratorsInput(
      {this.limit = 50,
      this.cursor,
      this.query,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetPopularFeedGeneratorsInputCopyWith<
          _UnspeccedGetPopularFeedGeneratorsInput>
      get copyWith => __$UnspeccedGetPopularFeedGeneratorsInputCopyWithImpl<
          _UnspeccedGetPopularFeedGeneratorsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetPopularFeedGeneratorsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetPopularFeedGeneratorsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.query, query) || other.query == query) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetPopularFeedGeneratorsInputCopyWith<$Res>
    implements $UnspeccedGetPopularFeedGeneratorsInputCopyWith<$Res> {
  factory _$UnspeccedGetPopularFeedGeneratorsInputCopyWith(
          _UnspeccedGetPopularFeedGeneratorsInput value,
          $Res Function(_UnspeccedGetPopularFeedGeneratorsInput) _then) =
      __$UnspeccedGetPopularFeedGeneratorsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int limit,
