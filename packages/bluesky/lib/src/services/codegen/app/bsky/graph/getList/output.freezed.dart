...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? list = null,Object? items = null,Object? $unknown = freezed,}) {
  return _then(GraphGetListOutput(
...
class _GraphGetListOutput implements GraphGetListOutput {
  const _GraphGetListOutput({this.cursor, @ListViewConverter() required this.list, @ListItemViewConverter() required  List<ListItemView> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
