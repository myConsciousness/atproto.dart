...
@pragma('vm:prefer-inline') @override $Res call({Object? preferences = null,Object? $unknown = freezed,}) {
  return _then(ActorGetPreferencesOutput(
...
class _ActorGetPreferencesOutput implements ActorGetPreferencesOutput {
  const _ActorGetPreferencesOutput({@UPreferencesConverter() required  List<UPreferences> preferences,  Map<String, dynamic>? $unknown}): _preferences = preferences,_$unknown = $unknown;
