...
mixin _$ActorGetPreferencesOutput {
  ...
  $ActorGetPreferencesOutputCopyWith<ActorGetPreferencesOutput> get copyWith =>
      _$ActorGetPreferencesOutputCopyWithImpl<ActorGetPreferencesOutput>(
          this as ActorGetPreferencesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorGetPreferencesOutput &&
...
abstract mixin class $ActorGetPreferencesOutputCopyWith<$Res> {
  factory $ActorGetPreferencesOutputCopyWith(ActorGetPreferencesOutput value,
          $Res Function(ActorGetPreferencesOutput) _then) =
      _$ActorGetPreferencesOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ActorGetPreferencesOutputPatterns on ActorGetPreferencesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorGetPreferencesOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@UPreferencesConverter() List<UPreferences> preferences,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
...
class _ActorGetPreferencesOutput implements ActorGetPreferencesOutput {
  const _ActorGetPreferencesOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorGetPreferencesOutputCopyWith<_ActorGetPreferencesOutput>
      get copyWith =>
          __$ActorGetPreferencesOutputCopyWithImpl<_ActorGetPreferencesOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorGetPreferencesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorGetPreferencesOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$ActorGetPreferencesOutputCopyWith<$Res>
    implements $ActorGetPreferencesOutputCopyWith<$Res> {
  factory _$ActorGetPreferencesOutputCopyWith(_ActorGetPreferencesOutput value,
          $Res Function(_ActorGetPreferencesOutput) _then) =
      __$ActorGetPreferencesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@UPreferencesConverter() List<UPreferences> preferences,
