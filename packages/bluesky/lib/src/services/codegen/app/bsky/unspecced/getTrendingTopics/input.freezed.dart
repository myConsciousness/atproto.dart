...
mixin _$UnspeccedGetTrendingTopicsInput {
  ...
  $UnspeccedGetTrendingTopicsInputCopyWith<UnspeccedGetTrendingTopicsInput>
      get copyWith => _$UnspeccedGetTrendingTopicsInputCopyWithImpl<
              UnspeccedGetTrendingTopicsInput>(
          this as UnspeccedGetTrendingTopicsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetTrendingTopicsInput &&
...
abstract mixin class $UnspeccedGetTrendingTopicsInputCopyWith<$Res> {
  factory $UnspeccedGetTrendingTopicsInputCopyWith(
          ...
          $Res Function(UnspeccedGetTrendingTopicsInput) _then) =
      _$UnspeccedGetTrendingTopicsInputCopyWithImpl;
  @useResult
...
extension UnspeccedGetTrendingTopicsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetTrendingTopicsInput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetTrendingTopicsInput
    implements UnspeccedGetTrendingTopicsInput {
  const _UnspeccedGetTrendingTopicsInput(
      {this.viewer, this.limit = 10, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _UnspeccedGetTrendingTopicsInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetTrendingTopicsInputCopyWith<_UnspeccedGetTrendingTopicsInput>
      get copyWith => __$UnspeccedGetTrendingTopicsInputCopyWithImpl<
          _UnspeccedGetTrendingTopicsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetTrendingTopicsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetTrendingTopicsInput &&
            (identical(other.viewer, viewer) || other.viewer == viewer) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetTrendingTopicsInputCopyWith<$Res>
    implements $UnspeccedGetTrendingTopicsInputCopyWith<$Res> {
  factory _$UnspeccedGetTrendingTopicsInputCopyWith(
          _UnspeccedGetTrendingTopicsInput value,
          $Res Function(_UnspeccedGetTrendingTopicsInput) _then) =
      __$UnspeccedGetTrendingTopicsInputCopyWithImpl;
  @override
  @useResult
  $Res call({String? viewer, int limit, Map<String, dynamic>? $unknown});
}
