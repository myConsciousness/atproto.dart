...
class $MutedWordTargetCopyWith<$Res> {
  $MutedWordTargetCopyWith(
      MutedWordTarget _, $Res Function(MutedWordTarget) __);
}
...
extension MutedWordTargetPatterns on MutedWordTarget {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(MutedWordTargetKnownValue value)? knownValue,
    TResult Function(MutedWordTargetUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case MutedWordTargetUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(MutedWordTargetKnownValue value) knownValue,
    required TResult Function(MutedWordTargetUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case MutedWordTargetKnownValue():
        return knownValue(_that);
      case MutedWordTargetUnknown():
        return unknown(_that);
      case _:
...
class MutedWordTargetKnownValue extends MutedWordTarget {
  ...
  $MutedWordTargetKnownValueCopyWith<MutedWordTargetKnownValue> get copyWith =>
      _$MutedWordTargetKnownValueCopyWithImpl<MutedWordTargetKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MutedWordTargetKnownValue &&
...
/// @nodoc
abstract mixin class $MutedWordTargetKnownValueCopyWith<$Res>
    implements $MutedWordTargetCopyWith<$Res> {
  factory $MutedWordTargetKnownValueCopyWith(MutedWordTargetKnownValue value,
          $Res Function(MutedWordTargetKnownValue) _then) =
      _$MutedWordTargetKnownValueCopyWithImpl;
  @useResult
...
class MutedWordTargetUnknown extends MutedWordTarget {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MutedWordTargetUnknownCopyWith<MutedWordTargetUnknown> get copyWith =>
      _$MutedWordTargetUnknownCopyWithImpl<MutedWordTargetUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MutedWordTargetUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $MutedWordTargetUnknownCopyWith<$Res>
    implements $MutedWordTargetCopyWith<$Res> {
  factory $MutedWordTargetUnknownCopyWith(MutedWordTargetUnknown value,
          $Res Function(MutedWordTargetUnknown) _then) =
      _$MutedWordTargetUnknownCopyWithImpl;
  @useResult
