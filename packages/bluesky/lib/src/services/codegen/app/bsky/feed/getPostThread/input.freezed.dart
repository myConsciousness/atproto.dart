...
mixin _$FeedGetPostThreadInput {
  ...
  $FeedGetPostThreadInputCopyWith<FeedGetPostThreadInput> get copyWith =>
      _$FeedGetPostThreadInputCopyWithImpl<FeedGetPostThreadInput>(
          this as FeedGetPostThreadInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetPostThreadInput &&
...
abstract mixin class $FeedGetPostThreadInputCopyWith<$Res> {
  factory $FeedGetPostThreadInputCopyWith(FeedGetPostThreadInput value,
          $Res Function(FeedGetPostThreadInput) _then) =
      _$FeedGetPostThreadInputCopyWithImpl;
  @useResult
  $Res call(
      {String uri,
      int depth,
...
extension FeedGetPostThreadInputPatterns on FeedGetPostThreadInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetPostThreadInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String uri, int depth, int parentHeight,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _FeedGetPostThreadInput() when $default != null:
        return $default(
            _that.uri, _that.depth, _that.parentHeight, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetPostThreadInput implements FeedGetPostThreadInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetPostThreadInputCopyWith<_FeedGetPostThreadInput> get copyWith =>
      __$FeedGetPostThreadInputCopyWithImpl<_FeedGetPostThreadInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetPostThreadInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetPostThreadInput &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.depth, depth) || other.depth == depth) &&
            (identical(other.parentHeight, parentHeight) ||
                other.parentHeight == parentHeight) &&
...
/// @nodoc
abstract mixin class _$FeedGetPostThreadInputCopyWith<$Res>
    implements $FeedGetPostThreadInputCopyWith<$Res> {
  factory _$FeedGetPostThreadInputCopyWith(_FeedGetPostThreadInput value,
          $Res Function(_FeedGetPostThreadInput) _then) =
      __$FeedGetPostThreadInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String uri,
