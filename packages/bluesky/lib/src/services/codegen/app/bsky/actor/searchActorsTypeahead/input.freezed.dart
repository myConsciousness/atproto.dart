...
mixin _$ActorSearchActorsTypeaheadInput {
  ...
  $ActorSearchActorsTypeaheadInputCopyWith<ActorSearchActorsTypeaheadInput>
      get copyWith => _$ActorSearchActorsTypeaheadInputCopyWithImpl<
              ActorSearchActorsTypeaheadInput>(
          this as ActorSearchActorsTypeaheadInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorSearchActorsTypeaheadInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, q, limit, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ActorSearchActorsTypeaheadInputCopyWith<$Res> {
  factory $ActorSearchActorsTypeaheadInputCopyWith(
          ...
          $Res Function(ActorSearchActorsTypeaheadInput) _then) =
      _$ActorSearchActorsTypeaheadInputCopyWithImpl;
  @useResult
...
extension ActorSearchActorsTypeaheadInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorSearchActorsTypeaheadInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? q, int limit, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ActorSearchActorsTypeaheadInput() when $default != null:
        return $default(_that.q, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ActorSearchActorsTypeaheadInput
    implements ActorSearchActorsTypeaheadInput {
  const _ActorSearchActorsTypeaheadInput(
      {this.q, this.limit = 10, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _ActorSearchActorsTypeaheadInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorSearchActorsTypeaheadInputCopyWith<_ActorSearchActorsTypeaheadInput>
      get copyWith => __$ActorSearchActorsTypeaheadInputCopyWithImpl<
          _ActorSearchActorsTypeaheadInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorSearchActorsTypeaheadInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorSearchActorsTypeaheadInput &&
            (identical(other.q, q) || other.q == q) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$ActorSearchActorsTypeaheadInputCopyWith<$Res>
    implements $ActorSearchActorsTypeaheadInputCopyWith<$Res> {
  factory _$ActorSearchActorsTypeaheadInputCopyWith(
          _ActorSearchActorsTypeaheadInput value,
          $Res Function(_ActorSearchActorsTypeaheadInput) _then) =
      __$ActorSearchActorsTypeaheadInputCopyWithImpl;
  @override
  @useResult
  $Res call({String? q, int limit, Map<String, dynamic>? $unknown});
}
