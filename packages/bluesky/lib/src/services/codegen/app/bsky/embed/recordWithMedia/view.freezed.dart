...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? record = null,Object? media = null,Object? $unknown = freezed,}) {
  return _then(EmbedRecordWithMediaView(
...
class _EmbedRecordWithMediaView implements EmbedRecordWithMediaView {
  const _EmbedRecordWithMediaView({this.$type = 'app.bsky.embed.recordWithMedia#view', @EmbedRecordViewConverter() required this.record, @UEmbedRecordWithMediaViewMediaConverter() required this.media,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
