...
mixin _$UnspeccedSearchActorsSkeletonOutput {
  ...
  $UnspeccedSearchActorsSkeletonOutputCopyWith<
      ...
      get copyWith => _$UnspeccedSearchActorsSkeletonOutputCopyWithImpl<
              UnspeccedSearchActorsSkeletonOutput>(
          this as UnspeccedSearchActorsSkeletonOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedSearchActorsSkeletonOutput &&
...
abstract mixin class $UnspeccedSearchActorsSkeletonOutputCopyWith<$Res> {
  factory $UnspeccedSearchActorsSkeletonOutputCopyWith(
          ...
          $Res Function(UnspeccedSearchActorsSkeletonOutput) _then) =
      _$UnspeccedSearchActorsSkeletonOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
      int? hitsTotal,
...
extension UnspeccedSearchActorsSkeletonOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedSearchActorsSkeletonOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UnspeccedSearchActorsSkeletonOutput() when $default != null:
        return $default(
            _that.cursor, _that.hitsTotal, _that.actors, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedSearchActorsSkeletonOutput
    implements UnspeccedSearchActorsSkeletonOutput {
  const _UnspeccedSearchActorsSkeletonOutput(
      {this.cursor,
      this.hitsTotal,
      @SkeletonSearchActorConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedSearchActorsSkeletonOutputCopyWith<
          _UnspeccedSearchActorsSkeletonOutput>
      get copyWith => __$UnspeccedSearchActorsSkeletonOutputCopyWithImpl<
          _UnspeccedSearchActorsSkeletonOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedSearchActorsSkeletonOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedSearchActorsSkeletonOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            (identical(other.hitsTotal, hitsTotal) ||
                other.hitsTotal == hitsTotal) &&
...
/// @nodoc
abstract mixin class _$UnspeccedSearchActorsSkeletonOutputCopyWith<$Res>
    implements $UnspeccedSearchActorsSkeletonOutputCopyWith<$Res> {
  factory _$UnspeccedSearchActorsSkeletonOutputCopyWith(
          _UnspeccedSearchActorsSkeletonOutput value,
          $Res Function(_UnspeccedSearchActorsSkeletonOutput) _then) =
      __$UnspeccedSearchActorsSkeletonOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
