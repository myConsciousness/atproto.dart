...
class _ThreadItem implements ThreadItem {
  const _ThreadItem({this.$type = 'app.bsky.unspecced.getPostThreadV2#threadItem', @AtUriConverter() required this.uri, required this.depth, @UThreadItemValueConverter() required this.value,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
