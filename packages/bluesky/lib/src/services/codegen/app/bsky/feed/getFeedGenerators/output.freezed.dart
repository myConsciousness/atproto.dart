...
@pragma('vm:prefer-inline') @override $Res call({Object? feeds = null,Object? $unknown = freezed,}) {
  return _then(FeedGetFeedGeneratorsOutput(
...
class _FeedGetFeedGeneratorsOutput implements FeedGetFeedGeneratorsOutput {
  const _FeedGetFeedGeneratorsOutput({@GeneratorViewConverter() required  List<GeneratorView> feeds,  Map<String, dynamic>? $unknown}): _feeds = feeds,_$unknown = $unknown;
