...
mixin _$FeedGetFeedGeneratorsOutput {
  ...
  $FeedGetFeedGeneratorsOutputCopyWith<FeedGetFeedGeneratorsOutput>
      get copyWith => _$FeedGetFeedGeneratorsOutputCopyWithImpl<
              FeedGetFeedGeneratorsOutput>(
          this as FeedGetFeedGeneratorsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetFeedGeneratorsOutput &&
...
abstract mixin class $FeedGetFeedGeneratorsOutputCopyWith<$Res> {
  factory $FeedGetFeedGeneratorsOutputCopyWith(
          ...
          $Res Function(FeedGetFeedGeneratorsOutput) _then) =
      _$FeedGetFeedGeneratorsOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension FeedGetFeedGeneratorsOutputPatterns on FeedGetFeedGeneratorsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetFeedGeneratorsOutput value)? $default, {
...
class _FeedGetFeedGeneratorsOutput implements FeedGetFeedGeneratorsOutput {
  const _FeedGetFeedGeneratorsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetFeedGeneratorsOutputCopyWith<_FeedGetFeedGeneratorsOutput>
      get copyWith => __$FeedGetFeedGeneratorsOutputCopyWithImpl<
          _FeedGetFeedGeneratorsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetFeedGeneratorsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetFeedGeneratorsOutput &&
...
/// @nodoc
abstract mixin class _$FeedGetFeedGeneratorsOutputCopyWith<$Res>
    implements $FeedGetFeedGeneratorsOutputCopyWith<$Res> {
  factory _$FeedGetFeedGeneratorsOutputCopyWith(
          _FeedGetFeedGeneratorsOutput value,
          $Res Function(_FeedGetFeedGeneratorsOutput) _then) =
      __$FeedGetFeedGeneratorsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@GeneratorViewConverter() List<GeneratorView> feeds,
