...
$FeedGetActorLikesInputCopyWith<FeedGetActorLikesInput> get copyWith => _$FeedGetActorLikesInputCopyWithImpl<FeedGetActorLikesInput>(this as FeedGetActorLikesInput, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedGetActorLikesInput&&(identical(other.actor, actor) || other.actor == actor)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.cursor, cursor) || other.cursor == cursor)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? actor = null,Object? limit = null,Object? cursor = freezed,Object? $unknown = freezed,}) {
  return _then(FeedGetActorLikesInput(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FeedGetActorLikesInput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FeedGetActorLikesInput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FeedGetActorLikesInput value)?  $default,){
final _that = this;
switch (_that) {
case _FeedGetActorLikesInput() when $default != null:
return $default(_that);case _:
...
class _FeedGetActorLikesInput implements FeedGetActorLikesInput {
  const _FeedGetActorLikesInput({required this.actor, this.limit = 50, this.cursor,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$FeedGetActorLikesInputCopyWith<_FeedGetActorLikesInput> get copyWith => __$FeedGetActorLikesInputCopyWithImpl<_FeedGetActorLikesInput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FeedGetActorLikesInputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FeedGetActorLikesInput&&(identical(other.actor, actor) || other.actor == actor)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.cursor, cursor) || other.cursor == cursor)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$FeedGetActorLikesInputCopyWith<$Res> implements $FeedGetActorLikesInputCopyWith<$Res> {
