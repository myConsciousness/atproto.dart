...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? like = freezed,Object? $unknown = freezed,}) {
  return _then(GeneratorViewerState(
...
class _GeneratorViewerState implements GeneratorViewerState {
  const _GeneratorViewerState({this.$type = 'app.bsky.feed.defs#generatorViewerState', @AtUriConverter() this.like,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
