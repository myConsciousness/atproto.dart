...
mixin _$GeneratorViewerState {
  ...
  $GeneratorViewerStateCopyWith<GeneratorViewerState> get copyWith =>
      _$GeneratorViewerStateCopyWithImpl<GeneratorViewerState>(
          this as GeneratorViewerState, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, $type, like, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $GeneratorViewerStateCopyWith<$Res> {
  factory $GeneratorViewerStateCopyWith(GeneratorViewerState value,
          $Res Function(GeneratorViewerState) _then) =
      _$GeneratorViewerStateCopyWithImpl;
  @useResult
...
extension GeneratorViewerStatePatterns on GeneratorViewerState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GeneratorViewerState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _GeneratorViewerState() when $default != null:
        return $default(_that.$type, _that.like, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String $type, String? like, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _GeneratorViewerState implements GeneratorViewerState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GeneratorViewerStateCopyWith<_GeneratorViewerState> get copyWith =>
      __$GeneratorViewerStateCopyWithImpl<_GeneratorViewerState>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GeneratorViewerStateToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GeneratorViewerState &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.like, like) || other.like == like) &&
...
/// @nodoc
abstract mixin class _$GeneratorViewerStateCopyWith<$Res>
    implements $GeneratorViewerStateCopyWith<$Res> {
  factory _$GeneratorViewerStateCopyWith(_GeneratorViewerState value,
          $Res Function(_GeneratorViewerState) _then) =
      __$GeneratorViewerStateCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String? like, Map<String, dynamic>? $unknown});
}
