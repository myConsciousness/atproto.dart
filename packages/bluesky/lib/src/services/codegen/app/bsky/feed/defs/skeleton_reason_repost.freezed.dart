...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? repost = null,Object? $unknown = freezed,}) {
  return _then(SkeletonReasonRepost(
...
class _SkeletonReasonRepost implements SkeletonReasonRepost {
  const _SkeletonReasonRepost({this.$type = 'app.bsky.feed.defs#skeletonReasonRepost', @AtUriConverter() required this.repost,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
