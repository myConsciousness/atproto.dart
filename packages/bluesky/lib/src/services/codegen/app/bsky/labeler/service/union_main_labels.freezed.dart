  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelerServiceLabels &&
...
class $ULabelerServiceLabelsCopyWith<$Res> {
  $ULabelerServiceLabelsCopyWith(
      ULabelerServiceLabels _, $Res Function(ULabelerServiceLabels) __);
}
...
extension ULabelerServiceLabelsPatterns on ULabelerServiceLabels {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(ULabelerServiceLabelsSelfLabels value)? selfLabels,
    TResult Function(ULabelerServiceLabelsUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case ULabelerServiceLabelsUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(ULabelerServiceLabelsSelfLabels value) selfLabels,
    required TResult Function(ULabelerServiceLabelsUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case ULabelerServiceLabelsSelfLabels():
        return selfLabels(_that);
      case ULabelerServiceLabelsUnknown():
        return unknown(_that);
      case _:
...
class ULabelerServiceLabelsSelfLabels extends ULabelerServiceLabels {
  ...
  $ULabelerServiceLabelsSelfLabelsCopyWith<ULabelerServiceLabelsSelfLabels>
      get copyWith => _$ULabelerServiceLabelsSelfLabelsCopyWithImpl<
          ULabelerServiceLabelsSelfLabels>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelerServiceLabelsSelfLabels &&
...
/// @nodoc
abstract mixin class $ULabelerServiceLabelsSelfLabelsCopyWith<$Res>
    implements $ULabelerServiceLabelsCopyWith<$Res> {
  factory $ULabelerServiceLabelsSelfLabelsCopyWith(
          ULabelerServiceLabelsSelfLabels value,
          $Res Function(ULabelerServiceLabelsSelfLabels) _then) =
      _$ULabelerServiceLabelsSelfLabelsCopyWithImpl;
  @useResult
...
class ULabelerServiceLabelsUnknown extends ULabelerServiceLabels {
  const ULabelerServiceLabelsUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULabelerServiceLabelsUnknownCopyWith<ULabelerServiceLabelsUnknown>
      get copyWith => _$ULabelerServiceLabelsUnknownCopyWithImpl<
          ULabelerServiceLabelsUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULabelerServiceLabelsUnknown &&
...
/// @nodoc
abstract mixin class $ULabelerServiceLabelsUnknownCopyWith<$Res>
    implements $ULabelerServiceLabelsCopyWith<$Res> {
  factory $ULabelerServiceLabelsUnknownCopyWith(
          ULabelerServiceLabelsUnknown value,
          $Res Function(ULabelerServiceLabelsUnknown) _then) =
      _$ULabelerServiceLabelsUnknownCopyWithImpl;
  @useResult
