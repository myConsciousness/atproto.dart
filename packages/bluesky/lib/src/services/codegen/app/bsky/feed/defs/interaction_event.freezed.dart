...
class $InteractionEventCopyWith<$Res> {
  $InteractionEventCopyWith(
      InteractionEvent _, $Res Function(InteractionEvent) __);
}
...
extension InteractionEventPatterns on InteractionEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case InteractionEventUnknown() when unknown != null:
...
class InteractionEventKnownValue extends InteractionEvent {
  ...
  $InteractionEventKnownValueCopyWith<InteractionEventKnownValue>
      get copyWith =>
          _$InteractionEventKnownValueCopyWithImpl<InteractionEventKnownValue>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InteractionEventKnownValue &&
...
/// @nodoc
abstract mixin class $InteractionEventKnownValueCopyWith<$Res>
    implements $InteractionEventCopyWith<$Res> {
  factory $InteractionEventKnownValueCopyWith(InteractionEventKnownValue value,
          $Res Function(InteractionEventKnownValue) _then) =
      _$InteractionEventKnownValueCopyWithImpl;
  @useResult
...
class InteractionEventUnknown extends InteractionEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $InteractionEventUnknownCopyWith<InteractionEventUnknown> get copyWith =>
      _$InteractionEventUnknownCopyWithImpl<InteractionEventUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is InteractionEventUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $InteractionEventUnknownCopyWith<$Res>
    implements $InteractionEventCopyWith<$Res> {
  factory $InteractionEventUnknownCopyWith(InteractionEventUnknown value,
          $Res Function(InteractionEventUnknown) _then) =
      _$InteractionEventUnknownCopyWithImpl;
  @useResult
