...
mixin _$VideoGetJobStatusOutput {
  ...
  $VideoGetJobStatusOutputCopyWith<VideoGetJobStatusOutput> get copyWith =>
      _$VideoGetJobStatusOutputCopyWithImpl<VideoGetJobStatusOutput>(
          this as VideoGetJobStatusOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VideoGetJobStatusOutput &&
...
abstract mixin class $VideoGetJobStatusOutputCopyWith<$Res> {
  factory $VideoGetJobStatusOutputCopyWith(VideoGetJobStatusOutput value,
          $Res Function(VideoGetJobStatusOutput) _then) =
      _$VideoGetJobStatusOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension VideoGetJobStatusOutputPatterns on VideoGetJobStatusOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VideoGetJobStatusOutput value)? $default, {
...
class _VideoGetJobStatusOutput implements VideoGetJobStatusOutput {
  const _VideoGetJobStatusOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VideoGetJobStatusOutputCopyWith<_VideoGetJobStatusOutput> get copyWith =>
      __$VideoGetJobStatusOutputCopyWithImpl<_VideoGetJobStatusOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VideoGetJobStatusOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VideoGetJobStatusOutput &&
            (identical(other.jobStatus, jobStatus) ||
                other.jobStatus == jobStatus) &&
...
/// @nodoc
abstract mixin class _$VideoGetJobStatusOutputCopyWith<$Res>
    implements $VideoGetJobStatusOutputCopyWith<$Res> {
  factory _$VideoGetJobStatusOutputCopyWith(_VideoGetJobStatusOutput value,
          $Res Function(_VideoGetJobStatusOutput) _then) =
      __$VideoGetJobStatusOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JobStatusConverter() JobStatus jobStatus,
