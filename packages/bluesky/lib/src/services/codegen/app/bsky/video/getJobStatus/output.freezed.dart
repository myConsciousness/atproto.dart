...
@pragma('vm:prefer-inline') @override $Res call({Object? jobStatus = null,Object? $unknown = freezed,}) {
  return _then(VideoGetJobStatusOutput(
...
class _VideoGetJobStatusOutput implements VideoGetJobStatusOutput {
  const _VideoGetJobStatusOutput({@JobStatusConverter() required this.jobStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
