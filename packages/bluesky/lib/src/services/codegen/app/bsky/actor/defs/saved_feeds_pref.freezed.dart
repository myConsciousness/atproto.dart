...
mixin _$SavedFeedsPref {
  ...
  $SavedFeedsPrefCopyWith<SavedFeedsPref> get copyWith =>
      _$SavedFeedsPrefCopyWithImpl<SavedFeedsPref>(
          this as SavedFeedsPref, _$identity);
...
abstract mixin class $SavedFeedsPrefCopyWith<$Res> {
  factory $SavedFeedsPrefCopyWith(
          SavedFeedsPref value, $Res Function(SavedFeedsPref) _then) =
      _$SavedFeedsPrefCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      List<String> pinned,
...
extension SavedFeedsPrefPatterns on SavedFeedsPref {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SavedFeedsPref value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, List<String> pinned, List<String> saved,
            int? timelineIndex, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SavedFeedsPref() when $default != null:
        return $default(_that.$type, _that.pinned, _that.saved,
            _that.timelineIndex, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _SavedFeedsPref implements SavedFeedsPref {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SavedFeedsPrefCopyWith<_SavedFeedsPref> get copyWith =>
      __$SavedFeedsPrefCopyWithImpl<_SavedFeedsPref>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SavedFeedsPrefToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$SavedFeedsPrefCopyWith<$Res>
    implements $SavedFeedsPrefCopyWith<$Res> {
  factory _$SavedFeedsPrefCopyWith(
          _SavedFeedsPref value, $Res Function(_SavedFeedsPref) _then) =
      __$SavedFeedsPrefCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
