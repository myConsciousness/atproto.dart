...
mixin _$FeedGetRepostedByInput {
  ...
  $FeedGetRepostedByInputCopyWith<FeedGetRepostedByInput> get copyWith =>
      _$FeedGetRepostedByInputCopyWithImpl<FeedGetRepostedByInput>(
          this as FeedGetRepostedByInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetRepostedByInput &&
...
abstract mixin class $FeedGetRepostedByInputCopyWith<$Res> {
  factory $FeedGetRepostedByInputCopyWith(FeedGetRepostedByInput value,
          $Res Function(FeedGetRepostedByInput) _then) =
      _$FeedGetRepostedByInputCopyWithImpl;
  @useResult
  $Res call(
      {String uri,
      String? cid,
...
extension FeedGetRepostedByInputPatterns on FeedGetRepostedByInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetRepostedByInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String uri, String? cid, int limit, String? cursor,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _FeedGetRepostedByInput() when $default != null:
        return $default(
            _that.uri, _that.cid, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetRepostedByInput implements FeedGetRepostedByInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetRepostedByInputCopyWith<_FeedGetRepostedByInput> get copyWith =>
      __$FeedGetRepostedByInputCopyWithImpl<_FeedGetRepostedByInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetRepostedByInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetRepostedByInput &&
            (identical(other.uri, uri) || other.uri == uri) &&
            (identical(other.cid, cid) || other.cid == cid) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetRepostedByInputCopyWith<$Res>
    implements $FeedGetRepostedByInputCopyWith<$Res> {
  factory _$FeedGetRepostedByInputCopyWith(_FeedGetRepostedByInput value,
          $Res Function(_FeedGetRepostedByInput) _then) =
      __$FeedGetRepostedByInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String uri,
