...
$FeedGetTimelineOutputCopyWith<FeedGetTimelineOutput> get copyWith => _$FeedGetTimelineOutputCopyWithImpl<FeedGetTimelineOutput>(this as FeedGetTimelineOutput, _$identity);
...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feed = null,Object? $unknown = freezed,}) {
  return _then(FeedGetTimelineOutput(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FeedGetTimelineOutput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FeedGetTimelineOutput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FeedGetTimelineOutput value)?  $default,){
final _that = this;
switch (_that) {
case _FeedGetTimelineOutput() when $default != null:
return $default(_that);case _:
...
class _FeedGetTimelineOutput implements FeedGetTimelineOutput {
  const _FeedGetTimelineOutput({this.cursor, @FeedViewPostConverter() required  List<FeedViewPost> feed,  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$FeedGetTimelineOutputCopyWith<_FeedGetTimelineOutput> get copyWith => __$FeedGetTimelineOutputCopyWithImpl<_FeedGetTimelineOutput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FeedGetTimelineOutputToJson(this, );
}
...
/// @nodoc
abstract mixin class _$FeedGetTimelineOutputCopyWith<$Res> implements $FeedGetTimelineOutputCopyWith<$Res> {
