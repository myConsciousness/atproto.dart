...
class _ListViewerState implements ListViewerState {
  const _ListViewerState({this.$type = 'app.bsky.graph.defs#listViewerState', this.muted, @AtUriConverter() this.blocked,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
