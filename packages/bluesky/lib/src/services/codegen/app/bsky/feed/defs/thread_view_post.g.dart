...
_ThreadViewPost _$ThreadViewPostFromJson(Map json) => $checkedCreate(
      '_ThreadViewPost',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$ThreadViewPostToJson(_ThreadViewPost instance) =>
    <String, dynamic>{
      ...
      'replies': instance.replies
          ...
          .toList(),
      'threadContext':
          _$JsonConverterToJson<Map<String, dynamic>, ThreadContext>(
