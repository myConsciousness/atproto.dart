...
mixin _$FeedGetFeedSkeletonInput {
  ...
  $FeedGetFeedSkeletonInputCopyWith<FeedGetFeedSkeletonInput> get copyWith =>
      _$FeedGetFeedSkeletonInputCopyWithImpl<FeedGetFeedSkeletonInput>(
          this as FeedGetFeedSkeletonInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetFeedSkeletonInput &&
...
abstract mixin class $FeedGetFeedSkeletonInputCopyWith<$Res> {
  factory $FeedGetFeedSkeletonInputCopyWith(FeedGetFeedSkeletonInput value,
          $Res Function(FeedGetFeedSkeletonInput) _then) =
      _$FeedGetFeedSkeletonInputCopyWithImpl;
  @useResult
  $Res call(
...
extension FeedGetFeedSkeletonInputPatterns on FeedGetFeedSkeletonInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetFeedSkeletonInput value)? $default, {
...
class _FeedGetFeedSkeletonInput implements FeedGetFeedSkeletonInput {
  const _FeedGetFeedSkeletonInput(
      {required this.feed,
      this.limit = 50,
      this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetFeedSkeletonInputCopyWith<_FeedGetFeedSkeletonInput> get copyWith =>
      __$FeedGetFeedSkeletonInputCopyWithImpl<_FeedGetFeedSkeletonInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetFeedSkeletonInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetFeedSkeletonInput &&
            (identical(other.feed, feed) || other.feed == feed) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetFeedSkeletonInputCopyWith<$Res>
    implements $FeedGetFeedSkeletonInputCopyWith<$Res> {
  factory _$FeedGetFeedSkeletonInputCopyWith(_FeedGetFeedSkeletonInput value,
          $Res Function(_FeedGetFeedSkeletonInput) _then) =
      __$FeedGetFeedSkeletonInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String feed, int limit, String? cursor, Map<String, dynamic>? $unknown});
