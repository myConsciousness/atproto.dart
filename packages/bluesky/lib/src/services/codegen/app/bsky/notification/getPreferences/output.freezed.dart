...
@pragma('vm:prefer-inline') @override $Res call({Object? preferences = null,Object? $unknown = freezed,}) {
  return _then(NotificationGetPreferencesOutput(
...
class _NotificationGetPreferencesOutput implements NotificationGetPreferencesOutput {
  const _NotificationGetPreferencesOutput({@PreferencesConverter() required this.preferences,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
