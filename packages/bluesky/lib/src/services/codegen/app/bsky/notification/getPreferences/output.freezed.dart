...
mixin _$NotificationGetPreferencesOutput {
  ...
  $NotificationGetPreferencesOutputCopyWith<NotificationGetPreferencesOutput>
      get copyWith => _$NotificationGetPreferencesOutputCopyWithImpl<
              NotificationGetPreferencesOutput>(
          this as NotificationGetPreferencesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationGetPreferencesOutput &&
...
abstract mixin class $NotificationGetPreferencesOutputCopyWith<$Res> {
  factory $NotificationGetPreferencesOutputCopyWith(
          ...
          $Res Function(NotificationGetPreferencesOutput) _then) =
      _$NotificationGetPreferencesOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension NotificationGetPreferencesOutputPatterns
    on NotificationGetPreferencesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationGetPreferencesOutput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _NotificationGetPreferencesOutput
    implements NotificationGetPreferencesOutput {
  const _NotificationGetPreferencesOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationGetPreferencesOutputCopyWith<_NotificationGetPreferencesOutput>
      get copyWith => __$NotificationGetPreferencesOutputCopyWithImpl<
          _NotificationGetPreferencesOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationGetPreferencesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationGetPreferencesOutput &&
            (identical(other.preferences, preferences) ||
                other.preferences == preferences) &&
...
/// @nodoc
abstract mixin class _$NotificationGetPreferencesOutputCopyWith<$Res>
    implements $NotificationGetPreferencesOutputCopyWith<$Res> {
  factory _$NotificationGetPreferencesOutputCopyWith(
          _NotificationGetPreferencesOutput value,
          $Res Function(_NotificationGetPreferencesOutput) _then) =
      __$NotificationGetPreferencesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@PreferencesConverter() Preferences preferences,
