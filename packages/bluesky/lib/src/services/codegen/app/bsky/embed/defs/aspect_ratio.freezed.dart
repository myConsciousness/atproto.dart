...
class _AspectRatio implements AspectRatio {
  const _AspectRatio({this.$type = 'app.bsky.embed.defs#aspectRatio', required this.width, required this.height,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
