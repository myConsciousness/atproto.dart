...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? did = null,Object? $unknown = freezed,}) {
  return _then(RichtextFacetMention(
...
class _RichtextFacetMention implements RichtextFacetMention {
  const _RichtextFacetMention({this.$type = 'app.bsky.richtext.facet#mention', required this.did,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
