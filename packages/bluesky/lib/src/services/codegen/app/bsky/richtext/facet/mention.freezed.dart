...
mixin _$RichtextFacetMention {
  ...
  $RichtextFacetMentionCopyWith<RichtextFacetMention> get copyWith =>
      _$RichtextFacetMentionCopyWithImpl<RichtextFacetMention>(
          this as RichtextFacetMention, _$identity);
...
abstract mixin class $RichtextFacetMentionCopyWith<$Res> {
  factory $RichtextFacetMentionCopyWith(RichtextFacetMention value,
          $Res Function(RichtextFacetMention) _then) =
      _$RichtextFacetMentionCopyWithImpl;
  @useResult
...
extension RichtextFacetMentionPatterns on RichtextFacetMention {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RichtextFacetMention value)? $default, {
...
class _RichtextFacetMention implements RichtextFacetMention {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RichtextFacetMentionCopyWith<_RichtextFacetMention> get copyWith =>
      __$RichtextFacetMentionCopyWithImpl<_RichtextFacetMention>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RichtextFacetMentionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RichtextFacetMention &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.did, did) || other.did == did) &&
...
/// @nodoc
abstract mixin class _$RichtextFacetMentionCopyWith<$Res>
    implements $RichtextFacetMentionCopyWith<$Res> {
  factory _$RichtextFacetMentionCopyWith(_RichtextFacetMention value,
          $Res Function(_RichtextFacetMention) _then) =
      __$RichtextFacetMentionCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String did, Map<String, dynamic>? $unknown});
}
