...
@pragma('vm:prefer-inline') @override $Res call({Object? views = null,Object? $unknown = freezed,}) {
  return _then(LabelerGetServicesOutput(
...
class _LabelerGetServicesOutput implements LabelerGetServicesOutput {
  const _LabelerGetServicesOutput({@ULabelerGetServicesViewsConverter() required  List<ULabelerGetServicesViews> views,  Map<String, dynamic>? $unknown}): _views = views,_$unknown = $unknown;
