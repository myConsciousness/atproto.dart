...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? bookmarks = null,Object? $unknown = freezed,}) {
  return _then(BookmarkGetBookmarksOutput(
...
class _BookmarkGetBookmarksOutput implements BookmarkGetBookmarksOutput {
  const _BookmarkGetBookmarksOutput({this.cursor, @BookmarkViewConverter() required  List<BookmarkView> bookmarks,  Map<String, dynamic>? $unknown}): _bookmarks = bookmarks,_$unknown = $unknown;
