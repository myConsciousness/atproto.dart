...
class _LabelerPrefItem implements LabelerPrefItem {
  const _LabelerPrefItem({this.$type = 'app.bsky.actor.defs#labelerPrefItem', required this.did,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
