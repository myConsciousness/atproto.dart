...
_$UnspeccedCheckHandleAvailabilityOutputFromJson(Map json) => $checkedCreate(
  '_UnspeccedCheckHandleAvailabilityOutput',
  json,
  ($checkedConvert) {
    final val = _UnspeccedCheckHandleAvailabilityOutput(
      ...
      result: $checkedConvert(
        'result',
        (v) => const UUnspeccedCheckHandleAvailabilityResultConverter()
...
Map<String, dynamic> _$UnspeccedCheckHandleAvailabilityOutputToJson(
  ...
  'result': const UUnspeccedCheckHandleAvailabilityResultConverter().toJson(
    instance.result,
  ),
