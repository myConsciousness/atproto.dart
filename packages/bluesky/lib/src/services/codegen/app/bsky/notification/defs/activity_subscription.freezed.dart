...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? post = null,Object? reply = null,Object? $unknown = freezed,}) {
  return _then(ActivitySubscription(
...
class _ActivitySubscription implements ActivitySubscription {
  const _ActivitySubscription({this.$type = 'app.bsky.notification.defs#activitySubscription', required this.post, required this.reply,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
