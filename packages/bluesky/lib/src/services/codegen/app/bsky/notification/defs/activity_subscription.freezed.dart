...
mixin _$ActivitySubscription {
  ...
  $ActivitySubscriptionCopyWith<ActivitySubscription> get copyWith =>
      _$ActivitySubscriptionCopyWithImpl<ActivitySubscription>(
          this as ActivitySubscription, _$identity);
...
abstract mixin class $ActivitySubscriptionCopyWith<$Res> {
  factory $ActivitySubscriptionCopyWith(ActivitySubscription value,
          $Res Function(ActivitySubscription) _then) =
      _$ActivitySubscriptionCopyWithImpl;
  @useResult
  $Res call(
...
extension ActivitySubscriptionPatterns on ActivitySubscription {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActivitySubscription value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, bool post, bool reply,
    ...
    switch (_that) {
      case _ActivitySubscription() when $default != null:
        return $default(_that.$type, _that.post, _that.reply, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ActivitySubscription implements ActivitySubscription {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActivitySubscriptionCopyWith<_ActivitySubscription> get copyWith =>
      __$ActivitySubscriptionCopyWithImpl<_ActivitySubscription>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActivitySubscriptionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActivitySubscription &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.post, post) || other.post == post) &&
            (identical(other.reply, reply) || other.reply == reply) &&
...
/// @nodoc
abstract mixin class _$ActivitySubscriptionCopyWith<$Res>
    implements $ActivitySubscriptionCopyWith<$Res> {
  factory _$ActivitySubscriptionCopyWith(_ActivitySubscription value,
          $Res Function(_ActivitySubscription) _then) =
      __$ActivitySubscriptionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type, bool post, bool reply, Map<String, dynamic>? $unknown});
