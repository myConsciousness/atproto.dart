...
class _RichtextFacet implements RichtextFacet {
  const _RichtextFacet({this.$type = 'app.bsky.richtext.facet', @RichtextFacetByteSliceConverter() required this.index, @URichtextFacetFeaturesConverter() required  List<URichtextFacetFeatures> features,  Map<String, dynamic>? $unknown}): _features = features,_$unknown = $unknown;
