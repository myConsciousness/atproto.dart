...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? icon = freezed,Object? title = null,Object? description = freezed,Object? theme = freezed,Object? $unknown = freezed,}) {
  return _then(EmbedExternalViewExternalSource(
...
class _EmbedExternalViewExternalSource implements EmbedExternalViewExternalSource {
  const _EmbedExternalViewExternalSource({this.$type = 'app.bsky.embed.external#viewExternalSource', required this.uri, this.icon, required this.title, this.description, @EmbedExternalViewExternalSourceThemeConverter() this.theme,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
