...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? blocked = null,Object? author = null,Object? $unknown = freezed,}) {
  return _then(EmbedRecordViewBlocked(
...
class _EmbedRecordViewBlocked implements EmbedRecordViewBlocked {
  const _EmbedRecordViewBlocked({this.$type = 'app.bsky.embed.record#viewBlocked', @AtUriConverter() required this.uri, required this.blocked, @BlockedAuthorConverter() required this.author,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
