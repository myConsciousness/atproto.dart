...
mixin _$GraphGetFollowersOutput {
  ...
  $GraphGetFollowersOutputCopyWith<GraphGetFollowersOutput> get copyWith =>
      _$GraphGetFollowersOutputCopyWithImpl<GraphGetFollowersOutput>(
          this as GraphGetFollowersOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetFollowersOutput &&
...
abstract mixin class $GraphGetFollowersOutputCopyWith<$Res> {
  factory $GraphGetFollowersOutputCopyWith(GraphGetFollowersOutput value,
          $Res Function(GraphGetFollowersOutput) _then) =
      _$GraphGetFollowersOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetFollowersOutputPatterns on GraphGetFollowersOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetFollowersOutput value)? $default, {
...
class _GraphGetFollowersOutput implements GraphGetFollowersOutput {
  const _GraphGetFollowersOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetFollowersOutputCopyWith<_GraphGetFollowersOutput> get copyWith =>
      __$GraphGetFollowersOutputCopyWithImpl<_GraphGetFollowersOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetFollowersOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetFollowersOutput &&
            (identical(other.subject, subject) || other.subject == subject) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetFollowersOutputCopyWith<$Res>
    implements $GraphGetFollowersOutputCopyWith<$Res> {
  factory _$GraphGetFollowersOutputCopyWith(_GraphGetFollowersOutput value,
          $Res Function(_GraphGetFollowersOutput) _then) =
      __$GraphGetFollowersOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ProfileViewConverter() ProfileView subject,
