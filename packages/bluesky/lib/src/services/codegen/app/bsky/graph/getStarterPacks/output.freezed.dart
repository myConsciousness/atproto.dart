...
mixin _$GraphGetStarterPacksOutput {
  ...
  $GraphGetStarterPacksOutputCopyWith<GraphGetStarterPacksOutput>
      get copyWith =>
          _$GraphGetStarterPacksOutputCopyWithImpl<GraphGetStarterPacksOutput>(
              this as GraphGetStarterPacksOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetStarterPacksOutput &&
...
abstract mixin class $GraphGetStarterPacksOutputCopyWith<$Res> {
  factory $GraphGetStarterPacksOutputCopyWith(GraphGetStarterPacksOutput value,
          $Res Function(GraphGetStarterPacksOutput) _then) =
      _$GraphGetStarterPacksOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetStarterPacksOutputPatterns on GraphGetStarterPacksOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetStarterPacksOutput value)? $default, {
...
class _GraphGetStarterPacksOutput implements GraphGetStarterPacksOutput {
  const _GraphGetStarterPacksOutput(
      {@StarterPackViewBasicConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetStarterPacksOutputCopyWith<_GraphGetStarterPacksOutput>
      get copyWith => __$GraphGetStarterPacksOutputCopyWithImpl<
          _GraphGetStarterPacksOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetStarterPacksOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetStarterPacksOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$GraphGetStarterPacksOutputCopyWith<$Res>
    implements $GraphGetStarterPacksOutputCopyWith<$Res> {
  factory _$GraphGetStarterPacksOutputCopyWith(
          _GraphGetStarterPacksOutput value,
          $Res Function(_GraphGetStarterPacksOutput) _then) =
      __$GraphGetStarterPacksOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@StarterPackViewBasicConverter() List<StarterPackViewBasic> starterPacks,
