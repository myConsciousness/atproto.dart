...
@pragma('vm:prefer-inline') @override $Res call({Object? starterPacks = null,Object? $unknown = freezed,}) {
  return _then(GraphGetStarterPacksOutput(
...
class _GraphGetStarterPacksOutput implements GraphGetStarterPacksOutput {
  const _GraphGetStarterPacksOutput({@StarterPackViewBasicConverter() required  List<StarterPackViewBasic> starterPacks,  Map<String, dynamic>? $unknown}): _starterPacks = starterPacks,_$unknown = $unknown;
