...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SkeletonSearchPost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
/// @nodoc
abstract mixin class $SkeletonSearchPostCopyWith<$Res>  {
...
/// @nodoc
class _$SkeletonSearchPostCopyWithImpl<$Res>
    implements $SkeletonSearchPostCopyWith<$Res> {
  _$SkeletonSearchPostCopyWithImpl(this._self, this._then);

  final SkeletonSearchPost _self;
  final $Res Function(SkeletonSearchPost) _then;

/// Create a copy of SkeletonSearchPost
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? $unknown = freezed,}) {
  return _then(SkeletonSearchPost(
...
/// Adds pattern-matching-related methods to [SkeletonSearchPost].
extension SkeletonSearchPostPatterns on SkeletonSearchPost {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SkeletonSearchPost value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SkeletonSearchPost value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SkeletonSearchPost value)?  $default,){
final _that = this;
switch (_that) {
case _SkeletonSearchPost() when $default != null:
return $default(_that);case _:
...
class _SkeletonSearchPost implements SkeletonSearchPost {
  const _SkeletonSearchPost({this.$type = 'app.bsky.unspecced.defs#skeletonSearchPost', @AtUriConverter() required this.uri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$SkeletonSearchPostCopyWith<_SkeletonSearchPost> get copyWith => __$SkeletonSearchPostCopyWithImpl<_SkeletonSearchPost>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SkeletonSearchPostToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SkeletonSearchPost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$SkeletonSearchPostCopyWith<$Res> implements $SkeletonSearchPostCopyWith<$Res> {
...
/// @nodoc
class __$SkeletonSearchPostCopyWithImpl<$Res>
    implements _$SkeletonSearchPostCopyWith<$Res> {
  __$SkeletonSearchPostCopyWithImpl(this._self, this._then);

  final _SkeletonSearchPost _self;
  final $Res Function(_SkeletonSearchPost) _then;
