...
class _UnspeccedGetSuggestedUsersSkeletonOutput implements UnspeccedGetSuggestedUsersSkeletonOutput {
  const _UnspeccedGetSuggestedUsersSkeletonOutput({required final  List<String> dids, this.recIdStr, final  Map<String, dynamic>? $unknown}): _dids = dids,_$unknown = $unknown;
