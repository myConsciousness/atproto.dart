...
class _AdultContentPref implements AdultContentPref {
  const _AdultContentPref({this.$type = 'app.bsky.actor.defs#adultContentPref', this.enabled = false,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
