...
mixin _$FeedDescribeFeedGeneratorOutput {
  ...
  $FeedDescribeFeedGeneratorOutputCopyWith<FeedDescribeFeedGeneratorOutput>
      get copyWith => _$FeedDescribeFeedGeneratorOutputCopyWithImpl<
              FeedDescribeFeedGeneratorOutput>(
          this as FeedDescribeFeedGeneratorOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedDescribeFeedGeneratorOutput &&
...
abstract mixin class $FeedDescribeFeedGeneratorOutputCopyWith<$Res> {
  factory $FeedDescribeFeedGeneratorOutputCopyWith(
          ...
          $Res Function(FeedDescribeFeedGeneratorOutput) _then) =
      _$FeedDescribeFeedGeneratorOutputCopyWithImpl;
  @useResult
  $Res call(
      {String did,
...
extension FeedDescribeFeedGeneratorOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedDescribeFeedGeneratorOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String did, @FeedConverter() List<Feed> feeds,
            @LinksConverter() Links? links, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FeedDescribeFeedGeneratorOutput() when $default != null:
        return $default(_that.did, _that.feeds, _that.links, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _FeedDescribeFeedGeneratorOutput
    implements FeedDescribeFeedGeneratorOutput {
  const _FeedDescribeFeedGeneratorOutput(
      {required this.did,
      ...
      : _feeds = feeds,
        _$unknown = $unknown;
  factory _FeedDescribeFeedGeneratorOutput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedDescribeFeedGeneratorOutputCopyWith<_FeedDescribeFeedGeneratorOutput>
      get copyWith => __$FeedDescribeFeedGeneratorOutputCopyWithImpl<
          _FeedDescribeFeedGeneratorOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedDescribeFeedGeneratorOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedDescribeFeedGeneratorOutput &&
            (identical(other.did, did) || other.did == did) &&
...
/// @nodoc
abstract mixin class _$FeedDescribeFeedGeneratorOutputCopyWith<$Res>
    implements $FeedDescribeFeedGeneratorOutputCopyWith<$Res> {
  factory _$FeedDescribeFeedGeneratorOutputCopyWith(
          _FeedDescribeFeedGeneratorOutput value,
          $Res Function(_FeedDescribeFeedGeneratorOutput) _then) =
      __$FeedDescribeFeedGeneratorOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String did,
