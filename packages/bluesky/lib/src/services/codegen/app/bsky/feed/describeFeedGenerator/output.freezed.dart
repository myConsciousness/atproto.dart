...
@pragma('vm:prefer-inline') @override $Res call({Object? did = null,Object? feeds = null,Object? links = freezed,Object? $unknown = freezed,}) {
  return _then(FeedDescribeFeedGeneratorOutput(
...
class _FeedDescribeFeedGeneratorOutput implements FeedDescribeFeedGeneratorOutput {
  const _FeedDescribeFeedGeneratorOutput({required this.did, @FeedConverter() required  List<Feed> feeds, @LinksConverter() this.links,  Map<String, dynamic>? $unknown}): _feeds = feeds,_$unknown = $unknown;
