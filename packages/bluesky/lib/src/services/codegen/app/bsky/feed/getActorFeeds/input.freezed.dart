...
@pragma('vm:prefer-inline') @override $Res call({Object? actor = null,Object? limit = null,Object? cursor = freezed,Object? $unknown = freezed,}) {
  return _then(FeedGetActorFeedsInput(
...
class _FeedGetActorFeedsInput implements FeedGetActorFeedsInput {
  const _FeedGetActorFeedsInput({required this.actor, this.limit = 50, this.cursor,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
