  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPostThreadV2Sort &&
...
class $UnspeccedGetPostThreadV2SortCopyWith<$Res> {
  $UnspeccedGetPostThreadV2SortCopyWith(UnspeccedGetPostThreadV2Sort _,
      $Res Function(UnspeccedGetPostThreadV2Sort) __);
}
...
extension UnspeccedGetPostThreadV2SortPatterns on UnspeccedGetPostThreadV2Sort {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UnspeccedGetPostThreadV2SortUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UnspeccedGetPostThreadV2SortKnownValue():
        return knownValue(_that);
      case UnspeccedGetPostThreadV2SortUnknown():
        return unknown(_that);
      case _:
...
class UnspeccedGetPostThreadV2SortKnownValue
    extends UnspeccedGetPostThreadV2Sort {
  const UnspeccedGetPostThreadV2SortKnownValue({required this.data})
      : super._();
  ...
  $UnspeccedGetPostThreadV2SortKnownValueCopyWith<
          UnspeccedGetPostThreadV2SortKnownValue>
      get copyWith => _$UnspeccedGetPostThreadV2SortKnownValueCopyWithImpl<
          UnspeccedGetPostThreadV2SortKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPostThreadV2SortKnownValue &&
...
/// @nodoc
abstract mixin class $UnspeccedGetPostThreadV2SortKnownValueCopyWith<$Res>
    implements $UnspeccedGetPostThreadV2SortCopyWith<$Res> {
  factory $UnspeccedGetPostThreadV2SortKnownValueCopyWith(
          UnspeccedGetPostThreadV2SortKnownValue value,
          $Res Function(UnspeccedGetPostThreadV2SortKnownValue) _then) =
      _$UnspeccedGetPostThreadV2SortKnownValueCopyWithImpl;
  @useResult
...
class UnspeccedGetPostThreadV2SortUnknown extends UnspeccedGetPostThreadV2Sort {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UnspeccedGetPostThreadV2SortUnknownCopyWith<
          UnspeccedGetPostThreadV2SortUnknown>
      get copyWith => _$UnspeccedGetPostThreadV2SortUnknownCopyWithImpl<
          UnspeccedGetPostThreadV2SortUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetPostThreadV2SortUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UnspeccedGetPostThreadV2SortUnknownCopyWith<$Res>
    implements $UnspeccedGetPostThreadV2SortCopyWith<$Res> {
  factory $UnspeccedGetPostThreadV2SortUnknownCopyWith(
          UnspeccedGetPostThreadV2SortUnknown value,
          $Res Function(UnspeccedGetPostThreadV2SortUnknown) _then) =
      _$UnspeccedGetPostThreadV2SortUnknownCopyWithImpl;
  @useResult
