...
extension EmbedRecordViewDetachedPatterns on EmbedRecordViewDetached {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_EmbedRecordViewDetached value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String uri, bool detached,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _EmbedRecordViewDetached() when $default != null:
        return $default(_that.$type, _that.uri, _that.detached, _that.$unknown);
      case _:
        return orElse();
    }
  }
