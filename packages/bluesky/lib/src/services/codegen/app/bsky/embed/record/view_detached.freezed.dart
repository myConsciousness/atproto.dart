...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? detached = null,Object? $unknown = freezed,}) {
  return _then(EmbedRecordViewDetached(
...
class _EmbedRecordViewDetached implements EmbedRecordViewDetached {
  const _EmbedRecordViewDetached({this.$type = 'app.bsky.embed.record#viewDetached', @AtUriConverter() required this.uri, required this.detached,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
