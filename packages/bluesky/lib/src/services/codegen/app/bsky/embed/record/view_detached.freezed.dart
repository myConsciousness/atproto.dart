...
mixin _$EmbedRecordViewDetached {
 ...
 String get $type; String get uri; bool get detached; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type, String uri, bool detached, Map<String, dynamic>? $unknown
});
...
as String,detached: null == detached ? _self.detached : detached // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String uri,  bool detached,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmbedRecordViewDetached() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String uri,  bool detached,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _EmbedRecordViewDetached():
return $default(_that.$type,_that.uri,_that.detached,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String uri,  bool detached,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _EmbedRecordViewDetached() when $default != null:
return $default(_that.$type,_that.uri,_that.detached,_that.$unknown);case _:
  return null;
