...
mixin _$ActorGetProfileInput {
  ...
  $ActorGetProfileInputCopyWith<ActorGetProfileInput> get copyWith =>
      _$ActorGetProfileInputCopyWithImpl<ActorGetProfileInput>(
          this as ActorGetProfileInput, _$identity);
...
abstract mixin class $ActorGetProfileInputCopyWith<$Res> {
  factory $ActorGetProfileInputCopyWith(ActorGetProfileInput value,
          $Res Function(ActorGetProfileInput) _then) =
      _$ActorGetProfileInputCopyWithImpl;
  @useResult
...
extension ActorGetProfileInputPatterns on ActorGetProfileInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorGetProfileInput value)? $default, {
...
class _ActorGetProfileInput implements ActorGetProfileInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorGetProfileInputCopyWith<_ActorGetProfileInput> get copyWith =>
      __$ActorGetProfileInputCopyWithImpl<_ActorGetProfileInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorGetProfileInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorGetProfileInput &&
            (identical(other.actor, actor) || other.actor == actor) &&
...
/// @nodoc
abstract mixin class _$ActorGetProfileInputCopyWith<$Res>
    implements $ActorGetProfileInputCopyWith<$Res> {
  factory _$ActorGetProfileInputCopyWith(_ActorGetProfileInput value,
          $Res Function(_ActorGetProfileInput) _then) =
      __$ActorGetProfileInputCopyWithImpl;
  @override
  @useResult
  $Res call({String actor, Map<String, dynamic>? $unknown});
}
