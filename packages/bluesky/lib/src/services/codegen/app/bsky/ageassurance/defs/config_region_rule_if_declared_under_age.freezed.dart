...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? age = null,Object? access = null,Object? $unknown = freezed,}) {
  return _then(ConfigRegionRuleIfDeclaredUnderAge(
...
class _ConfigRegionRuleIfDeclaredUnderAge implements ConfigRegionRuleIfDeclaredUnderAge {
  const _ConfigRegionRuleIfDeclaredUnderAge({this.$type = 'app.bsky.ageassurance.defs#configRegionRuleIfDeclaredUnderAge', required this.age, @AccessConverter() required this.access,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
