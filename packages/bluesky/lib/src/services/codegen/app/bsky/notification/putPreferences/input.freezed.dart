...
mixin _$NotificationPutPreferencesInput {
  ...
  $NotificationPutPreferencesInputCopyWith<NotificationPutPreferencesInput>
      get copyWith => _$NotificationPutPreferencesInputCopyWithImpl<
              NotificationPutPreferencesInput>(
          this as NotificationPutPreferencesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationPutPreferencesInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, priority, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $NotificationPutPreferencesInputCopyWith<$Res> {
  factory $NotificationPutPreferencesInputCopyWith(
          ...
          $Res Function(NotificationPutPreferencesInput) _then) =
      _$NotificationPutPreferencesInputCopyWithImpl;
  @useResult
...
extension NotificationPutPreferencesInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationPutPreferencesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool priority, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NotificationPutPreferencesInput() when $default != null:
        return $default(_that.priority, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationPutPreferencesInput
    implements NotificationPutPreferencesInput {
  const _NotificationPutPreferencesInput(
      {required this.priority, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _NotificationPutPreferencesInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationPutPreferencesInputCopyWith<_NotificationPutPreferencesInput>
      get copyWith => __$NotificationPutPreferencesInputCopyWithImpl<
          _NotificationPutPreferencesInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationPutPreferencesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationPutPreferencesInput &&
            (identical(other.priority, priority) ||
                other.priority == priority) &&
...
/// @nodoc
abstract mixin class _$NotificationPutPreferencesInputCopyWith<$Res>
    implements $NotificationPutPreferencesInputCopyWith<$Res> {
  factory _$NotificationPutPreferencesInputCopyWith(
          _NotificationPutPreferencesInput value,
          $Res Function(_NotificationPutPreferencesInput) _then) =
      __$NotificationPutPreferencesInputCopyWithImpl;
  @override
  @useResult
  $Res call({bool priority, Map<String, dynamic>? $unknown});
}
