...
@ProfileViewConverter() List<ProfileView> get suggestions;/// Snowflake for this recommendation, use when submitting recommendation events.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GraphGetSuggestedFollowsByActorOutput&&const DeepCollectionEquality().equals(other.suggestions, suggestions)&&(identical(other.recIdStr, recIdStr) || other.recIdStr == recIdStr)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(suggestions),recIdStr,const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
@ProfileViewConverter() List<ProfileView> suggestions, String? recIdStr, Map<String, dynamic>? $unknown
});
...
/// Create a copy of GraphGetSuggestedFollowsByActorOutput
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? suggestions = null,Object? recIdStr = freezed,Object? $unknown = freezed,}) {
  return _then(GraphGetSuggestedFollowsByActorOutput(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@ProfileViewConverter()  List<ProfileView> suggestions,  String? recIdStr,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GraphGetSuggestedFollowsByActorOutput() when $default != null:
return $default(_that.suggestions,_that.recIdStr,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@ProfileViewConverter()  List<ProfileView> suggestions,  String? recIdStr,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _GraphGetSuggestedFollowsByActorOutput():
return $default(_that.suggestions,_that.recIdStr,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@ProfileViewConverter()  List<ProfileView> suggestions,  String? recIdStr,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _GraphGetSuggestedFollowsByActorOutput() when $default != null:
return $default(_that.suggestions,_that.recIdStr,_that.$unknown);case _:
  return null;
...
class _GraphGetSuggestedFollowsByActorOutput implements GraphGetSuggestedFollowsByActorOutput {
  const _GraphGetSuggestedFollowsByActorOutput({@ProfileViewConverter() required  List<ProfileView> suggestions, this.recIdStr,  Map<String, dynamic>? $unknown}): _suggestions = suggestions,_$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GraphGetSuggestedFollowsByActorOutput&&const DeepCollectionEquality().equals(other._suggestions, _suggestions)&&(identical(other.recIdStr, recIdStr) || other.recIdStr == recIdStr)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_suggestions),recIdStr,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of GraphGetSuggestedFollowsByActorOutput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? suggestions = null,Object? recIdStr = freezed,Object? $unknown = freezed,}) {
