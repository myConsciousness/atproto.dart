...
mixin _$GraphGetSuggestedFollowsByActorOutput {
  ...
  $GraphGetSuggestedFollowsByActorOutputCopyWith<
      ...
      get copyWith => _$GraphGetSuggestedFollowsByActorOutputCopyWithImpl<
              GraphGetSuggestedFollowsByActorOutput>(
          this as GraphGetSuggestedFollowsByActorOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetSuggestedFollowsByActorOutput &&
...
abstract mixin class $GraphGetSuggestedFollowsByActorOutputCopyWith<$Res> {
  factory $GraphGetSuggestedFollowsByActorOutputCopyWith(
          ...
          $Res Function(GraphGetSuggestedFollowsByActorOutput) _then) =
      _$GraphGetSuggestedFollowsByActorOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetSuggestedFollowsByActorOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetSuggestedFollowsByActorOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@ProfileViewConverter() List<ProfileView> suggestions,
            bool isFallback, int? recId, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _GraphGetSuggestedFollowsByActorOutput() when $default != null:
        return $default(
            _that.suggestions, _that.isFallback, _that.recId, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _GraphGetSuggestedFollowsByActorOutput
    implements GraphGetSuggestedFollowsByActorOutput {
  const _GraphGetSuggestedFollowsByActorOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetSuggestedFollowsByActorOutputCopyWith<
          _GraphGetSuggestedFollowsByActorOutput>
      get copyWith => __$GraphGetSuggestedFollowsByActorOutputCopyWithImpl<
          _GraphGetSuggestedFollowsByActorOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetSuggestedFollowsByActorOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetSuggestedFollowsByActorOutput &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$GraphGetSuggestedFollowsByActorOutputCopyWith<$Res>
    implements $GraphGetSuggestedFollowsByActorOutputCopyWith<$Res> {
  factory _$GraphGetSuggestedFollowsByActorOutputCopyWith(
          _GraphGetSuggestedFollowsByActorOutput value,
          $Res Function(_GraphGetSuggestedFollowsByActorOutput) _then) =
      __$GraphGetSuggestedFollowsByActorOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ProfileViewConverter() List<ProfileView> suggestions,
