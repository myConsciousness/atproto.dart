...
class _GraphGetSuggestedFollowsByActorOutput implements GraphGetSuggestedFollowsByActorOutput {
  const _GraphGetSuggestedFollowsByActorOutput({@ProfileViewConverter() required final  List<ProfileView> suggestions, this.recIdStr, final  Map<String, dynamic>? $unknown}): _suggestions = suggestions,_$unknown = $unknown;
