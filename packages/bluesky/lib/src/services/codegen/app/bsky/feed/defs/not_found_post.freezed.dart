...
class _NotFoundPost implements NotFoundPost {
  const _NotFoundPost({this.$type = 'app.bsky.feed.defs#notFoundPost', @AtUriConverter() required this.uri, required this.notFound,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
