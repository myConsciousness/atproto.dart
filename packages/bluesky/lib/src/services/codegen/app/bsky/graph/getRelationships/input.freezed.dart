...
mixin _$GraphGetRelationshipsInput {
  ...
  $GraphGetRelationshipsInputCopyWith<GraphGetRelationshipsInput>
      get copyWith =>
          _$GraphGetRelationshipsInputCopyWithImpl<GraphGetRelationshipsInput>(
              this as GraphGetRelationshipsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetRelationshipsInput &&
...
abstract mixin class $GraphGetRelationshipsInputCopyWith<$Res> {
  factory $GraphGetRelationshipsInputCopyWith(GraphGetRelationshipsInput value,
          $Res Function(GraphGetRelationshipsInput) _then) =
      _$GraphGetRelationshipsInputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetRelationshipsInputPatterns on GraphGetRelationshipsInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetRelationshipsInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _GraphGetRelationshipsInput() when $default != null:
        return $default(_that.actor, _that.others, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphGetRelationshipsInput implements GraphGetRelationshipsInput {
  const _GraphGetRelationshipsInput(
      {required this.actor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetRelationshipsInputCopyWith<_GraphGetRelationshipsInput>
      get copyWith => __$GraphGetRelationshipsInputCopyWithImpl<
          _GraphGetRelationshipsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetRelationshipsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetRelationshipsInput &&
            (identical(other.actor, actor) || other.actor == actor) &&
...
/// @nodoc
abstract mixin class _$GraphGetRelationshipsInputCopyWith<$Res>
    implements $GraphGetRelationshipsInputCopyWith<$Res> {
  factory _$GraphGetRelationshipsInputCopyWith(
          _GraphGetRelationshipsInput value,
          $Res Function(_GraphGetRelationshipsInput) _then) =
      __$GraphGetRelationshipsInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String actor, List<String>? others, Map<String, dynamic>? $unknown});
