...
mixin _$UnspeccedGetTrendsSkeletonOutput {
  ...
  $UnspeccedGetTrendsSkeletonOutputCopyWith<UnspeccedGetTrendsSkeletonOutput>
      get copyWith => _$UnspeccedGetTrendsSkeletonOutputCopyWithImpl<
              UnspeccedGetTrendsSkeletonOutput>(
          this as UnspeccedGetTrendsSkeletonOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetTrendsSkeletonOutput &&
...
abstract mixin class $UnspeccedGetTrendsSkeletonOutputCopyWith<$Res> {
  factory $UnspeccedGetTrendsSkeletonOutputCopyWith(
          ...
          $Res Function(UnspeccedGetTrendsSkeletonOutput) _then) =
      _$UnspeccedGetTrendsSkeletonOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension UnspeccedGetTrendsSkeletonOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetTrendsSkeletonOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@SkeletonTrendConverter() List<SkeletonTrend> trends,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetTrendsSkeletonOutput() when $default != null:
        return $default(_that.trends, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetTrendsSkeletonOutput
    implements UnspeccedGetTrendsSkeletonOutput {
  const _UnspeccedGetTrendsSkeletonOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetTrendsSkeletonOutputCopyWith<_UnspeccedGetTrendsSkeletonOutput>
      get copyWith => __$UnspeccedGetTrendsSkeletonOutputCopyWithImpl<
          _UnspeccedGetTrendsSkeletonOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetTrendsSkeletonOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetTrendsSkeletonOutput &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetTrendsSkeletonOutputCopyWith<$Res>
    implements $UnspeccedGetTrendsSkeletonOutputCopyWith<$Res> {
  factory _$UnspeccedGetTrendsSkeletonOutputCopyWith(
          _UnspeccedGetTrendsSkeletonOutput value,
          $Res Function(_UnspeccedGetTrendsSkeletonOutput) _then) =
      __$UnspeccedGetTrendsSkeletonOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@SkeletonTrendConverter() List<SkeletonTrend> trends,
