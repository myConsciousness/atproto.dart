...
@pragma('vm:prefer-inline') @override $Res call({Object? trends = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetTrendsSkeletonOutput(
...
class _UnspeccedGetTrendsSkeletonOutput implements UnspeccedGetTrendsSkeletonOutput {
  const _UnspeccedGetTrendsSkeletonOutput({@SkeletonTrendConverter() required  List<SkeletonTrend> trends,  Map<String, dynamic>? $unknown}): _trends = trends,_$unknown = $unknown;
