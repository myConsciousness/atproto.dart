...
class _DraftEmbedRecord implements DraftEmbedRecord {
  const _DraftEmbedRecord({this.$type = 'app.bsky.draft.defs#draftEmbedRecord', @RepoStrongRefConverter() required this.record,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
