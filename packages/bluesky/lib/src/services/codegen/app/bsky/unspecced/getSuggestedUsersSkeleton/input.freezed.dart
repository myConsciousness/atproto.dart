...
mixin _$UnspeccedGetSuggestedUsersSkeletonInput {
  ...
  $UnspeccedGetSuggestedUsersSkeletonInputCopyWith<
      ...
      get copyWith => _$UnspeccedGetSuggestedUsersSkeletonInputCopyWithImpl<
              UnspeccedGetSuggestedUsersSkeletonInput>(
          this as UnspeccedGetSuggestedUsersSkeletonInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestedUsersSkeletonInput &&
...
abstract mixin class $UnspeccedGetSuggestedUsersSkeletonInputCopyWith<$Res> {
  factory $UnspeccedGetSuggestedUsersSkeletonInputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestedUsersSkeletonInput) _then) =
...
extension UnspeccedGetSuggestedUsersSkeletonInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedUsersSkeletonInput value)?
        $default, {
  ...
  TResult map<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedUsersSkeletonInput value) $default,
  ) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? viewer, String? category, int limit,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UnspeccedGetSuggestedUsersSkeletonInput() when $default != null:
        return $default(
            _that.viewer, _that.category, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestedUsersSkeletonInput
    implements UnspeccedGetSuggestedUsersSkeletonInput {
  const _UnspeccedGetSuggestedUsersSkeletonInput(
      {this.viewer,
      this.category,
      this.limit = 25,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestedUsersSkeletonInputCopyWith<
          _UnspeccedGetSuggestedUsersSkeletonInput>
      get copyWith => __$UnspeccedGetSuggestedUsersSkeletonInputCopyWithImpl<
          _UnspeccedGetSuggestedUsersSkeletonInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestedUsersSkeletonInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestedUsersSkeletonInput &&
            (identical(other.viewer, viewer) || other.viewer == viewer) &&
            (identical(other.category, category) ||
                other.category == category) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestedUsersSkeletonInputCopyWith<$Res>
    implements $UnspeccedGetSuggestedUsersSkeletonInputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestedUsersSkeletonInputCopyWith(
          _UnspeccedGetSuggestedUsersSkeletonInput value,
          $Res Function(_UnspeccedGetSuggestedUsersSkeletonInput) _then) =
      __$UnspeccedGetSuggestedUsersSkeletonInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? viewer,
