...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? path = null,Object? $unknown = freezed,}) {
  return _then(DraftEmbedLocalRef(
...
class _DraftEmbedLocalRef implements DraftEmbedLocalRef {
  const _DraftEmbedLocalRef({this.$type = 'app.bsky.draft.defs#draftEmbedLocalRef', required this.path,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
