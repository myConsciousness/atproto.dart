  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationDeclarationAllowSubscriptions &&
...
class $NotificationDeclarationAllowSubscriptionsCopyWith<$Res> {
  $NotificationDeclarationAllowSubscriptionsCopyWith(
      NotificationDeclarationAllowSubscriptions _,
      $Res Function(NotificationDeclarationAllowSubscriptions) __);
}

/// Adds pattern-matching-related methods to [NotificationDeclarationAllowSubscriptions].
extension NotificationDeclarationAllowSubscriptionsPatterns
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case NotificationDeclarationAllowSubscriptionsUnknown()
          when unknown != null:
...
class NotificationDeclarationAllowSubscriptionsKnownValue
    extends NotificationDeclarationAllowSubscriptions {
  const NotificationDeclarationAllowSubscriptionsKnownValue(
      {required this.data})
      : super._();
  ...
  $NotificationDeclarationAllowSubscriptionsKnownValueCopyWith<
          NotificationDeclarationAllowSubscriptionsKnownValue>
      get copyWith =>
          _$NotificationDeclarationAllowSubscriptionsKnownValueCopyWithImpl<
                  NotificationDeclarationAllowSubscriptionsKnownValue>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationDeclarationAllowSubscriptionsKnownValue &&
...
/// @nodoc
abstract mixin class $NotificationDeclarationAllowSubscriptionsKnownValueCopyWith<
    $Res> implements $NotificationDeclarationAllowSubscriptionsCopyWith<$Res> {
  factory $NotificationDeclarationAllowSubscriptionsKnownValueCopyWith(
          NotificationDeclarationAllowSubscriptionsKnownValue value,
          $Res Function(NotificationDeclarationAllowSubscriptionsKnownValue)
              _then) =
      _$NotificationDeclarationAllowSubscriptionsKnownValueCopyWithImpl;
  @useResult
...
class _$NotificationDeclarationAllowSubscriptionsKnownValueCopyWithImpl<$Res>
    implements
        $NotificationDeclarationAllowSubscriptionsKnownValueCopyWith<$Res> {
  _$NotificationDeclarationAllowSubscriptionsKnownValueCopyWithImpl(
      this._self, this._then);

  final NotificationDeclarationAllowSubscriptionsKnownValue _self;
  final $Res Function(NotificationDeclarationAllowSubscriptionsKnownValue)
      _then;
...
class NotificationDeclarationAllowSubscriptionsUnknown
    extends NotificationDeclarationAllowSubscriptions {
  const NotificationDeclarationAllowSubscriptionsUnknown({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $NotificationDeclarationAllowSubscriptionsUnknownCopyWith<
          NotificationDeclarationAllowSubscriptionsUnknown>
      get copyWith =>
          _$NotificationDeclarationAllowSubscriptionsUnknownCopyWithImpl<
                  NotificationDeclarationAllowSubscriptionsUnknown>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationDeclarationAllowSubscriptionsUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $NotificationDeclarationAllowSubscriptionsUnknownCopyWith<
    $Res> implements $NotificationDeclarationAllowSubscriptionsCopyWith<$Res> {
  factory $NotificationDeclarationAllowSubscriptionsUnknownCopyWith(
          NotificationDeclarationAllowSubscriptionsUnknown value,
          $Res Function(NotificationDeclarationAllowSubscriptionsUnknown)
              _then) =
      _$NotificationDeclarationAllowSubscriptionsUnknownCopyWithImpl;
  @useResult
