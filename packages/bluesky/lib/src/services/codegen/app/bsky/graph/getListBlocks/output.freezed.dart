...
mixin _$GraphGetListBlocksOutput {
  ...
  $GraphGetListBlocksOutputCopyWith<GraphGetListBlocksOutput> get copyWith =>
      _$GraphGetListBlocksOutputCopyWithImpl<GraphGetListBlocksOutput>(
          this as GraphGetListBlocksOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetListBlocksOutput &&
...
abstract mixin class $GraphGetListBlocksOutputCopyWith<$Res> {
  factory $GraphGetListBlocksOutputCopyWith(GraphGetListBlocksOutput value,
          $Res Function(GraphGetListBlocksOutput) _then) =
      _$GraphGetListBlocksOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension GraphGetListBlocksOutputPatterns on GraphGetListBlocksOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetListBlocksOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? cursor, @ListViewConverter() List<ListView> lists,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _GraphGetListBlocksOutput() when $default != null:
        return $default(_that.cursor, _that.lists, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphGetListBlocksOutput implements GraphGetListBlocksOutput {
  const _GraphGetListBlocksOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetListBlocksOutputCopyWith<_GraphGetListBlocksOutput> get copyWith =>
      __$GraphGetListBlocksOutputCopyWithImpl<_GraphGetListBlocksOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetListBlocksOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetListBlocksOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetListBlocksOutputCopyWith<$Res>
    implements $GraphGetListBlocksOutputCopyWith<$Res> {
  factory _$GraphGetListBlocksOutputCopyWith(_GraphGetListBlocksOutput value,
          $Res Function(_GraphGetListBlocksOutput) _then) =
      __$GraphGetListBlocksOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
