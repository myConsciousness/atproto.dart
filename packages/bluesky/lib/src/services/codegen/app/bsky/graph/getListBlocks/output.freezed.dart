...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? lists = null,Object? $unknown = freezed,}) {
  return _then(GraphGetListBlocksOutput(
...
class _GraphGetListBlocksOutput implements GraphGetListBlocksOutput {
  const _GraphGetListBlocksOutput({this.cursor, @ListViewConverter() required  List<ListView> lists,  Map<String, dynamic>? $unknown}): _lists = lists,_$unknown = $unknown;
