...
class _ContentLabelPref implements ContentLabelPref {
  const _ContentLabelPref({this.$type = 'app.bsky.actor.defs#contentLabelPref', this.labelerDid, required this.label, @ContentLabelPrefVisibilityConverter() required this.visibility,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
