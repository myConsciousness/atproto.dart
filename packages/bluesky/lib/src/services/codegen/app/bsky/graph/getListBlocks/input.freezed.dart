...
mixin _$GraphGetListBlocksInput {
  ...
  $GraphGetListBlocksInputCopyWith<GraphGetListBlocksInput> get copyWith =>
      _$GraphGetListBlocksInputCopyWithImpl<GraphGetListBlocksInput>(
          this as GraphGetListBlocksInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetListBlocksInput &&
...
abstract mixin class $GraphGetListBlocksInputCopyWith<$Res> {
  factory $GraphGetListBlocksInputCopyWith(GraphGetListBlocksInput value,
          $Res Function(GraphGetListBlocksInput) _then) =
      _$GraphGetListBlocksInputCopyWithImpl;
  @useResult
...
extension GraphGetListBlocksInputPatterns on GraphGetListBlocksInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetListBlocksInput value)? $default, {
...
class _GraphGetListBlocksInput implements GraphGetListBlocksInput {
  const _GraphGetListBlocksInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetListBlocksInputCopyWith<_GraphGetListBlocksInput> get copyWith =>
      __$GraphGetListBlocksInputCopyWithImpl<_GraphGetListBlocksInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetListBlocksInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetListBlocksInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetListBlocksInputCopyWith<$Res>
    implements $GraphGetListBlocksInputCopyWith<$Res> {
  factory _$GraphGetListBlocksInputCopyWith(_GraphGetListBlocksInput value,
          $Res Function(_GraphGetListBlocksInput) _then) =
      __$GraphGetListBlocksInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
