...
extension SavedFeedsPrefV2Patterns on SavedFeedsPrefV2 {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SavedFeedsPrefV2 value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, @SavedFeedConverter() List<SavedFeed> items,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SavedFeedsPrefV2() when $default != null:
        return $default(_that.$type, _that.items, _that.$unknown);
      case _:
        return orElse();
    }
  }
