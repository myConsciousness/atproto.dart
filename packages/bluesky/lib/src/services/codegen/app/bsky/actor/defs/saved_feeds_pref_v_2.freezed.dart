...
class _SavedFeedsPrefV2 implements SavedFeedsPrefV2 {
  const _SavedFeedsPrefV2({this.$type = 'app.bsky.actor.defs#savedFeedsPrefV2', @SavedFeedConverter() required  List<SavedFeed> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
