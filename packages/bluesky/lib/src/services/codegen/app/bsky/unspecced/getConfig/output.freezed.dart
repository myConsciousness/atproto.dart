...
@pragma('vm:prefer-inline') @override $Res call({Object? checkEmailConfirmed = freezed,Object? liveNow = freezed,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetConfigOutput(
...
class _UnspeccedGetConfigOutput implements UnspeccedGetConfigOutput {
  const _UnspeccedGetConfigOutput({this.checkEmailConfirmed, @LiveNowConfigConverter()  List<LiveNowConfig>? liveNow,  Map<String, dynamic>? $unknown}): _liveNow = liveNow,_$unknown = $unknown;
