...
class _NotFoundActor implements NotFoundActor {
  const _NotFoundActor({this.$type = 'app.bsky.graph.defs#notFoundActor', required this.actor, required this.notFound,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
