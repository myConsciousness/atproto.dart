...
extension NotFoundActorPatterns on NotFoundActor {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotFoundActor value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String actor, bool notFound,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _NotFoundActor() when $default != null:
        return $default(
            _that.$type, _that.actor, _that.notFound, _that.$unknown);
      case _:
        return orElse();
    }
  }
