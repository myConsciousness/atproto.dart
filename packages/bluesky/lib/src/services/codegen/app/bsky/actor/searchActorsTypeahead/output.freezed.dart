...
mixin _$ActorSearchActorsTypeaheadOutput {
  ...
  $ActorSearchActorsTypeaheadOutputCopyWith<ActorSearchActorsTypeaheadOutput>
      get copyWith => _$ActorSearchActorsTypeaheadOutputCopyWithImpl<
              ActorSearchActorsTypeaheadOutput>(
          this as ActorSearchActorsTypeaheadOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorSearchActorsTypeaheadOutput &&
...
abstract mixin class $ActorSearchActorsTypeaheadOutputCopyWith<$Res> {
  factory $ActorSearchActorsTypeaheadOutputCopyWith(
          ...
          $Res Function(ActorSearchActorsTypeaheadOutput) _then) =
      _$ActorSearchActorsTypeaheadOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ActorSearchActorsTypeaheadOutputPatterns
    on ActorSearchActorsTypeaheadOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorSearchActorsTypeaheadOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@ProfileViewBasicConverter() List<ProfileViewBasic> actors,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ActorSearchActorsTypeaheadOutput() when $default != null:
        return $default(_that.actors, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ActorSearchActorsTypeaheadOutput
    implements ActorSearchActorsTypeaheadOutput {
  const _ActorSearchActorsTypeaheadOutput(
      {@ProfileViewBasicConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorSearchActorsTypeaheadOutputCopyWith<_ActorSearchActorsTypeaheadOutput>
      get copyWith => __$ActorSearchActorsTypeaheadOutputCopyWithImpl<
          _ActorSearchActorsTypeaheadOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorSearchActorsTypeaheadOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorSearchActorsTypeaheadOutput &&
...
/// @nodoc
abstract mixin class _$ActorSearchActorsTypeaheadOutputCopyWith<$Res>
    implements $ActorSearchActorsTypeaheadOutputCopyWith<$Res> {
  factory _$ActorSearchActorsTypeaheadOutputCopyWith(
          _ActorSearchActorsTypeaheadOutput value,
          $Res Function(_ActorSearchActorsTypeaheadOutput) _then) =
      __$ActorSearchActorsTypeaheadOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ProfileViewBasicConverter() List<ProfileViewBasic> actors,
