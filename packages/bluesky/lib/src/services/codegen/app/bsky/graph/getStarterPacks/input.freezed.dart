...
@pragma('vm:prefer-inline') @override $Res call({Object? uris = null,Object? $unknown = freezed,}) {
  return _then(GraphGetStarterPacksInput(
...
class _GraphGetStarterPacksInput implements GraphGetStarterPacksInput {
  const _GraphGetStarterPacksInput({@AtUriConverter() required  List<AtUri> uris,  Map<String, dynamic>? $unknown}): _uris = uris,_$unknown = $unknown;
