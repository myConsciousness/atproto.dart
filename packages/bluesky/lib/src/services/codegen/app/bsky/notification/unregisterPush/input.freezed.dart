...
mixin _$NotificationUnregisterPushInput {
  ...
  $NotificationUnregisterPushInputCopyWith<NotificationUnregisterPushInput>
      get copyWith => _$NotificationUnregisterPushInputCopyWithImpl<
              NotificationUnregisterPushInput>(
          this as NotificationUnregisterPushInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationUnregisterPushInput &&
  ...
  int get hashCode => Object.hash(runtimeType, serviceDid, token, platform,
      appId, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $NotificationUnregisterPushInputCopyWith<$Res> {
  factory $NotificationUnregisterPushInputCopyWith(
          ...
          $Res Function(NotificationUnregisterPushInput) _then) =
      _$NotificationUnregisterPushInputCopyWithImpl;
  @useResult
  $Res call(
      {String serviceDid,
      String token,
...
class _$NotificationUnregisterPushInputCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $NotificationUnregisterPushPlatformCopyWith<$Res> get platform {
    return $NotificationUnregisterPushPlatformCopyWith<$Res>(_self.platform,
        (value) {
...
extension NotificationUnregisterPushInputPatterns
    on NotificationUnregisterPushInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationUnregisterPushInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NotificationUnregisterPushInput() when $default != null:
        return $default(_that.serviceDid, _that.token, _that.platform,
            _that.appId, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationUnregisterPushInput
    implements NotificationUnregisterPushInput {
  const _NotificationUnregisterPushInput(
      ...
      : _$unknown = $unknown;
  factory _NotificationUnregisterPushInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationUnregisterPushInputCopyWith<_NotificationUnregisterPushInput>
      get copyWith => __$NotificationUnregisterPushInputCopyWithImpl<
          _NotificationUnregisterPushInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationUnregisterPushInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationUnregisterPushInput &&
            (identical(other.serviceDid, serviceDid) ||
                other.serviceDid == serviceDid) &&
            (identical(other.token, token) || other.token == token) &&
            (identical(other.platform, platform) ||
...
/// @nodoc
abstract mixin class _$NotificationUnregisterPushInputCopyWith<$Res>
    implements $NotificationUnregisterPushInputCopyWith<$Res> {
  factory _$NotificationUnregisterPushInputCopyWith(
          _NotificationUnregisterPushInput value,
          $Res Function(_NotificationUnregisterPushInput) _then) =
      __$NotificationUnregisterPushInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String serviceDid,
