...
@pragma('vm:prefer-inline') @override $Res call({Object? serviceDid = null,Object? token = null,Object? platform = null,Object? appId = null,Object? $unknown = freezed,}) {
  return _then(NotificationUnregisterPushInput(
...
class _NotificationUnregisterPushInput implements NotificationUnregisterPushInput {
  const _NotificationUnregisterPushInput({required this.serviceDid, required this.token, @NotificationUnregisterPushPlatformConverter() required this.platform, required this.appId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
