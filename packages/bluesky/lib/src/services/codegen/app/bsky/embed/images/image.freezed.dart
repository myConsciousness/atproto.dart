...
class _EmbedImagesImage implements EmbedImagesImage {
  const _EmbedImagesImage({this.$type = 'app.bsky.embed.images#image', @BlobConverter() required this.image, required this.alt, @AspectRatioConverter() this.aspectRatio,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
