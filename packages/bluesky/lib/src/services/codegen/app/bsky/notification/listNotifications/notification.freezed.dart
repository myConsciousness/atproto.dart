...
@StarterPackViewBasicConverter() StarterPackViewBasic? get starterPack; bool get isRead;@JsonKey(toJson: iso8601) DateTime get indexedAt;@LabelConverter() List<Label>? get labels; Map<String, dynamic>? get $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,author,reason,reasonSubject,const DeepCollectionEquality().hash(record),starterPack,isRead,indexedAt,const DeepCollectionEquality().hash(labels),const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type,@AtUriConverter() AtUri uri, String cid,@ProfileViewConverter() ProfileView author,@NotificationReasonConverter() NotificationReason reason,@AtUriConverter() AtUri? reasonSubject, Map<String, dynamic> record,@StarterPackViewBasicConverter() StarterPackViewBasic? starterPack, bool isRead,@JsonKey(toJson: iso8601) DateTime indexedAt,@LabelConverter() List<Label>? labels, Map<String, dynamic>? $unknown
});


$ProfileViewCopyWith<$Res> get author;$NotificationReasonCopyWith<$Res> get reason;$StarterPackViewBasicCopyWith<$Res>? get starterPack;
...
/// Create a copy of Notification
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? cid = null,Object? author = null,Object? reason = null,Object? reasonSubject = freezed,Object? record = null,Object? starterPack = freezed,Object? isRead = null,Object? indexedAt = null,Object? labels = freezed,Object? $unknown = freezed,}) {
...
as Map<String, dynamic>,starterPack: freezed == starterPack ? _self.starterPack : starterPack // ignore: cast_nullable_to_non_nullable
as StarterPackViewBasic?,isRead: null == isRead ? _self.isRead : isRead // ignore: cast_nullable_to_non_nullable
...
$StarterPackViewBasicCopyWith<$Res>? get starterPack {
    if (_self.starterPack == null) {
    return null;
  }

  return $StarterPackViewBasicCopyWith<$Res>(_self.starterPack!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri uri,  String cid, @ProfileViewConverter()  ProfileView author, @NotificationReasonConverter()  NotificationReason reason, @AtUriConverter()  AtUri? reasonSubject,  Map<String, dynamic> record, @StarterPackViewBasicConverter()  StarterPackViewBasic? starterPack,  bool isRead, @JsonKey(toJson: iso8601)  DateTime indexedAt, @LabelConverter()  List<Label>? labels,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Notification() when $default != null:
return $default(_that.$type,_that.uri,_that.cid,_that.author,_that.reason,_that.reasonSubject,_that.record,_that.starterPack,_that.isRead,_that.indexedAt,_that.labels,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri uri,  String cid, @ProfileViewConverter()  ProfileView author, @NotificationReasonConverter()  NotificationReason reason, @AtUriConverter()  AtUri? reasonSubject,  Map<String, dynamic> record, @StarterPackViewBasicConverter()  StarterPackViewBasic? starterPack,  bool isRead, @JsonKey(toJson: iso8601)  DateTime indexedAt, @LabelConverter()  List<Label>? labels,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _Notification():
return $default(_that.$type,_that.uri,_that.cid,_that.author,_that.reason,_that.reasonSubject,_that.record,_that.starterPack,_that.isRead,_that.indexedAt,_that.labels,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
class _Notification implements Notification {
  const _Notification({this.$type = 'app.bsky.notification.listNotifications#notification', @AtUriConverter() required this.uri, required this.cid, @ProfileViewConverter() required this.author, @NotificationReasonConverter() required this.reason, @AtUriConverter() this.reasonSubject, required final  Map<String, dynamic> record, @StarterPackViewBasicConverter() this.starterPack, required this.isRead, @JsonKey(toJson: iso8601) required this.indexedAt, @LabelConverter() final  List<Label>? labels, final  Map<String, dynamic>? $unknown}): _record = record,_labels = labels,_$unknown = $unknown;
...
@override@StarterPackViewBasicConverter() final  StarterPackViewBasic? starterPack;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,author,reason,reasonSubject,const DeepCollectionEquality().hash(_record),starterPack,isRead,indexedAt,const DeepCollectionEquality().hash(_labels),const DeepCollectionEquality().hash(_$unknown));
...
@override $ProfileViewCopyWith<$Res> get author;@override $NotificationReasonCopyWith<$Res> get reason;@override $StarterPackViewBasicCopyWith<$Res>? get starterPack;
...
/// Create a copy of Notification
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? uri = null,Object? cid = null,Object? author = null,Object? reason = null,Object? reasonSubject = freezed,Object? record = null,Object? starterPack = freezed,Object? isRead = null,Object? indexedAt = null,Object? labels = freezed,Object? $unknown = freezed,}) {
