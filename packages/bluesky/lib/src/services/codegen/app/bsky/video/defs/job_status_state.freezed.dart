...
extension JobStatusStatePatterns on JobStatusState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case JobStatusStateUnknown() when unknown != null:
...
class JobStatusStateKnownValue extends JobStatusState {
  ...
  $JobStatusStateKnownValueCopyWith<JobStatusStateKnownValue> get copyWith =>
      _$JobStatusStateKnownValueCopyWithImpl<JobStatusStateKnownValue>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is JobStatusStateKnownValue &&
...
/// @nodoc
abstract mixin class $JobStatusStateKnownValueCopyWith<$Res>
    implements $JobStatusStateCopyWith<$Res> {
  factory $JobStatusStateKnownValueCopyWith(JobStatusStateKnownValue value,
          $Res Function(JobStatusStateKnownValue) _then) =
      _$JobStatusStateKnownValueCopyWithImpl;
  @useResult
...
class JobStatusStateUnknown extends JobStatusState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $JobStatusStateUnknownCopyWith<JobStatusStateUnknown> get copyWith =>
      _$JobStatusStateUnknownCopyWithImpl<JobStatusStateUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is JobStatusStateUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $JobStatusStateUnknownCopyWith<$Res>
    implements $JobStatusStateCopyWith<$Res> {
  factory $JobStatusStateUnknownCopyWith(JobStatusStateUnknown value,
          $Res Function(JobStatusStateUnknown) _then) =
      _$JobStatusStateUnknownCopyWithImpl;
  @useResult
