...
class _ViewerState implements ViewerState {
  const _ViewerState({this.$type = 'app.bsky.feed.defs#viewerState', @AtUriConverter() this.repost, @AtUriConverter() this.like, this.bookmarked, this.threadMuted, this.replyDisabled, this.embeddingDisabled, this.pinned,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
