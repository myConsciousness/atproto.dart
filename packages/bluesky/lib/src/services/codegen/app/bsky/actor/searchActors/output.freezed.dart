...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? actors = null,Object? $unknown = freezed,}) {
  return _then(ActorSearchActorsOutput(
...
class _ActorSearchActorsOutput implements ActorSearchActorsOutput {
  const _ActorSearchActorsOutput({this.cursor, @ProfileViewConverter() required  List<ProfileView> actors,  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
