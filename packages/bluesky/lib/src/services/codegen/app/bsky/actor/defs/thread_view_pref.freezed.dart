...
class _ThreadViewPref implements ThreadViewPref {
  const _ThreadViewPref({this.$type = 'app.bsky.actor.defs#threadViewPref', @ThreadViewPrefSortConverter() this.sort,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
