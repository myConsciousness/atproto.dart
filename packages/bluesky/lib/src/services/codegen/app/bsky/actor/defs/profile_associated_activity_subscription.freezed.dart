...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? allowSubscriptions = null,Object? $unknown = freezed,}) {
  return _then(ProfileAssociatedActivitySubscription(
...
class _ProfileAssociatedActivitySubscription implements ProfileAssociatedActivitySubscription {
  const _ProfileAssociatedActivitySubscription({this.$type = 'app.bsky.actor.defs#profileAssociatedActivitySubscription', @ProfileAssociatedActivitySubscriptionAllowSubscriptionsConverter() required this.allowSubscriptions,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
