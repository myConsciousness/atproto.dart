...
mixin _$ProfileAssociatedActivitySubscription {
  ...
  $ProfileAssociatedActivitySubscriptionCopyWith<
      ...
      get copyWith => _$ProfileAssociatedActivitySubscriptionCopyWithImpl<
              ProfileAssociatedActivitySubscription>(
          this as ProfileAssociatedActivitySubscription, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProfileAssociatedActivitySubscription &&
...
abstract mixin class $ProfileAssociatedActivitySubscriptionCopyWith<$Res> {
  factory $ProfileAssociatedActivitySubscriptionCopyWith(
          ...
          $Res Function(ProfileAssociatedActivitySubscription) _then) =
      _$ProfileAssociatedActivitySubscriptionCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      @ProfileAssociatedActivitySubscriptionAllowSubscriptionsConverter()
...
class _$ProfileAssociatedActivitySubscriptionCopyWithImpl<$Res>
  ...
  $ProfileAssociatedActivitySubscriptionAllowSubscriptionsCopyWith<$Res>
    ...
    return $ProfileAssociatedActivitySubscriptionAllowSubscriptionsCopyWith<
        $Res>(_self.allowSubscriptions, (value) {
...
extension ProfileAssociatedActivitySubscriptionPatterns
    on ProfileAssociatedActivitySubscription {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ProfileAssociatedActivitySubscription value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ProfileAssociatedActivitySubscription() when $default != null:
        return $default(_that.$type, _that.allowSubscriptions, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ProfileAssociatedActivitySubscription
    implements ProfileAssociatedActivitySubscription {
  const _ProfileAssociatedActivitySubscription(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProfileAssociatedActivitySubscriptionCopyWith<
          _ProfileAssociatedActivitySubscription>
      get copyWith => __$ProfileAssociatedActivitySubscriptionCopyWithImpl<
          _ProfileAssociatedActivitySubscription>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ProfileAssociatedActivitySubscriptionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProfileAssociatedActivitySubscription &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.allowSubscriptions, allowSubscriptions) ||
                other.allowSubscriptions == allowSubscriptions) &&
...
/// @nodoc
abstract mixin class _$ProfileAssociatedActivitySubscriptionCopyWith<$Res>
    implements $ProfileAssociatedActivitySubscriptionCopyWith<$Res> {
  factory _$ProfileAssociatedActivitySubscriptionCopyWith(
          _ProfileAssociatedActivitySubscription value,
          $Res Function(_ProfileAssociatedActivitySubscription) _then) =
      __$ProfileAssociatedActivitySubscriptionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
