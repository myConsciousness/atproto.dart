...
_GeneratorView _$GeneratorViewFromJson(Map json) => $checkedCreate(
      '_GeneratorView',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$GeneratorViewToJson(_GeneratorView instance) =>
    <String, dynamic>{
      ...
      'viewer':
          _$JsonConverterToJson<Map<String, dynamic>, GeneratorViewerState>(
