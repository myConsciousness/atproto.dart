...
mixin _$GraphGetListMutesOutput {
  ...
  $GraphGetListMutesOutputCopyWith<GraphGetListMutesOutput> get copyWith =>
      _$GraphGetListMutesOutputCopyWithImpl<GraphGetListMutesOutput>(
          this as GraphGetListMutesOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetListMutesOutput &&
...
abstract mixin class $GraphGetListMutesOutputCopyWith<$Res> {
  factory $GraphGetListMutesOutputCopyWith(GraphGetListMutesOutput value,
          $Res Function(GraphGetListMutesOutput) _then) =
      _$GraphGetListMutesOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension GraphGetListMutesOutputPatterns on GraphGetListMutesOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetListMutesOutput value)? $default, {
...
class _GraphGetListMutesOutput implements GraphGetListMutesOutput {
  const _GraphGetListMutesOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetListMutesOutputCopyWith<_GraphGetListMutesOutput> get copyWith =>
      __$GraphGetListMutesOutputCopyWithImpl<_GraphGetListMutesOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetListMutesOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetListMutesOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetListMutesOutputCopyWith<$Res>
    implements $GraphGetListMutesOutputCopyWith<$Res> {
  factory _$GraphGetListMutesOutputCopyWith(_GraphGetListMutesOutput value,
          $Res Function(_GraphGetListMutesOutput) _then) =
      __$GraphGetListMutesOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
