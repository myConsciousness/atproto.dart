...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? lists = null,Object? $unknown = freezed,}) {
  return _then(GraphGetListMutesOutput(
...
class _GraphGetListMutesOutput implements GraphGetListMutesOutput {
  const _GraphGetListMutesOutput({this.cursor, @ListViewConverter() required  List<ListView> lists,  Map<String, dynamic>? $unknown}): _lists = lists,_$unknown = $unknown;
