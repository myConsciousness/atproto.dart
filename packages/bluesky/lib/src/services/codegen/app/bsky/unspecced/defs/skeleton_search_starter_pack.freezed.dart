...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? $unknown = freezed,}) {
  return _then(SkeletonSearchStarterPack(
...
class _SkeletonSearchStarterPack implements SkeletonSearchStarterPack {
  const _SkeletonSearchStarterPack({this.$type = 'app.bsky.unspecced.defs#skeletonSearchStarterPack', @AtUriConverter() required this.uri,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
