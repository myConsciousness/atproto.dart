...
mixin _$VideoGetUploadLimitsOutput {
  ...
  $VideoGetUploadLimitsOutputCopyWith<VideoGetUploadLimitsOutput>
      get copyWith =>
          _$VideoGetUploadLimitsOutputCopyWithImpl<VideoGetUploadLimitsOutput>(
              this as VideoGetUploadLimitsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VideoGetUploadLimitsOutput &&
...
abstract mixin class $VideoGetUploadLimitsOutputCopyWith<$Res> {
  factory $VideoGetUploadLimitsOutputCopyWith(VideoGetUploadLimitsOutput value,
          $Res Function(VideoGetUploadLimitsOutput) _then) =
      _$VideoGetUploadLimitsOutputCopyWithImpl;
  @useResult
  $Res call(
      {bool canUpload,
...
extension VideoGetUploadLimitsOutputPatterns on VideoGetUploadLimitsOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VideoGetUploadLimitsOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VideoGetUploadLimitsOutput() when $default != null:
        return $default(
            _that.canUpload,
            _that.remainingDailyVideos,
            _that.remainingDailyBytes,
            _that.message,
            _that.error,
            _that.$unknown);
      case _:
...
class _VideoGetUploadLimitsOutput implements VideoGetUploadLimitsOutput {
  const _VideoGetUploadLimitsOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VideoGetUploadLimitsOutputCopyWith<_VideoGetUploadLimitsOutput>
      get copyWith => __$VideoGetUploadLimitsOutputCopyWithImpl<
          _VideoGetUploadLimitsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VideoGetUploadLimitsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VideoGetUploadLimitsOutput &&
            (identical(other.canUpload, canUpload) ||
                other.canUpload == canUpload) &&
            (identical(other.remainingDailyVideos, remainingDailyVideos) ||
                other.remainingDailyVideos == remainingDailyVideos) &&
...
/// @nodoc
abstract mixin class _$VideoGetUploadLimitsOutputCopyWith<$Res>
    implements $VideoGetUploadLimitsOutputCopyWith<$Res> {
  factory _$VideoGetUploadLimitsOutputCopyWith(
          _VideoGetUploadLimitsOutput value,
          $Res Function(_VideoGetUploadLimitsOutput) _then) =
      __$VideoGetUploadLimitsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool canUpload,
