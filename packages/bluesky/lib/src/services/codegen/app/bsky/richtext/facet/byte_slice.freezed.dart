...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? byteStart = null,Object? byteEnd = null,Object? $unknown = freezed,}) {
  return _then(RichtextFacetByteSlice(
...
class _RichtextFacetByteSlice implements RichtextFacetByteSlice {
  const _RichtextFacetByteSlice({this.$type = 'app.bsky.richtext.facet#byteSlice', required this.byteStart, required this.byteEnd,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
