...
mixin _$RichtextFacetByteSlice {
  ...
  $RichtextFacetByteSliceCopyWith<RichtextFacetByteSlice> get copyWith =>
      _$RichtextFacetByteSliceCopyWithImpl<RichtextFacetByteSlice>(
          this as RichtextFacetByteSlice, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RichtextFacetByteSlice &&
...
abstract mixin class $RichtextFacetByteSliceCopyWith<$Res> {
  factory $RichtextFacetByteSliceCopyWith(RichtextFacetByteSlice value,
          $Res Function(RichtextFacetByteSlice) _then) =
      _$RichtextFacetByteSliceCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      int byteStart,
...
extension RichtextFacetByteSlicePatterns on RichtextFacetByteSlice {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RichtextFacetByteSlice value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, int byteStart, int byteEnd,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _RichtextFacetByteSlice() when $default != null:
        return $default(
            _that.$type, _that.byteStart, _that.byteEnd, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _RichtextFacetByteSlice implements RichtextFacetByteSlice {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RichtextFacetByteSliceCopyWith<_RichtextFacetByteSlice> get copyWith =>
      __$RichtextFacetByteSliceCopyWithImpl<_RichtextFacetByteSlice>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RichtextFacetByteSliceToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RichtextFacetByteSlice &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.byteStart, byteStart) ||
                other.byteStart == byteStart) &&
            (identical(other.byteEnd, byteEnd) || other.byteEnd == byteEnd) &&
...
/// @nodoc
abstract mixin class _$RichtextFacetByteSliceCopyWith<$Res>
    implements $RichtextFacetByteSliceCopyWith<$Res> {
  factory _$RichtextFacetByteSliceCopyWith(_RichtextFacetByteSlice value,
          $Res Function(_RichtextFacetByteSlice) _then) =
      __$RichtextFacetByteSliceCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
