...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? lastInitiatedAt = freezed,Object? status = null,Object? $unknown = freezed,}) {
  return _then(AgeAssuranceState(
...
class _AgeAssuranceState implements AgeAssuranceState {
  const _AgeAssuranceState({this.$type = 'app.bsky.unspecced.defs#ageAssuranceState', @JsonKey(toJson: iso8601) this.lastInitiatedAt, @AgeAssuranceStateStatusConverter() required this.status,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
