...
mixin _$ProfileAssociatedChat {
  ...
  $ProfileAssociatedChatCopyWith<ProfileAssociatedChat> get copyWith =>
      _$ProfileAssociatedChatCopyWithImpl<ProfileAssociatedChat>(
          this as ProfileAssociatedChat, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProfileAssociatedChat &&
...
abstract mixin class $ProfileAssociatedChatCopyWith<$Res> {
  factory $ProfileAssociatedChatCopyWith(ProfileAssociatedChat value,
          $Res Function(ProfileAssociatedChat) _then) =
      _$ProfileAssociatedChatCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      @ProfileAssociatedChatAllowIncomingConverter()
...
extension ProfileAssociatedChatPatterns on ProfileAssociatedChat {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ProfileAssociatedChat value)? $default, {
...
class _ProfileAssociatedChat implements ProfileAssociatedChat {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProfileAssociatedChatCopyWith<_ProfileAssociatedChat> get copyWith =>
      __$ProfileAssociatedChatCopyWithImpl<_ProfileAssociatedChat>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ProfileAssociatedChatToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProfileAssociatedChat &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.allowIncoming, allowIncoming) ||
                other.allowIncoming == allowIncoming) &&
...
/// @nodoc
abstract mixin class _$ProfileAssociatedChatCopyWith<$Res>
    implements $ProfileAssociatedChatCopyWith<$Res> {
  factory _$ProfileAssociatedChatCopyWith(_ProfileAssociatedChat value,
          $Res Function(_ProfileAssociatedChat) _then) =
      __$ProfileAssociatedChatCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
