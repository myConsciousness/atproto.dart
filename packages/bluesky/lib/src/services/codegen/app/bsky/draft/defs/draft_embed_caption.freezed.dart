...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? lang = null,Object? content = null,Object? $unknown = freezed,}) {
  return _then(DraftEmbedCaption(
...
class _DraftEmbedCaption implements DraftEmbedCaption {
  const _DraftEmbedCaption({this.$type = 'app.bsky.draft.defs#draftEmbedCaption', required this.lang, required this.content,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
