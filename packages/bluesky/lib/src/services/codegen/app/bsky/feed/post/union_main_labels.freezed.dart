...
class $UFeedPostLabelsCopyWith<$Res> {
  $UFeedPostLabelsCopyWith(
      UFeedPostLabels _, $Res Function(UFeedPostLabels) __);
}
...
extension UFeedPostLabelsPatterns on UFeedPostLabels {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(UFeedPostLabelsSelfLabels value)? selfLabels,
    TResult Function(UFeedPostLabelsUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case UFeedPostLabelsUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(UFeedPostLabelsSelfLabels value) selfLabels,
    required TResult Function(UFeedPostLabelsUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case UFeedPostLabelsSelfLabels():
        return selfLabels(_that);
      case UFeedPostLabelsUnknown():
        return unknown(_that);
      case _:
...
class UFeedPostLabelsSelfLabels extends UFeedPostLabels {
  ...
  $UFeedPostLabelsSelfLabelsCopyWith<UFeedPostLabelsSelfLabels> get copyWith =>
      _$UFeedPostLabelsSelfLabelsCopyWithImpl<UFeedPostLabelsSelfLabels>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UFeedPostLabelsSelfLabels &&
...
/// @nodoc
abstract mixin class $UFeedPostLabelsSelfLabelsCopyWith<$Res>
    implements $UFeedPostLabelsCopyWith<$Res> {
  factory $UFeedPostLabelsSelfLabelsCopyWith(UFeedPostLabelsSelfLabels value,
          $Res Function(UFeedPostLabelsSelfLabels) _then) =
      _$UFeedPostLabelsSelfLabelsCopyWithImpl;
  @useResult
...
class UFeedPostLabelsUnknown extends UFeedPostLabels {
  const UFeedPostLabelsUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UFeedPostLabelsUnknownCopyWith<UFeedPostLabelsUnknown> get copyWith =>
      _$UFeedPostLabelsUnknownCopyWithImpl<UFeedPostLabelsUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UFeedPostLabelsUnknown &&
...
/// @nodoc
abstract mixin class $UFeedPostLabelsUnknownCopyWith<$Res>
    implements $UFeedPostLabelsCopyWith<$Res> {
  factory $UFeedPostLabelsUnknownCopyWith(UFeedPostLabelsUnknown value,
          $Res Function(UFeedPostLabelsUnknown) _then) =
      _$UFeedPostLabelsUnknownCopyWithImpl;
  @useResult
