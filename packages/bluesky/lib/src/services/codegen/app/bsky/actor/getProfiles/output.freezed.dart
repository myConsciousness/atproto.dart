...
@pragma('vm:prefer-inline') @override $Res call({Object? profiles = null,Object? $unknown = freezed,}) {
  return _then(ActorGetProfilesOutput(
...
class _ActorGetProfilesOutput implements ActorGetProfilesOutput {
  const _ActorGetProfilesOutput({@ProfileViewDetailedConverter() required  List<ProfileViewDetailed> profiles,  Map<String, dynamic>? $unknown}): _profiles = profiles,_$unknown = $unknown;
