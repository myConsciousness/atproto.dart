...
class $UStatusViewEmbedCopyWith<$Res> {
  $UStatusViewEmbedCopyWith(
      UStatusViewEmbed _, $Res Function(UStatusViewEmbed) __);
}
...
extension UStatusViewEmbedPatterns on UStatusViewEmbed {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(UStatusViewEmbedEmbedExternalView value)?
        embedExternalView,
    TResult Function(UStatusViewEmbedUnknown value)? unknown,
    ...
    switch (_that) {
      ...
      case UStatusViewEmbedUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(UStatusViewEmbedEmbedExternalView value)
        embedExternalView,
    required TResult Function(UStatusViewEmbedUnknown value) unknown,
  }) {
    final _that = this;
    switch (_that) {
      case UStatusViewEmbedEmbedExternalView():
        return embedExternalView(_that);
      case UStatusViewEmbedUnknown():
        return unknown(_that);
      case _:
...
class UStatusViewEmbedEmbedExternalView extends UStatusViewEmbed {
  ...
  $UStatusViewEmbedEmbedExternalViewCopyWith<UStatusViewEmbedEmbedExternalView>
      get copyWith => _$UStatusViewEmbedEmbedExternalViewCopyWithImpl<
          UStatusViewEmbedEmbedExternalView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UStatusViewEmbedEmbedExternalView &&
...
/// @nodoc
abstract mixin class $UStatusViewEmbedEmbedExternalViewCopyWith<$Res>
    implements $UStatusViewEmbedCopyWith<$Res> {
  factory $UStatusViewEmbedEmbedExternalViewCopyWith(
          UStatusViewEmbedEmbedExternalView value,
          $Res Function(UStatusViewEmbedEmbedExternalView) _then) =
      _$UStatusViewEmbedEmbedExternalViewCopyWithImpl;
  @useResult
...
class UStatusViewEmbedUnknown extends UStatusViewEmbed {
  const UStatusViewEmbedUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UStatusViewEmbedUnknownCopyWith<UStatusViewEmbedUnknown> get copyWith =>
      _$UStatusViewEmbedUnknownCopyWithImpl<UStatusViewEmbedUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UStatusViewEmbedUnknown &&
...
/// @nodoc
abstract mixin class $UStatusViewEmbedUnknownCopyWith<$Res>
    implements $UStatusViewEmbedCopyWith<$Res> {
  factory $UStatusViewEmbedUnknownCopyWith(UStatusViewEmbedUnknown value,
          $Res Function(UStatusViewEmbedUnknown) _then) =
      _$UStatusViewEmbedUnknownCopyWithImpl;
  @useResult
