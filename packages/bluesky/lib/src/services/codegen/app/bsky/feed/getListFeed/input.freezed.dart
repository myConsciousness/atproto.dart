...
mixin _$FeedGetListFeedInput {
  ...
  $FeedGetListFeedInputCopyWith<FeedGetListFeedInput> get copyWith =>
      _$FeedGetListFeedInputCopyWithImpl<FeedGetListFeedInput>(
          this as FeedGetListFeedInput, _$identity);
...
abstract mixin class $FeedGetListFeedInputCopyWith<$Res> {
  factory $FeedGetListFeedInputCopyWith(FeedGetListFeedInput value,
          $Res Function(FeedGetListFeedInput) _then) =
      _$FeedGetListFeedInputCopyWithImpl;
  @useResult
  $Res call(
...
extension FeedGetListFeedInputPatterns on FeedGetListFeedInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetListFeedInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String list, int limit, String? cursor,
    ...
    switch (_that) {
      case _FeedGetListFeedInput() when $default != null:
        return $default(_that.list, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _FeedGetListFeedInput implements FeedGetListFeedInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetListFeedInputCopyWith<_FeedGetListFeedInput> get copyWith =>
      __$FeedGetListFeedInputCopyWithImpl<_FeedGetListFeedInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetListFeedInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetListFeedInput &&
            (identical(other.list, list) || other.list == list) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetListFeedInputCopyWith<$Res>
    implements $FeedGetListFeedInputCopyWith<$Res> {
  factory _$FeedGetListFeedInputCopyWith(_FeedGetListFeedInput value,
          $Res Function(_FeedGetListFeedInput) _then) =
      __$FeedGetListFeedInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String list, int limit, String? cursor, Map<String, dynamic>? $unknown});
