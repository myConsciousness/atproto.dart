...
mixin _$GraphUnmuteActorListInput {
  ...
  $GraphUnmuteActorListInputCopyWith<GraphUnmuteActorListInput> get copyWith =>
      _$GraphUnmuteActorListInputCopyWithImpl<GraphUnmuteActorListInput>(
          this as GraphUnmuteActorListInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphUnmuteActorListInput &&
...
abstract mixin class $GraphUnmuteActorListInputCopyWith<$Res> {
  factory $GraphUnmuteActorListInputCopyWith(GraphUnmuteActorListInput value,
          $Res Function(GraphUnmuteActorListInput) _then) =
      _$GraphUnmuteActorListInputCopyWithImpl;
  @useResult
...
extension GraphUnmuteActorListInputPatterns on GraphUnmuteActorListInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphUnmuteActorListInput value)? $default, {
...
class _GraphUnmuteActorListInput implements GraphUnmuteActorListInput {
  const _GraphUnmuteActorListInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphUnmuteActorListInputCopyWith<_GraphUnmuteActorListInput>
      get copyWith =>
          __$GraphUnmuteActorListInputCopyWithImpl<_GraphUnmuteActorListInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphUnmuteActorListInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphUnmuteActorListInput &&
            (identical(other.list, list) || other.list == list) &&
...
/// @nodoc
abstract mixin class _$GraphUnmuteActorListInputCopyWith<$Res>
    implements $GraphUnmuteActorListInputCopyWith<$Res> {
  factory _$GraphUnmuteActorListInputCopyWith(_GraphUnmuteActorListInput value,
          $Res Function(_GraphUnmuteActorListInput) _then) =
      __$GraphUnmuteActorListInputCopyWithImpl;
  @override
  @useResult
  $Res call({String list, Map<String, dynamic>? $unknown});
}
