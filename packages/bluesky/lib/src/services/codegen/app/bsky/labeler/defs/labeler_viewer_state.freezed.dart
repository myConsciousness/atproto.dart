...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? like = freezed,Object? $unknown = freezed,}) {
  return _then(LabelerViewerState(
...
class _LabelerViewerState implements LabelerViewerState {
  const _LabelerViewerState({this.$type = 'app.bsky.labeler.defs#labelerViewerState', @AtUriConverter() this.like,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
