...
@pragma('vm:prefer-inline') @override $Res call({Object? state = null,Object? metadata = null,Object? $unknown = freezed,}) {
  return _then(AgeassuranceGetStateOutput(
...
class _AgeassuranceGetStateOutput implements AgeassuranceGetStateOutput {
  const _AgeassuranceGetStateOutput({@StateConverter() required this.state, @StateMetadataConverter() required this.metadata,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
