...
mixin _$GraphGetListMutesInput {
  ...
  $GraphGetListMutesInputCopyWith<GraphGetListMutesInput> get copyWith =>
      _$GraphGetListMutesInputCopyWithImpl<GraphGetListMutesInput>(
          this as GraphGetListMutesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetListMutesInput &&
...
abstract mixin class $GraphGetListMutesInputCopyWith<$Res> {
  factory $GraphGetListMutesInputCopyWith(GraphGetListMutesInput value,
          $Res Function(GraphGetListMutesInput) _then) =
      _$GraphGetListMutesInputCopyWithImpl;
  @useResult
...
extension GraphGetListMutesInputPatterns on GraphGetListMutesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetListMutesInput value)? $default, {
...
class _GraphGetListMutesInput implements GraphGetListMutesInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetListMutesInputCopyWith<_GraphGetListMutesInput> get copyWith =>
      __$GraphGetListMutesInputCopyWithImpl<_GraphGetListMutesInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetListMutesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetListMutesInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetListMutesInputCopyWith<$Res>
    implements $GraphGetListMutesInputCopyWith<$Res> {
  factory _$GraphGetListMutesInputCopyWith(_GraphGetListMutesInput value,
          $Res Function(_GraphGetListMutesInput) _then) =
      __$GraphGetListMutesInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
