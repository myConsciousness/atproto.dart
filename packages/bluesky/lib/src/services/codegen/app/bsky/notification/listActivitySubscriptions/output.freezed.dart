...
mixin _$NotificationListActivitySubscriptionsOutput {
  ...
  $NotificationListActivitySubscriptionsOutputCopyWith<
      ...
      get copyWith => _$NotificationListActivitySubscriptionsOutputCopyWithImpl<
              NotificationListActivitySubscriptionsOutput>(
          this as NotificationListActivitySubscriptionsOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationListActivitySubscriptionsOutput &&
...
/// @nodoc
abstract mixin class $NotificationListActivitySubscriptionsOutputCopyWith<
    $Res> {
  factory $NotificationListActivitySubscriptionsOutputCopyWith(
          NotificationListActivitySubscriptionsOutput value,
          $Res Function(NotificationListActivitySubscriptionsOutput) _then) =
...
extension NotificationListActivitySubscriptionsOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationListActivitySubscriptionsOutput value)?
        $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NotificationListActivitySubscriptionsOutput() when $default != null:
        return $default(_that.cursor, _that.subscriptions, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _NotificationListActivitySubscriptionsOutput
    implements NotificationListActivitySubscriptionsOutput {
  const _NotificationListActivitySubscriptionsOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationListActivitySubscriptionsOutputCopyWith<
          _NotificationListActivitySubscriptionsOutput>
      get copyWith =>
          __$NotificationListActivitySubscriptionsOutputCopyWithImpl<
              _NotificationListActivitySubscriptionsOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationListActivitySubscriptionsOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationListActivitySubscriptionsOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$NotificationListActivitySubscriptionsOutputCopyWith<$Res>
    implements $NotificationListActivitySubscriptionsOutputCopyWith<$Res> {
  factory _$NotificationListActivitySubscriptionsOutputCopyWith(
          _NotificationListActivitySubscriptionsOutput value,
          $Res Function(_NotificationListActivitySubscriptionsOutput) _then) =
      __$NotificationListActivitySubscriptionsOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
