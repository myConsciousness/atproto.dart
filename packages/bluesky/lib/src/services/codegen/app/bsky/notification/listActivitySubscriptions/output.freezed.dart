...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? subscriptions = null,Object? $unknown = freezed,}) {
  return _then(NotificationListActivitySubscriptionsOutput(
...
class _NotificationListActivitySubscriptionsOutput implements NotificationListActivitySubscriptionsOutput {
  const _NotificationListActivitySubscriptionsOutput({this.cursor, @ProfileViewConverter() required  List<ProfileView> subscriptions,  Map<String, dynamic>? $unknown}): _subscriptions = subscriptions,_$unknown = $unknown;
