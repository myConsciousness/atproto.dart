...
mixin _$GraphGetKnownFollowersOutput {
  ...
  $GraphGetKnownFollowersOutputCopyWith<GraphGetKnownFollowersOutput>
      get copyWith => _$GraphGetKnownFollowersOutputCopyWithImpl<
              GraphGetKnownFollowersOutput>(
          this as GraphGetKnownFollowersOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetKnownFollowersOutput &&
...
abstract mixin class $GraphGetKnownFollowersOutputCopyWith<$Res> {
  factory $GraphGetKnownFollowersOutputCopyWith(
          ...
          $Res Function(GraphGetKnownFollowersOutput) _then) =
      _$GraphGetKnownFollowersOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension GraphGetKnownFollowersOutputPatterns on GraphGetKnownFollowersOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetKnownFollowersOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _GraphGetKnownFollowersOutput() when $default != null:
        return $default(
            _that.subject, _that.cursor, _that.followers, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphGetKnownFollowersOutput implements GraphGetKnownFollowersOutput {
  const _GraphGetKnownFollowersOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetKnownFollowersOutputCopyWith<_GraphGetKnownFollowersOutput>
      get copyWith => __$GraphGetKnownFollowersOutputCopyWithImpl<
          _GraphGetKnownFollowersOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetKnownFollowersOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetKnownFollowersOutput &&
            (identical(other.subject, subject) || other.subject == subject) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$GraphGetKnownFollowersOutputCopyWith<$Res>
    implements $GraphGetKnownFollowersOutputCopyWith<$Res> {
  factory _$GraphGetKnownFollowersOutputCopyWith(
          _GraphGetKnownFollowersOutput value,
          $Res Function(_GraphGetKnownFollowersOutput) _then) =
      __$GraphGetKnownFollowersOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@ProfileViewConverter() ProfileView subject,
