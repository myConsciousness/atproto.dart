...
@pragma('vm:prefer-inline') @override $Res call({Object? subject = null,Object? cursor = freezed,Object? followers = null,Object? $unknown = freezed,}) {
  return _then(GraphGetKnownFollowersOutput(
...
class _GraphGetKnownFollowersOutput implements GraphGetKnownFollowersOutput {
  const _GraphGetKnownFollowersOutput({@ProfileViewConverter() required this.subject, this.cursor, @ProfileViewConverter() required  List<ProfileView> followers,  Map<String, dynamic>? $unknown}): _followers = followers,_$unknown = $unknown;
