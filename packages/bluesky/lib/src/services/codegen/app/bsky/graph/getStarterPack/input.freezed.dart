...
mixin _$GraphGetStarterPackInput {
  ...
  $GraphGetStarterPackInputCopyWith<GraphGetStarterPackInput> get copyWith =>
      _$GraphGetStarterPackInputCopyWithImpl<GraphGetStarterPackInput>(
          this as GraphGetStarterPackInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetStarterPackInput &&
...
abstract mixin class $GraphGetStarterPackInputCopyWith<$Res> {
  factory $GraphGetStarterPackInputCopyWith(GraphGetStarterPackInput value,
          $Res Function(GraphGetStarterPackInput) _then) =
      _$GraphGetStarterPackInputCopyWithImpl;
  @useResult
...
extension GraphGetStarterPackInputPatterns on GraphGetStarterPackInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetStarterPackInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String starterPack, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _GraphGetStarterPackInput implements GraphGetStarterPackInput {
  const _GraphGetStarterPackInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetStarterPackInputCopyWith<_GraphGetStarterPackInput> get copyWith =>
      __$GraphGetStarterPackInputCopyWithImpl<_GraphGetStarterPackInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetStarterPackInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetStarterPackInput &&
            (identical(other.starterPack, starterPack) ||
                other.starterPack == starterPack) &&
...
/// @nodoc
abstract mixin class _$GraphGetStarterPackInputCopyWith<$Res>
    implements $GraphGetStarterPackInputCopyWith<$Res> {
  factory _$GraphGetStarterPackInputCopyWith(_GraphGetStarterPackInput value,
          $Res Function(_GraphGetStarterPackInput) _then) =
      __$GraphGetStarterPackInputCopyWithImpl;
  @override
  @useResult
  $Res call({String starterPack, Map<String, dynamic>? $unknown});
}
