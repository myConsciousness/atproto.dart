...
class $SkeletonTrendStatusCopyWith<$Res> {
  $SkeletonTrendStatusCopyWith(
      SkeletonTrendStatus _, $Res Function(SkeletonTrendStatus) __);
}
...
extension SkeletonTrendStatusPatterns on SkeletonTrendStatus {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SkeletonTrendStatusUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case SkeletonTrendStatusKnownValue():
        return knownValue(_that);
      case SkeletonTrendStatusUnknown():
        return unknown(_that);
      case _:
...
class SkeletonTrendStatusKnownValue extends SkeletonTrendStatus {
  ...
  $SkeletonTrendStatusKnownValueCopyWith<SkeletonTrendStatusKnownValue>
      get copyWith => _$SkeletonTrendStatusKnownValueCopyWithImpl<
          SkeletonTrendStatusKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SkeletonTrendStatusKnownValue &&
...
/// @nodoc
abstract mixin class $SkeletonTrendStatusKnownValueCopyWith<$Res>
    implements $SkeletonTrendStatusCopyWith<$Res> {
  factory $SkeletonTrendStatusKnownValueCopyWith(
          SkeletonTrendStatusKnownValue value,
          $Res Function(SkeletonTrendStatusKnownValue) _then) =
      _$SkeletonTrendStatusKnownValueCopyWithImpl;
  @useResult
...
class SkeletonTrendStatusUnknown extends SkeletonTrendStatus {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SkeletonTrendStatusUnknownCopyWith<SkeletonTrendStatusUnknown>
      get copyWith =>
          _$SkeletonTrendStatusUnknownCopyWithImpl<SkeletonTrendStatusUnknown>(
              this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SkeletonTrendStatusUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $SkeletonTrendStatusUnknownCopyWith<$Res>
    implements $SkeletonTrendStatusCopyWith<$Res> {
  factory $SkeletonTrendStatusUnknownCopyWith(SkeletonTrendStatusUnknown value,
          $Res Function(SkeletonTrendStatusUnknown) _then) =
      _$SkeletonTrendStatusUnknownCopyWithImpl;
  @useResult
