...
@pragma('vm:prefer-inline') @override $Res call({Object? preferences = null,Object? $unknown = freezed,}) {
  return _then(ActorPutPreferencesInput(
...
class _ActorPutPreferencesInput implements ActorPutPreferencesInput {
  const _ActorPutPreferencesInput({@UPreferencesConverter() required  List<UPreferences> preferences,  Map<String, dynamic>? $unknown}): _preferences = preferences,_$unknown = $unknown;
