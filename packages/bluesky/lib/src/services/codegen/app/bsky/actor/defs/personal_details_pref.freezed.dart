...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? birthDate = freezed,Object? $unknown = freezed,}) {
  return _then(PersonalDetailsPref(
...
class _PersonalDetailsPref implements PersonalDetailsPref {
  const _PersonalDetailsPref({this.$type = 'app.bsky.actor.defs#personalDetailsPref', @JsonKey(toJson: iso8601) this.birthDate,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
