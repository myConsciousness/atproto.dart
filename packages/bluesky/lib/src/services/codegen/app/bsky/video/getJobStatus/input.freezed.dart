...
mixin _$VideoGetJobStatusInput {
  ...
  $VideoGetJobStatusInputCopyWith<VideoGetJobStatusInput> get copyWith =>
      _$VideoGetJobStatusInputCopyWithImpl<VideoGetJobStatusInput>(
          this as VideoGetJobStatusInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is VideoGetJobStatusInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, jobId, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $VideoGetJobStatusInputCopyWith<$Res> {
  factory $VideoGetJobStatusInputCopyWith(VideoGetJobStatusInput value,
          $Res Function(VideoGetJobStatusInput) _then) =
      _$VideoGetJobStatusInputCopyWithImpl;
  @useResult
...
extension VideoGetJobStatusInputPatterns on VideoGetJobStatusInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VideoGetJobStatusInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String jobId, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _VideoGetJobStatusInput() when $default != null:
        return $default(_that.jobId, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _VideoGetJobStatusInput implements VideoGetJobStatusInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$VideoGetJobStatusInputCopyWith<_VideoGetJobStatusInput> get copyWith =>
      __$VideoGetJobStatusInputCopyWithImpl<_VideoGetJobStatusInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$VideoGetJobStatusInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _VideoGetJobStatusInput &&
            (identical(other.jobId, jobId) || other.jobId == jobId) &&
...
/// @nodoc
abstract mixin class _$VideoGetJobStatusInputCopyWith<$Res>
    implements $VideoGetJobStatusInputCopyWith<$Res> {
  factory _$VideoGetJobStatusInputCopyWith(_VideoGetJobStatusInput value,
          $Res Function(_VideoGetJobStatusInput) _then) =
      __$VideoGetJobStatusInputCopyWithImpl;
  @override
  @useResult
  $Res call({String jobId, Map<String, dynamic>? $unknown});
}
