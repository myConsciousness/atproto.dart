...
$ListRuleCopyWith<ListRule> get copyWith => _$ListRuleCopyWithImpl<ListRule>(this as ListRule, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ListRule&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.list, list) || other.list == list)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,list,const DeepCollectionEquality().hash($unknown));
...
/// @nodoc
class _$ListRuleCopyWithImpl<$Res>
...
/// Create a copy of ListRule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? list = null,Object? $unknown = freezed,}) {
  return _then(ListRule(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ListRule value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ListRule value)  $default,){
final _that = this;
switch (_that) {
case _ListRule():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ListRule value)?  $default,){
final _that = this;
switch (_that) {
case _ListRule() when $default != null:
return $default(_that);case _:
...
class _ListRule implements ListRule {
  const _ListRule({this.$type = 'app.bsky.feed.threadgate#listRule', @AtUriConverter() required this.list,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$ListRuleCopyWith<_ListRule> get copyWith => __$ListRuleCopyWithImpl<_ListRule>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ListRuleToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ListRule&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.list, list) || other.list == list)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,list,const DeepCollectionEquality().hash(_$unknown));
...
/// @nodoc
abstract mixin class _$ListRuleCopyWith<$Res> implements $ListRuleCopyWith<$Res> {
...
/// @nodoc
class __$ListRuleCopyWithImpl<$Res>
    implements _$ListRuleCopyWith<$Res> {
...
/// Create a copy of ListRule
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? list = null,Object? $unknown = freezed,}) {
