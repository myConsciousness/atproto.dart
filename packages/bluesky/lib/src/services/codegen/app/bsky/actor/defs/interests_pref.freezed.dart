...
class _InterestsPref implements InterestsPref {
  const _InterestsPref({this.$type = 'app.bsky.actor.defs#interestsPref', required  List<String> tags,  Map<String, dynamic>? $unknown}): _tags = tags,_$unknown = $unknown;
