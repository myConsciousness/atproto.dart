...
mixin _$NotificationListActivitySubscriptionsInput {
  ...
  $NotificationListActivitySubscriptionsInputCopyWith<
      ...
      get copyWith => _$NotificationListActivitySubscriptionsInputCopyWithImpl<
              NotificationListActivitySubscriptionsInput>(
          this as NotificationListActivitySubscriptionsInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationListActivitySubscriptionsInput &&
...
abstract mixin class $NotificationListActivitySubscriptionsInputCopyWith<$Res> {
  factory $NotificationListActivitySubscriptionsInputCopyWith(
          ...
          $Res Function(NotificationListActivitySubscriptionsInput) _then) =
...
extension NotificationListActivitySubscriptionsInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationListActivitySubscriptionsInput value)?
        $default, {
...
/// @nodoc
@JsonSerializable()
class _NotificationListActivitySubscriptionsInput
    implements NotificationListActivitySubscriptionsInput {
  const _NotificationListActivitySubscriptionsInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationListActivitySubscriptionsInputCopyWith<
          _NotificationListActivitySubscriptionsInput>
      get copyWith => __$NotificationListActivitySubscriptionsInputCopyWithImpl<
          _NotificationListActivitySubscriptionsInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationListActivitySubscriptionsInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationListActivitySubscriptionsInput &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$NotificationListActivitySubscriptionsInputCopyWith<$Res>
    implements $NotificationListActivitySubscriptionsInputCopyWith<$Res> {
  factory _$NotificationListActivitySubscriptionsInputCopyWith(
          _NotificationListActivitySubscriptionsInput value,
          $Res Function(_NotificationListActivitySubscriptionsInput) _then) =
      __$NotificationListActivitySubscriptionsInputCopyWithImpl;
  @override
  @useResult
  $Res call({int limit, String? cursor, Map<String, dynamic>? $unknown});
}
