...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feed = null,Object? $unknown = freezed,}) {
  return _then(FeedGetFeedOutput(
...
class _FeedGetFeedOutput implements FeedGetFeedOutput {
  const _FeedGetFeedOutput({this.cursor, @FeedViewPostConverter() required  List<FeedViewPost> feed,  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
