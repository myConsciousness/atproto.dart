...
mixin _$UnspeccedGetSuggestedUsersInput {
  ...
  $UnspeccedGetSuggestedUsersInputCopyWith<UnspeccedGetSuggestedUsersInput>
      get copyWith => _$UnspeccedGetSuggestedUsersInputCopyWithImpl<
              UnspeccedGetSuggestedUsersInput>(
          this as UnspeccedGetSuggestedUsersInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestedUsersInput &&
...
abstract mixin class $UnspeccedGetSuggestedUsersInputCopyWith<$Res> {
  factory $UnspeccedGetSuggestedUsersInputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestedUsersInput) _then) =
      _$UnspeccedGetSuggestedUsersInputCopyWithImpl;
  @useResult
...
extension UnspeccedGetSuggestedUsersInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedUsersInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UnspeccedGetSuggestedUsersInput() when $default != null:
        return $default(_that.category, _that.limit, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestedUsersInput
    implements UnspeccedGetSuggestedUsersInput {
  const _UnspeccedGetSuggestedUsersInput(
      {this.category, this.limit = 25, final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _UnspeccedGetSuggestedUsersInput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestedUsersInputCopyWith<_UnspeccedGetSuggestedUsersInput>
      get copyWith => __$UnspeccedGetSuggestedUsersInputCopyWithImpl<
          _UnspeccedGetSuggestedUsersInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestedUsersInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestedUsersInput &&
            (identical(other.category, category) ||
                other.category == category) &&
            (identical(other.limit, limit) || other.limit == limit) &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestedUsersInputCopyWith<$Res>
    implements $UnspeccedGetSuggestedUsersInputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestedUsersInputCopyWith(
          _UnspeccedGetSuggestedUsersInput value,
          $Res Function(_UnspeccedGetSuggestedUsersInput) _then) =
      __$UnspeccedGetSuggestedUsersInputCopyWithImpl;
  @override
  @useResult
  $Res call({String? category, int limit, Map<String, dynamic>? $unknown});
}
