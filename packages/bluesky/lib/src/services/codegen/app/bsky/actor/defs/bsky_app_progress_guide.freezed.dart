...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? guide = null,Object? $unknown = freezed,}) {
  return _then(BskyAppProgressGuide(
...
class _BskyAppProgressGuide implements BskyAppProgressGuide {
  const _BskyAppProgressGuide({this.$type = 'app.bsky.actor.defs#bskyAppProgressGuide', required this.guide,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
