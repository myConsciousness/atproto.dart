...
mixin _$BskyAppProgressGuide {
  ...
  $BskyAppProgressGuideCopyWith<BskyAppProgressGuide> get copyWith =>
      _$BskyAppProgressGuideCopyWithImpl<BskyAppProgressGuide>(
          this as BskyAppProgressGuide, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, $type, guide, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $BskyAppProgressGuideCopyWith<$Res> {
  factory $BskyAppProgressGuideCopyWith(BskyAppProgressGuide value,
          $Res Function(BskyAppProgressGuide) _then) =
      _$BskyAppProgressGuideCopyWithImpl;
  @useResult
...
extension BskyAppProgressGuidePatterns on BskyAppProgressGuide {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_BskyAppProgressGuide value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _BskyAppProgressGuide() when $default != null:
        return $default(_that.$type, _that.guide, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String $type, String guide, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _BskyAppProgressGuide implements BskyAppProgressGuide {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BskyAppProgressGuideCopyWith<_BskyAppProgressGuide> get copyWith =>
      __$BskyAppProgressGuideCopyWithImpl<_BskyAppProgressGuide>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BskyAppProgressGuideToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _BskyAppProgressGuide &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.guide, guide) || other.guide == guide) &&
...
/// @nodoc
abstract mixin class _$BskyAppProgressGuideCopyWith<$Res>
    implements $BskyAppProgressGuideCopyWith<$Res> {
  factory _$BskyAppProgressGuideCopyWith(_BskyAppProgressGuide value,
          $Res Function(_BskyAppProgressGuide) _then) =
      __$BskyAppProgressGuideCopyWithImpl;
  @override
  @useResult
  $Res call({String $type, String guide, Map<String, dynamic>? $unknown});
}
