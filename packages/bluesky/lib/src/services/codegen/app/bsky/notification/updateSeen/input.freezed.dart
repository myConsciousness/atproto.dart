...
mixin _$NotificationUpdateSeenInput {
  ...
  $NotificationUpdateSeenInputCopyWith<NotificationUpdateSeenInput>
      get copyWith => _$NotificationUpdateSeenInputCopyWithImpl<
              NotificationUpdateSeenInput>(
          this as NotificationUpdateSeenInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationUpdateSeenInput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, seenAt, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $NotificationUpdateSeenInputCopyWith<$Res> {
  factory $NotificationUpdateSeenInputCopyWith(
          ...
          $Res Function(NotificationUpdateSeenInput) _then) =
      _$NotificationUpdateSeenInputCopyWithImpl;
  @useResult
...
extension NotificationUpdateSeenInputPatterns on NotificationUpdateSeenInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_NotificationUpdateSeenInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime seenAt, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _NotificationUpdateSeenInput() when $default != null:
        return $default(_that.seenAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(DateTime seenAt, Map<String, dynamic>? $unknown) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _NotificationUpdateSeenInput():
...
class _NotificationUpdateSeenInput implements NotificationUpdateSeenInput {
  const _NotificationUpdateSeenInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NotificationUpdateSeenInputCopyWith<_NotificationUpdateSeenInput>
      get copyWith => __$NotificationUpdateSeenInputCopyWithImpl<
          _NotificationUpdateSeenInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$NotificationUpdateSeenInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NotificationUpdateSeenInput &&
            (identical(other.seenAt, seenAt) || other.seenAt == seenAt) &&
...
/// @nodoc
abstract mixin class _$NotificationUpdateSeenInputCopyWith<$Res>
    implements $NotificationUpdateSeenInputCopyWith<$Res> {
  factory _$NotificationUpdateSeenInputCopyWith(
          _NotificationUpdateSeenInput value,
          $Res Function(_NotificationUpdateSeenInput) _then) =
      __$NotificationUpdateSeenInputCopyWithImpl;
  @override
  @useResult
  $Res call({DateTime seenAt, Map<String, dynamic>? $unknown});
}
