...
@pragma('vm:prefer-inline') @override $Res call({Object? seenAt = null,Object? $unknown = freezed,}) {
  return _then(NotificationUpdateSeenInput(
...
class _NotificationUpdateSeenInput implements NotificationUpdateSeenInput {
  const _NotificationUpdateSeenInput({@JsonKey(toJson: iso8601) required this.seenAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
