...
mixin _$ActorGetProfilesInput {
  ...
  $ActorGetProfilesInputCopyWith<ActorGetProfilesInput> get copyWith =>
      _$ActorGetProfilesInputCopyWithImpl<ActorGetProfilesInput>(
          this as ActorGetProfilesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorGetProfilesInput &&
...
abstract mixin class $ActorGetProfilesInputCopyWith<$Res> {
  factory $ActorGetProfilesInputCopyWith(ActorGetProfilesInput value,
          $Res Function(ActorGetProfilesInput) _then) =
      _$ActorGetProfilesInputCopyWithImpl;
  @useResult
...
extension ActorGetProfilesInputPatterns on ActorGetProfilesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorGetProfilesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> actors, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _ActorGetProfilesInput implements ActorGetProfilesInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorGetProfilesInputCopyWith<_ActorGetProfilesInput> get copyWith =>
      __$ActorGetProfilesInputCopyWithImpl<_ActorGetProfilesInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorGetProfilesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorGetProfilesInput &&
...
/// @nodoc
abstract mixin class _$ActorGetProfilesInputCopyWith<$Res>
    implements $ActorGetProfilesInputCopyWith<$Res> {
  factory _$ActorGetProfilesInputCopyWith(_ActorGetProfilesInput value,
          $Res Function(_ActorGetProfilesInput) _then) =
      __$ActorGetProfilesInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> actors, Map<String, dynamic>? $unknown});
}
