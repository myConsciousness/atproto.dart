...
@pragma('vm:prefer-inline') @override $Res call({Object? actors = null,Object? $unknown = freezed,}) {
  return _then(ActorGetProfilesInput(
...
class _ActorGetProfilesInput implements ActorGetProfilesInput {
  const _ActorGetProfilesInput({required  List<String> actors,  Map<String, dynamic>? $unknown}): _actors = actors,_$unknown = $unknown;
