...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? items = null,Object? $unknown = freezed,}) {
  return _then(DraftEmbedGallery(
...
class _DraftEmbedGallery implements DraftEmbedGallery {
  const _DraftEmbedGallery({this.$type = 'app.bsky.draft.defs#draftEmbedGallery', @UDraftEmbedGalleryItemsConverter() required  List<UDraftEmbedGalleryItems> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
