...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? list = null,Object? listItem = freezed,Object? $unknown = freezed,}) {
  return _then(ListWithMembership(
...
class _ListWithMembership implements ListWithMembership {
  const _ListWithMembership({this.$type = 'app.bsky.graph.getListsWithMembership#listWithMembership', @ListViewConverter() required this.list, @ListItemViewConverter() this.listItem,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
