  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GeneratorViewContentMode &&
...
class $GeneratorViewContentModeCopyWith<$Res> {
  $GeneratorViewContentModeCopyWith(
      GeneratorViewContentMode _, $Res Function(GeneratorViewContentMode) __);
}
...
extension GeneratorViewContentModePatterns on GeneratorViewContentMode {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case GeneratorViewContentModeUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case GeneratorViewContentModeKnownValue():
        return knownValue(_that);
      case GeneratorViewContentModeUnknown():
        return unknown(_that);
      case _:
...
class GeneratorViewContentModeKnownValue extends GeneratorViewContentMode {
  ...
  $GeneratorViewContentModeKnownValueCopyWith<
          GeneratorViewContentModeKnownValue>
      get copyWith => _$GeneratorViewContentModeKnownValueCopyWithImpl<
          GeneratorViewContentModeKnownValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GeneratorViewContentModeKnownValue &&
...
/// @nodoc
abstract mixin class $GeneratorViewContentModeKnownValueCopyWith<$Res>
    implements $GeneratorViewContentModeCopyWith<$Res> {
  factory $GeneratorViewContentModeKnownValueCopyWith(
          GeneratorViewContentModeKnownValue value,
          $Res Function(GeneratorViewContentModeKnownValue) _then) =
      _$GeneratorViewContentModeKnownValueCopyWithImpl;
  @useResult
...
class GeneratorViewContentModeUnknown extends GeneratorViewContentMode {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $GeneratorViewContentModeUnknownCopyWith<GeneratorViewContentModeUnknown>
      get copyWith => _$GeneratorViewContentModeUnknownCopyWithImpl<
          GeneratorViewContentModeUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GeneratorViewContentModeUnknown &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $GeneratorViewContentModeUnknownCopyWith<$Res>
    implements $GeneratorViewContentModeCopyWith<$Res> {
  factory $GeneratorViewContentModeUnknownCopyWith(
          GeneratorViewContentModeUnknown value,
          $Res Function(GeneratorViewContentModeUnknown) _then) =
      _$GeneratorViewContentModeUnknownCopyWithImpl;
  @useResult
