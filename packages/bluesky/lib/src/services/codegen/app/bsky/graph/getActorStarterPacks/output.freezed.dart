...
mixin _$GraphGetActorStarterPacksOutput {
  ...
  $GraphGetActorStarterPacksOutputCopyWith<GraphGetActorStarterPacksOutput>
      get copyWith => _$GraphGetActorStarterPacksOutputCopyWithImpl<
              GraphGetActorStarterPacksOutput>(
          this as GraphGetActorStarterPacksOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GraphGetActorStarterPacksOutput &&
...
abstract mixin class $GraphGetActorStarterPacksOutputCopyWith<$Res> {
  factory $GraphGetActorStarterPacksOutputCopyWith(
          ...
          $Res Function(GraphGetActorStarterPacksOutput) _then) =
      _$GraphGetActorStarterPacksOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension GraphGetActorStarterPacksOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphGetActorStarterPacksOutput value)? $default, {
...
/// @nodoc
@JsonSerializable()
class _GraphGetActorStarterPacksOutput
    implements GraphGetActorStarterPacksOutput {
  const _GraphGetActorStarterPacksOutput(
      {this.cursor,
      @StarterPackViewBasicConverter()
      ...
      : _starterPacks = starterPacks,
        _$unknown = $unknown;
  factory _GraphGetActorStarterPacksOutput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphGetActorStarterPacksOutputCopyWith<_GraphGetActorStarterPacksOutput>
      get copyWith => __$GraphGetActorStarterPacksOutputCopyWithImpl<
          _GraphGetActorStarterPacksOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphGetActorStarterPacksOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphGetActorStarterPacksOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$GraphGetActorStarterPacksOutputCopyWith<$Res>
    implements $GraphGetActorStarterPacksOutputCopyWith<$Res> {
  factory _$GraphGetActorStarterPacksOutputCopyWith(
          _GraphGetActorStarterPacksOutput value,
          $Res Function(_GraphGetActorStarterPacksOutput) _then) =
      __$GraphGetActorStarterPacksOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
