...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? starterPacks = null,Object? $unknown = freezed,}) {
  return _then(GraphGetActorStarterPacksOutput(
...
class _GraphGetActorStarterPacksOutput implements GraphGetActorStarterPacksOutput {
  const _GraphGetActorStarterPacksOutput({this.cursor, @StarterPackViewBasicConverter() required  List<StarterPackViewBasic> starterPacks,  Map<String, dynamic>? $unknown}): _starterPacks = starterPacks,_$unknown = $unknown;
