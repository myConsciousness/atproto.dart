...
mixin _$GraphListblockRecord {
  ...
  $GraphListblockRecordCopyWith<GraphListblockRecord> get copyWith =>
      _$GraphListblockRecordCopyWithImpl<GraphListblockRecord>(
          this as GraphListblockRecord, _$identity);
...
abstract mixin class $GraphListblockRecordCopyWith<$Res> {
  factory $GraphListblockRecordCopyWith(GraphListblockRecord value,
          $Res Function(GraphListblockRecord) _then) =
      _$GraphListblockRecordCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      String subject,
...
extension GraphListblockRecordPatterns on GraphListblockRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GraphListblockRecord value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String subject, DateTime createdAt,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _GraphListblockRecord() when $default != null:
        return $default(
            _that.$type, _that.subject, _that.createdAt, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _GraphListblockRecord implements GraphListblockRecord {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GraphListblockRecordCopyWith<_GraphListblockRecord> get copyWith =>
      __$GraphListblockRecordCopyWithImpl<_GraphListblockRecord>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GraphListblockRecordToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GraphListblockRecord &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.subject, subject) || other.subject == subject) &&
            (identical(other.createdAt, createdAt) ||
                other.createdAt == createdAt) &&
...
/// @nodoc
abstract mixin class _$GraphListblockRecordCopyWith<$Res>
    implements $GraphListblockRecordCopyWith<$Res> {
  factory _$GraphListblockRecordCopyWith(_GraphListblockRecord value,
          $Res Function(_GraphListblockRecord) _then) =
      __$GraphListblockRecordCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
