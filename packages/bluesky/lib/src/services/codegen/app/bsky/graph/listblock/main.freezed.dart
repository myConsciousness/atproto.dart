...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? subject = null,Object? createdAt = null,Object? $unknown = freezed,}) {
  return _then(GraphListblockRecord(
...
class _GraphListblockRecord implements GraphListblockRecord {
  const _GraphListblockRecord({this.$type = 'app.bsky.graph.listblock', @AtUriConverter() required this.subject, @JsonKey(toJson: iso8601) required this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
