...
mixin _$UnspeccedGetSuggestedFeedsSkeletonOutput {
  ...
  $UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith<
      ...
      get copyWith => _$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWithImpl<
              UnspeccedGetSuggestedFeedsSkeletonOutput>(
          this as UnspeccedGetSuggestedFeedsSkeletonOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UnspeccedGetSuggestedFeedsSkeletonOutput &&
...
abstract mixin class $UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith<$Res> {
  factory $UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith(
          ...
          $Res Function(UnspeccedGetSuggestedFeedsSkeletonOutput) _then) =
...
extension UnspeccedGetSuggestedFeedsSkeletonOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedFeedsSkeletonOutput value)?
        $default, {
  ...
  TResult map<TResult extends Object?>(
    TResult Function(_UnspeccedGetSuggestedFeedsSkeletonOutput value) $default,
  ) {
    final _that = this;
    switch (_that) {
...
/// @nodoc
@JsonSerializable()
class _UnspeccedGetSuggestedFeedsSkeletonOutput
    implements UnspeccedGetSuggestedFeedsSkeletonOutput {
  const _UnspeccedGetSuggestedFeedsSkeletonOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith<
          _UnspeccedGetSuggestedFeedsSkeletonOutput>
      get copyWith => __$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWithImpl<
          _UnspeccedGetSuggestedFeedsSkeletonOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UnspeccedGetSuggestedFeedsSkeletonOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UnspeccedGetSuggestedFeedsSkeletonOutput &&
...
/// @nodoc
abstract mixin class _$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith<$Res>
    implements $UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith<$Res> {
  factory _$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWith(
          _UnspeccedGetSuggestedFeedsSkeletonOutput value,
          $Res Function(_UnspeccedGetSuggestedFeedsSkeletonOutput) _then) =
      __$UnspeccedGetSuggestedFeedsSkeletonOutputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> feeds, Map<String, dynamic>? $unknown});
}
