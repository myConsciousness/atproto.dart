...
@pragma('vm:prefer-inline') @override $Res call({Object? feeds = null,Object? $unknown = freezed,}) {
  return _then(UnspeccedGetSuggestedFeedsSkeletonOutput(
...
class _UnspeccedGetSuggestedFeedsSkeletonOutput implements UnspeccedGetSuggestedFeedsSkeletonOutput {
  const _UnspeccedGetSuggestedFeedsSkeletonOutput({@AtUriConverter() required  List<AtUri> feeds,  Map<String, dynamic>? $unknown}): _feeds = feeds,_$unknown = $unknown;
