...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? feed = null,Object? $unknown = freezed,}) {
  return _then(FeedGetAuthorFeedOutput(
...
class _FeedGetAuthorFeedOutput implements FeedGetAuthorFeedOutput {
  const _FeedGetAuthorFeedOutput({this.cursor, @FeedViewPostConverter() required  List<FeedViewPost> feed,  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
