...
mixin _$FeedGetAuthorFeedOutput {
  ...
  $FeedGetAuthorFeedOutputCopyWith<FeedGetAuthorFeedOutput> get copyWith =>
      _$FeedGetAuthorFeedOutputCopyWithImpl<FeedGetAuthorFeedOutput>(
          this as FeedGetAuthorFeedOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FeedGetAuthorFeedOutput &&
...
abstract mixin class $FeedGetAuthorFeedOutputCopyWith<$Res> {
  factory $FeedGetAuthorFeedOutputCopyWith(FeedGetAuthorFeedOutput value,
          $Res Function(FeedGetAuthorFeedOutput) _then) =
      _$FeedGetAuthorFeedOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension FeedGetAuthorFeedOutputPatterns on FeedGetAuthorFeedOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FeedGetAuthorFeedOutput value)? $default, {
...
class _FeedGetAuthorFeedOutput implements FeedGetAuthorFeedOutput {
  const _FeedGetAuthorFeedOutput(
      {this.cursor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FeedGetAuthorFeedOutputCopyWith<_FeedGetAuthorFeedOutput> get copyWith =>
      __$FeedGetAuthorFeedOutputCopyWithImpl<_FeedGetAuthorFeedOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FeedGetAuthorFeedOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _FeedGetAuthorFeedOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$FeedGetAuthorFeedOutputCopyWith<$Res>
    implements $FeedGetAuthorFeedOutputCopyWith<$Res> {
  factory _$FeedGetAuthorFeedOutputCopyWith(_FeedGetAuthorFeedOutput value,
          $Res Function(_FeedGetAuthorFeedOutput) _then) =
      __$FeedGetAuthorFeedOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
