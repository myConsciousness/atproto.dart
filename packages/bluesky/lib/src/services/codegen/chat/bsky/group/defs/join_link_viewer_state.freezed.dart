...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? requestedAt = freezed,Object? $unknown = freezed,}) {
  return _then(JoinLinkViewerState(
...
class _JoinLinkViewerState implements JoinLinkViewerState {
  const _JoinLinkViewerState({this.$type = 'chat.bsky.group.defs#joinLinkViewerState', @JsonKey(toJson: iso8601) this.requestedAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
