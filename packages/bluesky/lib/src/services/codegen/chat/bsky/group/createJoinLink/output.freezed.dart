...
@pragma('vm:prefer-inline') @override $Res call({Object? joinLink = null,Object? $unknown = freezed,}) {
  return _then(GroupCreateJoinLinkOutput(
...
class _GroupCreateJoinLinkOutput implements GroupCreateJoinLinkOutput {
  const _GroupCreateJoinLinkOutput({@JoinLinkViewConverter() required this.joinLink,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
