...
@pragma('vm:prefer-inline') @override $Res call({Object? convoIds = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetConvosInput(
...
class _ModerationGetConvosInput implements ModerationGetConvosInput {
  const _ModerationGetConvosInput({required  List<String> convoIds,  Map<String, dynamic>? $unknown}): _convoIds = convoIds,_$unknown = $unknown;
