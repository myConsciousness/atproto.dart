...
@pragma('vm:prefer-inline') @override $Res call({Object? day = null,Object? month = null,Object? all = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetActorMetadataOutput(
...
class _ModerationGetActorMetadataOutput implements ModerationGetActorMetadataOutput {
  const _ModerationGetActorMetadataOutput({@MetadataConverter() required this.day, @MetadataConverter() required this.month, @MetadataConverter() required this.all,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
