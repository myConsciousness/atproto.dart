  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogCreateMessageMessage &&
...
class $ULogCreateMessageMessageCopyWith<$Res> {
  $ULogCreateMessageMessageCopyWith(
      ULogCreateMessageMessage _, $Res Function(ULogCreateMessageMessage) __);
}
...
extension ULogCreateMessageMessagePatterns on ULogCreateMessageMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogCreateMessageMessageDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case ULogCreateMessageMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogCreateMessageMessageDeletedMessageView():
        return deletedMessageView(_that);
      case ULogCreateMessageMessageUnknown():
        return unknown(_that);
      case _:
...
class ULogCreateMessageMessageMessageView extends ULogCreateMessageMessage {
  ...
  $ULogCreateMessageMessageMessageViewCopyWith<
          ULogCreateMessageMessageMessageView>
      get copyWith => _$ULogCreateMessageMessageMessageViewCopyWithImpl<
          ULogCreateMessageMessageMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogCreateMessageMessageMessageView &&
...
/// @nodoc
abstract mixin class $ULogCreateMessageMessageMessageViewCopyWith<$Res>
    implements $ULogCreateMessageMessageCopyWith<$Res> {
  factory $ULogCreateMessageMessageMessageViewCopyWith(
          ULogCreateMessageMessageMessageView value,
          $Res Function(ULogCreateMessageMessageMessageView) _then) =
      _$ULogCreateMessageMessageMessageViewCopyWithImpl;
  @useResult
...
class ULogCreateMessageMessageDeletedMessageView
    extends ULogCreateMessageMessage {
  const ULogCreateMessageMessageDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogCreateMessageMessageDeletedMessageViewCopyWith<
          ULogCreateMessageMessageDeletedMessageView>
      get copyWith => _$ULogCreateMessageMessageDeletedMessageViewCopyWithImpl<
          ULogCreateMessageMessageDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogCreateMessageMessageDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ULogCreateMessageMessageDeletedMessageViewCopyWith<$Res>
    implements $ULogCreateMessageMessageCopyWith<$Res> {
  factory $ULogCreateMessageMessageDeletedMessageViewCopyWith(
          ULogCreateMessageMessageDeletedMessageView value,
          $Res Function(ULogCreateMessageMessageDeletedMessageView) _then) =
      _$ULogCreateMessageMessageDeletedMessageViewCopyWithImpl;
  @useResult
...
class ULogCreateMessageMessageUnknown extends ULogCreateMessageMessage {
  const ULogCreateMessageMessageUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogCreateMessageMessageUnknownCopyWith<ULogCreateMessageMessageUnknown>
      get copyWith => _$ULogCreateMessageMessageUnknownCopyWithImpl<
          ULogCreateMessageMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogCreateMessageMessageUnknown &&
...
/// @nodoc
abstract mixin class $ULogCreateMessageMessageUnknownCopyWith<$Res>
    implements $ULogCreateMessageMessageCopyWith<$Res> {
  factory $ULogCreateMessageMessageUnknownCopyWith(
          ULogCreateMessageMessageUnknown value,
          $Res Function(ULogCreateMessageMessageUnknown) _then) =
      _$ULogCreateMessageMessageUnknownCopyWithImpl;
  @useResult
