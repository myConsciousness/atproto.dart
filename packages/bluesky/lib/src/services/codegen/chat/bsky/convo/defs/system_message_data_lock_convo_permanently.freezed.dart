...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? lockedBy = null,Object? $unknown = freezed,}) {
  return _then(SystemMessageDataLockConvoPermanently(
...
class _SystemMessageDataLockConvoPermanently implements SystemMessageDataLockConvoPermanently {
  const _SystemMessageDataLockConvoPermanently({this.$type = 'chat.bsky.convo.defs#systemMessageDataLockConvoPermanently', @SystemMessageReferredUserConverter() required this.lockedBy,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
