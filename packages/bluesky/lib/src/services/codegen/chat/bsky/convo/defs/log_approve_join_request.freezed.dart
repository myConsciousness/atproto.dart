...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? member = null,Object? $unknown = freezed,}) {
  return _then(LogApproveJoinRequest(
...
class _LogApproveJoinRequest implements LogApproveJoinRequest {
  const _LogApproveJoinRequest({this.$type = 'chat.bsky.convo.defs#logApproveJoinRequest', required this.rev, required this.convoId, @ProfileViewBasicConverter() required this.member,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
