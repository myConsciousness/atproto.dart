...
mixin _$ModerationUpdateActorAccessInput {
  ...
  $ModerationUpdateActorAccessInputCopyWith<ModerationUpdateActorAccessInput>
      get copyWith => _$ModerationUpdateActorAccessInputCopyWithImpl<
              ModerationUpdateActorAccessInput>(
          this as ModerationUpdateActorAccessInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationUpdateActorAccessInput &&
...
abstract mixin class $ModerationUpdateActorAccessInputCopyWith<$Res> {
  factory $ModerationUpdateActorAccessInputCopyWith(
          ...
          $Res Function(ModerationUpdateActorAccessInput) _then) =
      _$ModerationUpdateActorAccessInputCopyWithImpl;
  @useResult
  $Res call(
      {String actor,
      bool allowAccess,
...
extension ModerationUpdateActorAccessInputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationUpdateActorAccessInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String actor, bool allowAccess, String? ref,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ModerationUpdateActorAccessInput() when $default != null:
        return $default(
            _that.actor, _that.allowAccess, _that.ref, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ModerationUpdateActorAccessInput
    implements ModerationUpdateActorAccessInput {
  const _ModerationUpdateActorAccessInput(
      {required this.actor,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationUpdateActorAccessInputCopyWith<_ModerationUpdateActorAccessInput>
      get copyWith => __$ModerationUpdateActorAccessInputCopyWithImpl<
          _ModerationUpdateActorAccessInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationUpdateActorAccessInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationUpdateActorAccessInput &&
            (identical(other.actor, actor) || other.actor == actor) &&
            (identical(other.allowAccess, allowAccess) ||
                other.allowAccess == allowAccess) &&
            (identical(other.ref, ref) || other.ref == ref) &&
...
/// @nodoc
abstract mixin class _$ModerationUpdateActorAccessInputCopyWith<$Res>
    implements $ModerationUpdateActorAccessInputCopyWith<$Res> {
  factory _$ModerationUpdateActorAccessInputCopyWith(
          _ModerationUpdateActorAccessInput value,
          $Res Function(_ModerationUpdateActorAccessInput) _then) =
      __$ModerationUpdateActorAccessInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String actor,
