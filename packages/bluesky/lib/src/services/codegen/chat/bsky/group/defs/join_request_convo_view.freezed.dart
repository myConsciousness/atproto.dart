...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? convoId = null,Object? name = null,Object? owner = null,Object? memberCount = null,Object? memberLimit = null,Object? viewer = null,Object? $unknown = freezed,}) {
  return _then(JoinRequestConvoView(
...
class _JoinRequestConvoView implements JoinRequestConvoView {
  const _JoinRequestConvoView({this.$type = 'chat.bsky.group.defs#joinRequestConvoView', required this.convoId, required this.name, @ProfileViewBasicConverter() required this.owner, required this.memberCount, required this.memberLimit, @JoinLinkViewerStateConverter() required this.viewer,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
