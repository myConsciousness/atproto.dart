...
mixin _$ConvoAcceptConvoOutput {
  ...
  $ConvoAcceptConvoOutputCopyWith<ConvoAcceptConvoOutput> get copyWith =>
      _$ConvoAcceptConvoOutputCopyWithImpl<ConvoAcceptConvoOutput>(
          this as ConvoAcceptConvoOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoAcceptConvoOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, rev, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ConvoAcceptConvoOutputCopyWith<$Res> {
  factory $ConvoAcceptConvoOutputCopyWith(ConvoAcceptConvoOutput value,
          $Res Function(ConvoAcceptConvoOutput) _then) =
      _$ConvoAcceptConvoOutputCopyWithImpl;
  @useResult
...
extension ConvoAcceptConvoOutputPatterns on ConvoAcceptConvoOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoAcceptConvoOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? rev, Map<String, dynamic>? $unknown)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ConvoAcceptConvoOutput() when $default != null:
        return $default(_that.rev, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoAcceptConvoOutput implements ConvoAcceptConvoOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoAcceptConvoOutputCopyWith<_ConvoAcceptConvoOutput> get copyWith =>
      __$ConvoAcceptConvoOutputCopyWithImpl<_ConvoAcceptConvoOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoAcceptConvoOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoAcceptConvoOutput &&
            (identical(other.rev, rev) || other.rev == rev) &&
...
/// @nodoc
abstract mixin class _$ConvoAcceptConvoOutputCopyWith<$Res>
    implements $ConvoAcceptConvoOutputCopyWith<$Res> {
  factory _$ConvoAcceptConvoOutputCopyWith(_ConvoAcceptConvoOutput value,
          $Res Function(_ConvoAcceptConvoOutput) _then) =
      __$ConvoAcceptConvoOutputCopyWithImpl;
  @override
  @useResult
  $Res call({String? rev, Map<String, dynamic>? $unknown});
}
