...
extension MetadataPatterns on Metadata {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, int messagesSent, int messagesReceived,
            int convos, int convosStarted, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Metadata() when $default != null:
        return $default(_that.$type, _that.messagesSent, _that.messagesReceived,
            _that.convos, _that.convosStarted, _that.$unknown);
      case _:
        return orElse();
    }
  }
