...
@pragma('vm:prefer-inline') @override $Res call({Object? codes = null,Object? $unknown = freezed,}) {
  return _then(GroupGetJoinLinkPreviewsInput(
...
class _GroupGetJoinLinkPreviewsInput implements GroupGetJoinLinkPreviewsInput {
  const _GroupGetJoinLinkPreviewsInput({required  List<String> codes,  Map<String, dynamic>? $unknown}): _codes = codes,_$unknown = $unknown;
