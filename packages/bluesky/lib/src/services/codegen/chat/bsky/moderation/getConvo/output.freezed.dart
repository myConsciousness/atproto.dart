...
@pragma('vm:prefer-inline') @override $Res call({Object? convo = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetConvoOutput(
...
class _ModerationGetConvoOutput implements ModerationGetConvoOutput {
  const _ModerationGetConvoOutput({@ConvoViewConverter() required this.convo,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
