...
mixin _$ConvoSendMessageInput {
  ...
  $ConvoSendMessageInputCopyWith<ConvoSendMessageInput> get copyWith =>
      _$ConvoSendMessageInputCopyWithImpl<ConvoSendMessageInput>(
          this as ConvoSendMessageInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoSendMessageInput &&
...
abstract mixin class $ConvoSendMessageInputCopyWith<$Res> {
  factory $ConvoSendMessageInputCopyWith(ConvoSendMessageInput value,
          $Res Function(ConvoSendMessageInput) _then) =
      _$ConvoSendMessageInputCopyWithImpl;
  @useResult
  $Res call(
      {String convoId,
...
extension ConvoSendMessageInputPatterns on ConvoSendMessageInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoSendMessageInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ConvoSendMessageInput() when $default != null:
        return $default(_that.convoId, _that.message, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoSendMessageInput implements ConvoSendMessageInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoSendMessageInputCopyWith<_ConvoSendMessageInput> get copyWith =>
      __$ConvoSendMessageInputCopyWithImpl<_ConvoSendMessageInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoSendMessageInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoSendMessageInput &&
            (identical(other.convoId, convoId) || other.convoId == convoId) &&
            (identical(other.message, message) || other.message == message) &&
...
/// @nodoc
abstract mixin class _$ConvoSendMessageInputCopyWith<$Res>
    implements $ConvoSendMessageInputCopyWith<$Res> {
  factory _$ConvoSendMessageInputCopyWith(_ConvoSendMessageInput value,
          $Res Function(_ConvoSendMessageInput) _then) =
      __$ConvoSendMessageInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String convoId,
