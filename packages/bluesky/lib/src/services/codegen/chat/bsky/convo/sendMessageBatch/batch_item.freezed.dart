...
class _BatchItem implements BatchItem {
  const _BatchItem({this.$type = 'chat.bsky.convo.sendMessageBatch#batchItem', required this.convoId, @MessageInputConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
