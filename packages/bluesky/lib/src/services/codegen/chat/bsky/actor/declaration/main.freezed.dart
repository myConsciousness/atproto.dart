...
mixin _$ActorDeclarationRecord {
  ...
  $ActorDeclarationRecordCopyWith<ActorDeclarationRecord> get copyWith =>
      _$ActorDeclarationRecordCopyWithImpl<ActorDeclarationRecord>(
          this as ActorDeclarationRecord, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActorDeclarationRecord &&
...
abstract mixin class $ActorDeclarationRecordCopyWith<$Res> {
  factory $ActorDeclarationRecordCopyWith(ActorDeclarationRecord value,
          $Res Function(ActorDeclarationRecord) _then) =
      _$ActorDeclarationRecordCopyWithImpl;
  @useResult
  $Res call(
      {String $type,
      @ActorDeclarationAllowIncomingConverter()
...
class _$ActorDeclarationRecordCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $ActorDeclarationAllowIncomingCopyWith<$Res> get allowIncoming {
    return $ActorDeclarationAllowIncomingCopyWith<$Res>(_self.allowIncoming,
        (value) {
...
extension ActorDeclarationRecordPatterns on ActorDeclarationRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ActorDeclarationRecord value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ActorDeclarationRecord() when $default != null:
        return $default(_that.$type, _that.allowIncoming, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ActorDeclarationRecord implements ActorDeclarationRecord {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ActorDeclarationRecordCopyWith<_ActorDeclarationRecord> get copyWith =>
      __$ActorDeclarationRecordCopyWithImpl<_ActorDeclarationRecord>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ActorDeclarationRecordToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ActorDeclarationRecord &&
            (identical(other.$type, $type) || other.$type == $type) &&
            (identical(other.allowIncoming, allowIncoming) ||
                other.allowIncoming == allowIncoming) &&
...
/// @nodoc
abstract mixin class _$ActorDeclarationRecordCopyWith<$Res>
    implements $ActorDeclarationRecordCopyWith<$Res> {
  factory _$ActorDeclarationRecordCopyWith(_ActorDeclarationRecord value,
          $Res Function(_ActorDeclarationRecord) _then) =
      __$ActorDeclarationRecordCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String $type,
