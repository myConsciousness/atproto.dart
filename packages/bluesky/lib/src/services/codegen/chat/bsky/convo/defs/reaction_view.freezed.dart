...
class _ReactionView implements ReactionView {
  const _ReactionView({this.$type = 'chat.bsky.convo.defs#reactionView', required this.value, @ReactionViewSenderConverter() required this.sender, @JsonKey(toJson: iso8601) required this.createdAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
