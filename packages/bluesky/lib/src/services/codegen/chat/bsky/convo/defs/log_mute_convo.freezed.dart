...
class _LogMuteConvo implements LogMuteConvo {
  const _LogMuteConvo({this.$type = 'chat.bsky.convo.defs#logMuteConvo', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
