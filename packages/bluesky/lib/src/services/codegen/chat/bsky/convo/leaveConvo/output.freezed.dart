...
mixin _$ConvoLeaveConvoOutput {
  ...
  $ConvoLeaveConvoOutputCopyWith<ConvoLeaveConvoOutput> get copyWith =>
      _$ConvoLeaveConvoOutputCopyWithImpl<ConvoLeaveConvoOutput>(
          this as ConvoLeaveConvoOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoLeaveConvoOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, convoId, rev, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ConvoLeaveConvoOutputCopyWith<$Res> {
  factory $ConvoLeaveConvoOutputCopyWith(ConvoLeaveConvoOutput value,
          $Res Function(ConvoLeaveConvoOutput) _then) =
      _$ConvoLeaveConvoOutputCopyWithImpl;
  @useResult
...
extension ConvoLeaveConvoOutputPatterns on ConvoLeaveConvoOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoLeaveConvoOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ConvoLeaveConvoOutput() when $default != null:
        return $default(_that.convoId, _that.rev, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String convoId, String rev, Map<String, dynamic>? $unknown)
        $default,
  ) {
    final _that = this;
    switch (_that) {
...
class _ConvoLeaveConvoOutput implements ConvoLeaveConvoOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoLeaveConvoOutputCopyWith<_ConvoLeaveConvoOutput> get copyWith =>
      __$ConvoLeaveConvoOutputCopyWithImpl<_ConvoLeaveConvoOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoLeaveConvoOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoLeaveConvoOutput &&
            (identical(other.convoId, convoId) || other.convoId == convoId) &&
            (identical(other.rev, rev) || other.rev == rev) &&
...
/// @nodoc
abstract mixin class _$ConvoLeaveConvoOutputCopyWith<$Res>
    implements $ConvoLeaveConvoOutputCopyWith<$Res> {
  factory _$ConvoLeaveConvoOutputCopyWith(_ConvoLeaveConvoOutput value,
          $Res Function(_ConvoLeaveConvoOutput) _then) =
      __$ConvoLeaveConvoOutputCopyWithImpl;
  @override
  @useResult
  $Res call({String convoId, String rev, Map<String, dynamic>? $unknown});
}
