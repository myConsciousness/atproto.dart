...
@pragma('vm:prefer-inline') @override $Res call({Object? members = null,Object? name = null,Object? $unknown = freezed,}) {
  return _then(GroupCreateGroupInput(
...
class _GroupCreateGroupInput implements GroupCreateGroupInput {
  const _GroupCreateGroupInput({required  List<String> members, required this.name,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
