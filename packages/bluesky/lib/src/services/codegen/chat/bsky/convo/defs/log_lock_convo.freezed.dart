...
class _LogLockConvo implements LogLockConvo {
  const _LogLockConvo({this.$type = 'chat.bsky.convo.defs#logLockConvo', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required  List<ProfileViewBasic> relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
