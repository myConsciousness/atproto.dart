...
mixin _$ConvoGetConvoAvailabilityOutput {
  ...
  $ConvoGetConvoAvailabilityOutputCopyWith<ConvoGetConvoAvailabilityOutput>
      get copyWith => _$ConvoGetConvoAvailabilityOutputCopyWithImpl<
              ConvoGetConvoAvailabilityOutput>(
          this as ConvoGetConvoAvailabilityOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoGetConvoAvailabilityOutput &&
...
abstract mixin class $ConvoGetConvoAvailabilityOutputCopyWith<$Res> {
  factory $ConvoGetConvoAvailabilityOutputCopyWith(
          ...
          $Res Function(ConvoGetConvoAvailabilityOutput) _then) =
      _$ConvoGetConvoAvailabilityOutputCopyWithImpl;
  @useResult
  $Res call(
      {bool canChat,
...
extension ConvoGetConvoAvailabilityOutputPatterns
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoGetConvoAvailabilityOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool canChat, @ConvoViewConverter() ConvoView? convo,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ConvoGetConvoAvailabilityOutput() when $default != null:
        return $default(_that.canChat, _that.convo, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ConvoGetConvoAvailabilityOutput
    implements ConvoGetConvoAvailabilityOutput {
  const _ConvoGetConvoAvailabilityOutput(
      {required this.canChat,
      @ConvoViewConverter() this.convo,
      final Map<String, dynamic>? $unknown})
      : _$unknown = $unknown;
  factory _ConvoGetConvoAvailabilityOutput.fromJson(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoGetConvoAvailabilityOutputCopyWith<_ConvoGetConvoAvailabilityOutput>
      get copyWith => __$ConvoGetConvoAvailabilityOutputCopyWithImpl<
          _ConvoGetConvoAvailabilityOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoGetConvoAvailabilityOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoGetConvoAvailabilityOutput &&
            (identical(other.canChat, canChat) || other.canChat == canChat) &&
            (identical(other.convo, convo) || other.convo == convo) &&
...
/// @nodoc
abstract mixin class _$ConvoGetConvoAvailabilityOutputCopyWith<$Res>
    implements $ConvoGetConvoAvailabilityOutputCopyWith<$Res> {
  factory _$ConvoGetConvoAvailabilityOutputCopyWith(
          _ConvoGetConvoAvailabilityOutput value,
          $Res Function(_ConvoGetConvoAvailabilityOutput) _then) =
      __$ConvoGetConvoAvailabilityOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool canChat,
