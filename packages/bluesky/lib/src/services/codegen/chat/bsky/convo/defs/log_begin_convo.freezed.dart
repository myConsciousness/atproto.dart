...
class _LogBeginConvo implements LogBeginConvo {
  const _LogBeginConvo({this.$type = 'chat.bsky.convo.defs#logBeginConvo', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
