...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? $unknown = freezed,}) {
  return _then(LogReadJoinRequests(
...
class _LogReadJoinRequests implements LogReadJoinRequests {
  const _LogReadJoinRequests({this.$type = 'chat.bsky.convo.defs#logReadJoinRequests', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
