...
@pragma('vm:prefer-inline') @override $Res call({Object? joinLink = null,Object? $unknown = freezed,}) {
  return _then(GroupEditJoinLinkOutput(
...
class _GroupEditJoinLinkOutput implements GroupEditJoinLinkOutput {
  const _GroupEditJoinLinkOutput({@JoinLinkViewConverter() required this.joinLink,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
