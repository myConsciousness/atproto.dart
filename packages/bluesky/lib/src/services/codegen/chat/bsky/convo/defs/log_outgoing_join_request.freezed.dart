...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? $unknown = freezed,}) {
  return _then(LogOutgoingJoinRequest(
...
class _LogOutgoingJoinRequest implements LogOutgoingJoinRequest {
  const _LogOutgoingJoinRequest({this.$type = 'chat.bsky.convo.defs#logOutgoingJoinRequest', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
