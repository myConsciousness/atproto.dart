...
mixin _$ConvoGetMessagesInput {
  ...
  $ConvoGetMessagesInputCopyWith<ConvoGetMessagesInput> get copyWith =>
      _$ConvoGetMessagesInputCopyWithImpl<ConvoGetMessagesInput>(
          this as ConvoGetMessagesInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoGetMessagesInput &&
...
abstract mixin class $ConvoGetMessagesInputCopyWith<$Res> {
  factory $ConvoGetMessagesInputCopyWith(ConvoGetMessagesInput value,
          $Res Function(ConvoGetMessagesInput) _then) =
      _$ConvoGetMessagesInputCopyWithImpl;
  @useResult
  $Res call(
      {String convoId,
      int limit,
...
extension ConvoGetMessagesInputPatterns on ConvoGetMessagesInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoGetMessagesInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String convoId, int limit, String? cursor,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ConvoGetMessagesInput() when $default != null:
        return $default(
            _that.convoId, _that.limit, _that.cursor, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoGetMessagesInput implements ConvoGetMessagesInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoGetMessagesInputCopyWith<_ConvoGetMessagesInput> get copyWith =>
      __$ConvoGetMessagesInputCopyWithImpl<_ConvoGetMessagesInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoGetMessagesInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoGetMessagesInput &&
            (identical(other.convoId, convoId) || other.convoId == convoId) &&
            (identical(other.limit, limit) || other.limit == limit) &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$ConvoGetMessagesInputCopyWith<$Res>
    implements $ConvoGetMessagesInputCopyWith<$Res> {
  factory _$ConvoGetMessagesInputCopyWith(_ConvoGetMessagesInput value,
          $Res Function(_ConvoGetMessagesInput) _then) =
      __$ConvoGetMessagesInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String convoId,
