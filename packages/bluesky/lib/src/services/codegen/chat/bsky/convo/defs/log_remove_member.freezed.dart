...
class _LogRemoveMember implements LogRemoveMember {
  const _LogRemoveMember({this.$type = 'chat.bsky.convo.defs#logRemoveMember', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required  List<ProfileViewBasic> relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
