...
@pragma('vm:prefer-inline') @override $Res call({Object? convos = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetConvosOutput(
...
class _ModerationGetConvosOutput implements ModerationGetConvosOutput {
  const _ModerationGetConvosOutput({@ConvoViewConverter() required  List<ConvoView> convos,  Map<String, dynamic>? $unknown}): _convos = convos,_$unknown = $unknown;
