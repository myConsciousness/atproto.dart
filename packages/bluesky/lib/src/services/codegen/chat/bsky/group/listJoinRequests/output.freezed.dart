...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? requests = null,Object? $unknown = freezed,}) {
  return _then(GroupListJoinRequestsOutput(
...
class _GroupListJoinRequestsOutput implements GroupListJoinRequestsOutput {
  const _GroupListJoinRequestsOutput({this.cursor, @JoinRequestViewConverter() required  List<JoinRequestView> requests,  Map<String, dynamic>? $unknown}): _requests = requests,_$unknown = $unknown;
