...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? $unknown = freezed,}) {
  return _then(SystemMessageDataCreateJoinLink(
...
class _SystemMessageDataCreateJoinLink implements SystemMessageDataCreateJoinLink {
  const _SystemMessageDataCreateJoinLink({this.$type = 'chat.bsky.convo.defs#systemMessageDataCreateJoinLink',  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
