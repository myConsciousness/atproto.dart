...
$ModerationGetMessageContextInputCopyWith<ModerationGetMessageContextInput> get copyWith => _$ModerationGetMessageContextInputCopyWithImpl<ModerationGetMessageContextInput>(this as ModerationGetMessageContextInput, _$identity);
...
/// @nodoc
abstract mixin class $ModerationGetMessageContextInputCopyWith<$Res>  {
...
class _$ModerationGetMessageContextInputCopyWithImpl<$Res>
  ...
  _$ModerationGetMessageContextInputCopyWithImpl(this._self, this._then);

  final ModerationGetMessageContextInput _self;
  final $Res Function(ModerationGetMessageContextInput) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? convoId = freezed,Object? messageId = null,Object? before = null,Object? after = null,Object? maxInterleavedSystemMessages = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetMessageContextInput(
...
/// Adds pattern-matching-related methods to [ModerationGetMessageContextInput].
extension ModerationGetMessageContextInputPatterns on ModerationGetMessageContextInput {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ModerationGetMessageContextInput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ModerationGetMessageContextInput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ModerationGetMessageContextInput value)?  $default,){
final _that = this;
switch (_that) {
case _ModerationGetMessageContextInput() when $default != null:
return $default(_that);case _:
...
class _ModerationGetMessageContextInput implements ModerationGetMessageContextInput {
  const _ModerationGetMessageContextInput({this.convoId, required this.messageId, this.before = 5, this.after = 5, this.maxInterleavedSystemMessages = 10,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$ModerationGetMessageContextInputCopyWith<_ModerationGetMessageContextInput> get copyWith => __$ModerationGetMessageContextInputCopyWithImpl<_ModerationGetMessageContextInput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ModerationGetMessageContextInputToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ModerationGetMessageContextInputCopyWith<$Res> implements $ModerationGetMessageContextInputCopyWith<$Res> {
...
/// @nodoc
class __$ModerationGetMessageContextInputCopyWithImpl<$Res>
    implements _$ModerationGetMessageContextInputCopyWith<$Res> {
  __$ModerationGetMessageContextInputCopyWithImpl(this._self, this._then);

  final _ModerationGetMessageContextInput _self;
  final $Res Function(_ModerationGetMessageContextInput) _then;
