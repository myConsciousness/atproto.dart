...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? code = null,Object? $unknown = freezed,}) {
  return _then(DisabledJoinLinkPreviewView(
...
class _DisabledJoinLinkPreviewView implements DisabledJoinLinkPreviewView {
  const _DisabledJoinLinkPreviewView({this.$type = 'chat.bsky.group.defs#disabledJoinLinkPreviewView', required this.code,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
