...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? $unknown = freezed,}) {
  return _then(MessageBeforeUserJoinedGroupView(
...
class _MessageBeforeUserJoinedGroupView implements MessageBeforeUserJoinedGroupView {
  const _MessageBeforeUserJoinedGroupView({this.$type = 'chat.bsky.convo.defs#messageBeforeUserJoinedGroupView',  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
