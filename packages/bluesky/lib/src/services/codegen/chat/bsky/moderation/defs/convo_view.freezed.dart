...
class _ConvoView implements ConvoView {
  const _ConvoView({this.$type = 'chat.bsky.moderation.defs#convoView', required this.id, required this.rev, @UConvoViewKindConverter() this.kind,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
