...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? message = null,Object? $unknown = freezed,}) {
  return _then(LogDisableJoinLink(
...
class _LogDisableJoinLink implements LogDisableJoinLink {
  const _LogDisableJoinLink({this.$type = 'chat.bsky.convo.defs#logDisableJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
