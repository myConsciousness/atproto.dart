...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? $unknown = freezed,}) {
  return _then(ConvoSendMessageBatchInput(
...
class _ConvoSendMessageBatchInput implements ConvoSendMessageBatchInput {
  const _ConvoSendMessageBatchInput({@BatchItemConverter() required  List<BatchItem> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
