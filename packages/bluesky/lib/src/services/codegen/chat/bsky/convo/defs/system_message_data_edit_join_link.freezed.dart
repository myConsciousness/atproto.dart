...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? $unknown = freezed,}) {
  return _then(SystemMessageDataEditJoinLink(
...
class _SystemMessageDataEditJoinLink implements SystemMessageDataEditJoinLink {
  const _SystemMessageDataEditJoinLink({this.$type = 'chat.bsky.convo.defs#systemMessageDataEditJoinLink',  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
