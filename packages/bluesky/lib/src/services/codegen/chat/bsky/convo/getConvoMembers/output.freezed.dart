...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? members = null,Object? $unknown = freezed,}) {
  return _then(ConvoGetConvoMembersOutput(
...
class _ConvoGetConvoMembersOutput implements ConvoGetConvoMembersOutput {
  const _ConvoGetConvoMembersOutput({this.cursor, @ProfileViewBasicConverter() required  List<ProfileViewBasic> members,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
