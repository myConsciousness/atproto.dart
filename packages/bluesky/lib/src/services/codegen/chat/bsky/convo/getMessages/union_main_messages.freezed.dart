  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoGetMessagesMessages &&
...
class $UConvoGetMessagesMessagesCopyWith<$Res> {
  $UConvoGetMessagesMessagesCopyWith(
      UConvoGetMessagesMessages _, $Res Function(UConvoGetMessagesMessages) __);
}
...
extension UConvoGetMessagesMessagesPatterns on UConvoGetMessagesMessages {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UConvoGetMessagesMessagesDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case UConvoGetMessagesMessagesUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UConvoGetMessagesMessagesDeletedMessageView():
        return deletedMessageView(_that);
      case UConvoGetMessagesMessagesUnknown():
        return unknown(_that);
      case _:
...
class UConvoGetMessagesMessagesMessageView extends UConvoGetMessagesMessages {
  ...
  $UConvoGetMessagesMessagesMessageViewCopyWith<
          UConvoGetMessagesMessagesMessageView>
      get copyWith => _$UConvoGetMessagesMessagesMessageViewCopyWithImpl<
          UConvoGetMessagesMessagesMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoGetMessagesMessagesMessageView &&
...
/// @nodoc
abstract mixin class $UConvoGetMessagesMessagesMessageViewCopyWith<$Res>
    implements $UConvoGetMessagesMessagesCopyWith<$Res> {
  factory $UConvoGetMessagesMessagesMessageViewCopyWith(
          UConvoGetMessagesMessagesMessageView value,
          $Res Function(UConvoGetMessagesMessagesMessageView) _then) =
      _$UConvoGetMessagesMessagesMessageViewCopyWithImpl;
  @useResult
...
class UConvoGetMessagesMessagesDeletedMessageView
    extends UConvoGetMessagesMessages {
  const UConvoGetMessagesMessagesDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UConvoGetMessagesMessagesDeletedMessageViewCopyWith<
          UConvoGetMessagesMessagesDeletedMessageView>
      get copyWith => _$UConvoGetMessagesMessagesDeletedMessageViewCopyWithImpl<
          UConvoGetMessagesMessagesDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoGetMessagesMessagesDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UConvoGetMessagesMessagesDeletedMessageViewCopyWith<$Res>
    implements $UConvoGetMessagesMessagesCopyWith<$Res> {
  factory $UConvoGetMessagesMessagesDeletedMessageViewCopyWith(
          UConvoGetMessagesMessagesDeletedMessageView value,
          $Res Function(UConvoGetMessagesMessagesDeletedMessageView) _then) =
      _$UConvoGetMessagesMessagesDeletedMessageViewCopyWithImpl;
  @useResult
...
class UConvoGetMessagesMessagesUnknown extends UConvoGetMessagesMessages {
  const UConvoGetMessagesMessagesUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UConvoGetMessagesMessagesUnknownCopyWith<UConvoGetMessagesMessagesUnknown>
      get copyWith => _$UConvoGetMessagesMessagesUnknownCopyWithImpl<
          UConvoGetMessagesMessagesUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoGetMessagesMessagesUnknown &&
...
/// @nodoc
abstract mixin class $UConvoGetMessagesMessagesUnknownCopyWith<$Res>
    implements $UConvoGetMessagesMessagesCopyWith<$Res> {
  factory $UConvoGetMessagesMessagesUnknownCopyWith(
          UConvoGetMessagesMessagesUnknown value,
          $Res Function(UConvoGetMessagesMessagesUnknown) _then) =
      _$UConvoGetMessagesMessagesUnknownCopyWithImpl;
  @useResult
