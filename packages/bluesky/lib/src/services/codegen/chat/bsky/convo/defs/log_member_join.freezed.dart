...
class _LogMemberJoin implements LogMemberJoin {
  const _LogMemberJoin({this.$type = 'chat.bsky.convo.defs#logMemberJoin', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required  List<ProfileViewBasic> relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
