...
mixin _$GroupConvo {
 ...
 int get memberCount; DateTime get createdAt;@JoinLinkViewConverter() JoinLinkView? get joinLink;/// The lock status of the conversation.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,name,memberCount,createdAt,joinLink,lockStatus,const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type, String name, int memberCount, DateTime createdAt,@JoinLinkViewConverter() JoinLinkView? joinLink,@ConvoLockStatusConverter() ConvoLockStatus lockStatus, Map<String, dynamic>? $unknown
});
...
/// Create a copy of GroupConvo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? name = null,Object? memberCount = null,Object? createdAt = null,Object? joinLink = freezed,Object? lockStatus = null,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String name,  int memberCount,  DateTime createdAt, @JoinLinkViewConverter()  JoinLinkView? joinLink, @ConvoLockStatusConverter()  ConvoLockStatus lockStatus,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupConvo() when $default != null:
return $default(_that.$type,_that.name,_that.memberCount,_that.createdAt,_that.joinLink,_that.lockStatus,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String name,  int memberCount,  DateTime createdAt, @JoinLinkViewConverter()  JoinLinkView? joinLink, @ConvoLockStatusConverter()  ConvoLockStatus lockStatus,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _GroupConvo():
return $default(_that.$type,_that.name,_that.memberCount,_that.createdAt,_that.joinLink,_that.lockStatus,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String name,  int memberCount,  DateTime createdAt, @JoinLinkViewConverter()  JoinLinkView? joinLink, @ConvoLockStatusConverter()  ConvoLockStatus lockStatus,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _GroupConvo() when $default != null:
return $default(_that.$type,_that.name,_that.memberCount,_that.createdAt,_that.joinLink,_that.lockStatus,_that.$unknown);case _:
  return null;
...
class _GroupConvo implements GroupConvo {
  const _GroupConvo({this.$type = 'chat.bsky.convo.defs#groupConvo', required this.name, required this.memberCount, required this.createdAt, @JoinLinkViewConverter() this.joinLink, @ConvoLockStatusConverter() required this.lockStatus, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,name,memberCount,createdAt,joinLink,lockStatus,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of GroupConvo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? name = null,Object? memberCount = null,Object? createdAt = null,Object? joinLink = freezed,Object? lockStatus = null,Object? $unknown = freezed,}) {
