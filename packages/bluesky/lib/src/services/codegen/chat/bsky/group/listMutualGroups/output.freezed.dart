...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? convos = null,Object? $unknown = freezed,}) {
  return _then(GroupListMutualGroupsOutput(
...
class _GroupListMutualGroupsOutput implements GroupListMutualGroupsOutput {
  const _GroupListMutualGroupsOutput({this.cursor, @ConvoViewConverter() required  List<ConvoView> convos,  Map<String, dynamic>? $unknown}): _convos = convos,_$unknown = $unknown;
