...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? member = null,Object? $unknown = freezed,}) {
  return _then(LogRejectJoinRequest(
...
class _LogRejectJoinRequest implements LogRejectJoinRequest {
  const _LogRejectJoinRequest({this.$type = 'chat.bsky.convo.defs#logRejectJoinRequest', required this.rev, required this.convoId, @ProfileViewBasicConverter() required this.member,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
