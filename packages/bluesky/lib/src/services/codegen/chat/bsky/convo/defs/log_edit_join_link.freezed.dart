...
class _LogEditJoinLink implements LogEditJoinLink {
  const _LogEditJoinLink({this.$type = 'chat.bsky.convo.defs#logEditJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
