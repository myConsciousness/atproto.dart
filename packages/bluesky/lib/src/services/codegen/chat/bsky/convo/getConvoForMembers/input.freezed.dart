...
mixin _$ConvoGetConvoForMembersInput {
  ...
  $ConvoGetConvoForMembersInputCopyWith<ConvoGetConvoForMembersInput>
      get copyWith => _$ConvoGetConvoForMembersInputCopyWithImpl<
              ConvoGetConvoForMembersInput>(
          this as ConvoGetConvoForMembersInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoGetConvoForMembersInput &&
...
abstract mixin class $ConvoGetConvoForMembersInputCopyWith<$Res> {
  factory $ConvoGetConvoForMembersInputCopyWith(
          ...
          $Res Function(ConvoGetConvoForMembersInput) _then) =
      _$ConvoGetConvoForMembersInputCopyWithImpl;
  @useResult
...
extension ConvoGetConvoForMembersInputPatterns on ConvoGetConvoForMembersInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoGetConvoForMembersInput value)? $default, {
...
class _ConvoGetConvoForMembersInput implements ConvoGetConvoForMembersInput {
  const _ConvoGetConvoForMembersInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoGetConvoForMembersInputCopyWith<_ConvoGetConvoForMembersInput>
      get copyWith => __$ConvoGetConvoForMembersInputCopyWithImpl<
          _ConvoGetConvoForMembersInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoGetConvoForMembersInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoGetConvoForMembersInput &&
...
/// @nodoc
abstract mixin class _$ConvoGetConvoForMembersInputCopyWith<$Res>
    implements $ConvoGetConvoForMembersInputCopyWith<$Res> {
  factory _$ConvoGetConvoForMembersInputCopyWith(
          _ConvoGetConvoForMembersInput value,
          $Res Function(_ConvoGetConvoForMembersInput) _then) =
      __$ConvoGetConvoForMembersInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> members, Map<String, dynamic>? $unknown});
}
