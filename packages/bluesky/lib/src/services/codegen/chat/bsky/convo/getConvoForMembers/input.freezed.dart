...
@pragma('vm:prefer-inline') @override $Res call({Object? members = null,Object? $unknown = freezed,}) {
  return _then(ConvoGetConvoForMembersInput(
...
class _ConvoGetConvoForMembersInput implements ConvoGetConvoForMembersInput {
  const _ConvoGetConvoForMembersInput({required  List<String> members,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
