...
@pragma('vm:prefer-inline') @override $Res call({Object? status = freezed,Object? $unknown = freezed,}) {
  return _then(ConvoUpdateAllReadInput(
...
class _ConvoUpdateAllReadInput implements ConvoUpdateAllReadInput {
  const _ConvoUpdateAllReadInput({@ConvoUpdateAllReadStatusConverter() this.status,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
