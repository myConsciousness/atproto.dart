...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? code = null,Object? $unknown = freezed,}) {
  return _then(InvalidJoinLinkPreviewView(
...
class _InvalidJoinLinkPreviewView implements InvalidJoinLinkPreviewView {
  const _InvalidJoinLinkPreviewView({this.$type = 'chat.bsky.group.defs#invalidJoinLinkPreviewView', required this.code,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
