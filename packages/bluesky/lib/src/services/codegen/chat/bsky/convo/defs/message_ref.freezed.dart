...
class _MessageRef implements MessageRef {
  const _MessageRef({this.$type = 'chat.bsky.convo.defs#messageRef', required this.did, required this.convoId, required this.messageId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
