...
extension MessageRefPatterns on MessageRef {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MessageRef value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String did, String convoId, String messageId,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _MessageRef() when $default != null:
        return $default(_that.$type, _that.did, _that.convoId, _that.messageId,
            _that.$unknown);
      case _:
        return orElse();
    }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    TResult? Function(String $type, String did, String convoId,
            String messageId, Map<String, dynamic>? $unknown)?
        $default,
  ) {
    final _that = this;
    switch (_that) {
