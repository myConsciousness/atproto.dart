...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? oldName = freezed,Object? newName = freezed,Object? $unknown = freezed,}) {
  return _then(SystemMessageDataEditGroup(
...
class _SystemMessageDataEditGroup implements SystemMessageDataEditGroup {
  const _SystemMessageDataEditGroup({this.$type = 'chat.bsky.convo.defs#systemMessageDataEditGroup', this.oldName, this.newName,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
