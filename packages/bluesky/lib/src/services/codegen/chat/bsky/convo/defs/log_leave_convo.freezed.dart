...
class _LogLeaveConvo implements LogLeaveConvo {
  const _LogLeaveConvo({this.$type = 'chat.bsky.convo.defs#logLeaveConvo', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
