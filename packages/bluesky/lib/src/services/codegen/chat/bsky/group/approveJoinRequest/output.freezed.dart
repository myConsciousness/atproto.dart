...
@pragma('vm:prefer-inline') @override $Res call({Object? convo = null,Object? $unknown = freezed,}) {
  return _then(GroupApproveJoinRequestOutput(
...
class _GroupApproveJoinRequestOutput implements GroupApproveJoinRequestOutput {
  const _GroupApproveJoinRequestOutput({@ConvoViewConverter() required this.convo,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
