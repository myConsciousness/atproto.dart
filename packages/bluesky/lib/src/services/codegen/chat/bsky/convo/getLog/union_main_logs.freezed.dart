...
class UConvoGetLogLogsUnknown extends UConvoGetLogLogs {
  const UConvoGetLogLogsUnknown({required  Map<String, dynamic> data}): _data = data,super._();
