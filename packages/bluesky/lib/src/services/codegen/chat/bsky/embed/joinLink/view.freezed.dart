...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? joinLinkPreview = null,Object? $unknown = freezed,}) {
  return _then(EmbedJoinLinkView(
...
class _EmbedJoinLinkView implements EmbedJoinLinkView {
  const _EmbedJoinLinkView({this.$type = 'chat.bsky.embed.joinLink#view', @UEmbedJoinLinkViewJoinLinkPreviewConverter() required this.joinLinkPreview,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
