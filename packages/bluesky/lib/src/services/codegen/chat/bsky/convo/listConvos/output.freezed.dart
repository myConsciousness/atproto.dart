...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? convos = null,Object? $unknown = freezed,}) {
  return _then(ConvoListConvosOutput(
...
class _ConvoListConvosOutput implements ConvoListConvosOutput {
  const _ConvoListConvosOutput({this.cursor, @ConvoViewConverter() required  List<ConvoView> convos,  Map<String, dynamic>? $unknown}): _convos = convos,_$unknown = $unknown;
