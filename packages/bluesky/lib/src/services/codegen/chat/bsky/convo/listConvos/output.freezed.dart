...
mixin _$ConvoListConvosOutput {
  ...
  $ConvoListConvosOutputCopyWith<ConvoListConvosOutput> get copyWith =>
      _$ConvoListConvosOutputCopyWithImpl<ConvoListConvosOutput>(
          this as ConvoListConvosOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoListConvosOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      cursor,
      const DeepCollectionEquality().hash(convos),
...
abstract mixin class $ConvoListConvosOutputCopyWith<$Res> {
  factory $ConvoListConvosOutputCopyWith(ConvoListConvosOutput value,
          $Res Function(ConvoListConvosOutput) _then) =
      _$ConvoListConvosOutputCopyWithImpl;
  @useResult
  $Res call(
      {String? cursor,
...
extension ConvoListConvosOutputPatterns on ConvoListConvosOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoListConvosOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ConvoListConvosOutput() when $default != null:
        return $default(_that.cursor, _that.convos, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoListConvosOutput implements ConvoListConvosOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoListConvosOutputCopyWith<_ConvoListConvosOutput> get copyWith =>
      __$ConvoListConvosOutputCopyWithImpl<_ConvoListConvosOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoListConvosOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoListConvosOutput &&
            (identical(other.cursor, cursor) || other.cursor == cursor) &&
...
/// @nodoc
abstract mixin class _$ConvoListConvosOutputCopyWith<$Res>
    implements $ConvoListConvosOutputCopyWith<$Res> {
  factory _$ConvoListConvosOutputCopyWith(_ConvoListConvosOutput value,
          $Res Function(_ConvoListConvosOutput) _then) =
      __$ConvoListConvosOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? cursor,
