...
extension LogAcceptConvoPatterns on LogAcceptConvo {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LogAcceptConvo value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String $type, String rev, String convoId,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LogAcceptConvo() when $default != null:
        return $default(_that.$type, _that.rev, _that.convoId, _that.$unknown);
      case _:
        return orElse();
    }
  }
