...
class _LogAcceptConvo implements LogAcceptConvo {
  const _LogAcceptConvo({this.$type = 'chat.bsky.convo.defs#logAcceptConvo', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
