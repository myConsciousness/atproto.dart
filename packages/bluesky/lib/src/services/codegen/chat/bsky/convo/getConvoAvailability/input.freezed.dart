...
mixin _$ConvoGetConvoAvailabilityInput {
  ...
  $ConvoGetConvoAvailabilityInputCopyWith<ConvoGetConvoAvailabilityInput>
      get copyWith => _$ConvoGetConvoAvailabilityInputCopyWithImpl<
              ConvoGetConvoAvailabilityInput>(
          this as ConvoGetConvoAvailabilityInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoGetConvoAvailabilityInput &&
...
abstract mixin class $ConvoGetConvoAvailabilityInputCopyWith<$Res> {
  factory $ConvoGetConvoAvailabilityInputCopyWith(
          ...
          $Res Function(ConvoGetConvoAvailabilityInput) _then) =
      _$ConvoGetConvoAvailabilityInputCopyWithImpl;
  @useResult
...
extension ConvoGetConvoAvailabilityInputPatterns
    on ConvoGetConvoAvailabilityInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoGetConvoAvailabilityInput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> members, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ConvoGetConvoAvailabilityInput() when $default != null:
        return $default(_that.members, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ConvoGetConvoAvailabilityInput
    implements ConvoGetConvoAvailabilityInput {
  const _ConvoGetConvoAvailabilityInput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoGetConvoAvailabilityInputCopyWith<_ConvoGetConvoAvailabilityInput>
      get copyWith => __$ConvoGetConvoAvailabilityInputCopyWithImpl<
          _ConvoGetConvoAvailabilityInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoGetConvoAvailabilityInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoGetConvoAvailabilityInput &&
...
/// @nodoc
abstract mixin class _$ConvoGetConvoAvailabilityInputCopyWith<$Res>
    implements $ConvoGetConvoAvailabilityInputCopyWith<$Res> {
  factory _$ConvoGetConvoAvailabilityInputCopyWith(
          _ConvoGetConvoAvailabilityInput value,
          $Res Function(_ConvoGetConvoAvailabilityInput) _then) =
      __$ConvoGetConvoAvailabilityInputCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> members, Map<String, dynamic>? $unknown});
}
