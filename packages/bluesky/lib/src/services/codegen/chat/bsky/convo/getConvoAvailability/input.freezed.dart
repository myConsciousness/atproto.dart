...
@pragma('vm:prefer-inline') @override $Res call({Object? members = null,Object? $unknown = freezed,}) {
  return _then(ConvoGetConvoAvailabilityInput(
...
class _ConvoGetConvoAvailabilityInput implements ConvoGetConvoAvailabilityInput {
  const _ConvoGetConvoAvailabilityInput({required  List<String> members,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
