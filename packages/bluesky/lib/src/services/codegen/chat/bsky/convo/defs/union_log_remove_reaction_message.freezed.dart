  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogRemoveReactionMessage &&
...
class $ULogRemoveReactionMessageCopyWith<$Res> {
  $ULogRemoveReactionMessageCopyWith(
      ULogRemoveReactionMessage _, $Res Function(ULogRemoveReactionMessage) __);
}
...
extension ULogRemoveReactionMessagePatterns on ULogRemoveReactionMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogRemoveReactionMessageDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case ULogRemoveReactionMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogRemoveReactionMessageDeletedMessageView():
        return deletedMessageView(_that);
      case ULogRemoveReactionMessageUnknown():
        return unknown(_that);
      case _:
...
class ULogRemoveReactionMessageMessageView extends ULogRemoveReactionMessage {
  ...
  $ULogRemoveReactionMessageMessageViewCopyWith<
          ULogRemoveReactionMessageMessageView>
      get copyWith => _$ULogRemoveReactionMessageMessageViewCopyWithImpl<
          ULogRemoveReactionMessageMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogRemoveReactionMessageMessageView &&
...
/// @nodoc
abstract mixin class $ULogRemoveReactionMessageMessageViewCopyWith<$Res>
    implements $ULogRemoveReactionMessageCopyWith<$Res> {
  factory $ULogRemoveReactionMessageMessageViewCopyWith(
          ULogRemoveReactionMessageMessageView value,
          $Res Function(ULogRemoveReactionMessageMessageView) _then) =
      _$ULogRemoveReactionMessageMessageViewCopyWithImpl;
  @useResult
...
class ULogRemoveReactionMessageDeletedMessageView
    extends ULogRemoveReactionMessage {
  const ULogRemoveReactionMessageDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogRemoveReactionMessageDeletedMessageViewCopyWith<
          ULogRemoveReactionMessageDeletedMessageView>
      get copyWith => _$ULogRemoveReactionMessageDeletedMessageViewCopyWithImpl<
          ULogRemoveReactionMessageDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogRemoveReactionMessageDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ULogRemoveReactionMessageDeletedMessageViewCopyWith<$Res>
    implements $ULogRemoveReactionMessageCopyWith<$Res> {
  factory $ULogRemoveReactionMessageDeletedMessageViewCopyWith(
          ULogRemoveReactionMessageDeletedMessageView value,
          $Res Function(ULogRemoveReactionMessageDeletedMessageView) _then) =
      _$ULogRemoveReactionMessageDeletedMessageViewCopyWithImpl;
  @useResult
...
class ULogRemoveReactionMessageUnknown extends ULogRemoveReactionMessage {
  const ULogRemoveReactionMessageUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogRemoveReactionMessageUnknownCopyWith<ULogRemoveReactionMessageUnknown>
      get copyWith => _$ULogRemoveReactionMessageUnknownCopyWithImpl<
          ULogRemoveReactionMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogRemoveReactionMessageUnknown &&
...
/// @nodoc
abstract mixin class $ULogRemoveReactionMessageUnknownCopyWith<$Res>
    implements $ULogRemoveReactionMessageCopyWith<$Res> {
  factory $ULogRemoveReactionMessageUnknownCopyWith(
          ULogRemoveReactionMessageUnknown value,
          $Res Function(ULogRemoveReactionMessageUnknown) _then) =
      _$ULogRemoveReactionMessageUnknownCopyWithImpl;
  @useResult
