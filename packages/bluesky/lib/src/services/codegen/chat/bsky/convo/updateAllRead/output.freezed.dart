...
mixin _$ConvoUpdateAllReadOutput {
  ...
  $ConvoUpdateAllReadOutputCopyWith<ConvoUpdateAllReadOutput> get copyWith =>
      _$ConvoUpdateAllReadOutputCopyWithImpl<ConvoUpdateAllReadOutput>(
          this as ConvoUpdateAllReadOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoUpdateAllReadOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, updatedCount, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ConvoUpdateAllReadOutputCopyWith<$Res> {
  factory $ConvoUpdateAllReadOutputCopyWith(ConvoUpdateAllReadOutput value,
          $Res Function(ConvoUpdateAllReadOutput) _then) =
      _$ConvoUpdateAllReadOutputCopyWithImpl;
  @useResult
...
extension ConvoUpdateAllReadOutputPatterns on ConvoUpdateAllReadOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoUpdateAllReadOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int updatedCount, Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ConvoUpdateAllReadOutput() when $default != null:
        return $default(_that.updatedCount, _that.$unknown);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int updatedCount, Map<String, dynamic>? $unknown) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _ConvoUpdateAllReadOutput():
...
class _ConvoUpdateAllReadOutput implements ConvoUpdateAllReadOutput {
  const _ConvoUpdateAllReadOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoUpdateAllReadOutputCopyWith<_ConvoUpdateAllReadOutput> get copyWith =>
      __$ConvoUpdateAllReadOutputCopyWithImpl<_ConvoUpdateAllReadOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoUpdateAllReadOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoUpdateAllReadOutput &&
            (identical(other.updatedCount, updatedCount) ||
                other.updatedCount == updatedCount) &&
...
/// @nodoc
abstract mixin class _$ConvoUpdateAllReadOutputCopyWith<$Res>
    implements $ConvoUpdateAllReadOutputCopyWith<$Res> {
  factory _$ConvoUpdateAllReadOutputCopyWith(_ConvoUpdateAllReadOutput value,
          $Res Function(_ConvoUpdateAllReadOutput) _then) =
      __$ConvoUpdateAllReadOutputCopyWithImpl;
  @override
  @useResult
  $Res call({int updatedCount, Map<String, dynamic>? $unknown});
}
