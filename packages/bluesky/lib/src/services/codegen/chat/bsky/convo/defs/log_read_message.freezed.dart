...
class _LogReadMessage implements LogReadMessage {
  const _LogReadMessage({this.$type = 'chat.bsky.convo.defs#logReadMessage', required this.rev, required this.convoId, @ULogReadMessageMessageConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
