...
@pragma('vm:prefer-inline') @override $Res call({Object? limit = null,Object? cursor = freezed,Object? readState = freezed,Object? status = freezed,Object? kind = freezed,Object? lockStatus = freezed,Object? $unknown = freezed,}) {
  return _then(ConvoListConvosInput(
...
class _ConvoListConvosInput implements ConvoListConvosInput {
  const _ConvoListConvosInput({this.limit = 50, this.cursor, @ConvoListConvosReadStateConverter() this.readState, @ConvoListConvosStatusConverter() this.status, @ConvoListConvosKindConverter() this.kind, @ConvoListConvosLockStatusConverter() this.lockStatus,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
