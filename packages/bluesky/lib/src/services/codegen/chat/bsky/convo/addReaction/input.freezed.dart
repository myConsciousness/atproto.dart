...
mixin _$ConvoAddReactionInput {
  ...
  $ConvoAddReactionInputCopyWith<ConvoAddReactionInput> get copyWith =>
      _$ConvoAddReactionInputCopyWithImpl<ConvoAddReactionInput>(
          this as ConvoAddReactionInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoAddReactionInput &&
...
abstract mixin class $ConvoAddReactionInputCopyWith<$Res> {
  factory $ConvoAddReactionInputCopyWith(ConvoAddReactionInput value,
          $Res Function(ConvoAddReactionInput) _then) =
      _$ConvoAddReactionInputCopyWithImpl;
  @useResult
  $Res call(
      {String convoId,
      String messageId,
...
extension ConvoAddReactionInputPatterns on ConvoAddReactionInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoAddReactionInput value)? $default, {
...
class _ConvoAddReactionInput implements ConvoAddReactionInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoAddReactionInputCopyWith<_ConvoAddReactionInput> get copyWith =>
      __$ConvoAddReactionInputCopyWithImpl<_ConvoAddReactionInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoAddReactionInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoAddReactionInput &&
            (identical(other.convoId, convoId) || other.convoId == convoId) &&
            (identical(other.messageId, messageId) ||
                other.messageId == messageId) &&
            (identical(other.value, value) || other.value == value) &&
...
/// @nodoc
abstract mixin class _$ConvoAddReactionInputCopyWith<$Res>
    implements $ConvoAddReactionInputCopyWith<$Res> {
  factory _$ConvoAddReactionInputCopyWith(_ConvoAddReactionInput value,
          $Res Function(_ConvoAddReactionInput) _then) =
      __$ConvoAddReactionInputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String convoId,
