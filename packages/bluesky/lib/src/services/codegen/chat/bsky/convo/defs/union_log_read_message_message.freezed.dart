  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogReadMessageMessage &&
...
class $ULogReadMessageMessageCopyWith<$Res> {
  $ULogReadMessageMessageCopyWith(
      ULogReadMessageMessage _, $Res Function(ULogReadMessageMessage) __);
}
...
extension ULogReadMessageMessagePatterns on ULogReadMessageMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogReadMessageMessageDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case ULogReadMessageMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogReadMessageMessageDeletedMessageView():
        return deletedMessageView(_that);
      case ULogReadMessageMessageUnknown():
        return unknown(_that);
      case _:
...
class ULogReadMessageMessageMessageView extends ULogReadMessageMessage {
  ...
  $ULogReadMessageMessageMessageViewCopyWith<ULogReadMessageMessageMessageView>
      get copyWith => _$ULogReadMessageMessageMessageViewCopyWithImpl<
          ULogReadMessageMessageMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogReadMessageMessageMessageView &&
...
/// @nodoc
abstract mixin class $ULogReadMessageMessageMessageViewCopyWith<$Res>
    implements $ULogReadMessageMessageCopyWith<$Res> {
  factory $ULogReadMessageMessageMessageViewCopyWith(
          ULogReadMessageMessageMessageView value,
          $Res Function(ULogReadMessageMessageMessageView) _then) =
      _$ULogReadMessageMessageMessageViewCopyWithImpl;
  @useResult
...
class ULogReadMessageMessageDeletedMessageView extends ULogReadMessageMessage {
  const ULogReadMessageMessageDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogReadMessageMessageDeletedMessageViewCopyWith<
          ULogReadMessageMessageDeletedMessageView>
      get copyWith => _$ULogReadMessageMessageDeletedMessageViewCopyWithImpl<
          ULogReadMessageMessageDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogReadMessageMessageDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ULogReadMessageMessageDeletedMessageViewCopyWith<$Res>
    implements $ULogReadMessageMessageCopyWith<$Res> {
  factory $ULogReadMessageMessageDeletedMessageViewCopyWith(
          ULogReadMessageMessageDeletedMessageView value,
          $Res Function(ULogReadMessageMessageDeletedMessageView) _then) =
      _$ULogReadMessageMessageDeletedMessageViewCopyWithImpl;
  @useResult
...
class ULogReadMessageMessageUnknown extends ULogReadMessageMessage {
  const ULogReadMessageMessageUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogReadMessageMessageUnknownCopyWith<ULogReadMessageMessageUnknown>
      get copyWith => _$ULogReadMessageMessageUnknownCopyWithImpl<
          ULogReadMessageMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogReadMessageMessageUnknown &&
...
/// @nodoc
abstract mixin class $ULogReadMessageMessageUnknownCopyWith<$Res>
    implements $ULogReadMessageMessageCopyWith<$Res> {
  factory $ULogReadMessageMessageUnknownCopyWith(
          ULogReadMessageMessageUnknown value,
          $Res Function(ULogReadMessageMessageUnknown) _then) =
      _$ULogReadMessageMessageUnknownCopyWithImpl;
  @useResult
