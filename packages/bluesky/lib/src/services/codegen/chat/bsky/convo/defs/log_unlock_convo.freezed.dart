...
class _LogUnlockConvo implements LogUnlockConvo {
  const _LogUnlockConvo({this.$type = 'chat.bsky.convo.defs#logUnlockConvo', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required  List<ProfileViewBasic> relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
