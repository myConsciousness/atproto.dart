...
@pragma('vm:prefer-inline') @override $Res call({Object? joinLink = null,Object? $unknown = freezed,}) {
  return _then(GroupDisableJoinLinkOutput(
...
class _GroupDisableJoinLinkOutput implements GroupDisableJoinLinkOutput {
  const _GroupDisableJoinLinkOutput({@JoinLinkViewConverter() required this.joinLink,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
