...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? $unknown = freezed,}) {
  return _then(ConvoSendMessageBatchOutput(
...
class _ConvoSendMessageBatchOutput implements ConvoSendMessageBatchOutput {
  const _ConvoSendMessageBatchOutput({@MessageViewConverter() required  List<MessageView> items,  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
