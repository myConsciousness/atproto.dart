...
mixin _$ConvoSendMessageBatchOutput {
  ...
  $ConvoSendMessageBatchOutputCopyWith<ConvoSendMessageBatchOutput>
      get copyWith => _$ConvoSendMessageBatchOutputCopyWithImpl<
              ConvoSendMessageBatchOutput>(
          this as ConvoSendMessageBatchOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoSendMessageBatchOutput &&
...
abstract mixin class $ConvoSendMessageBatchOutputCopyWith<$Res> {
  factory $ConvoSendMessageBatchOutputCopyWith(
          ...
          $Res Function(ConvoSendMessageBatchOutput) _then) =
      _$ConvoSendMessageBatchOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ConvoSendMessageBatchOutputPatterns on ConvoSendMessageBatchOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoSendMessageBatchOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@MessageViewConverter() List<MessageView> items,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ConvoSendMessageBatchOutput() when $default != null:
        return $default(_that.items, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoSendMessageBatchOutput implements ConvoSendMessageBatchOutput {
  const _ConvoSendMessageBatchOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoSendMessageBatchOutputCopyWith<_ConvoSendMessageBatchOutput>
      get copyWith => __$ConvoSendMessageBatchOutputCopyWithImpl<
          _ConvoSendMessageBatchOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoSendMessageBatchOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoSendMessageBatchOutput &&
...
/// @nodoc
abstract mixin class _$ConvoSendMessageBatchOutputCopyWith<$Res>
    implements $ConvoSendMessageBatchOutputCopyWith<$Res> {
  factory _$ConvoSendMessageBatchOutputCopyWith(
          _ConvoSendMessageBatchOutput value,
          $Res Function(_ConvoSendMessageBatchOutput) _then) =
      __$ConvoSendMessageBatchOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@MessageViewConverter() List<MessageView> items,
