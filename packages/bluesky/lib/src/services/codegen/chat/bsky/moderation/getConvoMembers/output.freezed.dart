...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? members = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetConvoMembersOutput(
...
class _ModerationGetConvoMembersOutput implements ModerationGetConvoMembersOutput {
  const _ModerationGetConvoMembersOutput({this.cursor, @ProfileViewBasicConverter() required  List<ProfileViewBasic> members,  Map<String, dynamic>? $unknown}): _members = members,_$unknown = $unknown;
