...
@pragma('vm:prefer-inline') @override $Res call({Object? convo = null,Object? addedMembers = freezed,Object? $unknown = freezed,}) {
  return _then(GroupAddMembersOutput(
...
class _GroupAddMembersOutput implements GroupAddMembersOutput {
  const _GroupAddMembersOutput({@ConvoViewConverter() required this.convo, @ProfileViewBasicConverter()  List<ProfileViewBasic>? addedMembers,  Map<String, dynamic>? $unknown}): _addedMembers = addedMembers,_$unknown = $unknown;
