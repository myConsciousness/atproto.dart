...
@pragma('vm:prefer-inline') @override $Res call({Object? convoId = null,Object? requireApproval = null,Object? joinRule = null,Object? $unknown = freezed,}) {
  return _then(GroupCreateJoinLinkInput(
...
class _GroupCreateJoinLinkInput implements GroupCreateJoinLinkInput {
  const _GroupCreateJoinLinkInput({required this.convoId, this.requireApproval = false, @JoinRuleConverter() required this.joinRule,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
