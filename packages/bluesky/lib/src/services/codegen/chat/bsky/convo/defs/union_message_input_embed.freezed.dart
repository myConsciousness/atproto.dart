...
class $UMessageInputEmbedCopyWith<$Res> {
  $UMessageInputEmbedCopyWith(
      UMessageInputEmbed _, $Res Function(UMessageInputEmbed) __);
}
...
extension UMessageInputEmbedPatterns on UMessageInputEmbed {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UMessageInputEmbedUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case UMessageInputEmbedEmbedRecord():
        return embedRecord(_that);
      case UMessageInputEmbedUnknown():
        return unknown(_that);
      case _:
...
class UMessageInputEmbedEmbedRecord extends UMessageInputEmbed {
  ...
  $UMessageInputEmbedEmbedRecordCopyWith<UMessageInputEmbedEmbedRecord>
      get copyWith => _$UMessageInputEmbedEmbedRecordCopyWithImpl<
          UMessageInputEmbedEmbedRecord>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UMessageInputEmbedEmbedRecord &&
...
/// @nodoc
abstract mixin class $UMessageInputEmbedEmbedRecordCopyWith<$Res>
    implements $UMessageInputEmbedCopyWith<$Res> {
  factory $UMessageInputEmbedEmbedRecordCopyWith(
          UMessageInputEmbedEmbedRecord value,
          $Res Function(UMessageInputEmbedEmbedRecord) _then) =
      _$UMessageInputEmbedEmbedRecordCopyWithImpl;
  @useResult
...
class UMessageInputEmbedUnknown extends UMessageInputEmbed {
  const UMessageInputEmbedUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UMessageInputEmbedUnknownCopyWith<UMessageInputEmbedUnknown> get copyWith =>
      _$UMessageInputEmbedUnknownCopyWithImpl<UMessageInputEmbedUnknown>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UMessageInputEmbedUnknown &&
...
/// @nodoc
abstract mixin class $UMessageInputEmbedUnknownCopyWith<$Res>
    implements $UMessageInputEmbedCopyWith<$Res> {
  factory $UMessageInputEmbedUnknownCopyWith(UMessageInputEmbedUnknown value,
          $Res Function(UMessageInputEmbedUnknown) _then) =
      _$UMessageInputEmbedUnknownCopyWithImpl;
  @useResult
