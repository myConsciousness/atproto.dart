...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? $unknown = freezed,}) {
  return _then(SystemMessageDataDisableJoinLink(
...
class _SystemMessageDataDisableJoinLink implements SystemMessageDataDisableJoinLink {
  const _SystemMessageDataDisableJoinLink({this.$type = 'chat.bsky.convo.defs#systemMessageDataDisableJoinLink',  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
