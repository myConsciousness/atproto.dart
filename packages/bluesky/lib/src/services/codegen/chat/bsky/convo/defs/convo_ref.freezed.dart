...
class _ConvoRef implements ConvoRef {
  const _ConvoRef({this.$type = 'chat.bsky.convo.defs#convoRef', required this.did, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
