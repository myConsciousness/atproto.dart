...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? member = null,Object? $unknown = freezed,}) {
  return _then(LogIncomingJoinRequest(
...
class _LogIncomingJoinRequest implements LogIncomingJoinRequest {
  const _LogIncomingJoinRequest({this.$type = 'chat.bsky.convo.defs#logIncomingJoinRequest', required this.rev, required this.convoId, @ProfileViewBasicConverter() required this.member,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
