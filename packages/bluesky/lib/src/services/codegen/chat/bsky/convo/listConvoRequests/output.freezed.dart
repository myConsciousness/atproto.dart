...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? requests = null,Object? $unknown = freezed,}) {
  return _then(ConvoListConvoRequestsOutput(
...
class _ConvoListConvoRequestsOutput implements ConvoListConvoRequestsOutput {
  const _ConvoListConvoRequestsOutput({this.cursor, @UConvoListConvoRequestsRequestsConverter() required  List<UConvoListConvoRequestsRequests> requests,  Map<String, dynamic>? $unknown}): _requests = requests,_$unknown = $unknown;
