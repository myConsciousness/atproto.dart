  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoViewLastMessage &&
...
class $UConvoViewLastMessageCopyWith<$Res> {
  $UConvoViewLastMessageCopyWith(
      UConvoViewLastMessage _, $Res Function(UConvoViewLastMessage) __);
}
...
extension UConvoViewLastMessagePatterns on UConvoViewLastMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UConvoViewLastMessageDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case UConvoViewLastMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UConvoViewLastMessageDeletedMessageView():
        return deletedMessageView(_that);
      case UConvoViewLastMessageUnknown():
        return unknown(_that);
      case _:
...
class UConvoViewLastMessageMessageView extends UConvoViewLastMessage {
  ...
  $UConvoViewLastMessageMessageViewCopyWith<UConvoViewLastMessageMessageView>
      get copyWith => _$UConvoViewLastMessageMessageViewCopyWithImpl<
          UConvoViewLastMessageMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoViewLastMessageMessageView &&
...
/// @nodoc
abstract mixin class $UConvoViewLastMessageMessageViewCopyWith<$Res>
    implements $UConvoViewLastMessageCopyWith<$Res> {
  factory $UConvoViewLastMessageMessageViewCopyWith(
          UConvoViewLastMessageMessageView value,
          $Res Function(UConvoViewLastMessageMessageView) _then) =
      _$UConvoViewLastMessageMessageViewCopyWithImpl;
  @useResult
...
class UConvoViewLastMessageDeletedMessageView extends UConvoViewLastMessage {
  const UConvoViewLastMessageDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UConvoViewLastMessageDeletedMessageViewCopyWith<
          UConvoViewLastMessageDeletedMessageView>
      get copyWith => _$UConvoViewLastMessageDeletedMessageViewCopyWithImpl<
          UConvoViewLastMessageDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoViewLastMessageDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $UConvoViewLastMessageDeletedMessageViewCopyWith<$Res>
    implements $UConvoViewLastMessageCopyWith<$Res> {
  factory $UConvoViewLastMessageDeletedMessageViewCopyWith(
          UConvoViewLastMessageDeletedMessageView value,
          $Res Function(UConvoViewLastMessageDeletedMessageView) _then) =
      _$UConvoViewLastMessageDeletedMessageViewCopyWithImpl;
  @useResult
...
class UConvoViewLastMessageUnknown extends UConvoViewLastMessage {
  const UConvoViewLastMessageUnknown({required final Map<String, dynamic> data})
      : _data = data,
        super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UConvoViewLastMessageUnknownCopyWith<UConvoViewLastMessageUnknown>
      get copyWith => _$UConvoViewLastMessageUnknownCopyWithImpl<
          UConvoViewLastMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UConvoViewLastMessageUnknown &&
...
/// @nodoc
abstract mixin class $UConvoViewLastMessageUnknownCopyWith<$Res>
    implements $UConvoViewLastMessageCopyWith<$Res> {
  factory $UConvoViewLastMessageUnknownCopyWith(
          UConvoViewLastMessageUnknown value,
          $Res Function(UConvoViewLastMessageUnknown) _then) =
      _$UConvoViewLastMessageUnknownCopyWithImpl;
  @useResult
