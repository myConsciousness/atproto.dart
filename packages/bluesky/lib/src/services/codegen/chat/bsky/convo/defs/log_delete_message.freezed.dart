...
class _LogDeleteMessage implements LogDeleteMessage {
  const _LogDeleteMessage({this.$type = 'chat.bsky.convo.defs#logDeleteMessage', required this.rev, required this.convoId, @ULogDeleteMessageMessageConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
