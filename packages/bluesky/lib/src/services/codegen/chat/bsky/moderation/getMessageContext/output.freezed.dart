...
@pragma('vm:prefer-inline') @override $Res call({Object? messages = null,Object? $unknown = freezed,}) {
  return _then(ModerationGetMessageContextOutput(
...
class _ModerationGetMessageContextOutput implements ModerationGetMessageContextOutput {
  const _ModerationGetMessageContextOutput({@UModerationGetMessageContextMessagesConverter() required  List<UModerationGetMessageContextMessages> messages,  Map<String, dynamic>? $unknown}): _messages = messages,_$unknown = $unknown;
