...
mixin _$ModerationGetMessageContextOutput {
  ...
  $ModerationGetMessageContextOutputCopyWith<ModerationGetMessageContextOutput>
      get copyWith => _$ModerationGetMessageContextOutputCopyWithImpl<
              ModerationGetMessageContextOutput>(
          this as ModerationGetMessageContextOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ModerationGetMessageContextOutput &&
...
abstract mixin class $ModerationGetMessageContextOutputCopyWith<$Res> {
  factory $ModerationGetMessageContextOutputCopyWith(
          ...
          $Res Function(ModerationGetMessageContextOutput) _then) =
      _$ModerationGetMessageContextOutputCopyWithImpl;
  @useResult
  $Res call(
      {@UModerationGetMessageContextMessagesConverter()
...
extension ModerationGetMessageContextOutputPatterns
    on ModerationGetMessageContextOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModerationGetMessageContextOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ModerationGetMessageContextOutput() when $default != null:
        return $default(_that.messages, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _ModerationGetMessageContextOutput
    implements ModerationGetMessageContextOutput {
  const _ModerationGetMessageContextOutput(
      {@UModerationGetMessageContextMessagesConverter()
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModerationGetMessageContextOutputCopyWith<
          _ModerationGetMessageContextOutput>
      get copyWith => __$ModerationGetMessageContextOutputCopyWithImpl<
          _ModerationGetMessageContextOutput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ModerationGetMessageContextOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModerationGetMessageContextOutput &&
...
/// @nodoc
abstract mixin class _$ModerationGetMessageContextOutputCopyWith<$Res>
    implements $ModerationGetMessageContextOutputCopyWith<$Res> {
  factory _$ModerationGetMessageContextOutputCopyWith(
          _ModerationGetMessageContextOutput value,
          $Res Function(_ModerationGetMessageContextOutput) _then) =
      __$ModerationGetMessageContextOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@UModerationGetMessageContextMessagesConverter()
