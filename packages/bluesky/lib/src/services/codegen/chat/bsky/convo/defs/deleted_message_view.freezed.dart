...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? id = null,Object? rev = null,Object? sender = null,Object? sentAt = null,Object? $unknown = freezed,}) {
  return _then(DeletedMessageView(
...
class _DeletedMessageView implements DeletedMessageView {
  const _DeletedMessageView({this.$type = 'chat.bsky.convo.defs#deletedMessageView', required this.id, required this.rev, @MessageViewSenderConverter() required this.sender, @JsonKey(toJson: iso8601) required this.sentAt,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
