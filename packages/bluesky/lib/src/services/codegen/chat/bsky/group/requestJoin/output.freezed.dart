...
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? convo = freezed,Object? $unknown = freezed,}) {
  return _then(GroupRequestJoinOutput(
...
class _GroupRequestJoinOutput implements GroupRequestJoinOutput {
  const _GroupRequestJoinOutput({@GroupRequestJoinStatusConverter() required this.status, @ConvoViewConverter() this.convo,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
