...
class _LogUnmuteConvo implements LogUnmuteConvo {
  const _LogUnmuteConvo({this.$type = 'chat.bsky.convo.defs#logUnmuteConvo', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
