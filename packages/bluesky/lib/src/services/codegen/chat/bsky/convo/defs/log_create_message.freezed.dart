...
class _LogCreateMessage implements LogCreateMessage {
  const _LogCreateMessage({this.$type = 'chat.bsky.convo.defs#logCreateMessage', required this.rev, required this.convoId, @ULogCreateMessageMessageConverter() required this.message, @ProfileViewBasicConverter()  List<ProfileViewBasic>? relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
