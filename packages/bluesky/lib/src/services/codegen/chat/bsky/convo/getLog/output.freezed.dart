...
@pragma('vm:prefer-inline') @override $Res call({Object? cursor = freezed,Object? logs = null,Object? $unknown = freezed,}) {
  return _then(ConvoGetLogOutput(
...
class _ConvoGetLogOutput implements ConvoGetLogOutput {
  const _ConvoGetLogOutput({this.cursor, @UConvoGetLogLogsConverter() required  List<UConvoGetLogLogs> logs,  Map<String, dynamic>? $unknown}): _logs = logs,_$unknown = $unknown;
