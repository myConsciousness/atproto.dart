...
$ConvoRemoveReactionInputCopyWith<ConvoRemoveReactionInput> get copyWith => _$ConvoRemoveReactionInputCopyWithImpl<ConvoRemoveReactionInput>(this as ConvoRemoveReactionInput, _$identity);
...
abstract mixin class $ConvoRemoveReactionInputCopyWith<$Res>  {
  factory $ConvoRemoveReactionInputCopyWith(ConvoRemoveReactionInput value, $Res Function(ConvoRemoveReactionInput) _then) = _$ConvoRemoveReactionInputCopyWithImpl;
@useResult
$Res call({
...
@pragma('vm:prefer-inline') @override $Res call({Object? convoId = null,Object? messageId = null,Object? value = null,Object? $unknown = freezed,}) {
  return _then(ConvoRemoveReactionInput(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ConvoRemoveReactionInput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ConvoRemoveReactionInput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ConvoRemoveReactionInput value)?  $default,){
final _that = this;
switch (_that) {
case _ConvoRemoveReactionInput() when $default != null:
return $default(_that);case _:
...
class _ConvoRemoveReactionInput implements ConvoRemoveReactionInput {
  const _ConvoRemoveReactionInput({required this.convoId, required this.messageId, required this.value,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _ConvoRemoveReactionInput.fromJson(Map<String, dynamic> json) => _$ConvoRemoveReactionInputFromJson(json);
...
@pragma('vm:prefer-inline')
_$ConvoRemoveReactionInputCopyWith<_ConvoRemoveReactionInput> get copyWith => __$ConvoRemoveReactionInputCopyWithImpl<_ConvoRemoveReactionInput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ConvoRemoveReactionInputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConvoRemoveReactionInput&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.value, value) || other.value == value)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$ConvoRemoveReactionInputCopyWith<$Res> implements $ConvoRemoveReactionInputCopyWith<$Res> {
  factory _$ConvoRemoveReactionInputCopyWith(_ConvoRemoveReactionInput value, $Res Function(_ConvoRemoveReactionInput) _then) = __$ConvoRemoveReactionInputCopyWithImpl;
@override @useResult
$Res call({
 String convoId, String messageId, String value, Map<String, dynamic>? $unknown
});
