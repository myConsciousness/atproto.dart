...
mixin _$ConvoLeaveConvoInput {
  ...
  $ConvoLeaveConvoInputCopyWith<ConvoLeaveConvoInput> get copyWith =>
      _$ConvoLeaveConvoInputCopyWithImpl<ConvoLeaveConvoInput>(
          this as ConvoLeaveConvoInput, _$identity);
...
abstract mixin class $ConvoLeaveConvoInputCopyWith<$Res> {
  factory $ConvoLeaveConvoInputCopyWith(ConvoLeaveConvoInput value,
          $Res Function(ConvoLeaveConvoInput) _then) =
      _$ConvoLeaveConvoInputCopyWithImpl;
  @useResult
...
extension ConvoLeaveConvoInputPatterns on ConvoLeaveConvoInput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoLeaveConvoInput value)? $default, {
...
class _ConvoLeaveConvoInput implements ConvoLeaveConvoInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoLeaveConvoInputCopyWith<_ConvoLeaveConvoInput> get copyWith =>
      __$ConvoLeaveConvoInputCopyWithImpl<_ConvoLeaveConvoInput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoLeaveConvoInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoLeaveConvoInput &&
            (identical(other.convoId, convoId) || other.convoId == convoId) &&
...
/// @nodoc
abstract mixin class _$ConvoLeaveConvoInputCopyWith<$Res>
    implements $ConvoLeaveConvoInputCopyWith<$Res> {
  factory _$ConvoLeaveConvoInputCopyWith(_ConvoLeaveConvoInput value,
          $Res Function(_ConvoLeaveConvoInput) _then) =
      __$ConvoLeaveConvoInputCopyWithImpl;
  @override
  @useResult
  $Res call({String convoId, Map<String, dynamic>? $unknown});
}
