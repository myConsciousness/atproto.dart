...
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? $unknown = freezed,}) {
  return _then(ConvoAddReactionOutput(
...
class _ConvoAddReactionOutput implements ConvoAddReactionOutput {
  const _ConvoAddReactionOutput({@MessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
