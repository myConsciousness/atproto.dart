...
mixin _$ConvoAddReactionOutput {
  ...
  $ConvoAddReactionOutputCopyWith<ConvoAddReactionOutput> get copyWith =>
      _$ConvoAddReactionOutputCopyWithImpl<ConvoAddReactionOutput>(
          this as ConvoAddReactionOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoAddReactionOutput &&
...
abstract mixin class $ConvoAddReactionOutputCopyWith<$Res> {
  factory $ConvoAddReactionOutputCopyWith(ConvoAddReactionOutput value,
          $Res Function(ConvoAddReactionOutput) _then) =
      _$ConvoAddReactionOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ConvoAddReactionOutputPatterns on ConvoAddReactionOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoAddReactionOutput value)? $default, {
...
class _ConvoAddReactionOutput implements ConvoAddReactionOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoAddReactionOutputCopyWith<_ConvoAddReactionOutput> get copyWith =>
      __$ConvoAddReactionOutputCopyWithImpl<_ConvoAddReactionOutput>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoAddReactionOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoAddReactionOutput &&
            (identical(other.message, message) || other.message == message) &&
...
/// @nodoc
abstract mixin class _$ConvoAddReactionOutputCopyWith<$Res>
    implements $ConvoAddReactionOutputCopyWith<$Res> {
  factory _$ConvoAddReactionOutputCopyWith(_ConvoAddReactionOutput value,
          $Res Function(_ConvoAddReactionOutput) _then) =
      __$ConvoAddReactionOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@MessageViewConverter() MessageView message,
