...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? message = null,Object? $unknown = freezed,}) {
  return _then(LogEnableJoinLink(
...
class _LogEnableJoinLink implements LogEnableJoinLink {
  const _LogEnableJoinLink({this.$type = 'chat.bsky.convo.defs#logEnableJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
