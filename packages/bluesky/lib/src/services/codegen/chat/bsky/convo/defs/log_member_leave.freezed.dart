...
class _LogMemberLeave implements LogMemberLeave {
  const _LogMemberLeave({this.$type = 'chat.bsky.convo.defs#logMemberLeave', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required  List<ProfileViewBasic> relatedProfiles,  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
