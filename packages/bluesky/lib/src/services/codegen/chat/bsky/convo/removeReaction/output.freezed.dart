...
mixin _$ConvoRemoveReactionOutput {
  ...
  $ConvoRemoveReactionOutputCopyWith<ConvoRemoveReactionOutput> get copyWith =>
      _$ConvoRemoveReactionOutputCopyWithImpl<ConvoRemoveReactionOutput>(
          this as ConvoRemoveReactionOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ConvoRemoveReactionOutput &&
  ...
  int get hashCode => Object.hash(
      runtimeType, message, const DeepCollectionEquality().hash($unknown));
...
abstract mixin class $ConvoRemoveReactionOutputCopyWith<$Res> {
  factory $ConvoRemoveReactionOutputCopyWith(ConvoRemoveReactionOutput value,
          $Res Function(ConvoRemoveReactionOutput) _then) =
      _$ConvoRemoveReactionOutputCopyWithImpl;
  @useResult
  $Res call(
...
extension ConvoRemoveReactionOutputPatterns on ConvoRemoveReactionOutput {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConvoRemoveReactionOutput value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@MessageViewConverter() MessageView message,
            Map<String, dynamic>? $unknown)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ConvoRemoveReactionOutput() when $default != null:
        return $default(_that.message, _that.$unknown);
      case _:
        return orElse();
    }
  }
...
class _ConvoRemoveReactionOutput implements ConvoRemoveReactionOutput {
  const _ConvoRemoveReactionOutput(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConvoRemoveReactionOutputCopyWith<_ConvoRemoveReactionOutput>
      get copyWith =>
          __$ConvoRemoveReactionOutputCopyWithImpl<_ConvoRemoveReactionOutput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ConvoRemoveReactionOutputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ConvoRemoveReactionOutput &&
            (identical(other.message, message) || other.message == message) &&
...
/// @nodoc
abstract mixin class _$ConvoRemoveReactionOutputCopyWith<$Res>
    implements $ConvoRemoveReactionOutputCopyWith<$Res> {
  factory _$ConvoRemoveReactionOutputCopyWith(_ConvoRemoveReactionOutput value,
          $Res Function(_ConvoRemoveReactionOutput) _then) =
      __$ConvoRemoveReactionOutputCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@MessageViewConverter() MessageView message,
