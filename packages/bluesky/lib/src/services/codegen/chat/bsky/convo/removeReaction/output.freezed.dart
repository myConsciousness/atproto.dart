...
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? $unknown = freezed,}) {
  return _then(ConvoRemoveReactionOutput(
...
class _ConvoRemoveReactionOutput implements ConvoRemoveReactionOutput {
  const _ConvoRemoveReactionOutput({@MessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
