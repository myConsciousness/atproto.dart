...
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? $unknown = freezed,}) {
  return _then(LogWithdrawOutgoingJoinRequest(
...
class _LogWithdrawOutgoingJoinRequest implements LogWithdrawOutgoingJoinRequest {
  const _LogWithdrawOutgoingJoinRequest({this.$type = 'chat.bsky.convo.defs#logWithdrawOutgoingJoinRequest', required this.rev, required this.convoId,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
