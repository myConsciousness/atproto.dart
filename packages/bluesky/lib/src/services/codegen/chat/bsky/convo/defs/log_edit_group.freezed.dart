...
class _LogEditGroup implements LogEditGroup {
  const _LogEditGroup({this.$type = 'chat.bsky.convo.defs#logEditGroup', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message,  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
