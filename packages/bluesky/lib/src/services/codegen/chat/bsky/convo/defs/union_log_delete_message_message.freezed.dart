  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogDeleteMessageMessage &&
...
class $ULogDeleteMessageMessageCopyWith<$Res> {
  $ULogDeleteMessageMessageCopyWith(
      ULogDeleteMessageMessage _, $Res Function(ULogDeleteMessageMessage) __);
}
...
extension ULogDeleteMessageMessagePatterns on ULogDeleteMessageMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogDeleteMessageMessageDeletedMessageView()
          when deletedMessageView != null:
        return deletedMessageView(_that);
      case ULogDeleteMessageMessageUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULogDeleteMessageMessageDeletedMessageView():
        return deletedMessageView(_that);
      case ULogDeleteMessageMessageUnknown():
        return unknown(_that);
      case _:
...
class ULogDeleteMessageMessageMessageView extends ULogDeleteMessageMessage {
  ...
  $ULogDeleteMessageMessageMessageViewCopyWith<
          ULogDeleteMessageMessageMessageView>
      get copyWith => _$ULogDeleteMessageMessageMessageViewCopyWithImpl<
          ULogDeleteMessageMessageMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogDeleteMessageMessageMessageView &&
...
/// @nodoc
abstract mixin class $ULogDeleteMessageMessageMessageViewCopyWith<$Res>
    implements $ULogDeleteMessageMessageCopyWith<$Res> {
  factory $ULogDeleteMessageMessageMessageViewCopyWith(
          ULogDeleteMessageMessageMessageView value,
          $Res Function(ULogDeleteMessageMessageMessageView) _then) =
      _$ULogDeleteMessageMessageMessageViewCopyWithImpl;
  @useResult
...
class ULogDeleteMessageMessageDeletedMessageView
    extends ULogDeleteMessageMessage {
  const ULogDeleteMessageMessageDeletedMessageView({required this.data})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogDeleteMessageMessageDeletedMessageViewCopyWith<
          ULogDeleteMessageMessageDeletedMessageView>
      get copyWith => _$ULogDeleteMessageMessageDeletedMessageViewCopyWithImpl<
          ULogDeleteMessageMessageDeletedMessageView>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogDeleteMessageMessageDeletedMessageView &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class $ULogDeleteMessageMessageDeletedMessageViewCopyWith<$Res>
    implements $ULogDeleteMessageMessageCopyWith<$Res> {
  factory $ULogDeleteMessageMessageDeletedMessageViewCopyWith(
          ULogDeleteMessageMessageDeletedMessageView value,
          $Res Function(ULogDeleteMessageMessageDeletedMessageView) _then) =
      _$ULogDeleteMessageMessageDeletedMessageViewCopyWithImpl;
  @useResult
...
class ULogDeleteMessageMessageUnknown extends ULogDeleteMessageMessage {
  const ULogDeleteMessageMessageUnknown(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ULogDeleteMessageMessageUnknownCopyWith<ULogDeleteMessageMessageUnknown>
      get copyWith => _$ULogDeleteMessageMessageUnknownCopyWithImpl<
          ULogDeleteMessageMessageUnknown>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ULogDeleteMessageMessageUnknown &&
...
/// @nodoc
abstract mixin class $ULogDeleteMessageMessageUnknownCopyWith<$Res>
    implements $ULogDeleteMessageMessageCopyWith<$Res> {
  factory $ULogDeleteMessageMessageUnknownCopyWith(
          ULogDeleteMessageMessageUnknown value,
          $Res Function(ULogDeleteMessageMessageUnknown) _then) =
      _$ULogDeleteMessageMessageUnknownCopyWithImpl;
  @useResult
