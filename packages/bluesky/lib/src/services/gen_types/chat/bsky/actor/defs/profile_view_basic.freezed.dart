...
class _$ProfileViewBasicImpl implements _ProfileViewBasic {
  const _$ProfileViewBasicImpl(
      {@JsonKey(name: r'$type') this.$type = chatBskyActorDefsProfileViewBasic,
      required this.did,
  ...
  @override
  String toString() {
    return 'ProfileViewBasic(\$type: ${$type}, did: $did, handle: $handle, displayName: $displayName, avatar: $avatar, associated: $associated, viewer: $viewer, labels: $labels, chatDisabled: $chatDisabled, \$unknown: ${$unknown})';
  }
