...
class _LogLeaveConvo implements LogLeaveConvo {
  const _LogLeaveConvo({this.$type = chatBskyConvoDefsLogLeaveConvo, required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
