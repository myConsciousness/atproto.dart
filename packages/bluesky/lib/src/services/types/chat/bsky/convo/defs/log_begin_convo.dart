...
abstract class LogBeginConvo with _$LogBeginConvo {
  ...
  const factory LogBeginConvo({
    @Default(chatBskyConvoDefsLogBeginConvo) String $type,
    required String rev,
  ...
  static bool validate(final Map<String, dynamic> object) {
    ...
    return object['\$type'] == chatBskyConvoDefsLogBeginConvo;
  }
}

final class LogBeginConvoConverter
    extends LexObjectConverter<LogBeginConvo, Map<String, dynamic>> {
