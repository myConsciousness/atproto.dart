...
class _LogMuteConvo implements LogMuteConvo {
  const _LogMuteConvo({this.$type = chatBskyConvoDefsLogMuteConvo, required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
