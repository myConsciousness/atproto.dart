...
class _$ListRecordImpl implements _ListRecord {
  ...
  @override
  String toString() {
    return 'ListRecord(purpose: $purpose, name: $name, description: $description, descriptionFacets: $descriptionFacets, avatar: $avatar, labels: $labels, createdAt: $createdAt)';
  }
