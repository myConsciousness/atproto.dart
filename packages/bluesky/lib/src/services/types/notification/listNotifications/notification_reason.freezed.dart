...
abstract class UNotificationReasonKnownValue implements NotificationReason {
...
class _$UNotificationReasonUnknownValueImpl
  ...
  @override
  String toString() {
    return 'NotificationReason.unknownValue(data: $data)';
  }
...
abstract class UNotificationReasonUnknownValue implements NotificationReason {
