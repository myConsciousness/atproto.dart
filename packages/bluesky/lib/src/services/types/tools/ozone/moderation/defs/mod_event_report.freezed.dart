...
class _ModEventReport implements ModEventReport {
  const _ModEventReport({this.$type = toolsOzoneModerationDefsModEventReport, this.comment, this.isReporterMuted, @ReasonTypeConverter() required this.reportType, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
