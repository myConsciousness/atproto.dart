...
mixin _$SettingListOptionsInput {
 ...
 int? get limit; String? get cursor; String? get scope;/// Filter keys by prefix
...
@useResult
$Res call({
 int? limit, String? cursor, String? scope, String? prefix, List<String>? keys, Map<String, dynamic>? $unknown
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? limit,  String? cursor,  String? scope,  String? prefix,  List<String>? keys,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingListOptionsInput() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? limit,  String? cursor,  String? scope,  String? prefix,  List<String>? keys,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _SettingListOptionsInput():
return $default(_that.limit,_that.cursor,_that.scope,_that.prefix,_that.keys,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? limit,  String? cursor,  String? scope,  String? prefix,  List<String>? keys,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _SettingListOptionsInput() when $default != null:
return $default(_that.limit,_that.cursor,_that.scope,_that.prefix,_that.keys,_that.$unknown);case _:
  return null;
...
class _SettingListOptionsInput implements SettingListOptionsInput {
  const _SettingListOptionsInput({this.limit, this.cursor, this.scope, this.prefix, final  List<String>? keys, final  Map<String, dynamic>? $unknown}): _keys = keys,_$unknown = $unknown;
