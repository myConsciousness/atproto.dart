      ...
      ($checkedConvert) {
        final val = _$VerificationViewImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ?? toolsOzoneVerificationDefsVerificationView),
