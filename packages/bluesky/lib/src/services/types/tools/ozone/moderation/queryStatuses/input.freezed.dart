...
@AtUriConverter() AtUri? get subject;/// Search subjects by keyword from comments
 ...
 String? get reviewState;@AtUriConverter() List<AtUri>? get ignoreSubjects;/// Get all subject statuses that were reviewed by a specific moderator
 ...
 String? get subjectType;/// If specified, only subjects that belong to an account that has at least this many suspensions will be returned.
 ...
 int? get minPriorityScore; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 int? queueCount, int? queueIndex, String? queueSeed, bool? includeAllUserRecords,@AtUriConverter() AtUri? subject, String? comment, DateTime? reportedAfter, DateTime? reportedBefore, DateTime? reviewedAfter, DateTime? hostingDeletedAfter, DateTime? hostingDeletedBefore, DateTime? hostingUpdatedAfter, DateTime? hostingUpdatedBefore, List<String>? hostingStatuses, DateTime? reviewedBefore, bool? includeMuted, bool? onlyMuted, String? reviewState,@AtUriConverter() List<AtUri>? ignoreSubjects, String? lastReviewedBy, String? sortField, String? sortDirection, bool? takendown, bool? appealed, int? limit, List<String>? tags, List<String>? excludeTags, String? cursor, List<String>? collections, String? subjectType, int? minAccountSuspendCount, int? minReportedRecordsCount, int? minTakendownRecordsCount, int? minPriorityScore, Map<String, dynamic>? $unknown
});
...
as AtUri?,comment: freezed == comment ? _self.comment : comment // ignore: cast_nullable_to_non_nullable
...
as List<AtUri>?,lastReviewedBy: freezed == lastReviewedBy ? _self.lastReviewedBy : lastReviewedBy // ignore: cast_nullable_to_non_nullable
...
as String?,minAccountSuspendCount: freezed == minAccountSuspendCount ? _self.minAccountSuspendCount : minAccountSuspendCount // ignore: cast_nullable_to_non_nullable
...
class _ModerationQueryStatusesInput implements ModerationQueryStatusesInput {
  const _ModerationQueryStatusesInput({this.queueCount, this.queueIndex, this.queueSeed, this.includeAllUserRecords, @AtUriConverter() this.subject, this.comment, this.reportedAfter, this.reportedBefore, this.reviewedAfter, this.hostingDeletedAfter, this.hostingDeletedBefore, this.hostingUpdatedAfter, this.hostingUpdatedBefore, final  List<String>? hostingStatuses, this.reviewedBefore, this.includeMuted, this.onlyMuted, this.reviewState, @AtUriConverter() final  List<AtUri>? ignoreSubjects, this.lastReviewedBy, this.sortField, this.sortDirection, this.takendown, this.appealed, this.limit, final  List<String>? tags, final  List<String>? excludeTags, this.cursor, final  List<String>? collections, this.subjectType, this.minAccountSuspendCount, this.minReportedRecordsCount, this.minTakendownRecordsCount, this.minPriorityScore, final  Map<String, dynamic>? $unknown}): _hostingStatuses = hostingStatuses,_ignoreSubjects = ignoreSubjects,_tags = tags,_excludeTags = excludeTags,_collections = collections,_$unknown = $unknown;
...
@override@AtUriConverter() List<AtUri>? get ignoreSubjects {
