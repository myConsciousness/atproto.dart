...
mixin _$ModerationQueryEventsInput {
 ...
 List<String>? get policies; List<String>? get modTool; String? get cursor; Map<String, dynamic>? get $unknown;
...
class _ModerationQueryEventsInput implements ModerationQueryEventsInput {
  const _ModerationQueryEventsInput({final  List<String>? types, this.createdBy, this.sortDirection, this.createdAfter, this.createdBefore, @AtUriConverter() this.subject, final  List<String>? collections, this.subjectType, this.includeAllUserRecords, this.limit, this.hasComment, this.comment, final  List<String>? addedLabels, final  List<String>? removedLabels, final  List<String>? addedTags, final  List<String>? removedTags, final  List<String>? reportTypes, final  List<String>? policies, final  List<String>? modTool, this.cursor, final  Map<String, dynamic>? $unknown}): _types = types,_collections = collections,_addedLabels = addedLabels,_removedLabels = removedLabels,_addedTags = addedTags,_removedTags = removedTags,_reportTypes = reportTypes,_policies = policies,_modTool = modTool,_$unknown = $unknown;
