...
_RelatedAccount _$RelatedAccountFromJson(
  Map json,
  ...
  final val = _RelatedAccount(
    $type: $checkedConvert(
      r'$type',
      (v) =>
          v as String? ?? toolsOzoneSignatureFindRelatedAccountsRelatedAccount,
    ),
    account: $checkedConvert(
      'account',
      (v) => const AccountViewConverter().fromJson(v as Map<String, dynamic>),
    ),
