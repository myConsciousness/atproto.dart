    ...
    Map<String, String>? $unknown,
      ...
      await _ctx.post(
        ...
        body: {
          ...
          if (likeViaRepost != null) 'likeViaRepost': likeViaRepost,
          if (mention != null) 'mention': mention,
          if (quote != null) 'quote': quote,
          if (reply != null) 'reply': reply,
          if (repost != null) 'repost': repost,
          if (repostViaRepost != null) 'repostViaRepost': repostViaRepost,
          if (starterpackJoined != null) 'starterpackJoined': starterpackJoined,
          if (subscribedPost != null) 'subscribedPost': subscribedPost,
