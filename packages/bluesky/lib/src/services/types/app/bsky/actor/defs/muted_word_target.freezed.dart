...
mixin _$MutedWordTarget {
  KnownMutedWordTarget? get knownValue => throw _privateConstructorUsedError;
...
abstract class $MutedWordTargetCopyWith<$Res> {
  ...
  @useResult
  $Res call({KnownMutedWordTarget? knownValue, String? unknownValue});
}
...
class _$MutedWordTargetImpl implements _MutedWordTarget {
  const _$MutedWordTargetImpl({this.knownValue, this.unknownValue});

  factory _$MutedWordTargetImpl.fromJson(Map<String, dynamic> json) =>
      _$$MutedWordTargetImplFromJson(json);

  @override
  final KnownMutedWordTarget? knownValue;
  @override
...
abstract class _MutedWordTarget implements MutedWordTarget {
  const factory _MutedWordTarget(
      {final KnownMutedWordTarget? knownValue,
      final String? unknownValue}) = _$MutedWordTargetImpl;
