...
class _Links implements Links {
  const _Links({this.$type = appBskyFeedDescribeFeedGeneratorLinks, this.privacyPolicy, this.termsOfService, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
