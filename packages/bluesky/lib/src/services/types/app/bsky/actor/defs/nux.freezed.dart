...
class _Nux implements Nux {
  const _Nux({this.$type = appBskyActorDefsNux, required this.id, required this.completed, this.data, this.expiresAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
