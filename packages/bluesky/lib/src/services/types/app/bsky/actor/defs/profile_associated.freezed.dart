...
class _ProfileAssociated implements ProfileAssociated {
  const _ProfileAssociated({this.$type = appBskyActorDefsProfileAssociated, this.lists, this.feedgens, this.starterPacks, this.labeler, @ProfileAssociatedChatConverter() this.chat, @ProfileAssociatedActivitySubscriptionConverter() this.activitySubscription, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
