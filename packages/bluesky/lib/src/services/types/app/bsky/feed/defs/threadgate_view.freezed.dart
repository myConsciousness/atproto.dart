...
class _ThreadgateView implements ThreadgateView {
  const _ThreadgateView({this.$type = appBskyFeedDefsThreadgateView, this.uri, this.cid, final  Map<String, dynamic>? record, @ListViewBasicConverter() final  List<ListViewBasic>? lists, final  Map<String, dynamic>? $unknown}): _record = record,_lists = lists,_$unknown = $unknown;
