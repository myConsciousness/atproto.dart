...
abstract class NotificationDeclarationRecord
  ...
  const factory NotificationDeclarationRecord({
    @Default(appBskyNotificationDeclaration) String $type,
  ...
  static bool validate(final Map<String, dynamic> object) {
    ...
    return object['\$type'] == appBskyNotificationDeclaration;
  }
}

final class NotificationDeclarationRecordConverter extends LexObjectConverter<
    NotificationDeclarationRecord, Map<String, dynamic>> {
