...
mixin _$ThreadgateRecord {
  ...
  @unionInputAllow
  @JsonKey(name: 'allow')
  List<UInputAllow>? get allowRules => throw _privateConstructorUsedError;
...
class _$ThreadgateRecordImpl implements _ThreadgateRecord {
  const _$ThreadgateRecordImpl(
      ...
      @unionInputAllow
      @JsonKey(name: 'allow')
      final List<UInputAllow>? allowRules,
  ...
  @JsonKey(name: 'post')
  final AtUri postUri;
  final List<UInputAllow>? _allowRules;
  @override
  @unionInputAllow
  @JsonKey(name: 'allow')
  List<UInputAllow>? get allowRules {
