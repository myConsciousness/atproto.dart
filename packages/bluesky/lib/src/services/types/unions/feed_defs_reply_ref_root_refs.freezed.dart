...
part of 'feed_defs_reply_ref_root_refs.dart';
...
/// @nodoc
mixin _$FeedDefsReplyRefRootRefs {
...
/// @nodoc
abstract class $FeedDefsReplyRefRootRefsCopyWith<$Res> {
  factory $FeedDefsReplyRefRootRefsCopyWith(FeedDefsReplyRefRootRefs value,
          $Res Function(FeedDefsReplyRefRootRefs) then) =
      _$FeedDefsReplyRefRootRefsCopyWithImpl<$Res, FeedDefsReplyRefRootRefs>;
}

/// @nodoc
class _$FeedDefsReplyRefRootRefsCopyWithImpl<$Res,
        $Val extends FeedDefsReplyRefRootRefs>
    implements $FeedDefsReplyRefRootRefsCopyWith<$Res> {
  _$FeedDefsReplyRefRootRefsCopyWithImpl(this._value, this._then);
...
class __$$UFeedDefsReplyRefRootPostViewImplCopyWithImpl<$Res>
    extends _$FeedDefsReplyRefRootRefsCopyWithImpl<$Res,
...
class _$UFeedDefsReplyRefRootPostViewImpl
    implements UFeedDefsReplyRefRootPostView {
  const _$UFeedDefsReplyRefRootPostViewImpl({required this.data});
  ...
  @override
  String toString() {
    return 'FeedDefsReplyRefRootRefs.postView(data: $data)';
  }
...
abstract class UFeedDefsReplyRefRootPostView
    implements FeedDefsReplyRefRootRefs {
...
class _$UFeedDefsReplyRefRootNotFoundPostImpl
    implements UFeedDefsReplyRefRootNotFoundPost {
  ...
  @override
  String toString() {
    return 'FeedDefsReplyRefRootRefs.notFoundPost(data: $data)';
  }
...
abstract class UFeedDefsReplyRefRootNotFoundPost
    implements FeedDefsReplyRefRootRefs {
...
class _$UFeedDefsReplyRefRootBlockedPostImpl
    implements UFeedDefsReplyRefRootBlockedPost {
  ...
  @override
  String toString() {
    return 'FeedDefsReplyRefRootRefs.blockedPost(data: $data)';
  }
...
abstract class UFeedDefsReplyRefRootBlockedPost
    implements FeedDefsReplyRefRootRefs {
...
class _$UFeedDefsReplyRefRootUnknownImpl
    implements UFeedDefsReplyRefRootUnknown {
  ...
  @override
  String toString() {
    return 'FeedDefsReplyRefRootRefs.unknown(data: $data)';
  }
...
abstract class UFeedDefsReplyRefRootUnknown
    implements FeedDefsReplyRefRootRefs {
