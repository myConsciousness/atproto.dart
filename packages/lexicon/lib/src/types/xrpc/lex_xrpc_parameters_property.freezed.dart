...
extension LexXrpcParametersPropertyPatterns on LexXrpcParametersProperty {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case ULexXrpcParametersPropertyPrimitiveArray()
          when primitiveArray != null:
        return primitiveArray(_that);
      case ULexXrpcParametersPropertyPrimitive() when primitive != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ULexXrpcParametersPropertyPrimitiveArray():
        return primitiveArray(_that);
      case ULexXrpcParametersPropertyPrimitive():
        return primitive(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case ULexXrpcParametersPropertyPrimitiveArray()
          when primitiveArray != null:
        return primitiveArray(_that.data);
      case ULexXrpcParametersPropertyPrimitive() when primitive != null:
