...
extension LexXrpcBodyPatterns on LexXrpcBody {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LexXrpcBody value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? description, String encoding,
            @LexXrpcSchemaConverter() LexXrpcSchema? schema)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _LexXrpcBody() when $default != null:
        return $default(_that.description, _that.encoding, _that.schema);
      case _:
        return orElse();
    }
  }
