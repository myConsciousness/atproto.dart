...
_LexXrpcParameters _$LexXrpcParametersFromJson(Map json) =>
    $checkedCreate('_LexXrpcParameters', json, ($checkedConvert) {
      final val = _LexXrpcParameters(
        type: $checkedConvert('type', (v) => v as String? ?? 'params'),
        description: $checkedConvert('description', (v) => v as String?),
        requiredProperties: $checkedConvert(
          'required',
        ...
        properties: $checkedConvert(
          ...
          (v) => (v as Map?)?.map(
            (k, e) => MapEntry(
              k as String,
              const LexXrpcParametersPropertyConverter().fromJson(
