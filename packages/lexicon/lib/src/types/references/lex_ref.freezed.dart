...
extension LexRefPatterns on LexRef {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LexRef value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String type, String? description, String? ref)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LexRef() when $default != null:
        return $default(_that.type, _that.description, _that.ref);
      case _:
        return orElse();
    }
  }
