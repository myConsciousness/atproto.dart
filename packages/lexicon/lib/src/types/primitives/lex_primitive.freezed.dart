...
extension LexPrimitivePatterns on LexPrimitive {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULexPrimitiveInteger() when integer != null:
        return integer(_that);
      case ULexPrimitiveString() when string != null:
        return string(_that);
      case ULexPrimitiveUnknown() when unknown != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ULexPrimitiveBoolean():
        return boolean(_that);
      case ULexPrimitiveInteger():
        return integer(_that);
      case ULexPrimitiveString():
        return string(_that);
      case ULexPrimitiveUnknown():
        return unknown(_that);
      case _:
