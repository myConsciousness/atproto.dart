...
extension LexObjectPropertyPatterns on LexObjectProperty {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ULexObjectPropertyIpld() when ipld != null:
        return ipld(_that);
      case ULexObjectPropertyArray() when array != null:
        return array(_that);
      case ULexObjectPropertyBlob() when blob != null:
        return blob(_that);
      case ULexObjectPropertyPrimitive() when primitive != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ULexObjectPropertyRefVariant():
        return refVariant(_that);
      case ULexObjectPropertyIpld():
        return ipld(_that);
      case ULexObjectPropertyArray():
        return array(_that);
      case ULexObjectPropertyBlob():
        return blob(_that);
      case ULexObjectPropertyPrimitive():
        return primitive(_that);
      case _:
