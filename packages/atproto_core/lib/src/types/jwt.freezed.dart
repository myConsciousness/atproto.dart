...
$JwtCopyWith<Jwt> get copyWith => _$JwtCopyWithImpl<Jwt>(this as Jwt, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Jwt&&(identical(other.aud, aud) || other.aud == aud)&&(identical(other.sub, sub) || other.sub == sub)&&(identical(other.jti, jti) || other.jti == jti)&&const DeepCollectionEquality().equals(other.cnf, cnf)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.scope, scope) || other.scope == scope)&&(identical(other.iss, iss) || other.iss == iss)&&(identical(other.exp, exp) || other.exp == exp)&&(identical(other.iat, iat) || other.iat == iat));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,aud,sub,jti,const DeepCollectionEquality().hash(cnf),clientId,scope,iss,exp,iat);
...
/// @nodoc
class _$JwtCopyWithImpl<$Res>
    implements $JwtCopyWith<$Res> {
...
/// Create a copy of Jwt
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? aud = freezed,Object? sub = null,Object? jti = freezed,Object? cnf = freezed,Object? clientId = freezed,Object? scope = freezed,Object? iss = freezed,Object? exp = null,Object? iat = null,}) {
...
as DateTime,iat: null == iat ? _self.iat : iat // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Jwt value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Jwt value)  $default,){
final _that = this;
switch (_that) {
case _Jwt():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Jwt value)?  $default,){
final _that = this;
switch (_that) {
case _Jwt() when $default != null:
return $default(_that);case _:
...
class _Jwt implements Jwt {
  const _Jwt({this.aud, required this.sub, this.jti, final  Map<String, dynamic>? cnf, this.clientId, this.scope, this.iss, @dateTimeConverter required this.exp, @dateTimeConverter required this.iat}): _cnf = cnf;
...
@override Map<String, dynamic>? get cnf {
  final value = _cnf;
...
@override@dateTimeConverter final  DateTime exp;
@override@dateTimeConverter final  DateTime iat;

/// Create a copy of Jwt
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$JwtCopyWith<_Jwt> get copyWith => __$JwtCopyWithImpl<_Jwt>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JwtToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Jwt&&(identical(other.aud, aud) || other.aud == aud)&&(identical(other.sub, sub) || other.sub == sub)&&(identical(other.jti, jti) || other.jti == jti)&&const DeepCollectionEquality().equals(other._cnf, _cnf)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.scope, scope) || other.scope == scope)&&(identical(other.iss, iss) || other.iss == iss)&&(identical(other.exp, exp) || other.exp == exp)&&(identical(other.iat, iat) || other.iat == iat));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,aud,sub,jti,const DeepCollectionEquality().hash(_cnf),clientId,scope,iss,exp,iat);
...
/// Create a copy of Jwt
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? aud = freezed,Object? sub = null,Object? jti = freezed,Object? cnf = freezed,Object? clientId = freezed,Object? scope = freezed,Object? iss = freezed,Object? exp = null,Object? iat = null,}) {
  return _then(_Jwt(
aud: freezed == aud ? _self.aud : aud // ignore: cast_nullable_to_non_nullable
as String?,sub: null == sub ? _self.sub : sub // ignore: cast_nullable_to_non_nullable
as String,jti: freezed == jti ? _self.jti : jti // ignore: cast_nullable_to_non_nullable
